Attribute VB_Name = "TreeAndTree"
Option Explicit

Sub MakeTreeAndTree(pctl As ControlData, p As PART, Child As PART, mode As String, body As String, tsClick As String, tsInit As String)
  ...
  body = body & vbCrLf & ""
    ...
    If AllowAdd Then
      ...
      body = body & vbCrLf & "    Dim f As Object"
      body = body & vbCrLf & "    Set f = gu." & Child.name & ".Add()"
      'Defaults
      body = body & vbCrLf & MakeDefaultCode(Child, "f")
    ...
    body = body & vbCrLf & "else"
    body = body & vbCrLf & "    Dim gu As Object"
    body = body & vbCrLf & "    Set gu = Item.FindRowObject(""" & Child.name & """, Left(" & lctl.name & ".selecteditem.Key, 38))"
    body = body & vbCrLf & "    if gu is nothing then exit sub"
