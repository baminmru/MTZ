Attribute VB_Name = "PanelAndPanel"
Option Explicit

Sub MakePanelAndPanel(pctl As ControlData, ot As OBJECTTYPE, p As PART, Child As PART, mode As String, body As String, tsClick As String, tsInit As String)
  ...
  body = body & vbCrLf & " If " & lctl.name & ".Item is nothing  Then"
  ...
  body = body & vbCrLf & " If " & lctl.name & ".Item." & Child.name & ".Count = 0 Then"
  body = body & vbCrLf & "   " & lctl.name & ".Item." & Child.name & ".Add"
  body = body & vbCrLf & " End If"
  body = body & vbCrLf & " Set " & rctl.name & ".Item = " & lctl.name & ".Item." & Child.name & ".Item(1)"
  ...
  body = body & vbCrLf & "End Sub"
    ...
    body = body & vbCrLf & "    if " & rctl.name & ".IsOK and " & lctl.name & ".IsOK then"
