...
Begin VB.UserControl ctlDEF_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin STDInfoStoreGUI.vpnFolder_DEF pnlFolder 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
' Главный контрольный элемент для редактирования документа режим DEF
...
pnlFolder.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "STDInfoStore", "ctlDEF_main"
