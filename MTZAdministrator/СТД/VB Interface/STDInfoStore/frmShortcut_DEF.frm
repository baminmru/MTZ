...
Begin VB.Form frmShortcut_DEF 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Ярлыки документов"
      Top             =   6225
      Width           =   825
   End
   Begin STDInfoStoreGUI.ShortcutDEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmShortcut_DEF"
...
' Форма редактирования раздела Shortcut режим DEF
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F4348200-31D1-4C14-B188-1CFE15547265}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F4348200-31D1-4C14-B188-1CFE15547265}"
  Open s & Me.Name & "{F4348200-31D1-4C14-B188-1CFE15547265}" For Output As #ff
