...
If Name = "Folder" Then
 Set FormByName = New frmFolder_DEF
 Exit Function
End If

If Name = "Shortcut" Then
 Set FormByName = New frmShortcut_DEF
 Exit Function
End If
...
If Name = "Folder" Then
 Set FormByName = New frmFolder_ADM
 Exit Function
End If

If Name = "Shortcut" Then
 Set FormByName = New frmShortcut_ADM
 Exit Function
End If

If Name = "InfoStoreDef" Then
 Set FormByName = New frmInfoStoreDef_ADM
 Exit Function
End If
...
If Name = "Folder" Then
 Set FormByName = New frmFolder_
 Exit Function
End If

If Name = "Shortcut" Then
 Set FormByName = New frmShortcut_
 Exit Function
End If
