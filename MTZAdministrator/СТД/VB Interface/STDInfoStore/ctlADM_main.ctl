...
Begin VB.UserControl ctlADM_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin STDInfoStoreGUI.vpnFolder_ADM pnlFolder 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin STDInfoStoreGUI.vpnInfoStoreDef_ADM pnlInfoStoreDef 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
' Главный контрольный элемент для редактирования документа режим ADM
...
If IsItOk Then IsItOk = pnlFolder.IsOK
If IsItOk Then IsItOk = pnlInfoStoreDef.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlInfoStoreDef.Visible = False
  pnlFolder.Visible = False
   ...
   Case "Folder"
     ...
     .Visible = True
     .ZOrder 0
     pnlFolder.OnClick Item, ParentForm
     End With
   Case "InfoStoreDef"
     With pnlInfoStoreDef
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlInfoStoreDef.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Папка"
ts.Tabs.Item(1).Key = "Folder"
pnlFolder.OnInit Item, ParentForm
Call ts.Tabs.Add(, "InfoStoreDef", "Описание")
pnlInfoStoreDef.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "STDInfoStore", "ctlADM_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlFolder.CloseClass
 pnlInfoStoreDef.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlFolder.IsChanged
m_IsChanged = m_IsChanged Or pnlInfoStoreDef.IsChanged
