...
Begin VB.UserControl vpnFolder_ADM 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.VFrames pnlFolder 
      ...
      Begin GridEX20.GridEX gridShortcut 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnFolder_ADM.ctx":0000
         Column(2)       =   "vpnFolder_ADM.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnFolder_ADM.ctx":016C
         FormatStyle(2)  =   "vpnFolder_ADM.ctx":02C8
         FormatStyle(3)  =   "vpnFolder_ADM.ctx":0378
         FormatStyle(4)  =   "vpnFolder_ADM.ctx":042C
         FormatStyle(5)  =   "vpnFolder_ADM.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnFolder_ADM.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnFolder_ADM"
...
Private Sub opShortcut_OpenRef_ADM(RowItem As Object)
With RowItem
...
If (treeFolder.SelectedItem Is Nothing) Then Exit Sub
  ...
  Set f = p.Folder.Add()
      ...
      Set frmFolder_ADM.Item = f
again:       frmFolder_ADM.NotFirstTime = False
      frmFolder_ADM.OnInit
      frmFolder_ADM.Show vbModal
      If frmFolder_ADM.OK Then
        err.Clear
        f.Save
...
Private Sub cmdShortcutEdit_Click()
    ...
    bm2 = gridShortcut.RowBookmark(gridShortcut.RowIndex(gridShortcut.Row))
    Set u = Item.FindRowObject(Right(bm2, Len(bm2) - 38), Left(bm2, 38))
    Set frmShortcut_ADM.Item = u
again:     frmShortcut_ADM.NotFirstTime = False
    frmShortcut_ADM.OnInit
    frmShortcut_ADM.Show vbModal
    If frmShortcut_ADM.OK Then
    err.Clear
    u.Save
    If err.Number <> 0 Then
      MsgBox err.Description, vbOKOnly + vbExclamation, "Изменение"
