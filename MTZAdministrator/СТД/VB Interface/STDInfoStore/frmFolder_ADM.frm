...
Begin VB.Form frmFolder_ADM 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Папка каталога"
      Top             =   6225
      Width           =   825
   End
   Begin STDInfoStoreGUI.FolderADM Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFolder_ADM"
...
' Форма редактирования раздела Folder режим ADM
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{B0C4BC9C-E241-4A7B-9CAC-E221DA31DF89}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{B0C4BC9C-E241-4A7B-9CAC-E221DA31DF89}"
  Open s & Me.Name & "{B0C4BC9C-E241-4A7B-9CAC-E221DA31DF89}" For Output As #ff
