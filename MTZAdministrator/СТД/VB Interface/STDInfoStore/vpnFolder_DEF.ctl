...
Begin VB.UserControl vpnFolder_DEF 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.VFrames pnlFolder 
      ...
      Begin GridEX20.GridEX gridShortcut 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnFolder_DEF.ctx":0000
         Column(2)       =   "vpnFolder_DEF.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnFolder_DEF.ctx":016C
         FormatStyle(2)  =   "vpnFolder_DEF.ctx":02C8
         FormatStyle(3)  =   "vpnFolder_DEF.ctx":0378
         FormatStyle(4)  =   "vpnFolder_DEF.ctx":042C
         FormatStyle(5)  =   "vpnFolder_DEF.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnFolder_DEF.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnFolder_DEF"
...
Private Sub opShortcut_OpenRef_DEF(RowItem As Object)
With RowItem
...
If (treeFolder.SelectedItem Is Nothing) Then Exit Sub
  ...
  Set f = p.Folder.Add()
      ...
      Set frmFolder_DEF.Item = f
again:       frmFolder_DEF.NotFirstTime = False
      frmFolder_DEF.OnInit
      frmFolder_DEF.Show vbModal
      If frmFolder_DEF.OK Then
        err.Clear
        f.Save
...
Private Sub cmdShortcutEdit_Click()
    ...
    bm2 = gridShortcut.RowBookmark(gridShortcut.RowIndex(gridShortcut.Row))
    Set u = Item.FindRowObject(Right(bm2, Len(bm2) - 38), Left(bm2, 38))
    Set frmShortcut_DEF.Item = u
again:     frmShortcut_DEF.NotFirstTime = False
    frmShortcut_DEF.OnInit
    frmShortcut_DEF.Show vbModal
    If frmShortcut_DEF.OK Then
    err.Clear
    u.Save
    If err.Number <> 0 Then
      MsgBox err.Description, vbOKOnly + vbExclamation, "Изменение"
