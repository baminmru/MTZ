VERSION 5.00
Begin VB.Form frmInfoStoreDef_ADM 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание каталога"
      Top             =   6225
      Width           =   825
   End
   Begin STDInfoStoreGUI.InfoStoreDefADM Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmInfoStoreDef_ADM"
...
' Форма редактирования раздела InfoStoreDef режим ADM
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{645CCAF4-0519-4B06-9325-B7F2EDFE46BD}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{645CCAF4-0519-4B06-9325-B7F2EDFE46BD}"
  Open s & Me.Name & "{645CCAF4-0519-4B06-9325-B7F2EDFE46BD}" For Output As #ff
