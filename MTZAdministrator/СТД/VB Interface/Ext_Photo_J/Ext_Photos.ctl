...
Begin VB.UserControl Ext_Photos 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtTheRefFieldName 
         Height          =   300
         Left            =   300
         MaxLength       =   255
         TabIndex        =   11
         ToolTipText     =   "Поле ссылка на добавление"
         Top             =   3225
         Width           =   3000
      End
      Begin VB.TextBox txtTheReplacedPart 
         Height          =   300
         Left            =   300
         MaxLength       =   255
         TabIndex        =   9
         ToolTipText     =   "Подменяемая часть"
         Top             =   2520
         Width           =   3000
      End
      ...
      Begin VB.TextBox txtTheJournal 
         ...
         Width           =   2550
      End
      Begin VB.TextBox txtTheSourceObject 
         Height          =   300
         Left            =   300
         MaxLength       =   255
         TabIndex        =   4
         ToolTipText     =   "Исходный объект (Тип)"
         Top             =   1110
         Width           =   3000
      End
      Begin VB.TextBox txtTheName 
         ...
         Width           =   3000
      End
      Begin VB.Label lblTheRefFieldName 
         BackStyle       =   0  'Transparent
         Caption         =   "Поле ссылка на добавление:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   10
         ...
         Width           =   3000
      End
      Begin VB.Label lblTheReplacedPart 
         BackStyle       =   0  'Transparent
         Caption         =   "Подменяемая часть:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   8
      ...
      Begin VB.Label lblTheJournal 
         ...
         Width           =   3000
      End
      Begin VB.Label lblTheSourceObject 
         BackStyle       =   0  'Transparent
         Caption         =   "Исходный объект (Тип):"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   3
...
End Sub
Private Sub txtTheSourceObject_Change()
  Changing
...
Private Sub cmdTheJournal_MenuClick(ByVal sCaption As String)
  ...
  End If
End Sub
Private Sub txtTheReplacedPart_Change()
  Changing

End Sub
Private Sub txtTheRefFieldName_Change()
  Changing
...
If mIsOK Then mIsOK = IsSet(txtTheSourceObject.Text)
...
txtTheName = Item.TheName
  On Error Resume Next
txtTheSourceObject = Item.TheSourceObject
...
End If
 LoadBtnPictures cmdTheJournal, cmdTheJournal.Tag
  ...
  On Error Resume Next
txtTheReplacedPart = Item.TheReplacedPart
  On Error Resume Next
txtTheRefFieldName = Item.TheRefFieldName
...
Item.TheSourceObject = txtTheSourceObject
If txtTheJournal.Tag <> "" Then
  Set Item.TheJournal = Item.Application.Manager.GetInstanceObject(txtTheJournal.Tag)
Else
  Set Item.TheJournal = Nothing
End If
Item.TheReplacedPart = txtTheReplacedPart
Item.TheRefFieldName = txtTheRefFieldName
 mIsChanged = False
 RaiseEvent Changed
End Sub
