...
Begin VB.UserControl Ext_Photo_Call 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtTheCallString 
         Height          =   300
         Left            =   300
         MaxLength       =   255
         TabIndex        =   5
      ...
      Begin VB.TextBox txtTargetPlatform 
         ...
         Width           =   2550
      End
      Begin VB.Label lblTheCallString 
   ...
   End
End
Attribute VB_Name = "Ext_Photo_Call"
...
Private Sub cmdTargetPlatform_MenuClick(ByVal sCaption As String)
          ...
          txtTargetPlatform = ""
End Sub
Private Sub txtTheCallString_Change()
  Changing
...
If mIsOK Then mIsOK = IsSet(txtTheCallString.Text)
  IsOK = mIsOK
End Function
...
End If
 LoadBtnPictures cmdTargetPlatform, cmdTargetPlatform.Tag
  ...
  On Error Resume Next
txtTheCallString = Item.TheCallString
...
End If
Item.TheCallString = txtTheCallString
 mIsChanged = False
 RaiseEvent Changed
End Sub
