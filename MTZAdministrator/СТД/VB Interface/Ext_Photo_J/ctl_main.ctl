...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin Ext_Photo_JGUI.vpnExt_Photos_ pnlExt_Photos 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlExt_Photos.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlExt_Photos.Visible = False
   ...
   Case "Ext_Photos"
     ...
     .Visible = True
     .ZOrder 0
     pnlExt_Photos.OnClick item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.item(1).Caption = "Настройка"
ts.Tabs.item(1).Key = "Ext_Photos"
pnlExt_Photos.OnInit item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "Ext_Photo_J", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlExt_Photos.IsChanged
