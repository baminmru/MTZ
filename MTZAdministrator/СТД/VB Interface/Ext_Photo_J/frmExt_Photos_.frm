...
Begin VB.Form frmExt_Photos_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin Ext_Photo_JGUI.Ext_Photos Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmExt_Photos_"
...
' Форма редактирования раздела Ext_Photos режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DCCCD618-515C-4765-8330-B52292C4A74F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DCCCD618-515C-4765-8330-B52292C4A74F}"
  Open s & Me.Name & "{DCCCD618-515C-4765-8330-B52292C4A74F}" For Output As #ff
