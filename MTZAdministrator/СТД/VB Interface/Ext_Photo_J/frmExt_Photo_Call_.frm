VERSION 5.00
Begin VB.Form frmExt_Photo_Call_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Вызов изображения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin Ext_Photo_JGUI.Ext_Photo_Call Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmExt_Photo_Call_"
...
' Форма редактирования раздела Ext_Photo_Call режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{FD8017D3-2B28-455E-BDAF-5D0D589442F6}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{FD8017D3-2B28-455E-BDAF-5D0D589442F6}"
  Open s & Me.Name & "{FD8017D3-2B28-455E-BDAF-5D0D589442F6}" For Output As #ff
