...
If Name = "Num_head" Then
 Set FormByName = New frmNum_head_
 Exit Function
End If

If Name = "Num_zones" Then
 Set FormByName = New frmNum_zones_
 Exit Function
End If

If Name = "Num_Values" Then
 Set FormByName = New frmNum_Values_
 Exit Function
End If
