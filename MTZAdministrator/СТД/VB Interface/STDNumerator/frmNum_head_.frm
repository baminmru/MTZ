...
Begin VB.Form frmNum_head_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание нумератора"
      Top             =   6225
      Width           =   825
   End
   Begin STDNumeratorGUI.Num_head Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmNum_head_"
...
' Форма редактирования раздела Num_head режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C436BED9-294E-48A7-8C37-6D4CF32343BE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C436BED9-294E-48A7-8C37-6D4CF32343BE}"
  Open s & Me.Name & "{C436BED9-294E-48A7-8C37-6D4CF32343BE}" For Output As #ff
