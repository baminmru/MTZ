...
Begin VB.UserControl Num_zones 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtZoneMask 
         Height          =   300
         Left            =   300
         MaxLength       =   255
         TabIndex        =   2
         ToolTipText     =   "ћаска зоны"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblZoneMask 
...
'панель редактировани€ раздела «оны уникальных нумеров
...
Private Sub txtZoneMask_Change()
  Changing
...
If mIsOK Then mIsOK = IsSet(txtZoneMask.Text)
  IsOK = mIsOK
End Function
