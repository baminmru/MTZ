...
Begin VB.Form frmNum_zones_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Зоны уникальных нумеров"
      Top             =   6225
      Width           =   825
   End
   Begin STDNumeratorGUI.Num_zones Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmNum_zones_"
...
' Форма редактирования раздела Num_zones режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{59512432-E6DF-41F9-A436-6BF7DB1800BB}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{59512432-E6DF-41F9-A436-6BF7DB1800BB}"
  Open s & Me.Name & "{59512432-E6DF-41F9-A436-6BF7DB1800BB}" For Output As #ff
