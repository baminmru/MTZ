...
Begin VB.Form frmNum_Values_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "уникальные номера"
      Top             =   6225
      Width           =   825
   End
   Begin STDNumeratorGUI.Num_Values Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmNum_Values_"
...
' Форма редактирования раздела Num_Values режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{833DC00B-E8D7-4D91-9103-2DD084BEFC1E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{833DC00B-E8D7-4D91-9103-2DD084BEFC1E}"
  Open s & Me.Name & "{833DC00B-E8D7-4D91-9103-2DD084BEFC1E}" For Output As #ff
