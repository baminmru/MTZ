...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin STDNumeratorGUI.vpnNum_head_ pnlNum_head 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin STDNumeratorGUI.vpnNum_zones_ pnlNum_zones 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlNum_head.IsOK
If IsItOk Then IsItOk = pnlNum_zones.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlNum_zones.Visible = False
  pnlNum_head.Visible = False
   ...
   Case "Num_head"
     ...
     .Visible = True
     .ZOrder 0
     pnlNum_head.OnClick Item, ParentForm
     End With
   Case "Num_zones"
     With pnlNum_zones
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlNum_zones.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "Num_head"
pnlNum_head.OnInit Item, ParentForm
Call ts.Tabs.Add(, "Num_zones", "Зоны")
pnlNum_zones.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "STDNumerator", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlNum_head.CloseClass
 pnlNum_zones.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlNum_head.IsChanged
m_IsChanged = m_IsChanged Or pnlNum_zones.IsChanged
