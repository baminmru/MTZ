...
Begin VB.UserControl vpnITTD_GTYPE_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerITTD_GTYPE 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlITTD_GTYPE 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdITTD_GTYPEAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPEFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPECfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPEPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPERef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPEDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPEEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTD_GTYPEAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridITTD_GTYPE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTD_GTYPE_main.ctx":0000
         Column(2)       =   "vpnITTD_GTYPE_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTD_GTYPE_main.ctx":016C
         FormatStyle(2)  =   "vpnITTD_GTYPE_main.ctx":02C8
         FormatStyle(3)  =   "vpnITTD_GTYPE_main.ctx":0378
         FormatStyle(4)  =   "vpnITTD_GTYPE_main.ctx":042C
         FormatStyle(5)  =   "vpnITTD_GTYPE_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTD_GTYPE_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdITTD_GTYPERun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupITTD_GTYPE 
      Caption         =   "Меню для Тип товара"
      Visible         =   0   'False
      Begin VB.Menu mnuITTD_GTYPEAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuITTD_GTYPEEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuITTD_GTYPEDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuITTD_GTYPEOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuITTD_GTYPERef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuITTD_GTYPES1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuITTD_GTYPEBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuITTD_GTYPECOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuITTD_GTYPECUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuITTD_GTYPEPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuITTD_GTYPECHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuITTD_GTYPECLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuITTD_GTYPEPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuITTD_GTYPECfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuITTD_GTYPEFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuITTD_GTYPEAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnITTD_GTYPE_main"
