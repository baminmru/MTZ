...
Begin VB.UserControl ITTD_EMAILadmi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.ComboBox cmbIgnoreAddress 
         Height          =   315
         Left            =   300
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   7
         ToolTipText     =   "Отключить уведомления на этот адрес"
         Top             =   1815
         Width           =   3000
      End
      Begin MTZ_PANEL.DropButton cmdEMAIL 
         ...
         TabIndex        =   5
         Tag             =   "mailopen.ico"
         ToolTipText     =   "Адрес электронной почты"
         Top             =   1110
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
      ...
      Begin VB.TextBox txtFIO 
         ...
         MaxLength       =   255
         TabIndex        =   2
         ToolTipText     =   "ФИО. получателя"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblIgnoreAddress 
         BackStyle       =   0  'Transparent
         Caption         =   "Отключить уведомления на этот адрес:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "ITTD_EMAILadmi"
...
'панель редактирования раздела Адреса получателей информации о выморозке
