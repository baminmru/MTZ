VERSION 5.00
Begin VB.Form frmITTD_ATYPE_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTDGUI.ITTD_ATYPEmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_ATYPE_main"
...
' Форма редактирования раздела ITTD_ATYPE режим main
