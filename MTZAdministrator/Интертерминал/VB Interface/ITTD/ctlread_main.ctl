...
Begin VB.UserControl ctlread_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTDGUI.vpnITTD_GTYPE_read pnlITTD_GTYPE 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_ZTYPE_read pnlITTD_ZTYPE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_PLTYPE_read pnlITTD_PLTYPE 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_QTYPE_read pnlITTD_QTYPE 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_ATYPE_read pnlITTD_ATYPE 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_SRV_read pnlITTD_SRV 
      Height          =   1500
      Left            =   1500
      TabIndex        =   6
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_PART_read pnlITTD_PART 
      Height          =   1500
      Left            =   3000
      TabIndex        =   7
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_FACTORY_read pnlITTD_FACTORY 
      Height          =   1500
      Left            =   4500
      TabIndex        =   8
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_KILLPLACE_read pnlITTD_KILLPLACE 
      Height          =   1500
      Left            =   6000
      TabIndex        =   9
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_COUNTRY_read pnlITTD_COUNTRY 
      Height          =   1500
      Left            =   0
      TabIndex        =   10
      Top             =   3000
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_CAMERA_read pnlITTD_CAMERA 
      Height          =   1500
      Left            =   1500
      TabIndex        =   11
      Top             =   3000
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_RULE_read pnlITTD_RULE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   12
      Top             =   3000
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_OPTTYPE_read pnlITTD_OPTTYPE 
      Height          =   1500
      Left            =   4500
      TabIndex        =   13
      Top             =   3000
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_MOROZ_read pnlITTD_MOROZ 
      Height          =   1500
      Left            =   6000
      TabIndex        =   14
      Top             =   3000
      ...
      _ExtentY        =   2646
   End
   Begin ITTDGUI.vpnITTD_EMAIL_read pnlITTD_EMAIL 
      Height          =   1500
      Left            =   0
      TabIndex        =   15
      Top             =   4500
