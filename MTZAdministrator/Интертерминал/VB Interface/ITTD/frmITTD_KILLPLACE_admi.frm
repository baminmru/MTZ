VERSION 5.00
Begin VB.Form frmITTD_KILLPLACE_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTDGUI.ITTD_KILLPLACEadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_KILLPLACE_admi"
...
' Форма редактирования раздела ITTD_KILLPLACE режим admi
