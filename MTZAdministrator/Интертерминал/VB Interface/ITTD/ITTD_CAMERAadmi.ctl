...
Begin VB.UserControl ITTD_CAMERAadmi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtCameraMask 
         Height          =   300
         Left            =   300
         MaxLength       =   12
         TabIndex        =   4
         ToolTipText     =   "ћаска номера €чеек"
         Top             =   1110
         Width           =   3000
      End
      Begin VB.TextBox txtName 
         ...
         Width           =   3000
      End
      Begin VB.Label lblCameraMask 
         BackStyle       =   0  'Transparent
         Caption         =   "ћаска номера €чеек:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "ITTD_CAMERAadmi"
...
'панель редактировани€ раздела ’олодильные камеры
