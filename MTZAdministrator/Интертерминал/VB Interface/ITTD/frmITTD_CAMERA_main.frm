VERSION 5.00
Begin VB.Form frmITTD_CAMERA_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Холодильные камеры"
      Top             =   6225
      Width           =   825
   End
   Begin ITTDGUI.ITTD_CAMERAmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_CAMERA_main"
...
' Форма редактирования раздела ITTD_CAMERA режим main
