VERSION 5.00
Begin VB.Form frmITTD_MOROZ_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Параметры выморозки"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Параметры выморозки"
      Top             =   6225
      Width           =   825
   End
   Begin ITTDGUI.ITTD_MOROZread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_MOROZ_read"
...
' Форма редактирования раздела ITTD_MOROZ режим read
