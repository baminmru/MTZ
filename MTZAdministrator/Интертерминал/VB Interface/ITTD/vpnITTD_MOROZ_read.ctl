...
Begin VB.UserControl vpnITTD_MOROZ_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTD_MOROZ 
      ...
      Begin GridEX20.GridEX gridITTD_MOROZ 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTD_MOROZ_read.ctx":0000
         Column(2)       =   "vpnITTD_MOROZ_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTD_MOROZ_read.ctx":016C
         FormatStyle(2)  =   "vpnITTD_MOROZ_read.ctx":02C8
         FormatStyle(3)  =   "vpnITTD_MOROZ_read.ctx":0378
         FormatStyle(4)  =   "vpnITTD_MOROZ_read.ctx":042C
         FormatStyle(5)  =   "vpnITTD_MOROZ_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTD_MOROZ_read.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnITTD_MOROZ_read"
