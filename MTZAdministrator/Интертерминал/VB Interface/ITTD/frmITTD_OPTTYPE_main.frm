VERSION 5.00
Begin VB.Form frmITTD_OPTTYPE_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTDGUI.ITTD_OPTTYPEmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_OPTTYPE_main"
...
' Форма редактирования раздела ITTD_OPTTYPE режим main
