...
Begin VB.UserControl ITTD_SRVmain 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.ComboBox cmbAutoSetPallet 
         Height          =   315
         Left            =   300
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   "Подставлять количество паллет"
         Top             =   3225
         Width           =   3000
      End
      Begin VB.TextBox txtLinkCode 
         Height          =   300
         Left            =   300
         MaxLength       =   30
         TabIndex        =   8
         ToolTipText     =   "Код привязки"
         Top             =   2520
         Width           =   3000
      End
      Begin VB.ComboBox cmbForReceiving 
         Height          =   315
         Left            =   300
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         ToolTipText     =   "Для приема товара"
         Top             =   1815
         Width           =   3000
      End
      Begin VB.ComboBox cmbForShipping 
         Height          =   315
         Left            =   300
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   4
         ToolTipText     =   "Для отгрузки"
         Top             =   1110
         Width           =   3000
      End
      Begin VB.TextBox txtName 
         ...
         Width           =   3000
      End
      Begin VB.Label lblAutoSetPallet 
         BackStyle       =   0  'Transparent
         Caption         =   "Подставлять количество паллет:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   9
      ...
      Begin VB.Label lblLinkCode 
         ...
         Width           =   3000
      End
      Begin VB.Label lblForReceiving 
         BackStyle       =   0  'Transparent
         Caption         =   "Для приема товара:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   5
         ...
         Width           =   3000
      End
      Begin VB.Label lblForShipping 
         BackStyle       =   0  'Transparent
         Caption         =   "Для отгрузки:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "ITTD_SRVmain"
