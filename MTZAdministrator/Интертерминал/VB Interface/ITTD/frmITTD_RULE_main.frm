VERSION 5.00
Begin VB.Form frmITTD_RULE_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Правило формирования партии"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Правило по которому зполняются обязательные поля и составляется код партии"
      Top             =   6225
      Width           =   825
   End
   Begin ITTDGUI.ITTD_RULEmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_RULE_main"
...
' Форма редактирования раздела ITTD_RULE режим main
