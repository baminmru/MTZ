VERSION 5.00
Begin VB.Form frmITTD_OPTTYPE_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Тип оптимизации склада"
      Top             =   6225
      Width           =   825
   End
   Begin ITTDGUI.ITTD_OPTTYPEadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_OPTTYPE_admi"
...
' Форма редактирования раздела ITTD_OPTTYPE режим admi
