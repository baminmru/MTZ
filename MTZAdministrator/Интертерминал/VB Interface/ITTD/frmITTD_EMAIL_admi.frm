VERSION 5.00
Begin VB.Form frmITTD_EMAIL_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Адреса получателей информации о выморозке"
      Top             =   6225
      Width           =   825
   End
   Begin ITTDGUI.ITTD_EMAILadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTD_EMAIL_admi"
...
' Форма редактирования раздела ITTD_EMAIL режим admi
