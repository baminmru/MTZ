...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITT2OPTGUI.vpnITT2OPT_DEF_main pnlITT2OPT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlITT2OPT_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlITT2OPT_DEF.Visible = False
   ...
   Case "ITT2OPT_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlITT2OPT_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "ITT2OPT_DEF"
pnlITT2OPT_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "ITT2OPT", "ctlmain_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlITT2OPT_DEF.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{EA1BFF2B-89AB-4EAA-A39B-17380CE9D963}"
    i = i + 1
    m(i).Caption = "Выдать задания"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{451AF4A2-1E63-42B6-9494-A4F8301AEEBB}"
End Function
...
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{EA1BFF2B-89AB-4EAA-A39B-17380CE9D963}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{451AF4A2-1E63-42B6-9494-A4F8301AEEBB}" Then
            m(i).Enabled = True
          End If
        Next
      End If
      If Item.Statusid = "{451AF4A2-1E63-42B6-9494-A4F8301AEEBB}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
   End If
