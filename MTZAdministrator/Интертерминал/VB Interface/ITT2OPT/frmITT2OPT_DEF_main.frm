VERSION 5.00
Begin VB.Form frmITT2OPT_DEF_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание оптимизмации"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITT2OPTGUI.ITT2OPT_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITT2OPT_DEF_main"
...
' Форма редактирования раздела ITT2OPT_DEF режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{54C8139A-4727-4BD3-A424-E11AFAE931AE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{54C8139A-4727-4BD3-A424-E11AFAE931AE}"
  Open s & Me.Name & "{54C8139A-4727-4BD3-A424-E11AFAE931AE}" For Output As #ff
