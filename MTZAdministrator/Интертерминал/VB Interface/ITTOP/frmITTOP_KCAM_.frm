VERSION 5.00
Begin VB.Form frmITTOP_KCAM_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Холодильные камеры"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Привязка кладовщика к холодильным камерам"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPGUI.ITTOP_KCAM Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOP_KCAM_"
...
' Форма редактирования раздела ITTOP_KCAM режим
