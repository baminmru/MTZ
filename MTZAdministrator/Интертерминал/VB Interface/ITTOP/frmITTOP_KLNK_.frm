...
Begin VB.Form frmITTOP_KLNK_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Привязка кладовщиков"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPGUI.ITTOP_KLNK Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOP_KLNK_"
...
' Форма редактирования раздела ITTOP_KLNK режим
