...
Begin VB.Form frmITTOP_KCLI_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "привязка кладвщиков к клиентам"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPGUI.ITTOP_KCLI Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOP_KCLI_"
...
' Форма редактирования раздела ITTOP_KCLI режим
