...
Begin VB.Form frmITTOP_OPKAM_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Камеры, с которыми работает оператор"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPGUI.ITTOP_OPKAM Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOP_OPKAM_"
...
' Форма редактирования раздела ITTOP_OPKAM режим
