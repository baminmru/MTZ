...
Begin VB.Form frmITTOP_OPLNK_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Привязка операторов"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPGUI.ITTOP_OPLNK Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOP_OPLNK_"
...
' Форма редактирования раздела ITTOP_OPLNK режим
