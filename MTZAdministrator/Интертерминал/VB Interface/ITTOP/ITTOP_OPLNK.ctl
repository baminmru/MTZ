...
Begin VB.UserControl ITTOP_OPLNK 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
...
'панель редактировани€ раздела ѕрив€зка операторов
