...
Begin VB.Form frmITTPL_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTPLGUI.ITTPL_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTPL_DEF_"
...
' Форма редактирования раздела ITTPL_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{70BA0B3E-8B61-404B-A8A8-48C80E255086}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{70BA0B3E-8B61-404B-A8A8-48C80E255086}"
  Open s & Me.Name & "{70BA0B3E-8B61-404B-A8A8-48C80E255086}" For Output As #ff
