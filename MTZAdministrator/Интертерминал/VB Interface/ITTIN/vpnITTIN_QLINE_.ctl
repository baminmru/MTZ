...
Begin VB.UserControl vpnITTIN_QLINE_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlITTIN_QLINE 
      ...
      Begin GridEX20.GridEX gridITTIN_PALET 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTIN_QLINE_.ctx":0000
         Column(2)       =   "vpnITTIN_QLINE_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTIN_QLINE_.ctx":016C
         FormatStyle(2)  =   "vpnITTIN_QLINE_.ctx":02C8
         FormatStyle(3)  =   "vpnITTIN_QLINE_.ctx":0378
         FormatStyle(4)  =   "vpnITTIN_QLINE_.ctx":042C
         FormatStyle(5)  =   "vpnITTIN_QLINE_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTIN_QLINE_.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridITTIN_QLINE 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTIN_QLINE_.ctx":0794
         Column(2)       =   "vpnITTIN_QLINE_.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTIN_QLINE_.ctx":0900
         FormatStyle(2)  =   "vpnITTIN_QLINE_.ctx":0A5C
         FormatStyle(3)  =   "vpnITTIN_QLINE_.ctx":0B0C
         FormatStyle(4)  =   "vpnITTIN_QLINE_.ctx":0BC0
         FormatStyle(5)  =   "vpnITTIN_QLINE_.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnITTIN_QLINE_.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnITTIN_QLINE_"
