VERSION 5.00
Begin VB.Form frmITTIN_QLINE_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTINGUI.ITTIN_QLINEadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTIN_QLINE_admi"
...
' Форма редактирования раздела ITTIN_QLINE режим admi
