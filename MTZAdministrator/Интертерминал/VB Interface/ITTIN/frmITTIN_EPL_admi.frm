VERSION 5.00
Begin VB.Form frmITTIN_EPL_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Пустые поддоны к заказу"
      Top             =   6225
      Width           =   825
   End
   Begin ITTINGUI.ITTIN_EPLadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTIN_EPL_admi"
...
' Форма редактирования раздела ITTIN_EPL режим admi
