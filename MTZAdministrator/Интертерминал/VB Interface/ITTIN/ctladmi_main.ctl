...
Begin VB.UserControl ctladmi_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTINGUI.vpnITTIN_DEF_admi pnlITTIN_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTINGUI.vpnITTIN_QLINE_admi pnlITTIN_QLINE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTINGUI.vpnITTIN_SRV_admi pnlITTIN_SRV 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTINGUI.vpnITTIN_EPL_admi pnlITTIN_EPL 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
