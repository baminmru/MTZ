...
Begin VB.UserControl vpnITTIN_EPL_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerITTIN_EPL 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlITTIN_EPL 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdITTIN_EPLAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLEdit 
         Enabled         =   0   'False
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdITTIN_EPLAdd 
         Enabled         =   0   'False
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridITTIN_EPL 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTIN_EPL_read.ctx":0000
         Column(2)       =   "vpnITTIN_EPL_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTIN_EPL_read.ctx":016C
         FormatStyle(2)  =   "vpnITTIN_EPL_read.ctx":02C8
         FormatStyle(3)  =   "vpnITTIN_EPL_read.ctx":0378
         FormatStyle(4)  =   "vpnITTIN_EPL_read.ctx":042C
         FormatStyle(5)  =   "vpnITTIN_EPL_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTIN_EPL_read.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdITTIN_EPLRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupITTIN_EPL 
      Caption         =   "Меню для Поддоны к заказу"
      Visible         =   0   'False
      Begin VB.Menu mnuITTIN_EPLAdd 
         Caption         =   "Создать"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuITTIN_EPLEdit 
         Caption         =   "Свойства"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuITTIN_EPLDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuITTIN_EPLOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuITTIN_EPLRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuITTIN_EPLS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuITTIN_EPLBuffer 
         Caption         =   "Буфер"
         Enabled         =   0   'False
         Begin VB.Menu mnuITTIN_EPLCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuITTIN_EPLCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuITTIN_EPLPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuITTIN_EPLCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuITTIN_EPLCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuITTIN_EPLPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuITTIN_EPLCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuITTIN_EPLFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuITTIN_EPLAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnITTIN_EPL_read"
...
'панель для работы со строками раздела Пустые поддоны к заказу
