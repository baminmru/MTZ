...
Begin VB.UserControl vpnITTIN_SRV_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTIN_SRV 
      ...
      Begin GridEX20.GridEX gridITTIN_SRV 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTIN_SRV_read.ctx":0000
         Column(2)       =   "vpnITTIN_SRV_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTIN_SRV_read.ctx":016C
         FormatStyle(2)  =   "vpnITTIN_SRV_read.ctx":02C8
         FormatStyle(3)  =   "vpnITTIN_SRV_read.ctx":0378
         FormatStyle(4)  =   "vpnITTIN_SRV_read.ctx":042C
         FormatStyle(5)  =   "vpnITTIN_SRV_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTIN_SRV_read.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnITTIN_SRV_read"
