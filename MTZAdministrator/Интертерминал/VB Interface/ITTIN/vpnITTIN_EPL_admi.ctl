...
Begin VB.UserControl vpnITTIN_EPL_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTIN_EPL 
      ...
      Begin GridEX20.GridEX gridITTIN_EPL 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTIN_EPL_admi.ctx":0000
         Column(2)       =   "vpnITTIN_EPL_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTIN_EPL_admi.ctx":016C
         FormatStyle(2)  =   "vpnITTIN_EPL_admi.ctx":02C8
         FormatStyle(3)  =   "vpnITTIN_EPL_admi.ctx":0378
         FormatStyle(4)  =   "vpnITTIN_EPL_admi.ctx":042C
         FormatStyle(5)  =   "vpnITTIN_EPL_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTIN_EPL_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnITTIN_EPL_admi"
