VERSION 5.00
Begin VB.UserControl vpnITTOPT_DEF_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTOPT_DEF 
      ...
      Begin VB.CommandButton cmdITTOPT_DEFSave 
         ...
         Width           =   330
      End
      Begin ITTOPTGUI.ITTOPT_DEFread editITTOPT_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnITTOPT_DEF_read"
...
Private Sub opITTOPT_DEF_ITTOPT_SetName_read(RowItem As Object)
With RowItem
...
Private Sub cmdITTOPT_DEFCfg_Click()
    ...
    Dim ff As Long
    ff = FreeFile
    Open GetSetting("MTZ", "CONFIG", "LAYOUTS", "c:\") & "ITTOPT_editITTOPT_DEF_read" For Output As #ff
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  ff = FreeFile
  On Error Resume Next
  Open GetSetting("MTZ", "CONFIG", "LAYOUTS", App.Path & "\LAYOUTS\") & "ITTOPT_editITTOPT_DEF_read" For Input As #ff
  buf = ""
  buf = Input(LOF(ff), ff)
  Close #ff
