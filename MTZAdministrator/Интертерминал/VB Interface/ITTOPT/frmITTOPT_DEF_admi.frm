VERSION 5.00
Begin VB.Form frmITTOPT_DEF_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTOPTGUI.ITTOPT_DEFadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOPT_DEF_admi"
...
' Форма редактирования раздела ITTOPT_DEF режим admi
