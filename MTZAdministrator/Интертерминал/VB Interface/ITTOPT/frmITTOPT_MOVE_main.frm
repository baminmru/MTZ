VERSION 5.00
Begin VB.Form frmITTOPT_MOVE_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Необходимые перемещения"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPTGUI.ITTOPT_MOVEmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOPT_MOVE_main"
...
' Форма редактирования раздела ITTOPT_MOVE режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1B5D7BC6-DB81-4019-9898-D77DC2FFDFF1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1B5D7BC6-DB81-4019-9898-D77DC2FFDFF1}"
  Open s & Me.Name & "{1B5D7BC6-DB81-4019-9898-D77DC2FFDFF1}" For Output As #ff
