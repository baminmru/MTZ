...
Begin VB.UserControl vpnITTOPT_MOVE_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTOPT_MOVE 
      ...
      Begin GridEX20.GridEX gridITTOPT_MOVE 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTOPT_MOVE_read.ctx":0000
         Column(2)       =   "vpnITTOPT_MOVE_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTOPT_MOVE_read.ctx":016C
         FormatStyle(2)  =   "vpnITTOPT_MOVE_read.ctx":02C8
         FormatStyle(3)  =   "vpnITTOPT_MOVE_read.ctx":0378
         FormatStyle(4)  =   "vpnITTOPT_MOVE_read.ctx":042C
         FormatStyle(5)  =   "vpnITTOPT_MOVE_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTOPT_MOVE_read.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnITTOPT_MOVE_read"
