VERSION 5.00
Begin VB.Form frmITTOPT_DEF_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание задания на оптимизацию"
      Top             =   6225
      Width           =   825
   End
   Begin ITTOPTGUI.ITTOPT_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOPT_DEF_main"
...
' Форма редактирования раздела ITTOPT_DEF режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A10E89B4-5EEE-4351-8E10-EF79D3C5576A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A10E89B4-5EEE-4351-8E10-EF79D3C5576A}"
  Open s & Me.Name & "{A10E89B4-5EEE-4351-8E10-EF79D3C5576A}" For Output As #ff
