VERSION 5.00
Begin VB.UserControl vpnITTOPT_DEF_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTOPT_DEF 
      ...
      Begin VB.CommandButton cmdITTOPT_DEFSave 
         ...
         Width           =   330
      End
      Begin ITTOPTGUI.ITTOPT_DEFmain editITTOPT_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnITTOPT_DEF_main"
...
'панель для работы со строками раздела Описание задания на оптимизацию
...
Private Sub opITTOPT_DEF_ITTOPT_SetName_main(RowItem As Object)
With RowItem
...
Private Sub cmdITTOPT_DEFCfg_Click()
    ...
    Dim ff As Long
    ff = FreeFile
    Open GetSetting("MTZ", "CONFIG", "LAYOUTS", "c:\") & "ITTOPT_editITTOPT_DEF_main" For Output As #ff
...
Private Sub cmdITTOPT_DEFDel_Click()
  ...
  If MsgBox("Удалить элемент" & vbCrLf & editITTOPT_DEF.Item.brief & vbCrLf & "?", vbYesNo + vbQuestion, "Внимание") = vbYes Then
    On Error GoTo bye
...
Private Sub cmdITTOPT_DEFSave_Click()
  ...
  On Error GoTo bye
    ...
    MousePointer = vbNormal
        opITTOPT_DEF_ITTOPT_SetName_main editITTOPT_DEF.Item
    cmdITTOPT_DEFSave.Enabled = False
    Else
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  ff = FreeFile
  On Error Resume Next
  Open GetSetting("MTZ", "CONFIG", "LAYOUTS", App.Path & "\LAYOUTS\") & "ITTOPT_editITTOPT_DEF_main" For Input As #ff
  buf = ""
  buf = Input(LOF(ff), ff)
  Close #ff
...
Public Sub OnSave()
  ...
  editITTOPT_DEF.Save
If editITTOPT_DEF.Item.Changed Then
  editITTOPT_DEF.Item.Save
End If
End Sub
