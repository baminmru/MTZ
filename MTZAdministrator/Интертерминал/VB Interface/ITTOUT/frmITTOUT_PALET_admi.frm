VERSION 5.00
Begin VB.Form frmITTOUT_PALET_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTOUTGUI.ITTOUT_PALETadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOUT_PALET_admi"
...
' Форма редактирования раздела ITTOUT_PALET режим admi
