...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTOUTGUI.vpnITTOUT_DEF_ pnlITTOUT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTOUTGUI.vpnITTOUT_LINES_ pnlITTOUT_LINES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTOUTGUI.vpnITTOUT_EPL_ pnlITTOUT_EPL 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTOUTGUI.vpnITTOUT_SRV_ pnlITTOUT_SRV 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
