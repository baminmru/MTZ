...
Begin VB.UserControl vpnITTOUT_EPL_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTOUT_EPL 
      ...
      Begin GridEX20.GridEX gridITTOUT_EPL 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTOUT_EPL_main.ctx":0000
         Column(2)       =   "vpnITTOUT_EPL_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTOUT_EPL_main.ctx":016C
         FormatStyle(2)  =   "vpnITTOUT_EPL_main.ctx":02C8
         FormatStyle(3)  =   "vpnITTOUT_EPL_main.ctx":0378
         FormatStyle(4)  =   "vpnITTOUT_EPL_main.ctx":042C
         FormatStyle(5)  =   "vpnITTOUT_EPL_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTOUT_EPL_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnITTOUT_EPL_main"
