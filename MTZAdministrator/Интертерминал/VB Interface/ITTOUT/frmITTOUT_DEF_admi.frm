VERSION 5.00
Begin VB.Form frmITTOUT_DEF_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTOUTGUI.ITTOUT_DEFadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOUT_DEF_admi"
...
' Форма редактирования раздела ITTOUT_DEF режим admi
