VERSION 5.00
Begin VB.Form frmITTOUT_DEF_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTOUTGUI.ITTOUT_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOUT_DEF_main"
...
' Форма редактирования раздела ITTOUT_DEF режим main
