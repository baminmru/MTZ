VERSION 5.00
Begin VB.Form frmITTOUT_PALET_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Палеты к строке"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTOUTGUI.ITTOUT_PALETmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOUT_PALET_main"
...
' Форма редактирования раздела ITTOUT_PALET режим main
