...
Begin VB.UserControl vpnITTOUT_SRV_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlITTOUT_SRV 
      ...
      Begin GridEX20.GridEX gridITTOUT_SRV 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnITTOUT_SRV_admi.ctx":0000
         Column(2)       =   "vpnITTOUT_SRV_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnITTOUT_SRV_admi.ctx":016C
         FormatStyle(2)  =   "vpnITTOUT_SRV_admi.ctx":02C8
         FormatStyle(3)  =   "vpnITTOUT_SRV_admi.ctx":0378
         FormatStyle(4)  =   "vpnITTOUT_SRV_admi.ctx":042C
         FormatStyle(5)  =   "vpnITTOUT_SRV_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnITTOUT_SRV_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnITTOUT_SRV_admi"
