...
Begin VB.UserControl ITTOUT_PALET 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   End
End
Attribute VB_Name = "ITTOUT_PALET"
...
If txtReorgWeight.Text <> "" Then
 On Error Resume Next
  ...
  ElseIf Val(txtReorgWeight.Text) < -922337203685478# Or Val(txtReorgWeight.Text) > 922337203685478# Then
     cancel = True
     MsgBox "Значение вне допустимого диапазона", vbOKOnly + vbExclamation, "Внимание"
     txtReorgWeight.SetFocus
  End If
...
If txtReorgPackageFullWeight.Text <> "" Then
 On Error Resume Next
  ...
  ElseIf Val(txtReorgPackageFullWeight.Text) < -922337203685478# Or Val(txtReorgPackageFullWeight.Text) > 922337203685478# Then
     cancel = True
     MsgBox "Значение вне допустимого диапазона", vbOKOnly + vbExclamation, "Внимание"
     txtReorgPackageFullWeight.SetFocus
  End If
