VERSION 5.00
Begin VB.Form frmITTOUT_LINES_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTOUTGUI.ITTOUT_LINESmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTOUT_LINES_main"
...
' Форма редактирования раздела ITTOUT_LINES режим main
