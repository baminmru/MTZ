...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTPRGUI.vpnITTPR_DEF_main pnlITTPR_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlITTPR_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlITTPR_DEF.Visible = False
   ...
   Case "ITTPR_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlITTPR_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "ITTPR_DEF"
pnlITTPR_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "ITTPR", "ctlmain_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlITTPR_DEF.IsChanged
