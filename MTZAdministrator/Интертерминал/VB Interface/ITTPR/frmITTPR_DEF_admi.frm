VERSION 5.00
Begin VB.Form frmITTPR_DEF_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTPRGUI.ITTPR_DEFadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTPR_DEF_admi"
...
' Форма редактирования раздела ITTPR_DEF режим admi
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5F6A648C-8BF9-4F5E-B1A1-8B273D3E34F1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5F6A648C-8BF9-4F5E-B1A1-8B273D3E34F1}"
  Open s & Me.Name & "{5F6A648C-8BF9-4F5E-B1A1-8B273D3E34F1}" For Output As #ff
