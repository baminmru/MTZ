...
Begin VB.UserControl ITTPR_DEFadmi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   End
End
Attribute VB_Name = "ITTPR_DEFadmi"
...
End Sub
Private Sub txtInWeight_Validate(cancel As Boolean)
If txtInWeight.Text <> "" Then
 On Error Resume Next
  If Not IsNumeric(txtInWeight.Text) Then
     cancel = True
     MsgBox "Ожидалось число", vbOKOnly + vbExclamation, "Внимание"
     txtInWeight.SetFocus
  ElseIf Val(txtInWeight.Text) < -922337203685478# Or Val(txtInWeight.Text) > 922337203685478# Then
     cancel = True
...
End If
End Sub
Private Sub txtInWeight_KeyPess(KeyAscii As Integer)
Dim s As String
s = "0123456789.,-" & Chr(8)
...
End Sub
Private Sub txtOutWeight_Validate(cancel As Boolean)
If txtOutWeight.Text <> "" Then
 On Error Resume Next
  If Not IsNumeric(txtOutWeight.Text) Then
     cancel = True
     MsgBox "Ожидалось число", vbOKOnly + vbExclamation, "Внимание"
     txtOutWeight.SetFocus
  ElseIf Val(txtOutWeight.Text) < -922337203685478# Or Val(txtOutWeight.Text) > 922337203685478# Then
     cancel = True
     MsgBox "Значение вне допустимого диапазона", vbOKOnly + vbExclamation, "Внимание"
     txtOutWeight.SetFocus
  End If
End If
End Sub
Private Sub txtOutWeight_KeyPess(KeyAscii As Integer)
Dim s As String
s = "0123456789.,-" & Chr(8)
If InStr(s, Chr(KeyAscii)) > 0 Then Exit Sub
KeyAscii = 0
...
End Sub
Private Sub txtMoroz_Validate(cancel As Boolean)
If txtMoroz.Text <> "" Then
 On Error Resume Next
  If Not IsNumeric(txtMoroz.Text) Then
     cancel = True
     MsgBox "Ожидалось число", vbOKOnly + vbExclamation, "Внимание"
     txtMoroz.SetFocus
  ElseIf Val(txtMoroz.Text) < -922337203685478# Or Val(txtMoroz.Text) > 922337203685478# Then
     cancel = True
     MsgBox "Значение вне допустимого диапазона", vbOKOnly + vbExclamation, "Внимание"
     txtMoroz.SetFocus
  End If
End If
End Sub
Private Sub txtMoroz_KeyPess(KeyAscii As Integer)
Dim s As String
s = "0123456789.,-" & Chr(8)
If InStr(s, Chr(KeyAscii)) > 0 Then Exit Sub
KeyAscii = 0
...
End Sub
Private Sub txtVesi_Validate(cancel As Boolean)
If txtVesi.Text <> "" Then
 On Error Resume Next
  If Not IsNumeric(txtVesi.Text) Then
     cancel = True
     MsgBox "Ожидалось число", vbOKOnly + vbExclamation, "Внимание"
     txtVesi.SetFocus
  ElseIf Val(txtVesi.Text) < -922337203685478# Or Val(txtVesi.Text) > 922337203685478# Then
     cancel = True
     MsgBox "Значение вне допустимого диапазона", vbOKOnly + vbExclamation, "Внимание"
     txtVesi.SetFocus
  End If
End If
End Sub
Private Sub txtVesi_KeyPess(KeyAscii As Integer)
Dim s As String
s = "0123456789.,-" & Chr(8)
If InStr(s, Chr(KeyAscii)) > 0 Then Exit Sub
KeyAscii = 0
...
End Sub
Private Sub txtWeightDelta_Validate(cancel As Boolean)
If txtWeightDelta.Text <> "" Then
 On Error Resume Next
  If Not IsNumeric(txtWeightDelta.Text) Then
     cancel = True
     MsgBox "Ожидалось число", vbOKOnly + vbExclamation, "Внимание"
     txtWeightDelta.SetFocus
  ElseIf Val(txtWeightDelta.Text) < -922337203685478# Or Val(txtWeightDelta.Text) > 922337203685478# Then
     cancel = True
     MsgBox "Значение вне допустимого диапазона", vbOKOnly + vbExclamation, "Внимание"
     txtWeightDelta.SetFocus
  End If
End If
End Sub
Private Sub txtWeightDelta_KeyPess(KeyAscii As Integer)
Dim s As String
s = "0123456789.,-" & Chr(8)
If InStr(s, Chr(KeyAscii)) > 0 Then Exit Sub
KeyAscii = 0
...
Item.Poddon = txtPoddon
Item.InWeight = CDbl(txtInWeight)
Item.OutWeight = CDbl(txtOutWeight)
Item.Moroz = CDbl(txtMoroz)
Item.Vesi = CDbl(txtVesi)
Item.Good = txtGood
Item.Description = txtDescription
Item.Country = txtCountry
Item.Factory = txtFactory
Item.KillPlace = txtKillPlace
Item.Brak = txtBrak
Item.Client = txtClient
  If IsNull(dtpTheDate) Then
    Item.TheDate = 0
  Else
    Item.TheDate = dtpTheDate.Value
  End If
Item.WeightDelta = CDbl(txtWeightDelta)
