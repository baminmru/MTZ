VERSION 5.00
Begin VB.Form frmITTSSCC_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание привязки"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTSSCCGUI.ITTSSCC_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTSSCC_DEF_"
...
' Форма редактирования раздела ITTSSCC_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0FC71C0E-DB49-43AE-B191-9FC078B522D9}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0FC71C0E-DB49-43AE-B191-9FC078B522D9}"
  Open s & Me.Name & "{0FC71C0E-DB49-43AE-B191-9FC078B522D9}" For Output As #ff
