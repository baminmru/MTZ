VERSION 5.00
Begin VB.Form frmITTSSCC_LINE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Строки привязки паллет"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTSSCCGUI.ITTSSCC_LINE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTSSCC_LINE_"
...
' Форма редактирования раздела ITTSSCC_LINE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C59253BE-F020-4E2A-B60C-69CE7B173263}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C59253BE-F020-4E2A-B60C-69CE7B173263}"
  Open s & Me.Name & "{C59253BE-F020-4E2A-B60C-69CE7B173263}" For Output As #ff
