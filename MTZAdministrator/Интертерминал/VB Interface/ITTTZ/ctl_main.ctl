...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTTZGUI.vpnITTTZ_DEF_ pnlITTTZ_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTTZGUI.vpnITTTZ_LINES_ pnlITTTZ_LINES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlITTTZ_DEF.IsOK
If IsItOk Then IsItOk = pnlITTTZ_LINES.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlITTTZ_LINES.Visible = False
  pnlITTTZ_DEF.Visible = False
   ...
   Case "ITTTZ_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlITTTZ_DEF.OnClick Item, ParentForm
     End With
   Case "ITTTZ_LINES"
     With pnlITTTZ_LINES
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlITTTZ_LINES.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "ITTTZ_DEF"
pnlITTTZ_DEF.OnInit Item, ParentForm
Call ts.Tabs.Add(, "ITTTZ_LINES", "Строки транспортного заказа")
pnlITTTZ_LINES.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "ITTTZ", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlITTTZ_DEF.CloseClass
 pnlITTTZ_LINES.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlITTTZ_DEF.IsChanged
m_IsChanged = m_IsChanged Or pnlITTTZ_LINES.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{EBB0BB6C-5585-4B02-A4A7-1664616A034A}"
    i = i + 1
    m(i).Caption = "Загружен из файла"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{EFA0E3E9-BD9A-4490-9E1E-305FC681A48D}"
    i = i + 1
    m(i).Caption = "Создан"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{4B130153-10BD-4E3E-A462-A8F7DF40E059}"
End Function
...
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{EBB0BB6C-5585-4B02-A4A7-1664616A034A}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
      If Item.Statusid = "{EFA0E3E9-BD9A-4490-9E1E-305FC681A48D}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{EBB0BB6C-5585-4B02-A4A7-1664616A034A}" Then
            m(i).Enabled = True
          End If
        Next
      End If
      If Item.Statusid = "{4B130153-10BD-4E3E-A462-A8F7DF40E059}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{EFA0E3E9-BD9A-4490-9E1E-305FC681A48D}" Then
            m(i).Enabled = True
          End If
        Next
      End If
