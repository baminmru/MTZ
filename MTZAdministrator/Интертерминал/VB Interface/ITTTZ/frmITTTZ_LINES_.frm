VERSION 5.00
Begin VB.Form frmITTTZ_LINES_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Строки транспортного заказа"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTTZGUI.ITTTZ_LINES Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTTZ_LINES_"
...
' Форма редактирования раздела ITTTZ_LINES режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{B22D9FA3-97A2-4E6E-BEFF-B70532974474}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{B22D9FA3-97A2-4E6E-BEFF-B70532974474}"
  Open s & Me.Name & "{B22D9FA3-97A2-4E6E-BEFF-B70532974474}" For Output As #ff
