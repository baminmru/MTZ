...
Begin VB.Form frmITTTZ_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Заголовок файла ранспортного заказа"
      Top             =   6225
      Width           =   825
   End
   Begin ITTTZGUI.ITTTZ_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTTZ_DEF_"
...
' Форма редактирования раздела ITTTZ_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1227B046-D986-48C5-BA79-37852784D8A9}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1227B046-D986-48C5-BA79-37852784D8A9}"
  Open s & Me.Name & "{1227B046-D986-48C5-BA79-37852784D8A9}" For Output As #ff
