...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTFNGUI.vpnITTFN_MAX_ pnlITTFN_MAX 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTFNGUI.vpnITTFN_INFO_ pnlITTFN_INFO 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlITTFN_MAX.IsOK
If IsItOk Then IsItOk = pnlITTFN_INFO.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlITTFN_INFO.Visible = False
  pnlITTFN_MAX.Visible = False
   ...
   Case "ITTFN_MAX"
     ...
     .Visible = True
     .ZOrder 0
     pnlITTFN_MAX.OnClick Item, ParentForm
     End With
   Case "ITTFN_INFO"
     With pnlITTFN_INFO
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlITTFN_INFO.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Максимальные номера объектов"
ts.Tabs.Item(1).Key = "ITTFN_MAX"
pnlITTFN_MAX.OnInit Item, ParentForm
Call ts.Tabs.Add(, "ITTFN_INFO", "Параметры")
pnlITTFN_INFO.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "ITTFN", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlITTFN_MAX.CloseClass
 pnlITTFN_INFO.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlITTFN_MAX.IsChanged
m_IsChanged = m_IsChanged Or pnlITTFN_INFO.IsChanged
