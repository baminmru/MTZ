VERSION 5.00
Begin VB.Form frmITTFN_MAX_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Максимальные номера объектов"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTFNGUI.ITTFN_MAX Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTFN_MAX_"
...
' Форма редактирования раздела ITTFN_MAX режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D5275672-6B03-4378-83B8-235F3F08B39E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D5275672-6B03-4378-83B8-235F3F08B39E}"
  Open s & Me.Name & "{D5275672-6B03-4378-83B8-235F3F08B39E}" For Output As #ff
