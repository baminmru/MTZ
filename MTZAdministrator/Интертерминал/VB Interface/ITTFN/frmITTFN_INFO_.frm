...
Begin VB.Form frmITTFN_INFO_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTFNGUI.ITTFN_INFO Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTFN_INFO_"
...
' Форма редактирования раздела ITTFN_INFO режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{400B1CD3-B611-4D17-BF4E-05CAC7DC59FF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{400B1CD3-B611-4D17-BF4E-05CAC7DC59FF}"
  Open s & Me.Name & "{400B1CD3-B611-4D17-BF4E-05CAC7DC59FF}" For Output As #ff
