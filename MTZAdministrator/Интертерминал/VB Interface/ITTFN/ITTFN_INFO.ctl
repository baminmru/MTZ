...
Begin VB.UserControl ITTFN_INFO 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.TextBox txtOrgCode 
         ...
         MaxLength       =   5
         TabIndex        =   4
         ToolTipText     =   " од дл€ формировани€номера документа"
         Top             =   1110
         Width           =   3000
      End
      Begin VB.TextBox txtOrgName 
         ...
         MaxLength       =   255
         TabIndex        =   2
         ToolTipText     =   "ќрганизаци€"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblOrgCode 
         BackStyle       =   0  'Transparent
         Caption         =   " од дл€ формировани€номера документа:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   3
...
If mIsOK Then mIsOK = IsSet(txtOrgName.Text)
If mIsOK Then mIsOK = IsSet(txtOrgCode.Text)
  IsOK = mIsOK
End Function
...
End If
  ...
  On Error Resume Next
txtOrgName = Item.OrgName
  On Error Resume Next
txtOrgCode = Item.OrgCode
...
Item.OrgName = txtOrgName
Item.OrgCode = txtOrgCode
 mIsChanged = False
 RaiseEvent Changed
End Sub
