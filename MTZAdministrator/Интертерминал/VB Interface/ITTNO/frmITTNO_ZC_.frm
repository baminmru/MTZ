...
Begin VB.Form frmITTNO_ZC_ 
   ...
   End
End
Attribute VB_Name = "frmITTNO_ZC_"
...
' Форма редактирования раздела ITTNO_ZC режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F0B2EB06-F357-47C3-B869-BAD108F937EC}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F0B2EB06-F357-47C3-B869-BAD108F937EC}"
  Open s & Me.Name & "{F0B2EB06-F357-47C3-B869-BAD108F937EC}" For Output As #ff
