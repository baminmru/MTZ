...
If Name = "ITTNO_CMN" Then
 Set FormByName = New frmITTNO_CMN_
 Exit Function
End If

If Name = "ITTNO_YC" Then
 Set FormByName = New frmITTNO_YC_
 Exit Function
End If

If Name = "ITTNO_ZC" Then
 Set FormByName = New frmITTNO_ZC_
 Exit Function
End If
