...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTNOGUI.vpnITTNO_CMN_ pnlITTNO_CMN 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTNOGUI.vpnITTNO_YC_ pnlITTNO_YC 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTNOGUI.vpnITTNO_ZC_ pnlITTNO_ZC 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
If IsItOk Then IsItOk = pnlITTNO_CMN.IsOK
If IsItOk Then IsItOk = pnlITTNO_YC.IsOK
If IsItOk Then IsItOk = pnlITTNO_ZC.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlITTNO_ZC.Visible = False
  pnlITTNO_YC.Visible = False
  pnlITTNO_CMN.Visible = False
   ...
   Case "ITTNO_CMN"
     ...
     .Visible = True
     .ZOrder 0
     pnlITTNO_CMN.OnClick Item, ParentForm
     End With
   Case "ITTNO_YC"
     With pnlITTNO_YC
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlITTNO_YC.OnClick Item, ParentForm
     End With
   Case "ITTNO_ZC"
     With pnlITTNO_ZC
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlITTNO_ZC.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Общие настройки"
ts.Tabs.Item(1).Key = "ITTNO_CMN"
pnlITTNO_CMN.OnInit Item, ParentForm
Call ts.Tabs.Add(, "ITTNO_YC", "Y-Cost")
pnlITTNO_YC.OnInit Item, ParentForm
Call ts.Tabs.Add(, "ITTNO_ZC", "Z-Cost")
pnlITTNO_ZC.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "ITTNO", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlITTNO_CMN.CloseClass
 pnlITTNO_YC.CloseClass
 pnlITTNO_ZC.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlITTNO_CMN.IsChanged
m_IsChanged = m_IsChanged Or pnlITTNO_YC.IsChanged
m_IsChanged = m_IsChanged Or pnlITTNO_ZC.IsChanged
