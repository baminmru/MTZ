...
Begin VB.Form frmITTNO_YC_ 
   ...
   End
End
Attribute VB_Name = "frmITTNO_YC_"
...
' Форма редактирования раздела ITTNO_YC режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A48EF2F8-8273-43CF-8786-34F24E4564CE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A48EF2F8-8273-43CF-8786-34F24E4564CE}"
  Open s & Me.Name & "{A48EF2F8-8273-43CF-8786-34F24E4564CE}" For Output As #ff
