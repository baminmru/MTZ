...
Begin VB.Form frmITTNO_CMN_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTNOGUI.ITTNO_CMN Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTNO_CMN_"
...
' Форма редактирования раздела ITTNO_CMN режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9B1AC869-21AD-40FC-A216-7754E198FAF2}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9B1AC869-21AD-40FC-A216-7754E198FAF2}"
  Open s & Me.Name & "{9B1AC869-21AD-40FC-A216-7754E198FAF2}" For Output As #ff
