...
Begin VB.Form frmITTCS_LIN_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTCSGUI.ITTCS_LIN Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTCS_LIN_"
...
' Форма редактирования раздела ITTCS_LIN режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3E685E67-276D-4B87-9DF7-424D11E69097}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3E685E67-276D-4B87-9DF7-424D11E69097}"
  Open s & Me.Name & "{3E685E67-276D-4B87-9DF7-424D11E69097}" For Output As #ff
