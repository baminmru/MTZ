...
Begin VB.Form frmITTCS_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ITTCSGUI.ITTCS_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmITTCS_DEF_"
...
' Форма редактирования раздела ITTCS_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5EE3E67A-CC31-4A4B-A9C9-C965F9C61A45}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5EE3E67A-CC31-4A4B-A9C9-C965F9C61A45}"
  Open s & Me.Name & "{5EE3E67A-CC31-4A4B-A9C9-C965F9C61A45}" For Output As #ff
