...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ITTCSGUI.vpnITTCS_DEF_ pnlITTCS_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ITTCSGUI.vpnITTCS_LIN_ pnlITTCS_LIN 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlITTCS_DEF.IsOK
If IsItOk Then IsItOk = pnlITTCS_LIN.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlITTCS_LIN.Visible = False
  pnlITTCS_DEF.Visible = False
   ...
   Case "ITTCS_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlITTCS_DEF.OnClick Item, ParentForm
     End With
   Case "ITTCS_LIN"
     With pnlITTCS_LIN
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlITTCS_LIN.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "ITTCS_DEF"
pnlITTCS_DEF.OnInit Item, ParentForm
Call ts.Tabs.Add(, "ITTCS_LIN", "Набор услуг")
pnlITTCS_LIN.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "ITTCS", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlITTCS_DEF.CloseClass
 pnlITTCS_LIN.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlITTCS_DEF.IsChanged
m_IsChanged = m_IsChanged Or pnlITTCS_LIN.IsChanged
