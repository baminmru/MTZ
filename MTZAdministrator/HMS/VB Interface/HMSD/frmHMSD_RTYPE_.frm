...
Begin VB.Form frmHMSD_RTYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin HMSDGUI.HMSD_RTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSD_RTYPE_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{CCBC3922-296A-443A-80CF-28133EF49228}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{CCBC3922-296A-443A-80CF-28133EF49228}"
  Open s & Me.Name & "{CCBC3922-296A-443A-80CF-28133EF49228}" For Output As #ff
