...
Begin VB.Form frmHMSD_TTYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin HMSDGUI.HMSD_TTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSD_TTYPE_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3F58FA52-B737-4CD5-9E17-5E10393F0B4D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3F58FA52-B737-4CD5-9E17-5E10393F0B4D}"
  Open s & Me.Name & "{3F58FA52-B737-4CD5-9E17-5E10393F0B4D}" For Output As #ff
