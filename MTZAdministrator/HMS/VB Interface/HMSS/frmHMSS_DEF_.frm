...
Begin VB.Form frmHMSS_DEF_ 
   ...
   End
End
Attribute VB_Name = "frmHMSS_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{181A8E71-D2D0-48AB-930E-C26D5DC7A99E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{181A8E71-D2D0-48AB-930E-C26D5DC7A99E}"
  Open s & Me.Name & "{181A8E71-D2D0-48AB-930E-C26D5DC7A99E}" For Output As #ff
