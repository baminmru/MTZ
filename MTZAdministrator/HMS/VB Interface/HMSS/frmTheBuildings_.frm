VERSION 5.00
Begin VB.Form frmTheBuildings_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin HMSSGUI.TheBuildings Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTheBuildings_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{63B7ECC9-DDD4-42D6-8032-AB9B4F1D9F4A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{63B7ECC9-DDD4-42D6-8032-AB9B4F1D9F4A}"
  Open s & Me.Name & "{63B7ECC9-DDD4-42D6-8032-AB9B4F1D9F4A}" For Output As #ff
