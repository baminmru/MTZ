VERSION 5.00
Begin VB.Form frmHMSR_PATH_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Схема прохода по этажу"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Схема прохода по этажу"
      Top             =   6225
      Width           =   825
   End
   Begin HMSRGUI.HMSR_PATH Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSR_PATH_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D5FBD8DE-36D2-4357-8CCB-D17066C049A4}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D5FBD8DE-36D2-4357-8CCB-D17066C049A4}"
  Open s & Me.Name & "{D5FBD8DE-36D2-4357-8CCB-D17066C049A4}" For Output As #ff
