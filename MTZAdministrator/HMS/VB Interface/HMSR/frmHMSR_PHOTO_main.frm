VERSION 5.00
Begin VB.Form frmHMSR_PHOTO_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Галерея фотографий"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin HMSRGUI.HMSR_PHOTOmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSR_PHOTO_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1FA38C07-3E1F-4013-A30B-50B34E8C927F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1FA38C07-3E1F-4013-A30B-50B34E8C927F}"
  Open s & Me.Name & "{1FA38C07-3E1F-4013-A30B-50B34E8C927F}" For Output As #ff
