VERSION 5.00
Begin VB.Form frmHMSR_TOOL_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Оборудование"
      Top             =   6225
      Width           =   825
   End
   Begin HMSRGUI.HMSR_TOOLmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSR_TOOL_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{B6F8F6FF-A840-4BD7-B252-3C2B6A08FED9}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{B6F8F6FF-A840-4BD7-B252-3C2B6A08FED9}"
  Open s & Me.Name & "{B6F8F6FF-A840-4BD7-B252-3C2B6A08FED9}" For Output As #ff
