VERSION 5.00
Begin VB.Form frmHMSR_MAP_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Разметка помещения"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Разметка помещения"
      Top             =   6225
      Width           =   825
   End
   Begin HMSRGUI.HMSR_MAP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSR_MAP_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{FB69C56E-B4FF-4D61-819E-6192F24E199B}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{FB69C56E-B4FF-4D61-819E-6192F24E199B}"
  Open s & Me.Name & "{FB69C56E-B4FF-4D61-819E-6192F24E199B}" For Output As #ff
