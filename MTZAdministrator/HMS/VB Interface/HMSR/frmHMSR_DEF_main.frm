VERSION 5.00
Begin VB.Form frmHMSR_DEF_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание помещения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание помещения"
      Top             =   6225
      Width           =   825
   End
   Begin HMSRGUI.HMSR_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSR_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{985BFA45-5BB4-42F7-A3A9-3499327FA231}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{985BFA45-5BB4-42F7-A3A9-3499327FA231}"
  Open s & Me.Name & "{985BFA45-5BB4-42F7-A3A9-3499327FA231}" For Output As #ff
