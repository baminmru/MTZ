...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin HSMBGUI.vpnHMSB_DEF_ pnlHMSB_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlHMSB_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlHMSB_DEF.Visible = False
   ...
   Case "HMSB_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlHMSB_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Описание здания"
ts.Tabs.Item(1).Key = "HMSB_DEF"
pnlHMSB_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "HSMB", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlHMSB_DEF.IsChanged
