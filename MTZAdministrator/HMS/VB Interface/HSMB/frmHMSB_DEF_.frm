VERSION 5.00
Begin VB.Form frmHMSB_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание здания"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание здания"
      Top             =   6225
      Width           =   825
   End
   Begin HSMBGUI.HMSB_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSB_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A8DA7E04-B51C-4BEC-8C7E-D52A66881009}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A8DA7E04-B51C-4BEC-8C7E-D52A66881009}"
  Open s & Me.Name & "{A8DA7E04-B51C-4BEC-8C7E-D52A66881009}" For Output As #ff
