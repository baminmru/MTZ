VERSION 5.00
Begin VB.Form frmHMSF_DEF_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание этажа"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin HMSFGUI.HMSF_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSF_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9BCBE52C-5B9B-4082-BFAA-E68289E2B600}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9BCBE52C-5B9B-4082-BFAA-E68289E2B600}"
  Open s & Me.Name & "{9BCBE52C-5B9B-4082-BFAA-E68289E2B600}" For Output As #ff
