...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin HMSFGUI.vpnHMSF_DEF_main pnlHMSF_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlHMSF_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlHMSF_DEF.Visible = False
   ...
   Case "HMSF_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlHMSF_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Описание этажа"
ts.Tabs.Item(1).Key = "HMSF_DEF"
pnlHMSF_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "HMSF", "ctlmain_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlHMSF_DEF.IsChanged
