VERSION 5.00
Begin VB.Form frmHMSF_3DMAP_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Разметка на 3d плане"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Разметка на 3d плане"
      Top             =   6225
      Width           =   825
   End
   Begin HMSFGUI.HMSF_3DMAP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHMSF_3DMAP_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9EDE2525-B962-41CF-BA95-B2DB256B05C2}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9EDE2525-B962-41CF-BA95-B2DB256B05C2}"
  Open s & Me.Name & "{9EDE2525-B962-41CF-BA95-B2DB256B05C2}" For Output As #ff
