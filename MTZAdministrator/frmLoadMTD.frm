...
Private Sub OKButton_Click()
  ...
  Set e_list = xdom.lastChild.firstChild.selectNodes("SHAREDMETHOD_COL")
  model.SHAREDMETHOD.XMLLoad e_list, 0
  model.BatchUpdate
