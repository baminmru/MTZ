VERSION 5.00
Begin VB.Form frmREPD_ResQueryRcv_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Результат запроса"
      Top             =   6225
      Width           =   825
   End
   Begin REPDGUI.REPD_ResQueryRcv Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmREPD_ResQueryRcv_"
...
' Форма редактирования раздела REPD_ResQueryRcv режим
