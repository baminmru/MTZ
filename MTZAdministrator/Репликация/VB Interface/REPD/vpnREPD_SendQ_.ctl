...
Begin VB.UserControl vpnREPD_SendQ_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerREPD_SendQ 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlREPD_SendQ 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdREPD_SendQAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_SendQAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridREPD_SendQ 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnREPD_SendQ_.ctx":0000
         Column(2)       =   "vpnREPD_SendQ_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnREPD_SendQ_.ctx":016C
         FormatStyle(2)  =   "vpnREPD_SendQ_.ctx":02C8
         FormatStyle(3)  =   "vpnREPD_SendQ_.ctx":0378
         FormatStyle(4)  =   "vpnREPD_SendQ_.ctx":042C
         FormatStyle(5)  =   "vpnREPD_SendQ_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnREPD_SendQ_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdREPD_SendQRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupREPD_SendQ 
      Caption         =   "Меню для Очередь отсылки"
      Visible         =   0   'False
      Begin VB.Menu mnuREPD_SendQAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuREPD_SendQEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuREPD_SendQDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuREPD_SendQOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuREPD_SendQRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuREPD_SendQS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuREPD_SendQBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuREPD_SendQCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuREPD_SendQCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuREPD_SendQPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuREPD_SendQCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuREPD_SendQCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuREPD_SendQPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuREPD_SendQCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuREPD_SendQFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuREPD_SendQAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnREPD_SendQ_"
...
'панель для работы со строками раздела Очередь отсылки
