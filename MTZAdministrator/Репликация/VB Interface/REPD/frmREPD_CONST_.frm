VERSION 5.00
Begin VB.Form frmREPD_CONST_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Константы к запросу"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin REPDGUI.REPD_CONST Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmREPD_CONST_"
...
' Форма редактирования раздела REPD_CONST режим
