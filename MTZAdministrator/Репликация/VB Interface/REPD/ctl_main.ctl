...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin REPDGUI.vpnREPD_SendQ_ pnlREPD_SendQ 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin REPDGUI.vpnREPD_SRV_ pnlREPD_SRV 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin REPDGUI.vpnREPD_RecvQ_ pnlREPD_RecvQ 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin REPDGUI.vpnREPD_LOCKED_ pnlREPD_LOCKED 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin REPDGUI.vpnREPD_PROV_ pnlREPD_PROV 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin REPDGUI.vpnREPD_RequestQuery_ pnlREPD_RequestQuery 
      Height          =   1500
      Left            =   1500
      TabIndex        =   6
      Top             =   1500
