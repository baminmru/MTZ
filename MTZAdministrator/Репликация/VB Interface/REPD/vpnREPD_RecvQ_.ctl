...
Begin VB.UserControl vpnREPD_RecvQ_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerREPD_RecvQ 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlREPD_RecvQ 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdREPD_RecvQAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_RecvQAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridREPD_RecvQ 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnREPD_RecvQ_.ctx":0000
         Column(2)       =   "vpnREPD_RecvQ_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnREPD_RecvQ_.ctx":016C
         FormatStyle(2)  =   "vpnREPD_RecvQ_.ctx":02C8
         FormatStyle(3)  =   "vpnREPD_RecvQ_.ctx":0378
         FormatStyle(4)  =   "vpnREPD_RecvQ_.ctx":042C
         FormatStyle(5)  =   "vpnREPD_RecvQ_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnREPD_RecvQ_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdREPD_RecvQRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupREPD_RecvQ 
      Caption         =   "Меню для Очередь полученых реплик"
      Visible         =   0   'False
      Begin VB.Menu mnuREPD_RecvQAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuREPD_RecvQEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuREPD_RecvQDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuREPD_RecvQOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuREPD_RecvQRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuREPD_RecvQS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuREPD_RecvQBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuREPD_RecvQCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuREPD_RecvQCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuREPD_RecvQPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuREPD_RecvQCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuREPD_RecvQCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuREPD_RecvQPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuREPD_RecvQCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuREPD_RecvQFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuREPD_RecvQAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnREPD_RecvQ_"
...
'панель для работы со строками раздела Очередь полученых реплик
