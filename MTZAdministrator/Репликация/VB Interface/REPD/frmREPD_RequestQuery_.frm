VERSION 5.00
Begin VB.Form frmREPD_RequestQuery_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Запрос данных на объект\ строку"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Запрос данных на объект\ строку"
      Top             =   6225
      Width           =   825
   End
   Begin REPDGUI.REPD_RequestQuery Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmREPD_RequestQuery_"
...
' Форма редактирования раздела REPD_RequestQuery режим
