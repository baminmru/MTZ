VERSION 5.00
Begin VB.Form frmREPD_PROV_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Провайдер репликациии"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Провайдер репликациии"
      Top             =   6225
      Width           =   825
   End
   Begin REPDGUI.REPD_PROV Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmREPD_PROV_"
...
' Форма редактирования раздела REPD_PROV режим
