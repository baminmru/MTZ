...
Begin VB.UserControl vpnREPD_PROV_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerREPD_PROV 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlREPD_PROV 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdREPD_PROVAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdREPD_PROVAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridREPD_PROV 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnREPD_PROV_.ctx":0000
         Column(2)       =   "vpnREPD_PROV_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnREPD_PROV_.ctx":016C
         FormatStyle(2)  =   "vpnREPD_PROV_.ctx":02C8
         FormatStyle(3)  =   "vpnREPD_PROV_.ctx":0378
         FormatStyle(4)  =   "vpnREPD_PROV_.ctx":042C
         FormatStyle(5)  =   "vpnREPD_PROV_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnREPD_PROV_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdREPD_PROVRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupREPD_PROV 
      Caption         =   "Меню для Провайдер репликациии"
      Visible         =   0   'False
      Begin VB.Menu mnuREPD_PROVAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuREPD_PROVEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuREPD_PROVDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuREPD_PROVOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuREPD_PROVRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuREPD_PROVS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuREPD_PROVBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuREPD_PROVCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuREPD_PROVCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuREPD_PROVPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuREPD_PROVCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuREPD_PROVCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuREPD_PROVPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuREPD_PROVCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuREPD_PROVFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuREPD_PROVAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnREPD_PROV_"
...
'панель для работы со строками раздела Провайдер репликациии
