...
Begin VB.UserControl REPD_ResQueryRcv 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin MTZ_PANEL.DropButton cmdReceiveRec 
         Height          =   300
         Left            =   2850
         TabIndex        =   3
         Tag             =   "refopen.ico"
         ToolTipText     =   "ReceiveRec"
         Top             =   405
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
         Caption         =   ""
      End
      Begin VB.TextBox txtReceiveRec 
         Height          =   300
         Left            =   300
         Locked          =   -1  'True
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "REPD_ResQueryRcv"
...
'панель редактирования раздела Результат запроса
