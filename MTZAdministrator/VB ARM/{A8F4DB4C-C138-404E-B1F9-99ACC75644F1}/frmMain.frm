...
Begin VB.MDIForm frmMain 
   ...
   Begin VB.Menu mnuJRNL 
      ...
      Begin VB.Menu mnuITTOUT 
         ...
         End
      End
      Begin VB.Menu mnuITTSSCC 
         Caption         =   "Привязка"
         Begin VB.Menu mnuAllITTSSCC 
            Caption         =   "Привязка - все состояния"
         End
         Begin VB.Menu mnuITTSSCC_1 
            Caption         =   "Привязка :Загружается"
         End
         Begin VB.Menu mnuITTSSCC_2 
            Caption         =   "Привязка :Загружен"
         End
         Begin VB.Menu mnuITTSSCC_3 
            Caption         =   "Привязка :Обработан"
         End
      End
...
Dim WithEvents jfmnuAllITTSSCC As frmJournalShow
Attribute jfmnuAllITTSSCC.VB_VarHelpID = -1

Dim WithEvents jfmnuITTSSCC_1 As frmJournalShow
Attribute jfmnuITTSSCC_1.VB_VarHelpID = -1

Dim WithEvents jfmnuITTSSCC_2 As frmJournalShow
Attribute jfmnuITTSSCC_2.VB_VarHelpID = -1

Dim WithEvents jfmnuITTSSCC_3 As frmJournalShow
Attribute jfmnuITTSSCC_3.VB_VarHelpID = -1
...
Private Sub mnuAllITTSSCC_Click()
    Dim journal As Object
    On Error Resume Next
    If jfmnuAllITTSSCC Is Nothing Then
      Set jfmnuAllITTSSCC = New frmJournalShow
      Set journal = Manager.GetInstanceObject("{7B2CDC60-B046-4E00-9351-E8DDF3C34746}")
      Manager.LockInstanceObject journal.ID
      Set jfmnuAllITTSSCC.jv.journal = journal
      jfmnuAllITTSSCC.jv.OpenModal = False
      jfmnuAllITTSSCC.Caption = "Привязка - все состояния"
      Me.MousePointer = vbHourglass
      DoEvents
      Dim f As String
    f = "1=1"
    Dim fltr As frmITTSSCC
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
    If fltr.OK Then
    ' build flter expression
      If fltr.lblTheUser.Value = vbChecked Then
        f = f & " and ITTSSCC_DEF_TheUser_ID='" & fltr.txtTheUser.Tag & "'"
      End If
      If fltr.lblTheDate_LE.Value = vbChecked Then
        f = f & " and ITTSSCC_DEF_TheDate<=" & MakeMSSQLDate(fltr.dtpTheDate_LE.Value)
      End If
      If fltr.lblTCode.Value = vbChecked Then
        f = f & " and ITTSSCC_DEF_TCode like '%" & fltr.txtTCode.Text & "%'"
      End If
      If fltr.lblTheDate_GE.Value = vbChecked Then
        f = f & " and ITTSSCC_DEF_TheDate>=" & MakeMSSQLDate(fltr.dtpTheDate_GE.Value)
      End If
    jfmnuAllITTSSCC.jv.Filter.Add "AUTOITTSSCC_DEF", f
    End If
      jfmnuAllITTSSCC.jv.Refresh
      Me.MousePointer = vbNormal
    End If
    jfmnuAllITTSSCC.Show
    jfmnuAllITTSSCC.WindowState = 0
    jfmnuAllITTSSCC.ZOrder 0
End Sub
Private Sub jfmnuAllITTSSCC_OnFilter(usedefault As Boolean)
    Dim fltr As frmITTSSCC
    Dim f As String
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
    ...
    usedefault = False
End Sub
Private Sub jfmnuAllITTSSCC_OnClearFilter()
End Sub
Private Sub jfmnuAllITTSSCC_OnAdd(usedefaut As Boolean, Refesh As Boolean)
  Dim objGui  As Object
  Dim o As Object
  Dim ID As String
  ID = CreateGUID2
  Manager.NewInstance ID, "ITTSSCC", "Привязка" & Now, Site
  Set o = Manager.GetInstanceObject(ID)
  If IsDocDenied(o) Then
    MsgBox "Не разрешен доступ к документам такого типа"
    Exit Sub
...
Private Sub mnuITTSSCC_1_Click()
    Dim journal As Object
    On Error Resume Next
    If jfmnuITTSSCC_1 Is Nothing Then
      Set jfmnuITTSSCC_1 = New frmJournalShow
      Set journal = Manager.GetInstanceObject("{7B2CDC60-B046-4E00-9351-E8DDF3C34746}")
      Manager.LockInstanceObject journal.ID
      Set jfmnuITTSSCC_1.jv.journal = journal
      jfmnuITTSSCC_1.jv.OpenModal = False
      jfmnuITTSSCC_1.Caption = "Привязка :Загружается"
      Me.MousePointer = vbHourglass
      DoEvents
      Dim f As String
    f = "1=1"
   f = " INTSANCEStatusID='{23F860AA-EFB4-4000-B5D8-AD0B5BB59730}'"
    jfmnuITTSSCC_1.jv.Filter.Add "AUTOITTSSCC_DEF", f
    Dim fltr As frmITTSSCC
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
    If fltr.OK Then
    ...
    jfmnuITTSSCC_1.jv.Filter.Add "AUTOITTSSCC_DEF", f
    End If
      jfmnuITTSSCC_1.jv.Refresh
      Me.MousePointer = vbNormal
    End If
    jfmnuITTSSCC_1.Show
    jfmnuITTSSCC_1.WindowState = 0
    jfmnuITTSSCC_1.ZOrder 0
End Sub
Private Sub jfmnuITTSSCC_1_OnFilter(usedefault As Boolean)
    Dim fltr As frmITTSSCC
    Dim f As String
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
   ...
   f = " INTSANCEStatusID='{23F860AA-EFB4-4000-B5D8-AD0B5BB59730}'"
    ...
    usedefault = False
End Sub
Private Sub jfmnuITTSSCC_1_OnClearFilter()
   jfmnuITTSSCC_1.jv.Filter.Add "AUTOITTSSCC_DEF", " INTSANCEStatusID='{23F860AA-EFB4-4000-B5D8-AD0B5BB59730}'"
End Sub
Private Sub jfmnuITTSSCC_1_OnAdd(usedefaut As Boolean, Refesh As Boolean)
  Dim objGui  As Object
  Dim o As Object
  Dim ID As String
  ID = CreateGUID2
...
Private Sub mnuITTSSCC_2_Click()
    Dim journal As Object
    On Error Resume Next
    If jfmnuITTSSCC_2 Is Nothing Then
      Set jfmnuITTSSCC_2 = New frmJournalShow
      Set journal = Manager.GetInstanceObject("{7B2CDC60-B046-4E00-9351-E8DDF3C34746}")
      Manager.LockInstanceObject journal.ID
      Set jfmnuITTSSCC_2.jv.journal = journal
      jfmnuITTSSCC_2.jv.OpenModal = False
      jfmnuITTSSCC_2.Caption = "Привязка :Загружен"
      Me.MousePointer = vbHourglass
      DoEvents
      Dim f As String
    f = "1=1"
   f = " INTSANCEStatusID='{7172D19B-4EC0-4084-A424-12602796CD48}'"
    jfmnuITTSSCC_2.jv.Filter.Add "AUTOITTSSCC_DEF", f
    Dim fltr As frmITTSSCC
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
    If fltr.OK Then
    ...
    jfmnuITTSSCC_2.jv.Filter.Add "AUTOITTSSCC_DEF", f
    End If
      jfmnuITTSSCC_2.jv.Refresh
      Me.MousePointer = vbNormal
    End If
    jfmnuITTSSCC_2.Show
    jfmnuITTSSCC_2.WindowState = 0
    jfmnuITTSSCC_2.ZOrder 0
End Sub
Private Sub jfmnuITTSSCC_2_OnFilter(usedefault As Boolean)
    Dim fltr As frmITTSSCC
    Dim f As String
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
   ...
   f = " INTSANCEStatusID='{7172D19B-4EC0-4084-A424-12602796CD48}'"
    ...
    usedefault = False
End Sub
Private Sub jfmnuITTSSCC_2_OnClearFilter()
   jfmnuITTSSCC_2.jv.Filter.Add "AUTOITTSSCC_DEF", " INTSANCEStatusID='{7172D19B-4EC0-4084-A424-12602796CD48}'"
End Sub
Private Sub jfmnuITTSSCC_2_OnAdd(usedefaut As Boolean, Refesh As Boolean)
  Dim objGui  As Object
  Dim o As Object
  Dim ID As String
  ID = CreateGUID2
...
Private Sub mnuITTSSCC_3_Click()
    Dim journal As Object
    On Error Resume Next
    If jfmnuITTSSCC_3 Is Nothing Then
      Set jfmnuITTSSCC_3 = New frmJournalShow
      Set journal = Manager.GetInstanceObject("{7B2CDC60-B046-4E00-9351-E8DDF3C34746}")
      Manager.LockInstanceObject journal.ID
      Set jfmnuITTSSCC_3.jv.journal = journal
      jfmnuITTSSCC_3.jv.OpenModal = False
      jfmnuITTSSCC_3.Caption = "Привязка :Обработан"
      Me.MousePointer = vbHourglass
      DoEvents
      Dim f As String
    f = "1=1"
   f = " INTSANCEStatusID='{CEB4EE91-C77A-430B-B04E-2791E98A4288}'"
    jfmnuITTSSCC_3.jv.Filter.Add "AUTOITTSSCC_DEF", f
    Dim fltr As frmITTSSCC
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
    If fltr.OK Then
    ...
    jfmnuITTSSCC_3.jv.Filter.Add "AUTOITTSSCC_DEF", f
    End If
      jfmnuITTSSCC_3.jv.Refresh
      Me.MousePointer = vbNormal
    End If
    jfmnuITTSSCC_3.Show
    jfmnuITTSSCC_3.WindowState = 0
    jfmnuITTSSCC_3.ZOrder 0
End Sub
Private Sub jfmnuITTSSCC_3_OnFilter(usedefault As Boolean)
    Dim fltr As frmITTSSCC
    Dim f As String
    Set fltr = New frmITTSSCC
    fltr.Show vbModal
   ...
   f = " INTSANCEStatusID='{CEB4EE91-C77A-430B-B04E-2791E98A4288}'"
    ...
    usedefault = False
End Sub
Private Sub jfmnuITTSSCC_3_OnClearFilter()
   jfmnuITTSSCC_3.jv.Filter.Add "AUTOITTSSCC_DEF", " INTSANCEStatusID='{CEB4EE91-C77A-430B-B04E-2791E98A4288}'"
End Sub
Private Sub jfmnuITTSSCC_3_OnAdd(usedefaut As Boolean, Refesh As Boolean)
  Dim objGui  As Object
  Dim o As Object
  Dim ID As String
  ID = CreateGUID2
...
Private Sub mnuITTTZ_1_Click()
    ...
    If jfmnuITTTZ_1 Is Nothing Then
      ...
      jfmnuITTTZ_1.Caption = "Транспортный заказ :Загружен из файла"
      Me.MousePointer = vbHourglass
      DoEvents
      Dim f As String
    f = "1=1"
...
Private Sub jfmnuITTTZ_1_OnClearFilter()
   jfmnuITTTZ_1.jv.Filter.Add "AUTOITTTZ_DEF", " INTSANCEStatusID='{EFA0E3E9-BD9A-4490-9E1E-305FC681A48D}'"
End Sub
...
Private Sub mnuITTTZ_2_Click()
    ...
    If jfmnuITTTZ_2 Is Nothing Then
      ...
      jfmnuITTTZ_2.Caption = "Транспортный заказ :Обработан"
      Me.MousePointer = vbHourglass
      DoEvents
      Dim f As String
    f = "1=1"
...
Private Sub jfmnuITTTZ_2_OnClearFilter()
   jfmnuITTTZ_2.jv.Filter.Add "AUTOITTTZ_DEF", " INTSANCEStatusID='{EBB0BB6C-5585-4B02-A4A7-1664616A034A}'"
End Sub
...
Unload jfmnuAllITTSSCC
Set jfmnuAllITTSSCC = Nothing

Unload jfmnuITTSSCC_1
Set jfmnuITTSSCC_1 = Nothing

Unload jfmnuITTSSCC_2
Set jfmnuITTSSCC_2 = Nothing

Unload jfmnuITTSSCC_3
Set jfmnuITTSSCC_3 = Nothing
