...
Begin VB.Form frmTP_MOUT 
   Caption         =   "Фильтр для Расход модемов"
   ClientHeight    =   3390
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
...
PanelfGroupInit
  ...
  TSCustom.Init ts, "TP_MOUT", "fctlTP_MOUT"
