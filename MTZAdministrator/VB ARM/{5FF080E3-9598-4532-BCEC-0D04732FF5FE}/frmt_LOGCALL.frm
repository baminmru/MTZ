...
Begin VB.Form frmt_LOGCALL 
   Caption         =   "Фильтр для Журнал опроса"
   ClientHeight    =   3390
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin MTZ_PANEL.ScrolledWindow PanelfGroup 
      ...
      Begin VB.TextBox txtQDay_LE 
         ...
         MaxLength       =   15
         TabIndex        =   24
         ToolTipText     =   "День опроса меньше или равно"
         Top             =   6045
         Width           =   1800
      End
      Begin VB.CheckBox lblQDay_LE 
         Caption         =   "День опроса меньше или равно:"
         ForeColor       =   &H00000000&
         Height          =   300
         Left            =   300
         TabIndex        =   23
      ...
      Begin VB.TextBox txtQDay_GE 
         ...
         MaxLength       =   15
         TabIndex        =   22
         ToolTipText     =   "День опроса больше или равно"
         Top             =   5340
         Width           =   1800
      End
      Begin VB.CheckBox lblQDay_GE 
         Caption         =   "День опроса больше или равно:"
         ForeColor       =   &H00000000&
         Height          =   300
         Left            =   300
         TabIndex        =   21
      ...
      Begin VB.TextBox txtQMonth_LE 
         ...
         MaxLength       =   15
         TabIndex        =   20
         ToolTipText     =   "Месяц опроса меньше или равно"
         Top             =   4635
         Width           =   1800
      End
      Begin VB.CheckBox lblQMonth_LE 
         Caption         =   "Месяц опроса меньше или равно:"
         ForeColor       =   &H00000000&
         Height          =   300
         Left            =   300
         TabIndex        =   19
      ...
      Begin VB.TextBox txtQMonth_GE 
         ...
         MaxLength       =   15
         TabIndex        =   18
         ToolTipText     =   "Месяц опроса больше или равно"
         Top             =   3930
         Width           =   1800
      End
      Begin VB.CheckBox lblQMonth_GE 
         Caption         =   "Месяц опроса больше или равно:"
         ForeColor       =   &H00000000&
         Height          =   300
         Left            =   300
         TabIndex        =   17
      ...
      Begin VB.TextBox txtQYear_LE 
         ...
         MaxLength       =   15
         TabIndex        =   16
         ToolTipText     =   "Год опроса меньше или равно"
         Top             =   3225
         Width           =   1800
      End
      Begin VB.CheckBox lblQYear_LE 
         Caption         =   "Год опроса меньше или равно:"
         ForeColor       =   &H00000000&
         Height          =   300
         Left            =   300
         TabIndex        =   15
      ...
      Begin VB.TextBox txtQYear_GE 
         ...
         MaxLength       =   15
         TabIndex        =   14
         ToolTipText     =   "Год опроса больше или равно"
         Top             =   2520
         Width           =   1800
      End
      Begin VB.CheckBox lblQYear_GE 
         Caption         =   "Год опроса больше или равно:"
         ForeColor       =   &H00000000&
         Height          =   300
         Left            =   300
         TabIndex        =   13
   ...
   End
End
Attribute VB_Name = "frmt_LOGCALL"
...
Private Sub cmdID_PTYPE_Click()
  On Error Resume Next
        Dim id As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("Tip_parametra", id, brief) Then
