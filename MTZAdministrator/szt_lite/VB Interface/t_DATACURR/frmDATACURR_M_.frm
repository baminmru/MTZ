VERSION 5.00
Begin VB.Form frmDATACURR_M_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Мгновенные значения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Текущие значения мгновенные"
      Top             =   6225
      Width           =   825
   End
   Begin t_DATACURRGUI.DATACURR_M Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDATACURR_M_"
...
' Форма редактирования раздела DATACURR_M режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4AAEE503-B986-4718-9A56-76E9E0441E2F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4AAEE503-B986-4718-9A56-76E9E0441E2F}"
  Open s & Me.Name & "{4AAEE503-B986-4718-9A56-76E9E0441E2F}" For Output As #ff
