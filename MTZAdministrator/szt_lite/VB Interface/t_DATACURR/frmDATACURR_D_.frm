VERSION 5.00
Begin VB.Form frmDATACURR_D_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Суточный архив"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Суточный архив"
      Top             =   6225
      Width           =   825
   End
   Begin t_DATACURRGUI.DATACURR_D Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDATACURR_D_"
...
' Форма редактирования раздела DATACURR_D режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2129C353-1FFF-4CF5-8A5C-ECE2A264E435}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2129C353-1FFF-4CF5-8A5C-ECE2A264E435}"
  Open s & Me.Name & "{2129C353-1FFF-4CF5-8A5C-ECE2A264E435}" For Output As #ff
