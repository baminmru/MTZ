VERSION 5.00
Begin VB.Form frmDATACURR_T_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Суммарные показатели"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Суммарные показатели"
      Top             =   6225
      Width           =   825
   End
   Begin t_DATACURRGUI.DATACURR_T Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDATACURR_T_"
...
' Форма редактирования раздела DATACURR_T режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{CAD8C6F6-8801-4C00-8493-2F3D0955374E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{CAD8C6F6-8801-4C00-8493-2F3D0955374E}"
  Open s & Me.Name & "{CAD8C6F6-8801-4C00-8493-2F3D0955374E}" For Output As #ff
