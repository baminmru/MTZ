...
Begin VB.Form frmDC_HEADER_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_DATACURRGUI.DC_HEADER Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDC_HEADER_"
...
' Форма редактирования раздела DC_HEADER режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9F5BBA30-BE28-4A09-A8F5-13C4549ABB7A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9F5BBA30-BE28-4A09-A8F5-13C4549ABB7A}"
  Open s & Me.Name & "{9F5BBA30-BE28-4A09-A8F5-13C4549ABB7A}" For Output As #ff
