VERSION 5.00
Begin VB.Form frmDATACURR_H_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Часовые архивы"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Часовые архивы"
      Top             =   6225
      Width           =   825
   End
   Begin t_DATACURRGUI.DATACURR_H Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDATACURR_H_"
...
' Форма редактирования раздела DATACURR_H режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{13C30E79-E4E7-4066-BED0-94E920BCEAC7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{13C30E79-E4E7-4066-BED0-94E920BCEAC7}"
  Open s & Me.Name & "{13C30E79-E4E7-4066-BED0-94E920BCEAC7}" For Output As #ff
