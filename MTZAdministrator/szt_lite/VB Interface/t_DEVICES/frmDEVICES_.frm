...
Begin VB.Form frmDEVICES_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_DEVICESGUI.DEVICES Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела DEVICES режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8EC1C842-2D29-4844-80D7-6C4914CF9DFC}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8EC1C842-2D29-4844-80D7-6C4914CF9DFC}"
  Open s & Me.Name & "{8EC1C842-2D29-4844-80D7-6C4914CF9DFC}" For Output As #ff
