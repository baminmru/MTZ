...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_DEVICESGUI.vpnDEVICES_ pnlDEVICES 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlDEVICES.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  ...
  pnlDEVICES.Visible = False
   ...
   Case "DEVICES"
     ...
     .Visible = True
     .ZOrder 0
     pnlDEVICES.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Устройства"
ts.Tabs.Item(1).Key = "DEVICES"
pnlDEVICES.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_DEVICES", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlDEVICES.IsChanged
