VERSION 5.00
Begin VB.Form frmDEVUNITS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Ёлементы устройств"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Ёлементы устройств"
      Top             =   6225
      Width           =   825
   End
   Begin t_DEVICESGUI.DEVUNITS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDEVUNITS_"
...
' ‘орма редактировани€ раздела DEVUNITS режим
...
Sub cmdOK_Click()
 ...
 If Panel.IsOK Then
   ...
   Me.Hide
 Else
   MsgBox "Ќе все об€зательные пол€ заполнены", vbOKOnly + vbExclamation
 End If
bye:
End Sub
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1CD760DD-5FF1-419A-A74C-7BC863036F3C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1CD760DD-5FF1-419A-A74C-7BC863036F3C}"
  Open s & Me.Name & "{1CD760DD-5FF1-419A-A74C-7BC863036F3C}" For Output As #ff
