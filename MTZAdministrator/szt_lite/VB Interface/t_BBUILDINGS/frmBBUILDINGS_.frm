...
Begin VB.Form frmBBUILDINGS_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Узлы учета"
      Top             =   6225
      Width           =   825
   End
   Begin t_BBUILDINGSGUI.BBUILDINGS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmBBUILDINGS_"
...
' Форма редактирования раздела BBUILDINGS режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{67430E1D-E78F-4E0F-A28E-C013D0930BE7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{67430E1D-E78F-4E0F-A28E-C013D0930BE7}"
  Open s & Me.Name & "{67430E1D-E78F-4E0F-A28E-C013D0930BE7}" For Output As #ff
