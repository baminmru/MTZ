...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_BBUILDINGSGUI.vpnBBUILDINGS_ pnlBBUILDINGS 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlBBUILDINGS.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlBBUILDINGS.Visible = False
   ...
   Case "BBUILDINGS"
     ...
     .Visible = True
     .ZOrder 0
     pnlBBUILDINGS.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Узлы учета"
ts.Tabs.Item(1).Key = "BBUILDINGS"
pnlBBUILDINGS.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_BBUILDINGS", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlBBUILDINGS.IsChanged
