VERSION 5.00
Begin VB.Form frmBGROUPS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Группы узлов учета"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Группы узлов учета"
      Top             =   6225
      Width           =   825
   End
   Begin t_BGROUPSGUI.BGROUPS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела BGROUPS режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{84C263DB-024D-4A5C-B532-F2CCD597D26B}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{84C263DB-024D-4A5C-B532-F2CCD597D26B}"
  Open s & Me.Name & "{84C263DB-024D-4A5C-B532-F2CCD597D26B}" For Output As #ff
