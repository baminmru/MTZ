...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_BGROUPSGUI.vpnBGROUPS_ pnlBGROUPS 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlBGROUPS.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlBGROUPS.Visible = False
   ...
   Case "BGROUPS"
     ...
     .Visible = True
     .ZOrder 0
     pnlBGROUPS.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Группы узлов учета"
ts.Tabs.Item(1).Key = "BGROUPS"
pnlBGROUPS.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_BGROUPS", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlBGROUPS.IsChanged
