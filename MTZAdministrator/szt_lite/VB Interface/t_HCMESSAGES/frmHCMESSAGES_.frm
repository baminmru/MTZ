...
Begin VB.Form frmHCMESSAGES_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Сообщения о нештатных ситуациях"
      Top             =   6225
      Width           =   825
   End
   Begin t_HCMESSAGESGUI.HCMESSAGES Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmHCMESSAGES_"
...
' Форма редактирования раздела HCMESSAGES режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{44B81BFB-FEEC-4A32-9E92-E7F5C63D054E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{44B81BFB-FEEC-4A32-9E92-E7F5C63D054E}"
  Open s & Me.Name & "{44B81BFB-FEEC-4A32-9E92-E7F5C63D054E}" For Output As #ff
