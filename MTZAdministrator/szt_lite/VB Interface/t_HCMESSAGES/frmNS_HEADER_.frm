...
Begin VB.Form frmNS_HEADER_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_HCMESSAGESGUI.NS_HEADER Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmNS_HEADER_"
...
' Форма редактирования раздела NS_HEADER режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C79643E8-2353-4AC4-8611-09421F71C8C0}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C79643E8-2353-4AC4-8611-09421F71C8C0}"
  Open s & Me.Name & "{C79643E8-2353-4AC4-8611-09421F71C8C0}" For Output As #ff
