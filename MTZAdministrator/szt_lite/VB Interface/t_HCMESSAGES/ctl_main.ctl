...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_HCMESSAGESGUI.vpnNS_HEADER_ pnlNS_HEADER 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin t_HCMESSAGESGUI.vpnHCMESSAGES_ pnlHCMESSAGES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlNS_HEADER.IsOK
If IsItOk Then IsItOk = pnlHCMESSAGES.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlHCMESSAGES.Visible = False
  pnlNS_HEADER.Visible = False
   ...
   Case "NS_HEADER"
     ...
     .Visible = True
     .ZOrder 0
     pnlNS_HEADER.OnClick Item, ParentForm
     End With
   Case "HCMESSAGES"
     With pnlHCMESSAGES
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlHCMESSAGES.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "NS_HEADER"
pnlNS_HEADER.OnInit Item, ParentForm
Call ts.Tabs.Add(, "HCMESSAGES", "Сообщения о нештатных ситуациях")
pnlHCMESSAGES.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_HCMESSAGES", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlNS_HEADER.CloseClass
 pnlHCMESSAGES.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlNS_HEADER.IsChanged
m_IsChanged = m_IsChanged Or pnlHCMESSAGES.IsChanged
