...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_PARAMTYPEGUI.vpnPARAMTYPE_ pnlPARAMTYPE 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlPARAMTYPE.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlPARAMTYPE.Visible = False
   ...
   Case "PARAMTYPE"
     ...
     .Visible = True
     .ZOrder 0
     pnlPARAMTYPE.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Тип архива"
ts.Tabs.Item(1).Key = "PARAMTYPE"
pnlPARAMTYPE.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_PARAMTYPE", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlPARAMTYPE.IsChanged
