...
Begin VB.Form frmPARAMTYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_PARAMTYPEGUI.PARAMTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPARAMTYPE_"
...
' Форма редактирования раздела PARAMTYPE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{255BCB70-3F28-4627-B9F7-33FE19D217F7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{255BCB70-3F28-4627-B9F7-33FE19D217F7}"
  Open s & Me.Name & "{255BCB70-3F28-4627-B9F7-33FE19D217F7}" For Output As #ff
