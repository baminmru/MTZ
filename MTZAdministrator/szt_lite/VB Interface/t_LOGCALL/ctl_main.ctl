...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_LOGCALLGUI.vpnLOG_HEADER_ pnlLOG_HEADER 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin t_LOGCALLGUI.vpnLOGCALL_ pnlLOGCALL 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlLOG_HEADER.IsOK
If IsItOk Then IsItOk = pnlLOGCALL.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlLOGCALL.Visible = False
  pnlLOG_HEADER.Visible = False
   ...
   Case "LOG_HEADER"
     ...
     .Visible = True
     .ZOrder 0
     pnlLOG_HEADER.OnClick Item, ParentForm
     End With
   Case "LOGCALL"
     With pnlLOGCALL
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlLOGCALL.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "LOG_HEADER"
pnlLOG_HEADER.OnInit Item, ParentForm
Call ts.Tabs.Add(, "LOGCALL", "Журнал опроса")
pnlLOGCALL.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_LOGCALL", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlLOG_HEADER.CloseClass
 pnlLOGCALL.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlLOG_HEADER.IsChanged
m_IsChanged = m_IsChanged Or pnlLOGCALL.IsChanged
