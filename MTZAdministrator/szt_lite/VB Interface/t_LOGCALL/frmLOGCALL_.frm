...
Begin VB.Form frmLOGCALL_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Журнал опроса"
      Top             =   6225
      Width           =   825
   End
   Begin t_LOGCALLGUI.LOGCALL Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела LOGCALL режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{960283FA-A47C-4409-92B9-78E93197551E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{960283FA-A47C-4409-92B9-78E93197551E}"
  Open s & Me.Name & "{960283FA-A47C-4409-92B9-78E93197551E}" For Output As #ff
