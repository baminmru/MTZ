...
Begin VB.Form frmLOG_HEADER_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_LOGCALLGUI.LOG_HEADER Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmLOG_HEADER_"
...
' Форма редактирования раздела LOG_HEADER режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E7240E4C-9C58-4E6C-B52D-1F0623CB7C70}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E7240E4C-9C58-4E6C-B52D-1F0623CB7C70}"
  Open s & Me.Name & "{E7240E4C-9C58-4E6C-B52D-1F0623CB7C70}" For Output As #ff
