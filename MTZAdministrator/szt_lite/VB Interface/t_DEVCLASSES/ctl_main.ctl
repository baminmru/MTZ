...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_DEVCLASSESGUI.vpnDEVCLASSES_ pnlDEVCLASSES 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlDEVCLASSES.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlDEVCLASSES.Visible = False
   ...
   Case "DEVCLASSES"
     ...
     .Visible = True
     .ZOrder 0
     pnlDEVCLASSES.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Классы приборов"
ts.Tabs.Item(1).Key = "DEVCLASSES"
pnlDEVCLASSES.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_DEVCLASSES", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlDEVCLASSES.IsChanged
