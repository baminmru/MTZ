...
Begin VB.Form frmDEVCLASSES_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Классы приборов"
      Top             =   6225
      Width           =   825
   End
   Begin t_DEVCLASSESGUI.DEVCLASSES Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDEVCLASSES_"
...
' Форма редактирования раздела DEVCLASSES режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2334F7AB-A5FA-4F6A-9337-F32C2924E37B}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2334F7AB-A5FA-4F6A-9337-F32C2924E37B}"
  Open s & Me.Name & "{2334F7AB-A5FA-4F6A-9337-F32C2924E37B}" For Output As #ff
