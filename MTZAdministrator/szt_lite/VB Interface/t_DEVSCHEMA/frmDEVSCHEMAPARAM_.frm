VERSION 5.00
Begin VB.Form frmDEVSCHEMAPARAM_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Параметры на схеме"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "DEVSCHEMAPARAM"
      Top             =   6225
      Width           =   825
   End
   Begin t_DEVSCHEMAGUI.DEVSCHEMAPARAM Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDEVSCHEMAPARAM_"
...
' Форма редактирования раздела DEVSCHEMAPARAM режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5F51ACAB-DA78-4428-B03A-1424902B9CB7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5F51ACAB-DA78-4428-B03A-1424902B9CB7}"
  Open s & Me.Name & "{5F51ACAB-DA78-4428-B03A-1424902B9CB7}" For Output As #ff
