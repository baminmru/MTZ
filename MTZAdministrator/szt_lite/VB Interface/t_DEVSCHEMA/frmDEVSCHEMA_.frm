...
Begin VB.Form frmDEVSCHEMA_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "DEVSCHEMA"
      Top             =   6225
      Width           =   825
   End
   Begin t_DEVSCHEMAGUI.DEVSCHEMA Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDEVSCHEMA_"
...
' Форма редактирования раздела DEVSCHEMA режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{54F16D64-F874-4CD3-8B49-79163B10088D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{54F16D64-F874-4CD3-8B49-79163B10088D}"
  Open s & Me.Name & "{54F16D64-F874-4CD3-8B49-79163B10088D}" For Output As #ff
