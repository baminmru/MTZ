...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_DEVSCHEMAGUI.vpnDEVSCHEMA_ pnlDEVSCHEMA 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin t_DEVSCHEMAGUI.vpnDEVSCHEMAPARAM_ pnlDEVSCHEMAPARAM 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlDEVSCHEMA.IsOK
If IsItOk Then IsItOk = pnlDEVSCHEMAPARAM.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlDEVSCHEMAPARAM.Visible = False
  pnlDEVSCHEMA.Visible = False
   ...
   Case "DEVSCHEMA"
     ...
     .Visible = True
     .ZOrder 0
     pnlDEVSCHEMA.OnClick Item, ParentForm
     End With
   Case "DEVSCHEMAPARAM"
     With pnlDEVSCHEMAPARAM
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlDEVSCHEMAPARAM.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "DEVSCHEMA"
pnlDEVSCHEMA.OnInit Item, ParentForm
Call ts.Tabs.Add(, "DEVSCHEMAPARAM", "Параметры на схеме")
pnlDEVSCHEMAPARAM.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_DEVSCHEMA", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlDEVSCHEMA.CloseClass
 pnlDEVSCHEMAPARAM.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlDEVSCHEMA.IsChanged
m_IsChanged = m_IsChanged Or pnlDEVSCHEMAPARAM.IsChanged
