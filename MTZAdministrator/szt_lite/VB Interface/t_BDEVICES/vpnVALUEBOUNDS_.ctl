...
Begin VB.UserControl vpnVALUEBOUNDS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerVALUEBOUNDS 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlVALUEBOUNDS 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdVALUEBOUNDSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVALUEBOUNDSAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridVALUEBOUNDS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVALUEBOUNDS_.ctx":0000
         Column(2)       =   "vpnVALUEBOUNDS_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVALUEBOUNDS_.ctx":016C
         FormatStyle(2)  =   "vpnVALUEBOUNDS_.ctx":02C8
         FormatStyle(3)  =   "vpnVALUEBOUNDS_.ctx":0378
         FormatStyle(4)  =   "vpnVALUEBOUNDS_.ctx":042C
         FormatStyle(5)  =   "vpnVALUEBOUNDS_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVALUEBOUNDS_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdVALUEBOUNDSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupVALUEBOUNDS 
      Caption         =   "Меню для Граничные значения проверяемых параметров"
      Visible         =   0   'False
      Begin VB.Menu mnuVALUEBOUNDSAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuVALUEBOUNDSEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuVALUEBOUNDSDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuVALUEBOUNDSOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuVALUEBOUNDSRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuVALUEBOUNDSS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuVALUEBOUNDSBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuVALUEBOUNDSCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuVALUEBOUNDSCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuVALUEBOUNDSPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuVALUEBOUNDSCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuVALUEBOUNDSCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuVALUEBOUNDSPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuVALUEBOUNDSCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuVALUEBOUNDSFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuVALUEBOUNDSAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnVALUEBOUNDS_"
...
'панель для работы со строками раздела Граничные значения проверяемых параметров
