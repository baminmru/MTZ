VERSION 5.00
Begin VB.Form frmVALUEBOUNDS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Граничные значения проверяемых параметров"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Граничные значения проверяемых параметров"
      Top             =   6225
      Width           =   825
   End
   Begin t_BDEVICESGUI.VALUEBOUNDS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVALUEBOUNDS_"
...
' Форма редактирования раздела VALUEBOUNDS режим
