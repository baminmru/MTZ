VERSION 5.00
Begin VB.Form frmCHARTSETTINGS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Настройки графиков"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Настройки графиков"
      Top             =   6225
      Width           =   825
   End
   Begin t_BDEVICESGUI.CHARTSETTINGS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmCHARTSETTINGS_"
...
' Форма редактирования раздела CHARTSETTINGS режим
