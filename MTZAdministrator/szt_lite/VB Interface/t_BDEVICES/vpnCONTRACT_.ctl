...
Begin VB.UserControl vpnCONTRACT_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerCONTRACT 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlCONTRACT 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdCONTRACTAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCONTRACTAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridCONTRACT 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnCONTRACT_.ctx":0000
         Column(2)       =   "vpnCONTRACT_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnCONTRACT_.ctx":016C
         FormatStyle(2)  =   "vpnCONTRACT_.ctx":02C8
         FormatStyle(3)  =   "vpnCONTRACT_.ctx":0378
         FormatStyle(4)  =   "vpnCONTRACT_.ctx":042C
         FormatStyle(5)  =   "vpnCONTRACT_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnCONTRACT_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdCONTRACTRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupCONTRACT 
      Caption         =   "Меню для Договорные установки"
      Visible         =   0   'False
      Begin VB.Menu mnuCONTRACTAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuCONTRACTEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuCONTRACTDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuCONTRACTOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuCONTRACTRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuCONTRACTS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuCONTRACTBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuCONTRACTCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuCONTRACTCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuCONTRACTPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuCONTRACTCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuCONTRACTCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuCONTRACTPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuCONTRACTCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuCONTRACTFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuCONTRACTAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnCONTRACT_"
...
'панель для работы со строками раздела Договорные установки
