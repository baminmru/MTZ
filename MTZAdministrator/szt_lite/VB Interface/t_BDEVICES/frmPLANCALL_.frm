...
Begin VB.Form frmPLANCALL_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "План опроса устройств"
      Top             =   6225
      Width           =   825
   End
   Begin t_BDEVICESGUI.PLANCALL Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPLANCALL_"
...
' Форма редактирования раздела PLANCALL режим
