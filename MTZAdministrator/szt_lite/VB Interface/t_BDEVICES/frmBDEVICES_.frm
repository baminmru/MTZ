VERSION 5.00
Begin VB.Form frmBDEVICES_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Подключенные к узлу устройства"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Подключенные к узлу устройства"
      Top             =   6225
      Width           =   825
   End
   Begin t_BDEVICESGUI.BDEVICES Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmBDEVICES_"
...
' Форма редактирования раздела BDEVICES режим
