VERSION 5.00
Begin VB.UserControl vpnSETUPHAN_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlSETUPHAN 
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdSETUPHANCfg 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdSETUPHANRef 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdSETUPHANSave 
         Enabled         =   0   'False
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin t_BDEVICESGUI.SETUPHAN editSETUPHAN 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnSETUPHAN_"
...
'панель для работы со строками раздела Настройки ручного опроса
