...
Begin VB.UserControl vpnCHARTSETTINGS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerCHARTSETTINGS 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlCHARTSETTINGS 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdCHARTSETTINGSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdCHARTSETTINGSAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridCHARTSETTINGS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnCHARTSETTINGS_.ctx":0000
         Column(2)       =   "vpnCHARTSETTINGS_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnCHARTSETTINGS_.ctx":016C
         FormatStyle(2)  =   "vpnCHARTSETTINGS_.ctx":02C8
         FormatStyle(3)  =   "vpnCHARTSETTINGS_.ctx":0378
         FormatStyle(4)  =   "vpnCHARTSETTINGS_.ctx":042C
         FormatStyle(5)  =   "vpnCHARTSETTINGS_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnCHARTSETTINGS_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdCHARTSETTINGSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupCHARTSETTINGS 
      Caption         =   "Меню для Настройки графиков"
      Visible         =   0   'False
      Begin VB.Menu mnuCHARTSETTINGSAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuCHARTSETTINGSEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuCHARTSETTINGSDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuCHARTSETTINGSOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuCHARTSETTINGSRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuCHARTSETTINGSS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuCHARTSETTINGSBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuCHARTSETTINGSCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuCHARTSETTINGSCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuCHARTSETTINGSPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuCHARTSETTINGSCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuCHARTSETTINGSCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuCHARTSETTINGSPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuCHARTSETTINGSCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuCHARTSETTINGSFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuCHARTSETTINGSAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnCHARTSETTINGS_"
...
'панель для работы со строками раздела Настройки графиков
