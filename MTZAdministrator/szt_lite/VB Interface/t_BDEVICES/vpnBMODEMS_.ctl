VERSION 5.00
Begin VB.UserControl vpnBMODEMS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlBMODEMS 
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdBMODEMSCfg 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdBMODEMSRef 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdBMODEMSSave 
         Enabled         =   0   'False
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin t_BDEVICESGUI.BMODEMS editBMODEMS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
...
'панель для работы со строками раздела Модемы в узлах учета
