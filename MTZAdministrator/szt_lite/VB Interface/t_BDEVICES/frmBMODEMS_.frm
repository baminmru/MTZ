VERSION 5.00
Begin VB.Form frmBMODEMS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Модемы в узлах учета"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Модемы в узлах учета"
      Top             =   6225
      Width           =   825
   End
   Begin t_BDEVICESGUI.BMODEMS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела BMODEMS режим
