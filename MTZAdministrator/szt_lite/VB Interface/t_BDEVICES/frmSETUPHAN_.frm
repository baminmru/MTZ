VERSION 5.00
Begin VB.Form frmSETUPHAN_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Настройки ручного опроса"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Настройки ручного опроса"
      Top             =   6225
      Width           =   825
   End
   Begin t_BDEVICESGUI.SETUPHAN Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSETUPHAN_"
...
' Форма редактирования раздела SETUPHAN режим
