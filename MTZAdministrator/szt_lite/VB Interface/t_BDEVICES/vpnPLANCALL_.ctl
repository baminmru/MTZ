...
Begin VB.UserControl vpnPLANCALL_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerPLANCALL 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlPLANCALL 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdPLANCALLAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPLANCALLAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridPLANCALL 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPLANCALL_.ctx":0000
         Column(2)       =   "vpnPLANCALL_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPLANCALL_.ctx":016C
         FormatStyle(2)  =   "vpnPLANCALL_.ctx":02C8
         FormatStyle(3)  =   "vpnPLANCALL_.ctx":0378
         FormatStyle(4)  =   "vpnPLANCALL_.ctx":042C
         FormatStyle(5)  =   "vpnPLANCALL_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPLANCALL_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdPLANCALLRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupPLANCALL 
      Caption         =   "Меню для План опроса устройств"
      Visible         =   0   'False
      Begin VB.Menu mnuPLANCALLAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuPLANCALLEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuPLANCALLDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuPLANCALLOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuPLANCALLRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuPLANCALLS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuPLANCALLBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuPLANCALLCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuPLANCALLCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuPLANCALLPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuPLANCALLCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuPLANCALLCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuPLANCALLPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuPLANCALLCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuPLANCALLFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuPLANCALLAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnPLANCALL_"
...
'панель для работы со строками раздела План опроса устройств
