VERSION 5.00
Begin VB.Form frmMASKS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание шаблона"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
...
' Форма редактирования раздела MASKS режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{EA007415-3F9A-4861-B7F7-8289599A3678}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{EA007415-3F9A-4861-B7F7-8289599A3678}"
  Open s & Me.Name & "{EA007415-3F9A-4861-B7F7-8289599A3678}" For Output As #ff
