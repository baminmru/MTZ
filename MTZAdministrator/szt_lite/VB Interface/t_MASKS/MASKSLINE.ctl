...
Begin VB.UserControl MASKSLINE 
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin MSMask.MaskEdBox txtSEQUENCE 
         ...
         Left            =   300
         TabIndex        =   6
         ToolTipText     =   "Порядок отображения"
         Top             =   1815
         Width           =   1800
         _ExtentX        =   3175
         _ExtentY        =   529
      ...
      Begin VB.TextBox txtCFLD 
         ...
         MaxLength       =   240
         TabIndex        =   2
         ToolTipText     =   "Название поля"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblCOLHIDDEN 
         BackStyle       =   0  'Transparent
         Caption         =   "Скрыть колонку:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   11
...
'панель редактирования раздела MASKSLINE
...
cmbCOLHIDDEN.Clear
cmbCOLHIDDEN.AddItem "Да"
cmbCOLHIDDEN.ItemData(cmbCOLHIDDEN.NewIndex) = -1
cmbCOLHIDDEN.AddItem "Нет"
