...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_MASKSGUI.vpnMASKS_ pnlMASKS 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin t_MASKSGUI.vpnMASKSLINE_ pnlMASKSLINE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlMASKS.IsOK
If IsItOk Then IsItOk = pnlMASKSLINE.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlMASKSLINE.Visible = False
  pnlMASKS.Visible = False
   ...
   Case "MASKS"
     ...
     .Visible = True
     .ZOrder 0
     pnlMASKS.OnClick Item, ParentForm
     End With
   Case "MASKSLINE"
     With pnlMASKSLINE
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlMASKSLINE.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "MASKS"
pnlMASKS.OnInit Item, ParentForm
Call ts.Tabs.Add(, "MASKSLINE", "Поля шаблона")
pnlMASKSLINE.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_MASKS", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlMASKS.IsChanged
m_IsChanged = m_IsChanged Or pnlMASKSLINE.IsChanged
