VERSION 5.00
Begin VB.Form frmMASKSLINE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Поля шаблона"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "MASKSLINE"
      Top             =   6225
      Width           =   825
   End
   Begin t_MASKSGUI.MASKSLINE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMASKSLINE_"
...
' Форма редактирования раздела MASKSLINE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E4B58C01-B3A4-4B08-A2A2-1B10021DF970}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E4B58C01-B3A4-4B08-A2A2-1B10021DF970}"
  Open s & Me.Name & "{E4B58C01-B3A4-4B08-A2A2-1B10021DF970}" For Output As #ff
