...
Begin VB.Form frmCOMMONPARAM_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Общие параметры"
      Top             =   6225
      Width           =   825
   End
   Begin t_COMMONPARAMGUI.COMMONPARAM Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmCOMMONPARAM_"
...
' Форма редактирования раздела COMMONPARAM режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{68E9773D-C4B7-481D-AD93-DC39C984D1D3}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{68E9773D-C4B7-481D-AD93-DC39C984D1D3}"
  Open s & Me.Name & "{68E9773D-C4B7-481D-AD93-DC39C984D1D3}" For Output As #ff
