...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_COMMONPARAMGUI.vpnCOMMONPARAM_ pnlCOMMONPARAM 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlCOMMONPARAM.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlCOMMONPARAM.Visible = False
   ...
   Case "COMMONPARAM"
     ...
     .Visible = True
     .ZOrder 0
     pnlCOMMONPARAM.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Общие параметры"
ts.Tabs.Item(1).Key = "COMMONPARAM"
pnlCOMMONPARAM.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_COMMONPARAM", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlCOMMONPARAM.IsChanged
