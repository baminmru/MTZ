...
Begin VB.Form frmWHOGIVE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_WHOGIVETOPGUI.WHOGIVE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела WHOGIVE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C70B1B3B-12E3-493A-A3C7-07369CBF07BA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C70B1B3B-12E3-493A-A3C7-07369CBF07BA}"
  Open s & Me.Name & "{C70B1B3B-12E3-493A-A3C7-07369CBF07BA}" For Output As #ff
