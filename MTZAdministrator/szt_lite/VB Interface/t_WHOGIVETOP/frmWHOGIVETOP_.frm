...
Begin VB.Form frmWHOGIVETOP_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Вышестоящая снабжающая организация"
      Top             =   6225
      Width           =   825
   End
   Begin t_WHOGIVETOPGUI.WHOGIVETOP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWHOGIVETOP_"
...
' Форма редактирования раздела WHOGIVETOP режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{17E94EDB-D83D-451A-99F4-A1B44268879D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{17E94EDB-D83D-451A-99F4-A1B44268879D}"
  Open s & Me.Name & "{17E94EDB-D83D-451A-99F4-A1B44268879D}" For Output As #ff
