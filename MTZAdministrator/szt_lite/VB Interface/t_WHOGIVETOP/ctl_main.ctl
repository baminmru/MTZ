...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_WHOGIVETOPGUI.vpnWHOGIVETOP_ pnlWHOGIVETOP 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin t_WHOGIVETOPGUI.vpnWHOGIVE_ pnlWHOGIVE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlWHOGIVETOP.IsOK
If IsItOk Then IsItOk = pnlWHOGIVE.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlWHOGIVE.Visible = False
  pnlWHOGIVETOP.Visible = False
   ...
   Case "WHOGIVETOP"
     ...
     .Visible = True
     .ZOrder 0
     pnlWHOGIVETOP.OnClick Item, ParentForm
     End With
   Case "WHOGIVE"
     With pnlWHOGIVE
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlWHOGIVE.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Вышестоящая снабжающая организация"
ts.Tabs.Item(1).Key = "WHOGIVETOP"
pnlWHOGIVETOP.OnInit Item, ParentForm
Call ts.Tabs.Add(, "WHOGIVE", "Снабжающая организация")
pnlWHOGIVE.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_WHOGIVETOP", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlWHOGIVETOP.CloseClass
 pnlWHOGIVE.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlWHOGIVETOP.IsChanged
m_IsChanged = m_IsChanged Or pnlWHOGIVE.IsChanged
