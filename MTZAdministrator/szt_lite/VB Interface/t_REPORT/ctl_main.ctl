...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin t_REPORTGUI.vpnREPORT_ pnlREPORT 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlREPORT.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  ...
  pnlREPORT.Visible = False
   ...
   Case "REPORT"
     ...
     .Visible = True
     .ZOrder 0
     pnlREPORT.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "REPORT"
pnlREPORT.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "t_REPORT", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlREPORT.IsChanged
