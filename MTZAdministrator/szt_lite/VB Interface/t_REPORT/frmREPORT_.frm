...
Begin VB.Form frmREPORT_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin t_REPORTGUI.REPORT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела REPORT режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0FD703C4-DA08-4801-A93C-DF363AAED6C8}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0FD703C4-DA08-4801-A93C-DF363AAED6C8}"
  Open s & Me.Name & "{0FD703C4-DA08-4801-A93C-DF363AAED6C8}" For Output As #ff
