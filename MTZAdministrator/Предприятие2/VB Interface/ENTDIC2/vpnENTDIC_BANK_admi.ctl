...
Begin VB.UserControl vpnENTDIC_BANK_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlENTDIC_BANK 
      ...
      Begin GridEX20.GridEX gridENTDIC_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnENTDIC_BANK_admi.ctx":0000
         Column(2)       =   "vpnENTDIC_BANK_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnENTDIC_BANK_admi.ctx":016C
         FormatStyle(2)  =   "vpnENTDIC_BANK_admi.ctx":02C8
         FormatStyle(3)  =   "vpnENTDIC_BANK_admi.ctx":0378
         FormatStyle(4)  =   "vpnENTDIC_BANK_admi.ctx":042C
         FormatStyle(5)  =   "vpnENTDIC_BANK_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnENTDIC_BANK_admi.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridENTDIC_BANK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnENTDIC_BANK_admi.ctx":0794
         Column(2)       =   "vpnENTDIC_BANK_admi.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnENTDIC_BANK_admi.ctx":0900
         FormatStyle(2)  =   "vpnENTDIC_BANK_admi.ctx":0A5C
         FormatStyle(3)  =   "vpnENTDIC_BANK_admi.ctx":0B0C
         FormatStyle(4)  =   "vpnENTDIC_BANK_admi.ctx":0BC0
         FormatStyle(5)  =   "vpnENTDIC_BANK_admi.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnENTDIC_BANK_admi.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnENTDIC_BANK_admi"
