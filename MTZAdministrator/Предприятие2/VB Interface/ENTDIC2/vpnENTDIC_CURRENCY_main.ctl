...
Begin VB.UserControl vpnENTDIC_CURRENCY_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlENTDIC_CURRENCY 
      ...
      Begin GridEX20.GridEX gridENTDIC_CURCOURCE 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnENTDIC_CURRENCY_main.ctx":0000
         Column(2)       =   "vpnENTDIC_CURRENCY_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnENTDIC_CURRENCY_main.ctx":016C
         FormatStyle(2)  =   "vpnENTDIC_CURRENCY_main.ctx":02C8
         FormatStyle(3)  =   "vpnENTDIC_CURRENCY_main.ctx":0378
         FormatStyle(4)  =   "vpnENTDIC_CURRENCY_main.ctx":042C
         FormatStyle(5)  =   "vpnENTDIC_CURRENCY_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnENTDIC_CURRENCY_main.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridENTDIC_CURRENCY 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnENTDIC_CURRENCY_main.ctx":0794
         Column(2)       =   "vpnENTDIC_CURRENCY_main.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnENTDIC_CURRENCY_main.ctx":0900
         FormatStyle(2)  =   "vpnENTDIC_CURRENCY_main.ctx":0A5C
         FormatStyle(3)  =   "vpnENTDIC_CURRENCY_main.ctx":0B0C
         FormatStyle(4)  =   "vpnENTDIC_CURRENCY_main.ctx":0BC0
         FormatStyle(5)  =   "vpnENTDIC_CURRENCY_main.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnENTDIC_CURRENCY_main.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnENTDIC_CURRENCY_main"
