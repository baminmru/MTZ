...
Begin VB.UserControl ctladmi_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin ENTDIC2GUI.vpnENTDIC_EDIZM_admi pnlENTDIC_EDIZM 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_BANK_admi pnlENTDIC_BANK 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_CURRENCY_admi pnlENTDIC_CURRENCY 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_DOST_admi pnlENTDIC_DOST 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_REGION_admi pnlENTDIC_REGION 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_TOWN_admi pnlENTDIC_TOWN 
      Height          =   1500
      Left            =   1500
      TabIndex        =   6
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_COUNTRY_admi pnlENTDIC_COUNTRY 
      Height          =   1500
      Left            =   3000
      TabIndex        =   7
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_TransportType_admi pnlENTDIC_TransportType 
      Height          =   1500
      Left            =   4500
      TabIndex        =   8
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin ENTDIC2GUI.vpnENTDIC_OPF_admi pnlENTDIC_OPF 
      Height          =   1500
      Left            =   6000
      TabIndex        =   9
      Top             =   1500
