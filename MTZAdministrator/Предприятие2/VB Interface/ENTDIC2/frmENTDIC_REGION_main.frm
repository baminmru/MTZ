VERSION 5.00
Begin VB.Form frmENTDIC_REGION_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Название областей"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Название областей"
      Top             =   6225
      Width           =   825
   End
   Begin ENTDIC2GUI.ENTDIC_REGIONmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmENTDIC_REGION_main"
