...
Begin VB.UserControl vpnENTDIC_TOWN_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlENTDIC_TOWN 
      ...
      Begin GridEX20.GridEX gridENTDIC_TOWN 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnENTDIC_TOWN_admi.ctx":0000
         Column(2)       =   "vpnENTDIC_TOWN_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnENTDIC_TOWN_admi.ctx":016C
         FormatStyle(2)  =   "vpnENTDIC_TOWN_admi.ctx":02C8
         FormatStyle(3)  =   "vpnENTDIC_TOWN_admi.ctx":0378
         FormatStyle(4)  =   "vpnENTDIC_TOWN_admi.ctx":042C
         FormatStyle(5)  =   "vpnENTDIC_TOWN_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnENTDIC_TOWN_admi.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnENTDIC_TOWN_admi"
