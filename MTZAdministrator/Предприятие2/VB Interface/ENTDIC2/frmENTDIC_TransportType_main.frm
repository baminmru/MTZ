VERSION 5.00
Begin VB.Form frmENTDIC_TransportType_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Типы транспорта"
      Top             =   6225
      Width           =   825
   End
   Begin ENTDIC2GUI.ENTDIC_TransportTypemain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmENTDIC_TransportType_main"
