VERSION 5.00
Begin VB.Form frmROLES_ACT_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Допустимые действия"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Допустимые действия"
      Top             =   6225
      Width           =   825
   End
   Begin ROLESGUI.ROLES_ACT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmROLES_ACT_"
...
' Форма редактирования раздела ROLES_ACT режим
