VERSION 5.00
Begin VB.Form frmROLES_WP_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Доступные приложения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Доступные приложения"
      Top             =   6225
      Width           =   825
   End
   Begin ROLESGUI.ROLES_WP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmROLES_WP_"
...
' Форма редактирования раздела ROLES_WP режим
