VERSION 5.00
Begin VB.Form frmROLES_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Определение роли"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Определение роли"
      Top             =   6225
      Width           =   825
   End
   Begin ROLESGUI.ROLES_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmROLES_DEF_"
...
' Форма редактирования раздела ROLES_DEF режим
