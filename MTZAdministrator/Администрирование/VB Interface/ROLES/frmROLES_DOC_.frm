VERSION 5.00
Begin VB.Form frmROLES_DOC_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Доступные документы"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin ROLESGUI.ROLES_DOC Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmROLES_DOC_"
...
' Форма редактирования раздела ROLES_DOC режим
