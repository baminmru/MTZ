...
Begin VB.UserControl ROLES_REPORTS 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin MTZ_PANEL.DropButton cmdThe_Report 
         Height          =   300
         Left            =   2850
         TabIndex        =   3
         Tag             =   "refopen.ico"
         ...
         Caption         =   ""
      End
      Begin VB.TextBox txtThe_Report 
         Height          =   300
         Left            =   300
         Locked          =   -1  'True
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "ROLES_REPORTS"
