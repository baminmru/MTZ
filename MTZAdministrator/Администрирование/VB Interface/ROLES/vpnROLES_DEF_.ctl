VERSION 5.00
Begin VB.UserControl vpnROLES_DEF_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlROLES_DEF 
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdROLES_DEFCfg 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_DEFRef 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_DEFSave 
         Enabled         =   0   'False
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin ROLESGUI.ROLES_DEF editROLES_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnROLES_DEF_"
...
'панель для работы со строками раздела Определение роли
