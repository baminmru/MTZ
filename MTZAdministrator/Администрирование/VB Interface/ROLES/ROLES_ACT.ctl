...
Begin VB.UserControl ROLES_ACT 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin MTZ_PANEL.DropButton cmdEntryPoints 
         Height          =   300
         Left            =   2850
         TabIndex        =   5
         Tag             =   "refopen.ico"
         ToolTipText     =   "Доступные действия"
         Top             =   1110
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
         Caption         =   ""
      End
      Begin VB.TextBox txtEntryPoints 
         Height          =   300
         Left            =   300
         Locked          =   -1  'True
         TabIndex        =   4
         ...
         Width           =   2550
      End
      Begin VB.ComboBox cmbAccesible 
         Height          =   315
         Left            =   300
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   2
         ToolTipText     =   "Доступность"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblEntryPoints 
         BackStyle       =   0  'Transparent
         Caption         =   "Доступные действия:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   3
...
'панель редактирования раздела Допустимые действия
