...
Begin VB.UserControl ROLES_DEF 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.TextBox txtname 
         ...
         Width           =   3000
      End
      Begin VB.Label lblFileExch_Denied 
         ...
         Width           =   3000
      End
      Begin VB.Label lblListCFG_Denied 
         BackStyle       =   0  'Transparent
         ...
         Width           =   3000
      End
      Begin VB.Label lblFormCFG_Denied 
         BackStyle       =   0  'Transparent
         ...
         Width           =   3000
      End
      Begin VB.Label lblRightsSet_Denied 
         BackStyle       =   0  'Transparent
...
'панель редактирования раздела Определение роли
