...
Begin VB.UserControl vpnROLES_REPORTS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerROLES_REPORTS 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlROLES_REPORTS 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdROLES_REPORTSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_REPORTSAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridROLES_REPORTS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnROLES_REPORTS_.ctx":0000
         Column(2)       =   "vpnROLES_REPORTS_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnROLES_REPORTS_.ctx":016C
         FormatStyle(2)  =   "vpnROLES_REPORTS_.ctx":02C8
         FormatStyle(3)  =   "vpnROLES_REPORTS_.ctx":0378
         FormatStyle(4)  =   "vpnROLES_REPORTS_.ctx":042C
         FormatStyle(5)  =   "vpnROLES_REPORTS_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnROLES_REPORTS_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdROLES_REPORTSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupROLES_REPORTS 
      Caption         =   "Меню для Отчёты"
      Visible         =   0   'False
      Begin VB.Menu mnuROLES_REPORTSAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuROLES_REPORTSEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuROLES_REPORTSDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuROLES_REPORTSOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuROLES_REPORTSRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuROLES_REPORTSS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuROLES_REPORTSBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuROLES_REPORTSCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuROLES_REPORTSCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuROLES_REPORTSPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuROLES_REPORTSCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuROLES_REPORTSCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuROLES_REPORTSPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuROLES_REPORTSCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuROLES_REPORTSFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuROLES_REPORTSAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnROLES_REPORTS_"
