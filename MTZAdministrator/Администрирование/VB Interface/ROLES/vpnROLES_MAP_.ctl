...
Begin VB.UserControl vpnROLES_MAP_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerROLES_MAP 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlROLES_MAP 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdROLES_MAPAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdROLES_MAPAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridROLES_MAP 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnROLES_MAP_.ctx":0000
         Column(2)       =   "vpnROLES_MAP_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnROLES_MAP_.ctx":016C
         FormatStyle(2)  =   "vpnROLES_MAP_.ctx":02C8
         FormatStyle(3)  =   "vpnROLES_MAP_.ctx":0378
         FormatStyle(4)  =   "vpnROLES_MAP_.ctx":042C
         FormatStyle(5)  =   "vpnROLES_MAP_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnROLES_MAP_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdROLES_MAPRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupROLES_MAP 
      Caption         =   "Меню для Отображение на группы защиты"
      Visible         =   0   'False
      Begin VB.Menu mnuROLES_MAPAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuROLES_MAPEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuROLES_MAPDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuROLES_MAPOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuROLES_MAPRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuROLES_MAPS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuROLES_MAPBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuROLES_MAPCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuROLES_MAPCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuROLES_MAPPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuROLES_MAPCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuROLES_MAPCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuROLES_MAPPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuROLES_MAPCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuROLES_MAPFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuROLES_MAPAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnROLES_MAP_"
...
'панель для работы со строками раздела Отображение на группы защиты
