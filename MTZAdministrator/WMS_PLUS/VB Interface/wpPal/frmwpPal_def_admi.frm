VERSION 5.00
Begin VB.Form frmwpPal_def_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpPalGUI.wpPal_defadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpPal_def_admi"
...
' Форма редактирования раздела wpPal_def режим admi
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4DD29EBB-386F-46A7-AB42-0648507C9A1C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4DD29EBB-386F-46A7-AB42-0648507C9A1C}"
  Open s & Me.Name & "{4DD29EBB-386F-46A7-AB42-0648507C9A1C}" For Output As #ff
