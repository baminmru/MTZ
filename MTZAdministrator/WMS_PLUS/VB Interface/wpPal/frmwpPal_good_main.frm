VERSION 5.00
Begin VB.Form frmwpPal_good_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Товар на паллете"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpPalGUI.wpPal_goodmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpPal_good_main"
...
' Форма редактирования раздела wpPal_good режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3A46F2C5-DAAA-4B36-8C0D-01D01D7C18FF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3A46F2C5-DAAA-4B36-8C0D-01D01D7C18FF}"
  Open s & Me.Name & "{3A46F2C5-DAAA-4B36-8C0D-01D01D7C18FF}" For Output As #ff
