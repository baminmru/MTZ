...
Begin VB.UserControl wpPal_goodadmi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   End
End
Attribute VB_Name = "wpPal_goodadmi"
...
Private Sub cmdTheInLine_CLick()
  On Error Resume Next
        ...
        If Item.Application.Manager.GetReferenceDialogEx2("wpin_line", ID, brief) Then
          txtTheInLine.Tag = Left(ID, 38)
          txtTheInLine = brief
        End If
End Sub
...
Private Sub cmdTheFactory_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpDic_factory", ID, brief) Then
...
Private Sub cmdS1_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_S1", ID, brief) Then
...
Private Sub cmdS2_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_S2", ID, brief) Then
...
Private Sub cmdS3_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpG_S3", ID, brief) Then
...
Private Sub cmdS4_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_s4", ID, brief) Then
...
Private Sub cmdS5_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_s5", ID, brief) Then
...
Private Sub cmdD1_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_D1", ID, brief) Then
...
Private Sub cmdD2_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_d2", ID, brief) Then
...
Private Sub cmdD3_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_d3", ID, brief) Then
...
Private Sub cmdD4_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_d4", ID, brief) Then
...
Private Sub cmdD5_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("wpg_d5", ID, brief) Then
...
If mIsOK Then mIsOK = txtTheInLine.Tag <> ""
...
If mIsOK Then mIsOK = txtTheCountry.Tag <> ""
If mIsOK Then mIsOK = txtTheDeveloper.Tag <> ""
If mIsOK Then mIsOK = txtTheFactory.Tag <> ""
If mIsOK Then mIsOK = IsSet(txtSertNum.Text)
If mIsOK Then mIsOK = IsSet(dtpmadeDate_from.Value)
If mIsOK Then mIsOK = IsSet(dtpexpdate.Value)
...
If txtTheInLine.Tag <> "" Then
  Set Item.TheInLine = Item.Application.FindRowObject("wpin_line", txtTheInLine.Tag)
Else
  Set Item.TheInLine = Nothing
End If
