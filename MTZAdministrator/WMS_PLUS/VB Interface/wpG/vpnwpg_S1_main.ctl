...
Begin VB.UserControl vpnwpg_S1_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpg_S1 
      ...
      Begin GridEX20.GridEX gridwpg_S1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpg_S1_main.ctx":0000
         Column(2)       =   "vpnwpg_S1_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpg_S1_main.ctx":016C
         FormatStyle(2)  =   "vpnwpg_S1_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpg_S1_main.ctx":0378
         FormatStyle(4)  =   "vpnwpg_S1_main.ctx":042C
         FormatStyle(5)  =   "vpnwpg_S1_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpg_S1_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpg_S1_main"
