...
Begin VB.UserControl vpnwpg_S2_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerwpg_S2 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlwpg_S2 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdwpg_S2Acc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Fnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Cfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Prn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Ref 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Del 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Edit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_S2Add 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridwpg_S2 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpg_S2_admi.ctx":0000
         Column(2)       =   "vpnwpg_S2_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpg_S2_admi.ctx":016C
         FormatStyle(2)  =   "vpnwpg_S2_admi.ctx":02C8
         FormatStyle(3)  =   "vpnwpg_S2_admi.ctx":0378
         FormatStyle(4)  =   "vpnwpg_S2_admi.ctx":042C
         FormatStyle(5)  =   "vpnwpg_S2_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpg_S2_admi.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdwpg_S2Run 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupwpg_S2 
      Caption         =   "Меню для С-Аналитика 2"
      Visible         =   0   'False
      Begin VB.Menu mnuwpg_S2Add 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuwpg_S2Edit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuwpg_S2Delete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuwpg_S2Open 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuwpg_S2Ref 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuwpg_S2S1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuwpg_S2Buffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuwpg_S2COPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuwpg_S2CUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuwpg_S2PASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuwpg_S2CHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuwpg_S2CLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuwpg_S2Prn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuwpg_S2Cfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuwpg_S2Find 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuwpg_S2Acc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnwpg_S2_admi"
