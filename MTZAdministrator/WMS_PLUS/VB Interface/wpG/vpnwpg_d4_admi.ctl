...
Begin VB.UserControl vpnwpg_d4_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpg_d4 
      ...
      Begin GridEX20.GridEX gridwpg_d4 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpg_d4_admi.ctx":0000
         Column(2)       =   "vpnwpg_d4_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpg_d4_admi.ctx":016C
         FormatStyle(2)  =   "vpnwpg_d4_admi.ctx":02C8
         FormatStyle(3)  =   "vpnwpg_d4_admi.ctx":0378
         FormatStyle(4)  =   "vpnwpg_d4_admi.ctx":042C
         FormatStyle(5)  =   "vpnwpg_d4_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpg_d4_admi.ctx":05BC
      End
   ...
   Begin VB.Menu mnuPopupwpg_d4 
      Caption         =   "Меню для Д-Аналитика 4"
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "vpnwpg_d4_admi"
