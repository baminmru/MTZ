...
Begin VB.UserControl vpnwpg_s4_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerwpg_s4 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlwpg_s4 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdwpg_s4Acc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Fnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Cfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Prn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Ref 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Del 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Edit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpg_s4Add 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridwpg_s4 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpg_s4_main.ctx":0000
         Column(2)       =   "vpnwpg_s4_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpg_s4_main.ctx":016C
         FormatStyle(2)  =   "vpnwpg_s4_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpg_s4_main.ctx":0378
         FormatStyle(4)  =   "vpnwpg_s4_main.ctx":042C
         FormatStyle(5)  =   "vpnwpg_s4_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpg_s4_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdwpg_s4Run 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupwpg_s4 
      Caption         =   "Меню для С-Аналитика 4"
      Visible         =   0   'False
      Begin VB.Menu mnuwpg_s4Add 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuwpg_s4Edit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuwpg_s4Delete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuwpg_s4Open 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuwpg_s4Ref 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuwpg_s4S1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuwpg_s4Buffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuwpg_s4COPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuwpg_s4CUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuwpg_s4PASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuwpg_s4CHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuwpg_s4CLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuwpg_s4Prn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuwpg_s4Cfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuwpg_s4Find 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuwpg_s4Acc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnwpg_s4_main"
