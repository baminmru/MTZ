...
Begin VB.UserControl vpnwpg_D1_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpg_D1 
      ...
      Begin GridEX20.GridEX gridwpg_D1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpg_D1_.ctx":0000
         Column(2)       =   "vpnwpg_D1_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpg_D1_.ctx":016C
         FormatStyle(2)  =   "vpnwpg_D1_.ctx":02C8
         FormatStyle(3)  =   "vpnwpg_D1_.ctx":0378
         FormatStyle(4)  =   "vpnwpg_D1_.ctx":042C
         FormatStyle(5)  =   "vpnwpg_D1_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpg_D1_.ctx":05BC
      End
