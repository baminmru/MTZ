...
Begin VB.UserControl vpnwpG_S3_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpG_S3 
      ...
      Begin GridEX20.GridEX gridwpG_S3 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpG_S3_.ctx":0000
         Column(2)       =   "vpnwpG_S3_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpG_S3_.ctx":016C
         FormatStyle(2)  =   "vpnwpG_S3_.ctx":02C8
         FormatStyle(3)  =   "vpnwpG_S3_.ctx":0378
         FormatStyle(4)  =   "vpnwpG_S3_.ctx":042C
         FormatStyle(5)  =   "vpnwpG_S3_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpG_S3_.ctx":05BC
      End
