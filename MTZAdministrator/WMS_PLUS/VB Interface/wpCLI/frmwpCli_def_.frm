...
Begin VB.Form frmwpCli_def_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpCLIGUI.wpCli_def Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpCli_def_"
...
' Форма редактирования раздела wpCli_def режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{CEB371FC-52AE-4C0A-864E-A5D3C23DC753}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{CEB371FC-52AE-4C0A-864E-A5D3C23DC753}"
  Open s & Me.Name & "{CEB371FC-52AE-4C0A-864E-A5D3C23DC753}" For Output As #ff
