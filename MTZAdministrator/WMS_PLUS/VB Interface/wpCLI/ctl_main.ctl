...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin wpCLIGUI.vpnwpCli_def_ pnlwpCli_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlwpCli_def.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlwpCli_def.Visible = False
   ...
   Case "wpCli_def"
     ...
     .Visible = True
     .ZOrder 0
     pnlwpCli_def.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "wpCli_def"
pnlwpCli_def.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "wpCLI", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlwpCli_def.IsChanged
