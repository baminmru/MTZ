...
Begin VB.UserControl vpnwpin_srv_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpin_srv 
      ...
      Begin GridEX20.GridEX gridwpin_srv 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpin_srv_read.ctx":0000
         Column(2)       =   "vpnwpin_srv_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpin_srv_read.ctx":016C
         FormatStyle(2)  =   "vpnwpin_srv_read.ctx":02C8
         FormatStyle(3)  =   "vpnwpin_srv_read.ctx":0378
         FormatStyle(4)  =   "vpnwpin_srv_read.ctx":042C
         FormatStyle(5)  =   "vpnwpin_srv_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpin_srv_read.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpin_srv_read"
