...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin wpINGUI.vpnwpIn_def_main pnlwpIn_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpINGUI.vpnwpin_line_main pnlwpin_line 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpINGUI.vpnwpin_srv_main pnlwpin_srv 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
pnlwpin_srv.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "wpIN", "ctlmain_main"
