VERSION 5.00
Begin VB.Form frmwpIn_def_mnew 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpINGUI.wpIn_defmnew Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpIn_def_mnew"
...
' Форма редактирования раздела wpIn_def режим mnew
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{09B106F9-11B0-443A-BB8B-A300060FED21}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{09B106F9-11B0-443A-BB8B-A300060FED21}"
  Open s & Me.Name & "{09B106F9-11B0-443A-BB8B-A300060FED21}" For Output As #ff
