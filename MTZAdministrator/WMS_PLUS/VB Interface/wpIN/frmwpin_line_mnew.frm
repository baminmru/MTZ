VERSION 5.00
Begin VB.Form frmwpin_line_mnew 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpINGUI.wpin_linemnew Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpin_line_mnew"
...
' Форма редактирования раздела wpin_line режим mnew
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0510F905-8E34-492B-B171-CF987DEE5B30}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0510F905-8E34-492B-B171-CF987DEE5B30}"
  Open s & Me.Name & "{0510F905-8E34-492B-B171-CF987DEE5B30}" For Output As #ff
