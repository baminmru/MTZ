VERSION 5.00
Begin VB.Form frmwpin_srv_mnew 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpINGUI.wpin_srvmnew Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpin_srv_mnew"
...
' Форма редактирования раздела wpin_srv режим mnew
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{BC492EB8-000D-4D4C-8226-FD2584EB18CB}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{BC492EB8-000D-4D4C-8226-FD2584EB18CB}"
  Open s & Me.Name & "{BC492EB8-000D-4D4C-8226-FD2584EB18CB}" For Output As #ff
