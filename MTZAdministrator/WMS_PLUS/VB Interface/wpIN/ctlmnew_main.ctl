...
Begin VB.UserControl ctlmnew_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin wpINGUI.vpnwpIn_def_mnew pnlwpIn_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpINGUI.vpnwpin_line_mnew pnlwpin_line 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpINGUI.vpnwpin_srv_mnew pnlwpin_srv 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
Call ts.Tabs.Add(, "wpin_line", "Строки заказа")
pnlwpin_line.OnInit Item, ParentForm
Call ts.Tabs.Add(, "wpin_srv", "Доп. услуги")
pnlwpin_srv.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "wpIN", "ctlmnew_main"
