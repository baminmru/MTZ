VERSION 5.00
Begin VB.Form frmwpin_pal_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Паллеты к заказу"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpINGUI.wpin_palmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpin_pal_main"
...
' Форма редактирования раздела wpin_pal режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1C09F313-F935-4A88-B8FE-4BCB07D63C57}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1C09F313-F935-4A88-B8FE-4BCB07D63C57}"
  Open s & Me.Name & "{1C09F313-F935-4A88-B8FE-4BCB07D63C57}" For Output As #ff
