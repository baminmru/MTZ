...
Begin VB.UserControl vpnwpin_line_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlwpin_line 
      ...
      Begin GridEX20.GridEX gridwpin_pal 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpin_line_main.ctx":0000
         Column(2)       =   "vpnwpin_line_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpin_line_main.ctx":016C
         FormatStyle(2)  =   "vpnwpin_line_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpin_line_main.ctx":0378
         FormatStyle(4)  =   "vpnwpin_line_main.ctx":042C
         FormatStyle(5)  =   "vpnwpin_line_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpin_line_main.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridwpin_line 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpin_line_main.ctx":0794
         Column(2)       =   "vpnwpin_line_main.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpin_line_main.ctx":0900
         FormatStyle(2)  =   "vpnwpin_line_main.ctx":0A5C
         FormatStyle(3)  =   "vpnwpin_line_main.ctx":0B0C
         FormatStyle(4)  =   "vpnwpin_line_main.ctx":0BC0
         FormatStyle(5)  =   "vpnwpin_line_main.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnwpin_line_main.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnwpin_line_main"
...
Private Sub cmdwpin_palEdit_Click()
    ...
    Dim u As Object
    Dim bm2
    bm2 = gridwpin_pal.RowBookmark(gridwpin_pal.RowIndex(gridwpin_pal.Row))
    Set u = Item.FindRowObject(Right(bm2, Len(bm2) - 38), Left(bm2, 38))
    Set frmwpin_pal_main.Item = u
again:     frmwpin_pal_main.NotFirstTime = False
    frmwpin_pal_main.OnInit
    frmwpin_pal_main.Show vbModal
    If frmwpin_pal_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
    If err.Number <> 0 Then
      ...
      GoTo again
    End If
    gridwpin_pal.RefreshRowBookmark bm2
    Else
        u.Refresh
    End If
    Set u = Nothing
...
again:       frmwpin_pal_main.NotFirstTime = False
      ...
      If frmwpin_pal_main.OK Then
        ...
        gridwpin_pal.ItemCount = gu.wpin_pal.Count
        gridwpin_pal.Refresh
        gridwpin_pal.RefreshGroups
        gridwpin_pal.RefreshSort
        gridwpin_pal.MoveToBookmark u.ID & "wpin_pal"
      Else
        gu.wpin_pal.Delete u.ID
        gu.wpin_pal.Remove u.ID
      End If
Exit Sub
bye:
MsgBox err.Description, vbOKOnly + vbExclamation, "Создание"
