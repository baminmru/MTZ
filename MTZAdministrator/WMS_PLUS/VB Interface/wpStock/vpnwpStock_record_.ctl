...
Begin VB.UserControl vpnwpStock_record_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpStock_record 
      ...
      Begin GridEX20.GridEX gridwpStock_record 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpStock_record_.ctx":0000
         Column(2)       =   "vpnwpStock_record_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpStock_record_.ctx":016C
         FormatStyle(2)  =   "vpnwpStock_record_.ctx":02C8
         FormatStyle(3)  =   "vpnwpStock_record_.ctx":0378
         FormatStyle(4)  =   "vpnwpStock_record_.ctx":042C
         FormatStyle(5)  =   "vpnwpStock_record_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpStock_record_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpStock_record_"
