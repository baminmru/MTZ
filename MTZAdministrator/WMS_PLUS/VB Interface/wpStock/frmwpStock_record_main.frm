VERSION 5.00
Begin VB.Form frmwpStock_record_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpStockGUI.wpStock_recordmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpStock_record_main"
...
' Форма редактирования раздела wpStock_record режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D68B77FF-3945-44E6-9657-059E484AE763}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D68B77FF-3945-44E6-9657-059E484AE763}"
  Open s & Me.Name & "{D68B77FF-3945-44E6-9657-059E484AE763}" For Output As #ff
