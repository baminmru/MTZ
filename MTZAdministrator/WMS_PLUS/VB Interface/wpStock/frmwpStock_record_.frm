VERSION 5.00
Begin VB.Form frmwpStock_record_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpStockGUI.wpStock_record Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpStock_record_"
...
' Форма редактирования раздела wpStock_record режим
