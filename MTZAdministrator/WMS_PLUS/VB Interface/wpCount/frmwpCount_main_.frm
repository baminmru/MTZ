VERSION 5.00
Begin VB.Form frmwpCount_main_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpCountGUI.wpCount_main Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpCount_main_"
...
' Форма редактирования раздела wpCount_main режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F7B3AE5F-9A4B-422E-A3C8-8492B980133D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F7B3AE5F-9A4B-422E-A3C8-8492B980133D}"
  Open s & Me.Name & "{F7B3AE5F-9A4B-422E-A3C8-8492B980133D}" For Output As #ff
