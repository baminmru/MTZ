...
Begin VB.Form frmwpShift_def_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpShiftGUI.wpShift_def Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpShift_def_"
...
' Форма редактирования раздела wpShift_def режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2AD86C17-9D00-415B-91D4-DCC9C5BEE3B5}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2AD86C17-9D00-415B-91D4-DCC9C5BEE3B5}"
  Open s & Me.Name & "{2AD86C17-9D00-415B-91D4-DCC9C5BEE3B5}" For Output As #ff
