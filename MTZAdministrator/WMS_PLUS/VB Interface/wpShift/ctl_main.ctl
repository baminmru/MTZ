...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin wpShiftGUI.vpnwpShift_def_ pnlwpShift_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlwpShift_def.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlwpShift_def.Visible = False
   ...
   Case "wpShift_def"
     ...
     .Visible = True
     .ZOrder 0
     pnlwpShift_def.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "wpShift_def"
pnlwpShift_def.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "wpShift", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlwpShift_def.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{C39DA1F6-9C9B-4B50-A32E-0A91438CA7F8}"
    i = i + 1
    m(i).Caption = "Перемещен"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{877CE768-3554-4D38-8419-0FA19D5F7ACB}"
    i = i + 1
    m(i).Caption = "Проведен"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{ADEA0736-B8F9-4414-8604-9BA3015EB112}"
    i = i + 1
    m(i).Caption = "Создан"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{52DE307B-4B5F-4320-A8DC-87B57B4250E1}"
End Function
...
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{C39DA1F6-9C9B-4B50-A32E-0A91438CA7F8}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
      If Item.Statusid = "{877CE768-3554-4D38-8419-0FA19D5F7ACB}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{ADEA0736-B8F9-4414-8604-9BA3015EB112}" Then
            m(i).Enabled = True
          End If
        Next
      End If
      If Item.Statusid = "{ADEA0736-B8F9-4414-8604-9BA3015EB112}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
      If Item.Statusid = "{52DE307B-4B5F-4320-A8DC-87B57B4250E1}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{C39DA1F6-9C9B-4B50-A32E-0A91438CA7F8}" Then
            m(i).Enabled = True
          End If
          If m(i).Tag = "{877CE768-3554-4D38-8419-0FA19D5F7ACB}" Then
            m(i).Enabled = True
          End If
        Next
      End If
