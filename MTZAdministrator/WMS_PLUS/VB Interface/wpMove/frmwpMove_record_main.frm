VERSION 5.00
Begin VB.Form frmwpMove_record_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpMoveGUI.wpMove_recordmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpMove_record_main"
...
' Форма редактирования раздела wpMove_record режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8C95CD87-A986-4A42-9CD5-B2C8CB5A5623}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8C95CD87-A986-4A42-9CD5-B2C8CB5A5623}"
  Open s & Me.Name & "{8C95CD87-A986-4A42-9CD5-B2C8CB5A5623}" For Output As #ff
