...
Begin VB.UserControl vpnwpMove_record_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpMove_record 
      ...
      Begin GridEX20.GridEX gridwpMove_record 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpMove_record_.ctx":0000
         Column(2)       =   "vpnwpMove_record_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpMove_record_.ctx":016C
         FormatStyle(2)  =   "vpnwpMove_record_.ctx":02C8
         FormatStyle(3)  =   "vpnwpMove_record_.ctx":0378
         FormatStyle(4)  =   "vpnwpMove_record_.ctx":042C
         FormatStyle(5)  =   "vpnwpMove_record_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpMove_record_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpMove_record_"
...
Dim jset As Object 'MTZ_JSetup.Customizer
Set jset = CreateObject("MTZ_JSetup.Customizer")
jset.Preview gridwpMove_record, "Движение"
Set jset = Nothing
End Sub
