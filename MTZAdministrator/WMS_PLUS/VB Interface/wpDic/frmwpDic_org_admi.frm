VERSION 5.00
Begin VB.Form frmwpDic_org_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Сведения об организации"
      Top             =   6225
      Width           =   825
   End
   Begin wpDicGUI.wpDic_orgadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_org_admi"
...
' Форма редактирования раздела wpDic_org режим admi
