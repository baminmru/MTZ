...
Begin VB.UserControl vpnwpDic_org_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerwpDic_org 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlwpDic_org 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdwpDic_orgAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_orgAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridwpDic_org 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpDic_org_admi.ctx":0000
         Column(2)       =   "vpnwpDic_org_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpDic_org_admi.ctx":016C
         FormatStyle(2)  =   "vpnwpDic_org_admi.ctx":02C8
         FormatStyle(3)  =   "vpnwpDic_org_admi.ctx":0378
         FormatStyle(4)  =   "vpnwpDic_org_admi.ctx":042C
         FormatStyle(5)  =   "vpnwpDic_org_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpDic_org_admi.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdwpDic_orgRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupwpDic_org 
      Caption         =   "Меню для Сведения об организации"
      Visible         =   0   'False
      Begin VB.Menu mnuwpDic_orgAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuwpDic_orgEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuwpDic_orgDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuwpDic_orgOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuwpDic_orgRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuwpDic_orgS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuwpDic_orgBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuwpDic_orgCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuwpDic_orgCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuwpDic_orgPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuwpDic_orgCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuwpDic_orgCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuwpDic_orgPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuwpDic_orgCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuwpDic_orgFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuwpDic_orgAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnwpDic_org_admi"
...
'панель для работы со строками раздела Сведения об организации
