VERSION 5.00
Begin VB.Form frmwpdic_op_admi 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Операция по регистру"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpdic_opadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpdic_op_admi"
...
' Форма редактирования раздела wpdic_op режим admi
