VERSION 5.00
Begin VB.Form frmwpDic_factory_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpDic_factoryadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_factory_admi"
...
' Форма редактирования раздела wpDic_factory режим admi
