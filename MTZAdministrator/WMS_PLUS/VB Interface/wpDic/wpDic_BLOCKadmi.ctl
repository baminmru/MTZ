...
Begin VB.UserControl wpDic_BLOCKadmi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.TextBox txtTheCode 
         ...
         Width           =   3000
      End
      Begin MTZ_PANEL.DropButton cmdTheStore 
         Height          =   300
         Left            =   2850
         TabIndex        =   3
         Tag             =   "refopen.ico"
   ...
   End
End
Attribute VB_Name = "wpDic_BLOCKadmi"
