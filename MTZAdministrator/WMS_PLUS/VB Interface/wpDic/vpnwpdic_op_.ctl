...
Begin VB.UserControl vpnwpdic_op_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpdic_op 
      ...
      Begin GridEX20.GridEX gridwpdic_op 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpdic_op_.ctx":0000
         Column(2)       =   "vpnwpdic_op_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpdic_op_.ctx":016C
         FormatStyle(2)  =   "vpnwpdic_op_.ctx":02C8
         FormatStyle(3)  =   "vpnwpdic_op_.ctx":0378
         FormatStyle(4)  =   "vpnwpdic_op_.ctx":042C
         FormatStyle(5)  =   "vpnwpdic_op_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpdic_op_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpdic_op_"
