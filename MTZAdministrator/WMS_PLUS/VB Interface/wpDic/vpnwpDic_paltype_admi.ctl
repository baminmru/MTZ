...
Begin VB.UserControl vpnwpDic_paltype_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpDic_paltype 
      ...
      Begin GridEX20.GridEX gridwpDic_paltype 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpDic_paltype_admi.ctx":0000
         Column(2)       =   "vpnwpDic_paltype_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpDic_paltype_admi.ctx":016C
         FormatStyle(2)  =   "vpnwpDic_paltype_admi.ctx":02C8
         FormatStyle(3)  =   "vpnwpDic_paltype_admi.ctx":0378
         FormatStyle(4)  =   "vpnwpDic_paltype_admi.ctx":042C
         FormatStyle(5)  =   "vpnwpDic_paltype_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpDic_paltype_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpDic_paltype_admi"
