VERSION 5.00
Begin VB.Form frmwpDic_Country_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpDic_Countryadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_Country_admi"
...
' Форма редактирования раздела wpDic_Country режим admi
