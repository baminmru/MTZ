...
Begin VB.UserControl vpnwpDic_firm_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpDic_firm 
      ...
      Begin GridEX20.GridEX gridwpDic_firm 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpDic_firm_main.ctx":0000
         Column(2)       =   "vpnwpDic_firm_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpDic_firm_main.ctx":016C
         FormatStyle(2)  =   "vpnwpDic_firm_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpDic_firm_main.ctx":0378
         FormatStyle(4)  =   "vpnwpDic_firm_main.ctx":042C
         FormatStyle(5)  =   "vpnwpDic_firm_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpDic_firm_main.ctx":05BC
      End
   ...
   Begin VB.Menu mnuPopupwpDic_firm 
      Caption         =   "Меню для Производитель"
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "vpnwpDic_firm_main"
