VERSION 5.00
Begin VB.Form frmwpDic_EDIZM_admi 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Единицы изменрения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Единицы изменрения"
      Top             =   6225
      Width           =   825
   End
   Begin wpDicGUI.wpDic_EDIZMadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_EDIZM_admi"
...
' Форма редактирования раздела wpDic_EDIZM режим admi
