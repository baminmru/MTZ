VERSION 5.00
Begin VB.Form frmwpDic_zone_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpDic_zoneadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_zone_admi"
...
' Форма редактирования раздела wpDic_zone режим admi
