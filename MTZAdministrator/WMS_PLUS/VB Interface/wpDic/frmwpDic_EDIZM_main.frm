VERSION 5.00
Begin VB.Form frmwpDic_EDIZM_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpDic_EDIZMmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_EDIZM_main"
...
' Форма редактирования раздела wpDic_EDIZM режим main
