VERSION 5.00
Begin VB.Form frmwpDic_store_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpDic_storeadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_store_admi"
...
' Форма редактирования раздела wpDic_store режим admi
