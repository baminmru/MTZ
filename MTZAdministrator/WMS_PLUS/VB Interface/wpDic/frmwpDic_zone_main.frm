VERSION 5.00
Begin VB.Form frmwpDic_zone_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Складская зона"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDicGUI.wpDic_zonemain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDic_zone_main"
...
' Форма редактирования раздела wpDic_zone режим main
