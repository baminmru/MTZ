...
Begin VB.UserControl vpnwpdic_op_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerwpdic_op 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlwpdic_op 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdwpdic_opAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpdic_opAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridwpdic_op 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpdic_op_admi.ctx":0000
         Column(2)       =   "vpnwpdic_op_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpdic_op_admi.ctx":016C
         FormatStyle(2)  =   "vpnwpdic_op_admi.ctx":02C8
         FormatStyle(3)  =   "vpnwpdic_op_admi.ctx":0378
         FormatStyle(4)  =   "vpnwpdic_op_admi.ctx":042C
         FormatStyle(5)  =   "vpnwpdic_op_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpdic_op_admi.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdwpdic_opRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupwpdic_op 
      Caption         =   "Меню для Операция по регистру"
      Visible         =   0   'False
      Begin VB.Menu mnuwpdic_opAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuwpdic_opEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuwpdic_opDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuwpdic_opOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuwpdic_opRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuwpdic_opS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuwpdic_opBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuwpdic_opCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuwpdic_opCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuwpdic_opPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuwpdic_opCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuwpdic_opCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuwpdic_opPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuwpdic_opCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuwpdic_opFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuwpdic_opAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnwpdic_op_admi"
