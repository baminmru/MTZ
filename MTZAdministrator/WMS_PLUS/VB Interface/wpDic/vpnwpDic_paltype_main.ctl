...
Begin VB.UserControl vpnwpDic_paltype_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerwpDic_paltype 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlwpDic_paltype 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdwpDic_paltypeAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypeFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypeCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypePrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypeRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypeDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypeEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdwpDic_paltypeAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridwpDic_paltype 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpDic_paltype_main.ctx":0000
         Column(2)       =   "vpnwpDic_paltype_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpDic_paltype_main.ctx":016C
         FormatStyle(2)  =   "vpnwpDic_paltype_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpDic_paltype_main.ctx":0378
         FormatStyle(4)  =   "vpnwpDic_paltype_main.ctx":042C
         FormatStyle(5)  =   "vpnwpDic_paltype_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpDic_paltype_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdwpDic_paltypeRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupwpDic_paltype 
      Caption         =   "Меню для Тип паллеты"
      Visible         =   0   'False
      Begin VB.Menu mnuwpDic_paltypeAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuwpDic_paltypeEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuwpDic_paltypeDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuwpDic_paltypeOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuwpDic_paltypeRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuwpDic_paltypeS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuwpDic_paltypeBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuwpDic_paltypeCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuwpDic_paltypeCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuwpDic_paltypePASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuwpDic_paltypeCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuwpDic_paltypeCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuwpDic_paltypePrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuwpDic_paltypeCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuwpDic_paltypeFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuwpDic_paltypeAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnwpDic_paltype_main"
