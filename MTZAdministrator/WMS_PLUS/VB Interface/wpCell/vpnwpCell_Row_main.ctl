...
Begin VB.UserControl vpnwpCell_Row_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpCell_Row 
      ...
      Begin GridEX20.GridEX gridwpCell_Row 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpCell_Row_main.ctx":0000
         Column(2)       =   "vpnwpCell_Row_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpCell_Row_main.ctx":016C
         FormatStyle(2)  =   "vpnwpCell_Row_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpCell_Row_main.ctx":0378
         FormatStyle(4)  =   "vpnwpCell_Row_main.ctx":042C
         FormatStyle(5)  =   "vpnwpCell_Row_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpCell_Row_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpCell_Row_main"
