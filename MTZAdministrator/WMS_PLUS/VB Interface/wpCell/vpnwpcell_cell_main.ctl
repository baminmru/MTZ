...
Begin VB.UserControl vpnwpcell_cell_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpcell_cell 
      ...
      Begin GridEX20.GridEX gridwpcell_cell 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpcell_cell_main.ctx":0000
         Column(2)       =   "vpnwpcell_cell_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpcell_cell_main.ctx":016C
         FormatStyle(2)  =   "vpnwpcell_cell_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpcell_cell_main.ctx":0378
         FormatStyle(4)  =   "vpnwpcell_cell_main.ctx":042C
         FormatStyle(5)  =   "vpnwpcell_cell_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpcell_cell_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpcell_cell_main"
