VERSION 5.00
Begin VB.Form frmwpcell_cell_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpCellGUI.wpcell_cellmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpcell_cell_main"
...
' Форма редактирования раздела wpcell_cell режим main
