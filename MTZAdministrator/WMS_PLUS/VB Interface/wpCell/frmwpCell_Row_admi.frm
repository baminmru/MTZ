VERSION 5.00
Begin VB.Form frmwpCell_Row_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpCellGUI.wpCell_Rowadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpCell_Row_admi"
...
' Форма редактирования раздела wpCell_Row режим admi
