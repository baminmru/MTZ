VERSION 5.00
Begin VB.Form frmwpCell_Row_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpCellGUI.wpCell_Rowmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpCell_Row_main"
...
' Форма редактирования раздела wpCell_Row режим main
