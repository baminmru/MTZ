VERSION 5.00
Begin VB.Form frmwpOut_line_mnew 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Строки заказа"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpOutGUI.wpOut_linemnew Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpOut_line_mnew"
...
' Форма редактирования раздела wpOut_line режим mnew
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2394F884-DC94-4F62-BE3A-D2CACDAA7F5F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2394F884-DC94-4F62-BE3A-D2CACDAA7F5F}"
  Open s & Me.Name & "{2394F884-DC94-4F62-BE3A-D2CACDAA7F5F}" For Output As #ff
