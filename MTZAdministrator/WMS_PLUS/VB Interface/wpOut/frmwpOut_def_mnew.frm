VERSION 5.00
Begin VB.Form frmwpOut_def_mnew 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpOutGUI.wpOut_defmnew Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpOut_def_mnew"
...
' Форма редактирования раздела wpOut_def режим mnew
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{6B0A3631-447C-46B5-9DB6-868E634D1424}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{6B0A3631-447C-46B5-9DB6-868E634D1424}"
  Open s & Me.Name & "{6B0A3631-447C-46B5-9DB6-868E634D1424}" For Output As #ff
