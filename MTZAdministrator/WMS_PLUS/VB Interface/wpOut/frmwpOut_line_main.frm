VERSION 5.00
Begin VB.Form frmwpOut_line_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpOutGUI.wpOut_linemain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpOut_line_main"
...
' Форма редактирования раздела wpOut_line режим main
