VERSION 5.00
Begin VB.Form frmwpout_pal_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Паллеты к строке"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpOutGUI.wpout_palmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpout_pal_main"
...
' Форма редактирования раздела wpout_pal режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A73FB52B-ECF2-4329-B7FC-15C47D08336D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A73FB52B-ECF2-4329-B7FC-15C47D08336D}"
  Open s & Me.Name & "{A73FB52B-ECF2-4329-B7FC-15C47D08336D}" For Output As #ff
