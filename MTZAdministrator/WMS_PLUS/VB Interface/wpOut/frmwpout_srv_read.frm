VERSION 5.00
Begin VB.Form frmwpout_srv_read 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpOutGUI.wpout_srvread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpout_srv_read"
...
' Форма редактирования раздела wpout_srv режим read
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1984F0F6-27B5-4983-BEC2-FC3F555B6877}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1984F0F6-27B5-4983-BEC2-FC3F555B6877}"
  Open s & Me.Name & "{1984F0F6-27B5-4983-BEC2-FC3F555B6877}" For Output As #ff
