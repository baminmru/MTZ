...
Begin VB.UserControl vpnwpout_srv_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpout_srv 
      ...
      Begin GridEX20.GridEX gridwpout_srv 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpout_srv_read.ctx":0000
         Column(2)       =   "vpnwpout_srv_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpout_srv_read.ctx":016C
         FormatStyle(2)  =   "vpnwpout_srv_read.ctx":02C8
         FormatStyle(3)  =   "vpnwpout_srv_read.ctx":0378
         FormatStyle(4)  =   "vpnwpout_srv_read.ctx":042C
         FormatStyle(5)  =   "vpnwpout_srv_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpout_srv_read.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpout_srv_read"
