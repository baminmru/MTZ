VERSION 5.00
Begin VB.Form frmwpDog_srvPrice_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Цены на доп. услуги"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDogGUI.wpDog_srvPrice Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpDog_srvPrice_"
...
' Форма редактирования раздела wpDog_srvPrice режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8A0B57C3-A08B-4668-9C40-C69D46162916}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8A0B57C3-A08B-4668-9C40-C69D46162916}"
  Open s & Me.Name & "{8A0B57C3-A08B-4668-9C40-C69D46162916}" For Output As #ff
