VERSION 5.00
Begin VB.Form frmwpdog_mainSrv_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Цены на основные услуги"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpDogGUI.wpdog_mainSrv Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpdog_mainSrv_"
...
' Форма редактирования раздела wpdog_mainSrv режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{365850D1-A72D-42E2-A4B5-C0E75087F668}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{365850D1-A72D-42E2-A4B5-C0E75087F668}"
  Open s & Me.Name & "{365850D1-A72D-42E2-A4B5-C0E75087F668}" For Output As #ff
