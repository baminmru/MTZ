...
If Name = "wpDog_def" Then
 Set FormByName = New frmwpDog_def_
 Exit Function
End If

If Name = "wpdog_mainSrv" Then
 Set FormByName = New frmwpdog_mainSrv_
 Exit Function
End If

If Name = "wpDog_srvPrice" Then
 Set FormByName = New frmwpDog_srvPrice_
 Exit Function
End If
