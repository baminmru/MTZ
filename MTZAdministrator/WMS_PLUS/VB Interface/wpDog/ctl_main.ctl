...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin wpDogGUI.vpnwpDog_def_ pnlwpDog_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpDogGUI.vpnwpdog_mainSrv_ pnlwpdog_mainSrv 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpDogGUI.vpnwpDog_srvPrice_ pnlwpDog_srvPrice 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
If IsItOk Then IsItOk = pnlwpDog_def.IsOK
If IsItOk Then IsItOk = pnlwpdog_mainSrv.IsOK
If IsItOk Then IsItOk = pnlwpDog_srvPrice.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlwpDog_srvPrice.Visible = False
  pnlwpdog_mainSrv.Visible = False
  pnlwpDog_def.Visible = False
   ...
   Case "wpDog_def"
     ...
     .Visible = True
     .ZOrder 0
     pnlwpDog_def.OnClick Item, ParentForm
     End With
   Case "wpdog_mainSrv"
     With pnlwpdog_mainSrv
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlwpdog_mainSrv.OnClick Item, ParentForm
     End With
   Case "wpDog_srvPrice"
     With pnlwpDog_srvPrice
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlwpDog_srvPrice.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "wpDog_def"
pnlwpDog_def.OnInit Item, ParentForm
Call ts.Tabs.Add(, "wpdog_mainSrv", "Цены на основные услуги")
pnlwpdog_mainSrv.OnInit Item, ParentForm
Call ts.Tabs.Add(, "wpDog_srvPrice", "Цены на доп. услуги")
pnlwpDog_srvPrice.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "wpDog", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlwpDog_def.CloseClass
 pnlwpdog_mainSrv.CloseClass
 pnlwpDog_srvPrice.CloseClass
End Sub
...
Public Sub OnSave()
 pnlwpDog_def.OnSave
 pnlwpdog_mainSrv.OnSave
 pnlwpDog_srvPrice.OnSave
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlwpDog_def.IsChanged
m_IsChanged = m_IsChanged Or pnlwpdog_mainSrv.IsChanged
m_IsChanged = m_IsChanged Or pnlwpDog_srvPrice.IsChanged
