...
Begin VB.UserControl vpnwpOpt_moves_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpOpt_moves 
      ...
      Begin GridEX20.GridEX gridwpOpt_moves 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpOpt_moves_.ctx":0000
         Column(2)       =   "vpnwpOpt_moves_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpOpt_moves_.ctx":016C
         FormatStyle(2)  =   "vpnwpOpt_moves_.ctx":02C8
         FormatStyle(3)  =   "vpnwpOpt_moves_.ctx":0378
         FormatStyle(4)  =   "vpnwpOpt_moves_.ctx":042C
         FormatStyle(5)  =   "vpnwpOpt_moves_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpOpt_moves_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpOpt_moves_"
