VERSION 5.00
Begin VB.Form frmwpOpt_moves_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpOptGUI.wpOpt_movesmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpOpt_moves_main"
...
' Форма редактирования раздела wpOpt_moves режим main
