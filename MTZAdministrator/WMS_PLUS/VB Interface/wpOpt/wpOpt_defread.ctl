...
Begin VB.UserControl wpOpt_defread 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.TextBox txtTheNumber 
         ...
         MaxLength       =   15
         TabIndex        =   2
         ToolTipText     =   "Ќомер документа"
         Top             =   405
         Width           =   1800
      End
      Begin VB.Label lblTheDate 
         BackStyle       =   0  'Transparent
         Caption         =   "ƒата документа:"
         Enabled         =   0   'False
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
   ...
   End
End
Attribute VB_Name = "wpOpt_defread"
