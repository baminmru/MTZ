VERSION 5.00
Begin VB.Form frmwpact_line_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpACTGUI.wpact_linemain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpact_line_main"
...
' Форма редактирования раздела wpact_line режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{188A5264-0BC4-4666-8BCA-2D1BEA294A79}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{188A5264-0BC4-4666-8BCA-2D1BEA294A79}"
  Open s & Me.Name & "{188A5264-0BC4-4666-8BCA-2D1BEA294A79}" For Output As #ff
