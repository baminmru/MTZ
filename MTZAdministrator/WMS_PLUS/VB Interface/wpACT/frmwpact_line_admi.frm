VERSION 5.00
Begin VB.Form frmwpact_line_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpACTGUI.wpact_lineadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpact_line_admi"
...
' Форма редактирования раздела wpact_line режим admi
