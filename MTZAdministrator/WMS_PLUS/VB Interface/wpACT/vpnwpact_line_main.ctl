...
Begin VB.UserControl vpnwpact_line_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpact_line 
      ...
      Begin GridEX20.GridEX gridwpact_line 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpact_line_main.ctx":0000
         Column(2)       =   "vpnwpact_line_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpact_line_main.ctx":016C
         FormatStyle(2)  =   "vpnwpact_line_main.ctx":02C8
         FormatStyle(3)  =   "vpnwpact_line_main.ctx":0378
         FormatStyle(4)  =   "vpnwpact_line_main.ctx":042C
         FormatStyle(5)  =   "vpnwpact_line_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpact_line_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpact_line_main"
...
Dim jset As Object 'MTZ_JSetup.Customizer
Set jset = CreateObject("MTZ_JSetup.Customizer")
jset.Preview gridwpact_line, "Строка акта"
Set jset = Nothing
End Sub
