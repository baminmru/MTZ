...
Begin VB.UserControl vpnwpact_line_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlwpact_line 
      ...
      Begin GridEX20.GridEX gridwpact_line 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnwpact_line_.ctx":0000
         Column(2)       =   "vpnwpact_line_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnwpact_line_.ctx":016C
         FormatStyle(2)  =   "vpnwpact_line_.ctx":02C8
         FormatStyle(3)  =   "vpnwpact_line_.ctx":0378
         FormatStyle(4)  =   "vpnwpact_line_.ctx":042C
         FormatStyle(5)  =   "vpnwpact_line_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnwpact_line_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnwpact_line_"
