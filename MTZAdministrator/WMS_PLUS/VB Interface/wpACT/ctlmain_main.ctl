...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin wpACTGUI.vpnwpACT_DEF_main pnlwpACT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin wpACTGUI.vpnwpact_line_main pnlwpact_line 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlwpACT_DEF.IsOK
If IsItOk Then IsItOk = pnlwpact_line.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlwpact_line.Visible = False
  pnlwpACT_DEF.Visible = False
   ...
   Case "wpACT_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlwpACT_DEF.OnClick Item, ParentForm
     End With
   Case "wpact_line"
     With pnlwpact_line
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlwpact_line.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "wpACT_DEF"
pnlwpACT_DEF.OnInit Item, ParentForm
Call ts.Tabs.Add(, "wpact_line", "Строка акта")
pnlwpact_line.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "wpACT", "ctlmain_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlwpACT_DEF.CloseClass
 pnlwpact_line.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlwpACT_DEF.IsChanged
m_IsChanged = m_IsChanged Or pnlwpact_line.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{71A9B033-A2BC-4683-85F6-3ECE99C40A00}"
    i = i + 1
    m(i).Caption = "Согласован"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{39C6754B-4D97-408F-AB9B-725AF8DA7140}"
    i = i + 1
    m(i).Caption = "Создан"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{1CFC4610-2026-4D82-A595-784D93F8830D}"
End Function
...
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{71A9B033-A2BC-4683-85F6-3ECE99C40A00}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
      If Item.Statusid = "{39C6754B-4D97-408F-AB9B-725AF8DA7140}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{71A9B033-A2BC-4683-85F6-3ECE99C40A00}" Then
            m(i).Enabled = True
          End If
        Next
      End If
      If Item.Statusid = "{1CFC4610-2026-4D82-A595-784D93F8830D}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{39C6754B-4D97-408F-AB9B-725AF8DA7140}" Then
            m(i).Enabled = True
          End If
        Next
      End If
