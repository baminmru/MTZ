VERSION 5.00
Begin VB.Form frmwpACT_DEF_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin wpACTGUI.wpACT_DEFadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmwpACT_DEF_admi"
...
' Форма редактирования раздела wpACT_DEF режим admi
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0D673035-EA21-4EB4-A074-912E137C170F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0D673035-EA21-4EB4-A074-912E137C170F}"
  Open s & Me.Name & "{0D673035-EA21-4EB4-A074-912E137C170F}" For Output As #ff
