...
Begin VB.UserControl WEBSDIC_DEF 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtPathToFiles 
         Height          =   300
         Left            =   300
         MaxLength       =   2048
         TabIndex        =   5
         ToolTipText     =   "Каталог для файлов"
         Top             =   1110
         Width           =   3000
      End
      ...
      Begin VB.TextBox txtWEBS 
         ...
         Width           =   2550
      End
      Begin VB.Label lblPathToFiles 
         BackStyle       =   0  'Transparent
         Caption         =   "Каталог для файлов:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   4
...
Private Sub cmdWEBS_MenuClick(ByVal sCaption As String)
  ...
  End If
End Sub
Private Sub txtPathToFiles_Change()
  Changing
...
End If
 LoadBtnPictures cmdWEBS, cmdWEBS.Tag
  ...
  On Error Resume Next
txtPathToFiles = Item.PathToFiles
...
End If
Item.PathToFiles = txtPathToFiles
 mIsChanged = False
 RaiseEvent Changed
End Sub
