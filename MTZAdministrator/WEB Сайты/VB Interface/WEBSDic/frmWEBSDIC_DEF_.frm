...
Begin VB.Form frmWEBSDIC_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBSDicGUI.WEBSDIC_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBSDIC_DEF_"
...
' Форма редактирования раздела WEBSDIC_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DB602701-EFE5-4CB3-97B4-9E7CC1793332}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DB602701-EFE5-4CB3-97B4-9E7CC1793332}"
  Open s & Me.Name & "{DB602701-EFE5-4CB3-97B4-9E7CC1793332}" For Output As #ff
