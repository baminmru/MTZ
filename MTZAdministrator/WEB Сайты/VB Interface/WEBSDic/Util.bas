...
If Name = "WEBSDIC_DEF" Then
 Set FormByName = New frmWEBSDIC_DEF_
 Exit Function
End If

If Name = "WEBSDIC_PAGETYPE" Then
 Set FormByName = New frmWEBSDIC_PAGETYPE_
 Exit Function
End If

If Name = "WEBSDIC_QTYPE" Then
 Set FormByName = New frmWEBSDIC_QTYPE_
 Exit Function
End If
