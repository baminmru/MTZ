VERSION 5.00
Begin VB.Form frmWEBSDIC_PAGETYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBSDicGUI.WEBSDIC_PAGETYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBSDIC_PAGETYPE_"
...
' Форма редактирования раздела WEBSDIC_PAGETYPE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{21A1FC55-B72D-41D7-A1CA-A1AD4B6C1BEC}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{21A1FC55-B72D-41D7-A1CA-A1AD4B6C1BEC}"
  Open s & Me.Name & "{21A1FC55-B72D-41D7-A1CA-A1AD4B6C1BEC}" For Output As #ff
