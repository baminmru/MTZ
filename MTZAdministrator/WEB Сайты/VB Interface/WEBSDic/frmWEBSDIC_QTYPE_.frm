VERSION 5.00
Begin VB.Form frmWEBSDIC_QTYPE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Тип вопроса в анкете"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBSDicGUI.WEBSDIC_QTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBSDIC_QTYPE_"
...
' Форма редактирования раздела WEBSDIC_QTYPE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{423A1EAB-3841-4E6B-8FBE-82706B085016}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{423A1EAB-3841-4E6B-8FBE-82706B085016}"
  Open s & Me.Name & "{423A1EAB-3841-4E6B-8FBE-82706B085016}" For Output As #ff
