...
' Форма редактирования раздела ST_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2C7C263D-B0EB-4656-BCF0-C1BCB5E27FD3}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2C7C263D-B0EB-4656-BCF0-C1BCB5E27FD3}"
  Open s & Me.Name & "{2C7C263D-B0EB-4656-BCF0-C1BCB5E27FD3}" For Output As #ff
