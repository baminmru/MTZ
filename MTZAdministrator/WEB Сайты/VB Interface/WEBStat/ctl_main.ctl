...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WEBStatGUI.vpnST_DEF_ pnlST_DEF 
      Height          =   1500
      Left            =   1440
      TabIndex        =   1
      Top             =   0
      ...
      _extenty        =   2646
   End
   Begin WEBStatGUI.vpnST_MAIN_ pnlST_MAIN 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _extenty        =   2646
   End
   Begin WEBStatGUI.vpnST_PAGES_ pnlST_PAGES 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
If IsItOk Then IsItOk = pnlST_DEF.IsOK
If IsItOk Then IsItOk = pnlST_MAIN.IsOK
If IsItOk Then IsItOk = pnlST_PAGES.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlST_PAGES.Visible = False
  pnlST_MAIN.Visible = False
  pnlST_DEF.Visible = False
   ...
   Case "ST_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlST_DEF.OnClick item, ParentForm
     End With
   Case "ST_MAIN"
     With pnlST_MAIN
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlST_MAIN.OnClick item, ParentForm
     End With
   Case "ST_PAGES"
     With pnlST_PAGES
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlST_PAGES.OnClick item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.item(1).Key = "ST_DEF"
pnlST_DEF.OnInit item, ParentForm
Call ts.Tabs.Add(, "ST_MAIN", "Статистика посещений сайта")
pnlST_MAIN.OnInit item, ParentForm
Call ts.Tabs.Add(, "ST_PAGES", "Статистика посещений страниц сайта")
pnlST_PAGES.OnInit item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "WEBStat", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlST_DEF.CloseClass
 pnlST_MAIN.CloseClass
 pnlST_PAGES.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlST_DEF.IsChanged
m_IsChanged = m_IsChanged Or pnlST_MAIN.IsChanged
m_IsChanged = m_IsChanged Or pnlST_PAGES.IsChanged
