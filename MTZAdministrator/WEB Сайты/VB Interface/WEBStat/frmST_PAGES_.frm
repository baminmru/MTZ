VERSION 5.00
Begin VB.Form frmST_PAGES_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Статистика посещений страниц сайта"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBStatGUI.ST_PAGES Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmST_PAGES_"
...
' Форма редактирования раздела ST_PAGES режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{352FA790-89C0-4AB6-8934-D2C5423B50A4}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{352FA790-89C0-4AB6-8934-D2C5423B50A4}"
  Open s & Me.Name & "{352FA790-89C0-4AB6-8934-D2C5423B50A4}" For Output As #ff
