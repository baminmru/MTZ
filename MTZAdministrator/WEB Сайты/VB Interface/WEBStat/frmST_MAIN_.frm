VERSION 5.00
Begin VB.Form frmST_MAIN_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Статистика посещений сайта"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBStatGUI.ST_MAIN Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела ST_MAIN режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4BA0A813-C698-430C-AC8D-627732AE916D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4BA0A813-C698-430C-AC8D-627732AE916D}"
  Open s & Me.Name & "{4BA0A813-C698-430C-AC8D-627732AE916D}" For Output As #ff
