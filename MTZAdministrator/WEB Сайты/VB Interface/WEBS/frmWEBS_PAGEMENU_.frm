VERSION 5.00
Begin VB.Form frmWEBS_PAGEMENU_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Отношения с меню"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBSGUI.WEBS_PAGEMENU Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBS_PAGEMENU_"
...
' Форма редактирования раздела WEBS_PAGEMENU режим
