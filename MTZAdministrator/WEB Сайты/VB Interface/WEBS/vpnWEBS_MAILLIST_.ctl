...
Begin VB.UserControl vpnWEBS_MAILLIST_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWEBS_MAILLIST 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWEBS_MAILLIST 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWEBS_MAILLISTAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_MAILLISTAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWEBS_MAILLIST 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWEBS_MAILLIST_.ctx":0000
         Column(2)       =   "vpnWEBS_MAILLIST_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWEBS_MAILLIST_.ctx":016C
         FormatStyle(2)  =   "vpnWEBS_MAILLIST_.ctx":02C8
         FormatStyle(3)  =   "vpnWEBS_MAILLIST_.ctx":0378
         FormatStyle(4)  =   "vpnWEBS_MAILLIST_.ctx":042C
         FormatStyle(5)  =   "vpnWEBS_MAILLIST_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWEBS_MAILLIST_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWEBS_MAILLISTRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWEBS_MAILLIST 
      Caption         =   "Меню для Список рассылки"
      Visible         =   0   'False
      Begin VB.Menu mnuWEBS_MAILLISTAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWEBS_MAILLISTEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWEBS_MAILLISTDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWEBS_MAILLISTOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWEBS_MAILLISTRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWEBS_MAILLISTS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWEBS_MAILLISTBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWEBS_MAILLISTCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWEBS_MAILLISTCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWEBS_MAILLISTPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWEBS_MAILLISTCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWEBS_MAILLISTCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWEBS_MAILLISTPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWEBS_MAILLISTCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWEBS_MAILLISTFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWEBS_MAILLISTAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWEBS_MAILLIST_"
