...
Begin VB.UserControl vpnWEBS_DDOC_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWEBS_DDOC 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWEBS_DDOC 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWEBS_DDOCAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_DDOCAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWEBS_DDOC 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWEBS_DDOC_.ctx":0000
         Column(2)       =   "vpnWEBS_DDOC_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWEBS_DDOC_.ctx":016C
         FormatStyle(2)  =   "vpnWEBS_DDOC_.ctx":02C8
         FormatStyle(3)  =   "vpnWEBS_DDOC_.ctx":0378
         FormatStyle(4)  =   "vpnWEBS_DDOC_.ctx":042C
         FormatStyle(5)  =   "vpnWEBS_DDOC_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWEBS_DDOC_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWEBS_DDOCRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWEBS_DDOC 
      Caption         =   "Меню для Документы для скачивания"
      Visible         =   0   'False
      Begin VB.Menu mnuWEBS_DDOCAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWEBS_DDOCEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWEBS_DDOCDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWEBS_DDOCOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWEBS_DDOCRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWEBS_DDOCS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWEBS_DDOCBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWEBS_DDOCCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWEBS_DDOCCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWEBS_DDOCPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWEBS_DDOCCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWEBS_DDOCCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWEBS_DDOCPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWEBS_DDOCCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWEBS_DDOCFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWEBS_DDOCAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWEBS_DDOC_"
...
'панель для работы со строками раздела Список документов которые можно скачать
