...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WEBSGUI.vpnWEBS_PAGEDEF_ pnlWEBS_PAGEDEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WEBSGUI.vpnWEBS_DDOC_ pnlWEBS_DDOC 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WEBSGUI.vpnWEBS_ANKETA_ pnlWEBS_ANKETA 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WEBSGUI.vpnWEBS_MAILLIST_ pnlWEBS_MAILLIST 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WEBSGUI.vpnWEBS_NEWS_ pnlWEBS_NEWS 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin WEBSGUI.vpnWEBS_USERS_ pnlWEBS_USERS 
      Height          =   1500
      Left            =   1500
      TabIndex        =   6
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin WEBSGUI.vpnWEBS_ROLES_ pnlWEBS_ROLES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   7
      Top             =   1500
