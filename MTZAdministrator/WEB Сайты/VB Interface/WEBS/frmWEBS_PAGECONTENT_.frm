VERSION 5.00
Begin VB.Form frmWEBS_PAGECONTENT_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBSGUI.WEBS_PAGECONTENT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBS_PAGECONTENT_"
...
' Форма редактирования раздела WEBS_PAGECONTENT режим
