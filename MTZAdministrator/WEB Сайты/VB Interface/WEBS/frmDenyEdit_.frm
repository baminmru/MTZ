VERSION 5.00
Begin VB.Form frmDenyEdit_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Запрещённые для редактирования поля"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   End
End
Attribute VB_Name = "frmDenyEdit_"
...
' Форма редактирования раздела DenyEdit режим
