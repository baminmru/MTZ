...
Begin VB.Form frmWEBS_NEWS_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Древовидный список новостей"
      Top             =   6225
      Width           =   825
   End
   Begin WEBSGUI.WEBS_NEWS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBS_NEWS_"
...
' Форма редактирования раздела WEBS_NEWS режим
