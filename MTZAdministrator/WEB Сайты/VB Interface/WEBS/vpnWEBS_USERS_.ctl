...
Begin VB.UserControl vpnWEBS_USERS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWEBS_USERS 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWEBS_USERS 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWEBS_USERSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWEBS_USERSAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWEBS_USERS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWEBS_USERS_.ctx":0000
         Column(2)       =   "vpnWEBS_USERS_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWEBS_USERS_.ctx":016C
         FormatStyle(2)  =   "vpnWEBS_USERS_.ctx":02C8
         FormatStyle(3)  =   "vpnWEBS_USERS_.ctx":0378
         FormatStyle(4)  =   "vpnWEBS_USERS_.ctx":042C
         FormatStyle(5)  =   "vpnWEBS_USERS_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWEBS_USERS_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWEBS_USERSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWEBS_USERS 
      Caption         =   "Меню для Users"
      Visible         =   0   'False
      Begin VB.Menu mnuWEBS_USERSAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWEBS_USERSEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWEBS_USERSDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWEBS_USERSOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWEBS_USERSRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWEBS_USERSS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWEBS_USERSBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWEBS_USERSCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWEBS_USERSCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWEBS_USERSPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWEBS_USERSCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWEBS_USERSCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWEBS_USERSPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWEBS_USERSCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWEBS_USERSFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWEBS_USERSAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWEBS_USERS_"
