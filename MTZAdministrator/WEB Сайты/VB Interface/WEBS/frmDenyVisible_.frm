VERSION 5.00
Begin VB.Form frmDenyVisible_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Невидимые поля"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WEBSGUI.DenyVisible Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDenyVisible_"
...
' Форма редактирования раздела DenyVisible режим
