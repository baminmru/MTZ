VERSION 5.00
Begin VB.Form frmWEBS_DDOC_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Документы для скачивания"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Список документов которые можно скачать"
      Top             =   6225
      Width           =   825
   End
   Begin WEBSGUI.WEBS_DDOC Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWEBS_DDOC_"
...
' Форма редактирования раздела WEBS_DDOC режим
