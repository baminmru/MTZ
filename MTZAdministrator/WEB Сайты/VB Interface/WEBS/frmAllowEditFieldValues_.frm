VERSION 5.00
Begin VB.Form frmAllowEditFieldValues_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Значения поля, разрешающего редактирование"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Значения поля, разрешающего редактирование"
      Top             =   6225
      Width           =   825
   End
   Begin WEBSGUI.AllowEditFieldValues Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmAllowEditFieldValues_"
...
' Форма редактирования раздела AllowEditFieldValues режим
