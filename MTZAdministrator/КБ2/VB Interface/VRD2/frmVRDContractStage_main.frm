VERSION 5.00
Begin VB.Form frmVRDContractStage_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Стадия договора"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Стадия договора"
      Top             =   6225
      Width           =   825
   End
   Begin VRD2GUI.VRDContractStagemain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRDContractStage_main"
