...
Begin VB.UserControl vpnVRDRreportType_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDRreportType 
      ...
      Begin GridEX20.GridEX gridVRDRreportType 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDRreportType_.ctx":0000
         Column(2)       =   "vpnVRDRreportType_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDRreportType_.ctx":016C
         FormatStyle(2)  =   "vpnVRDRreportType_.ctx":02C8
         FormatStyle(3)  =   "vpnVRDRreportType_.ctx":0378
         FormatStyle(4)  =   "vpnVRDRreportType_.ctx":042C
         FormatStyle(5)  =   "vpnVRDRreportType_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDRreportType_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDRreportType_"
