...
Begin VB.UserControl vpnVRDContractStage_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDContractStage 
      ...
      Begin GridEX20.GridEX gridVRDContractStage 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDContractStage_main.ctx":0000
         Column(2)       =   "vpnVRDContractStage_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDContractStage_main.ctx":016C
         FormatStyle(2)  =   "vpnVRDContractStage_main.ctx":02C8
         FormatStyle(3)  =   "vpnVRDContractStage_main.ctx":0378
         FormatStyle(4)  =   "vpnVRDContractStage_main.ctx":042C
         FormatStyle(5)  =   "vpnVRDContractStage_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDContractStage_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDContractStage_main"
