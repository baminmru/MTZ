...
Begin VB.UserControl vpnVRDStream_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDStream 
      ...
      Begin GridEX20.GridEX gridVRDStream 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDStream_.ctx":0000
         Column(2)       =   "vpnVRDStream_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDStream_.ctx":016C
         FormatStyle(2)  =   "vpnVRDStream_.ctx":02C8
         FormatStyle(3)  =   "vpnVRDStream_.ctx":0378
         FormatStyle(4)  =   "vpnVRDStream_.ctx":042C
         FormatStyle(5)  =   "vpnVRDStream_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDStream_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDStream_"
