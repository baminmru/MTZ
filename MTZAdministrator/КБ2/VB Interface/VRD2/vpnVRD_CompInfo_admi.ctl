...
Begin VB.UserControl vpnVRD_CompInfo_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRD_CompInfo 
      ...
      Begin GridEX20.GridEX gridVRD_CompInfo 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRD_CompInfo_admi.ctx":0000
         Column(2)       =   "vpnVRD_CompInfo_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRD_CompInfo_admi.ctx":016C
         FormatStyle(2)  =   "vpnVRD_CompInfo_admi.ctx":02C8
         FormatStyle(3)  =   "vpnVRD_CompInfo_admi.ctx":0378
         FormatStyle(4)  =   "vpnVRD_CompInfo_admi.ctx":042C
         FormatStyle(5)  =   "vpnVRD_CompInfo_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRD_CompInfo_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRD_CompInfo_admi"
