...
Begin VB.UserControl vpnVRDDocType_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDDocType 
      ...
      Begin GridEX20.GridEX gridVRDDocType 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDDocType_.ctx":0000
         Column(2)       =   "vpnVRDDocType_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDDocType_.ctx":016C
         FormatStyle(2)  =   "vpnVRDDocType_.ctx":02C8
         FormatStyle(3)  =   "vpnVRDDocType_.ctx":0378
         FormatStyle(4)  =   "vpnVRDDocType_.ctx":042C
         FormatStyle(5)  =   "vpnVRDDocType_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDDocType_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDDocType_"
