...
Begin VB.UserControl vpnVRDPrjType_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDPrjType 
      ...
      Begin GridEX20.GridEX gridVRDPrjType 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDPrjType_main.ctx":0000
         Column(2)       =   "vpnVRDPrjType_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDPrjType_main.ctx":016C
         FormatStyle(2)  =   "vpnVRDPrjType_main.ctx":02C8
         FormatStyle(3)  =   "vpnVRDPrjType_main.ctx":0378
         FormatStyle(4)  =   "vpnVRDPrjType_main.ctx":042C
         FormatStyle(5)  =   "vpnVRDPrjType_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDPrjType_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDPrjType_main"
