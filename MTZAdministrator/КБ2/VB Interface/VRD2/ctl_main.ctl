...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin VRD2GUI.vpnVRDMarket_ pnlVRDMarket 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDInterest_ pnlVRDInterest 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDStream_ pnlVRDStream 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDContractStage_ pnlVRDContractStage 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDLoyalty_ pnlVRDLoyalty 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDDocType_ pnlVRDDocType 
      Height          =   1500
      Left            =   1500
      TabIndex        =   6
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDPrjType_ pnlVRDPrjType 
      Height          =   1500
      Left            =   3000
      TabIndex        =   7
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDRreportType_ pnlVRDRreportType 
      Height          =   1500
      Left            =   4500
      TabIndex        =   8
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRD_CompInfo_ pnlVRD_CompInfo 
      Height          =   1500
      Left            =   6000
      TabIndex        =   9
      Top             =   1500
