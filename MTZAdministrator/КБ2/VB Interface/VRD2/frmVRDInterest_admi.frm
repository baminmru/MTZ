VERSION 5.00
Begin VB.Form frmVRDInterest_admi 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Заинтересованность"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Заинтересованность"
      Top             =   6225
      Width           =   825
   End
   Begin VRD2GUI.VRDInterestadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRDInterest_admi"
