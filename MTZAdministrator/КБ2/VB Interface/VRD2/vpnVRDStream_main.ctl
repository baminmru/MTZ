...
Begin VB.UserControl vpnVRDStream_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerVRDStream 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlVRDStream 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdVRDStreamAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdVRDStreamAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridVRDStream 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDStream_main.ctx":0000
         Column(2)       =   "vpnVRDStream_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDStream_main.ctx":016C
         FormatStyle(2)  =   "vpnVRDStream_main.ctx":02C8
         FormatStyle(3)  =   "vpnVRDStream_main.ctx":0378
         FormatStyle(4)  =   "vpnVRDStream_main.ctx":042C
         FormatStyle(5)  =   "vpnVRDStream_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDStream_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdVRDStreamRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupVRDStream 
      Caption         =   "Меню для Направление деятельности"
      Visible         =   0   'False
      Begin VB.Menu mnuVRDStreamAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuVRDStreamEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuVRDStreamDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuVRDStreamOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuVRDStreamRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuVRDStreamS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuVRDStreamBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuVRDStreamCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuVRDStreamCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuVRDStreamPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuVRDStreamCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuVRDStreamCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuVRDStreamPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuVRDStreamCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuVRDStreamFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuVRDStreamAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnVRDStream_main"
