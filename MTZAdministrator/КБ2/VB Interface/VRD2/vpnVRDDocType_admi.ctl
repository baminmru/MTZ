...
Begin VB.UserControl vpnVRDDocType_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDDocType 
      ...
      Begin GridEX20.GridEX gridVRDDocType 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDDocType_admi.ctx":0000
         Column(2)       =   "vpnVRDDocType_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDDocType_admi.ctx":016C
         FormatStyle(2)  =   "vpnVRDDocType_admi.ctx":02C8
         FormatStyle(3)  =   "vpnVRDDocType_admi.ctx":0378
         FormatStyle(4)  =   "vpnVRDDocType_admi.ctx":042C
         FormatStyle(5)  =   "vpnVRDDocType_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDDocType_admi.ctx":05BC
      End
   ...
   Begin VB.Menu mnuPopupVRDDocType 
      Caption         =   "Меню для Тип документа"
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "vpnVRDDocType_admi"
