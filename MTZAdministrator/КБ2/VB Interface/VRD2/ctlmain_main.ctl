...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin VRD2GUI.vpnVRDMarket_main pnlVRDMarket 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDInterest_main pnlVRDInterest 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDStream_main pnlVRDStream 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDContractStage_main pnlVRDContractStage 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDLoyalty_main pnlVRDLoyalty 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDDocType_main pnlVRDDocType 
      Height          =   1500
      Left            =   1500
      TabIndex        =   6
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDPrjType_main pnlVRDPrjType 
      Height          =   1500
      Left            =   3000
      TabIndex        =   7
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRDRreportType_main pnlVRDRreportType 
      Height          =   1500
      Left            =   4500
      TabIndex        =   8
      Top             =   1500
      ...
      _ExtentY        =   2646
   End
   Begin VRD2GUI.vpnVRD_CompInfo_main pnlVRD_CompInfo 
      Height          =   1500
      Left            =   6000
      TabIndex        =   9
      Top             =   1500
