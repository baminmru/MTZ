...
Begin VB.UserControl vpnVRDInterest_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDInterest 
      ...
      Begin GridEX20.GridEX gridVRDInterest 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDInterest_admi.ctx":0000
         Column(2)       =   "vpnVRDInterest_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDInterest_admi.ctx":016C
         FormatStyle(2)  =   "vpnVRDInterest_admi.ctx":02C8
         FormatStyle(3)  =   "vpnVRDInterest_admi.ctx":0378
         FormatStyle(4)  =   "vpnVRDInterest_admi.ctx":042C
         FormatStyle(5)  =   "vpnVRDInterest_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDInterest_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDInterest_admi"
