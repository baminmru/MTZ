...
Begin VB.UserControl vpnVRDContractStage_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDContractStage 
      ...
      Begin GridEX20.GridEX gridVRDContractStage 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDContractStage_.ctx":0000
         Column(2)       =   "vpnVRDContractStage_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDContractStage_.ctx":016C
         FormatStyle(2)  =   "vpnVRDContractStage_.ctx":02C8
         FormatStyle(3)  =   "vpnVRDContractStage_.ctx":0378
         FormatStyle(4)  =   "vpnVRDContractStage_.ctx":042C
         FormatStyle(5)  =   "vpnVRDContractStage_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDContractStage_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDContractStage_"
