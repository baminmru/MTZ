VERSION 5.00
Object = "{DA85CE39-310B-4FC0-9879-9A429319CCBE}#1.0#0"; "J2JournalExtender.ocx"
Begin VB.UserControl vpnVRC_DOGS_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRC_DOGS 
      ...
      Top             =   0
      Width           =   9000
      Begin J2JournalExtender.JournalViewEx editVRC_DOGS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnVRC_DOGS_main"
