...
Begin VB.UserControl vpnVRCTarif_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRCTarif 
      ...
      Begin GridEX20.GridEX gridVRCTarif 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRCTarif_.ctx":0000
         Column(2)       =   "vpnVRCTarif_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRCTarif_.ctx":016C
         FormatStyle(2)  =   "vpnVRCTarif_.ctx":02C8
         FormatStyle(3)  =   "vpnVRCTarif_.ctx":0378
         FormatStyle(4)  =   "vpnVRCTarif_.ctx":042C
         FormatStyle(5)  =   "vpnVRCTarif_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRCTarif_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRCTarif_"
