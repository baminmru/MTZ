...
Begin VB.UserControl vpnVRCTarif_ur 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRCTarif 
      ...
      Begin GridEX20.GridEX gridVRCTarif 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRCTarif_ur.ctx":0000
         Column(2)       =   "vpnVRCTarif_ur.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRCTarif_ur.ctx":016C
         FormatStyle(2)  =   "vpnVRCTarif_ur.ctx":02C8
         FormatStyle(3)  =   "vpnVRCTarif_ur.ctx":0378
         FormatStyle(4)  =   "vpnVRCTarif_ur.ctx":042C
         FormatStyle(5)  =   "vpnVRCTarif_ur.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRCTarif_ur.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRCTarif_ur"
