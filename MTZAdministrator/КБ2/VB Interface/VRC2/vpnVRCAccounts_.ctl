...
Begin VB.UserControl vpnVRCAccounts_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRCAccounts 
      ...
      Begin GridEX20.GridEX gridVRCAccounts 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRCAccounts_.ctx":0000
         Column(2)       =   "vpnVRCAccounts_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRCAccounts_.ctx":016C
         FormatStyle(2)  =   "vpnVRCAccounts_.ctx":02C8
         FormatStyle(3)  =   "vpnVRCAccounts_.ctx":0378
         FormatStyle(4)  =   "vpnVRCAccounts_.ctx":042C
         FormatStyle(5)  =   "vpnVRCAccounts_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRCAccounts_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRCAccounts_"
