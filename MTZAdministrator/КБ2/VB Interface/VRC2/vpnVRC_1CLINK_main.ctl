...
Begin VB.UserControl vpnVRC_1CLINK_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRC_1CLINK 
      ...
      Begin GridEX20.GridEX gridVRC_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRC_1CLINK_main.ctx":0000
         Column(2)       =   "vpnVRC_1CLINK_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRC_1CLINK_main.ctx":016C
         FormatStyle(2)  =   "vpnVRC_1CLINK_main.ctx":02C8
         FormatStyle(3)  =   "vpnVRC_1CLINK_main.ctx":0378
         FormatStyle(4)  =   "vpnVRC_1CLINK_main.ctx":042C
         FormatStyle(5)  =   "vpnVRC_1CLINK_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRC_1CLINK_main.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnVRC_1CLINK_main"
...
If gridVRC_1CLINK.Row > 0 Then
 If gridVRC_1CLINK.RowIndex(gridVRC_1CLINK.Row) > 0 Then
    ...
    bm = gridVRC_1CLINK.RowBookmark(gridVRC_1CLINK.RowIndex(gridVRC_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmVRC_1CLINK_main.item = u
again:     frmVRC_1CLINK_main.NotFirstTime = False
    frmVRC_1CLINK_main.OnInit
    frmVRC_1CLINK_main.Show vbModal
    If frmVRC_1CLINK_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
