...
Begin VB.UserControl vpnVRRPT_COSTS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRRPT_COSTS 
      ...
      Begin GridEX20.GridEX gridVRRPT_COSTS 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRRPT_COSTS_.ctx":0000
         Column(2)       =   "vpnVRRPT_COSTS_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRRPT_COSTS_.ctx":016C
         FormatStyle(2)  =   "vpnVRRPT_COSTS_.ctx":02C8
         FormatStyle(3)  =   "vpnVRRPT_COSTS_.ctx":0378
         FormatStyle(4)  =   "vpnVRRPT_COSTS_.ctx":042C
         FormatStyle(5)  =   "vpnVRRPT_COSTS_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRRPT_COSTS_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRRPT_COSTS_"
