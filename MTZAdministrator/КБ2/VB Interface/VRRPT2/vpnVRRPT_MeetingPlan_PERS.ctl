...
Begin VB.UserControl vpnVRRPT_MeetingPlan_PERS 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlVRRPT_MeetingPlan 
      ...
      Begin GridEX20.GridEX gridVRRPT_Meeters 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRRPT_MeetingPlan_PERS.ctx":0000
         Column(2)       =   "vpnVRRPT_MeetingPlan_PERS.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":016C
         FormatStyle(2)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":02C8
         FormatStyle(3)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0378
         FormatStyle(4)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":042C
         FormatStyle(5)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRRPT_MeetingPlan_PERS.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridVRRPT_MeetingPlan 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRRPT_MeetingPlan_PERS.ctx":0794
         Column(2)       =   "vpnVRRPT_MeetingPlan_PERS.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0900
         FormatStyle(2)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0A5C
         FormatStyle(3)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0B0C
         FormatStyle(4)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0BC0
         FormatStyle(5)  =   "vpnVRRPT_MeetingPlan_PERS.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnVRRPT_MeetingPlan_PERS.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnVRRPT_MeetingPlan_PERS"
