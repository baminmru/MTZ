...
Begin VB.UserControl VRRPT_MeetingPlanPERS 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   End
End
Attribute VB_Name = "VRRPT_MeetingPlanPERS"
