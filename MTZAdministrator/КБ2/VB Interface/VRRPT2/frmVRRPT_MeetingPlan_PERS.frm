VERSION 5.00
Begin VB.Form frmVRRPT_MeetingPlan_PERS 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Планируемые встречи"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Планируемые встречи"
      Top             =   6225
      Width           =   825
   End
   Begin VRRPT2GUI.VRRPT_MeetingPlanPERS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRRPT_MeetingPlan_PERS"
