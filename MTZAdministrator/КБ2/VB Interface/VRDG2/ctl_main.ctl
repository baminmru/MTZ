...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin VRDG2GUI.vpnVRDGCommon_ pnlVRDGCommon 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRDG2GUI.vpnVRDGContractVersion_ pnlVRDGContractVersion 
      Height          =   1500
      Left            =   4500
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRDG2GUI.vpnVRDGContractChanges_ pnlVRDGContractChanges 
      Height          =   1500
      Left            =   6000
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRDG2GUI.vpnVRDGContractSpesial_ pnlVRDGContractSpesial 
      Height          =   1500
      Left            =   0
      TabIndex        =   4
      Top             =   1500
