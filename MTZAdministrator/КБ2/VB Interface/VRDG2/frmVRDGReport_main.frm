VERSION 5.00
Begin VB.Form frmVRDGReport_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin VRDG2GUI.VRDGReportmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRDGReport_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{01070CD4-9E8E-4903-8531-4D91B17F908A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{01070CD4-9E8E-4903-8531-4D91B17F908A}"
  Open s & Me.Name & "{01070CD4-9E8E-4903-8531-4D91B17F908A}" For Output As #ff
