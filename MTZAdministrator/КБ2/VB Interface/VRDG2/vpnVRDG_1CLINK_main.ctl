...
Begin VB.UserControl vpnVRDG_1CLINK_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDG_1CLINK 
      ...
      Begin GridEX20.GridEX gridVRDG_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDG_1CLINK_main.ctx":0000
         Column(2)       =   "vpnVRDG_1CLINK_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDG_1CLINK_main.ctx":016C
         FormatStyle(2)  =   "vpnVRDG_1CLINK_main.ctx":02C8
         FormatStyle(3)  =   "vpnVRDG_1CLINK_main.ctx":0378
         FormatStyle(4)  =   "vpnVRDG_1CLINK_main.ctx":042C
         FormatStyle(5)  =   "vpnVRDG_1CLINK_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDG_1CLINK_main.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnVRDG_1CLINK_main"
...
If gridVRDG_1CLINK.Row > 0 Then
 If gridVRDG_1CLINK.RowIndex(gridVRDG_1CLINK.Row) > 0 Then
    ...
    bm = gridVRDG_1CLINK.RowBookmark(gridVRDG_1CLINK.RowIndex(gridVRDG_1CLINK.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmVRDG_1CLINK_main.Item = u
again:     frmVRDG_1CLINK_main.NotFirstTime = False
    frmVRDG_1CLINK_main.OnInit
    frmVRDG_1CLINK_main.Show vbModal
    If frmVRDG_1CLINK_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
