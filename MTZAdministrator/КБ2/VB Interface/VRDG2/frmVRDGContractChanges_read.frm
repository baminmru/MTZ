VERSION 5.00
Begin VB.Form frmVRDGContractChanges_read 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Дополнительные соглашения"
      Top             =   6225
      Width           =   825
   End
   Begin VRDG2GUI.VRDGContractChangesread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRDGContractChanges_read"
