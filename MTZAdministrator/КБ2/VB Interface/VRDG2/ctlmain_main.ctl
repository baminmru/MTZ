...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin VRDG2GUI.vpnVRDGCommon_main pnlVRDGCommon 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRDG2GUI.vpnVRDGContractVersion_main pnlVRDGContractVersion 
      Height          =   1500
      Left            =   4500
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRDG2GUI.vpnVRDGContractChanges_main pnlVRDGContractChanges 
      Height          =   1500
      Left            =   6000
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin VRDG2GUI.vpnVRDGContractSpesial_main pnlVRDGContractSpesial 
      Height          =   1500
      Left            =   0
      TabIndex        =   4
      Top             =   1500
