...
Begin VB.UserControl vpnVRDGContractSpesial_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDGContractSpesial 
      ...
      Begin GridEX20.GridEX gridVRDGContractSpesial 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDGContractSpesial_.ctx":0000
         Column(2)       =   "vpnVRDGContractSpesial_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDGContractSpesial_.ctx":016C
         FormatStyle(2)  =   "vpnVRDGContractSpesial_.ctx":02C8
         FormatStyle(3)  =   "vpnVRDGContractSpesial_.ctx":0378
         FormatStyle(4)  =   "vpnVRDGContractSpesial_.ctx":042C
         FormatStyle(5)  =   "vpnVRDGContractSpesial_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDGContractSpesial_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDGContractSpesial_"
