...
Begin VB.UserControl vpnVRDGContractChanges_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDGContractChanges 
      ...
      Begin GridEX20.GridEX gridVRDGContractChanges 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDGContractChanges_.ctx":0000
         Column(2)       =   "vpnVRDGContractChanges_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDGContractChanges_.ctx":016C
         FormatStyle(2)  =   "vpnVRDGContractChanges_.ctx":02C8
         FormatStyle(3)  =   "vpnVRDGContractChanges_.ctx":0378
         FormatStyle(4)  =   "vpnVRDGContractChanges_.ctx":042C
         FormatStyle(5)  =   "vpnVRDGContractChanges_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDGContractChanges_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnVRDGContractChanges_"
