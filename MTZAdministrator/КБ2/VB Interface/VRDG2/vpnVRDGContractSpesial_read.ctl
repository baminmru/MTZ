...
Begin VB.UserControl vpnVRDGContractSpesial_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlVRDGContractSpesial 
      ...
      Begin GridEX20.GridEX gridVRDGContractSpesial 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnVRDGContractSpesial_read.ctx":0000
         Column(2)       =   "vpnVRDGContractSpesial_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnVRDGContractSpesial_read.ctx":016C
         FormatStyle(2)  =   "vpnVRDGContractSpesial_read.ctx":02C8
         FormatStyle(3)  =   "vpnVRDGContractSpesial_read.ctx":0378
         FormatStyle(4)  =   "vpnVRDGContractSpesial_read.ctx":042C
         FormatStyle(5)  =   "vpnVRDGContractSpesial_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnVRDGContractSpesial_read.ctx":05BC
      End
   ...
   Begin VB.Menu mnuPopupVRDGContractSpesial 
      Caption         =   "Меню для Специальные условие"
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "vpnVRDGContractSpesial_read"
