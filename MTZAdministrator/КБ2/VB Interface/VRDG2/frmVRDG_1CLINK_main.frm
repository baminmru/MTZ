VERSION 5.00
Begin VB.Form frmVRDG_1CLINK_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin VRDG2GUI.VRDG_1CLINKmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRDG_1CLINK_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{FA5102F1-3CB4-4977-A309-8A1CCF67B041}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{FA5102F1-3CB4-4977-A309-8A1CCF67B041}"
  Open s & Me.Name & "{FA5102F1-3CB4-4977-A309-8A1CCF67B041}" For Output As #ff
