VERSION 5.00
Begin VB.Form frmVRDGContractVersion_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Версия договора"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Версия договора"
      Top             =   6225
      Width           =   825
   End
   Begin VRDG2GUI.VRDGContractVersionread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVRDGContractVersion_read"
