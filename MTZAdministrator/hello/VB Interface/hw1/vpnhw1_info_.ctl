...
Begin VB.UserControl vpnhw1_info_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlhw1_info 
      ...
      Begin GridEX20.GridEX gridhw1_info 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnhw1_info_.ctx":0000
         Column(2)       =   "vpnhw1_info_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnhw1_info_.ctx":016C
         FormatStyle(2)  =   "vpnhw1_info_.ctx":02C8
         FormatStyle(3)  =   "vpnhw1_info_.ctx":0378
         FormatStyle(4)  =   "vpnhw1_info_.ctx":042C
         FormatStyle(5)  =   "vpnhw1_info_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnhw1_info_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnhw1_info_"
...
If gridhw1_info.Row > 0 Then
 If gridhw1_info.RowIndex(gridhw1_info.Row) > 0 Then
    ...
    bm = gridhw1_info.RowBookmark(gridhw1_info.RowIndex(gridhw1_info.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmhw1_info_.Item = u
again:     frmhw1_info_.NotFirstTime = False
    frmhw1_info_.OnInit
    frmhw1_info_.Show vbModal
    If frmhw1_info_.OK Then
    On Error Resume Next
    err.Clear
    u.Save
