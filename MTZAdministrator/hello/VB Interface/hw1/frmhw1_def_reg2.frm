...
Begin VB.Form frmhw1_def_reg2 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin hw1GUI.hw1_defreg2 Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmhw1_def_reg2"
...
' Форма редактирования раздела hw1_def режим reg2
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{61E081EE-782F-4E2F-AF43-6B220193DD3F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{61E081EE-782F-4E2F-AF43-6B220193DD3F}"
  Open s & Me.Name & "{61E081EE-782F-4E2F-AF43-6B220193DD3F}" For Output As #ff
