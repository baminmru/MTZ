...
Begin VB.UserControl vpnhw1_info_reg1 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlhw1_info 
      ...
      Begin GridEX20.GridEX gridhw1_info 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnhw1_info_reg1.ctx":0000
         Column(2)       =   "vpnhw1_info_reg1.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnhw1_info_reg1.ctx":016C
         FormatStyle(2)  =   "vpnhw1_info_reg1.ctx":02C8
         FormatStyle(3)  =   "vpnhw1_info_reg1.ctx":0378
         FormatStyle(4)  =   "vpnhw1_info_reg1.ctx":042C
         FormatStyle(5)  =   "vpnhw1_info_reg1.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnhw1_info_reg1.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnhw1_info_reg1"
...
If gridhw1_info.Row > 0 Then
 If gridhw1_info.RowIndex(gridhw1_info.Row) > 0 Then
    ...
    bm = gridhw1_info.RowBookmark(gridhw1_info.RowIndex(gridhw1_info.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmhw1_info_reg1.Item = u
again:     frmhw1_info_reg1.NotFirstTime = False
    frmhw1_info_reg1.OnInit
    frmhw1_info_reg1.Show vbModal
    If frmhw1_info_reg1.OK Then
    On Error Resume Next
    err.Clear
    u.Save
...
again:       frmhw1_info_reg1.NotFirstTime = False
      ...
      If frmhw1_info_reg1.OK Then
        ...
        gridhw1_info.ItemCount = Item.hw1_info.Count
        gridhw1_info.Refresh
        gridhw1_info.RefreshGroups
        gridhw1_info.RefreshSort
        gridhw1_info.MoveToBookmark u.ID & "hw1_info"
      Else
        Item.hw1_info.Delete u.ID
        Item.hw1_info.Remove u.ID
      End If
      Exit Sub
bye:
   MsgBox err.Description, vbOKOnly + vbExclamation, "Создание"
...
Private Sub gridhw1_info_BeforeDeleteEX(ByVal RowIndex As Long, ByVal Bookmark As Variant, ByVal Cancel As GridEX20.JSRetBoolean)
  If gridhw1_info.ItemCount = 0 Then Exit Sub
  Dim u As Object
  Set u = Item.FindRowObject("hw1_info", Left(Bookmark, 38))
