...
Begin VB.UserControl ctlreg3_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin hw1GUI.vpnhw1_def_reg3 pnlhw1_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
   ...
   End
End
Attribute VB_Name = "ctlreg3_main"
...
' Главный контрольный элемент для редактирования документа режим reg3
...
pnlhw1_def.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "hw1", "ctlreg3_main"
