VERSION 5.00
Begin VB.Form frmhw1_info_reg2 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin hw1GUI.hw1_inforeg2 Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmhw1_info_reg2"
...
' Форма редактирования раздела hw1_info режим reg2
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E0143026-F5CF-4D34-A58B-DBEC11A9BA56}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E0143026-F5CF-4D34-A58B-DBEC11A9BA56}"
  Open s & Me.Name & "{E0143026-F5CF-4D34-A58B-DBEC11A9BA56}" For Output As #ff
