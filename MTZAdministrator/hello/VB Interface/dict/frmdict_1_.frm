...
' Форма редактирования раздела dict_1 режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{17C81196-644D-41FD-ABB3-4CAFA8206D65}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{17C81196-644D-41FD-ABB3-4CAFA8206D65}"
  Open s & Me.Name & "{17C81196-644D-41FD-ABB3-4CAFA8206D65}" For Output As #ff
