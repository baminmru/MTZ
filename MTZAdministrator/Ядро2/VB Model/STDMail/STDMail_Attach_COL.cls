...
END
Attribute VB_Name = "STDMail_Attach_COL"
...
Friend Property Set Application(newApplication As Object)
  ...
  m_Application.Logger.Message "STDMail_Attach.Init"
End Property
...
'Returns:
'  объект класса  STDMail_Attach
'  ,или Nothing
'See Also:
'Example:
' dim variable as  STDMail_Attach
' Set variable = me.Add(...параметры...)
Public Function Add(Optional ID As String = "") As STDMail_Attach
 Dim LID As String
 Dim o As STDMail_Attach
 If ID = "" Then
   LID = CreateGUID2()
 Else
   LID = Left(ID, 38)
...
Public Function Item(ByVal ID As Variant) As STDMail_Attach
...
Public Function GetEQ(ByVal Value As Variant) As STDMail_Attach
...
Public Function GetLE(ByVal Value As Variant) As STDMail_Attach
...
Public Function GetLT(ByVal Value As Variant) As STDMail_Attach
...
Public Function GetGE(ByVal Value As Variant) As STDMail_Attach
...
Public Function GetGT(ByVal Value As Variant) As STDMail_Attach
 ...
 Dim o As STDMail_Attach
    For i = 1 To mcol.Count
       Set o = mcol.Item(i)
        o.CloseClass
    Next
 If Not Application Is Nothing Then Application.Logger.Message "STDMail_Attach.CloseClass"
 CloseParents
 Set mcol = Nothing
End Sub
...
Public Sub XMLSave(ByRef ParentNode As IXMLDOMElement, Xdom As DOMDocument)
  ...
  Set pnode = Xdom.createElement("STDMAIL_ATTACH_COL")
  pnode.setAttribute "IsLocked", m_IsLocked
  Dim node As IXMLDOMElement
  ParentNode.appendChild pnode
  For i = 1 To Count
    Set o = Item(i)
    Set node = Xdom.createElement("STDMAIL_ATTACH")
...
Public Sub XMLLoad(ByRef NodeList As IXMLDOMNodeList, Optional ByVal LoadMode As Integer = 0)
  ...
  Set NodeList = pnode.selectNodes("STDMAIL_ATTACH")
...
YGrid.Columns.Clear
  YGrid.Columns.Add("Название", 0, 0, "TheName").SortType = 1
  YGrid.Columns.Add("Файл", 0, 0, "TheFile").SortType = 1
...
Public Sub LoadRow(YGrid As Object, ByVal RowIndex As Long, ByVal Bookmark As Variant, Values)
 Dim obj As STDMail_Attach
  If RowIndex > 0 And RowIndex <= Count Then
    ...
    On Error Resume Next
    Values.Value(1) = Left(Replace(obj.TheName, vbCrLf, " "), 255)
    Values.Value(2) = "-файл-"
   YGrid.RowBookmark(RowIndex) = obj.ID & "STDMail_Attach"
  End If 'RowIndex
End Sub
