VERSION 5.00
Begin VB.Form frmMTZExtRel_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Реализации расширения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Реализации расширения для разных разработческих плаформ"
      Top             =   6225
      Width           =   825
   End
   Begin MTZExtGUI.MTZExtRel Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMTZExtRel_"
...
' Форма редактирования раздела MTZExtRel режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E48FE6DD-79F9-4D42-BAC3-CB39F69171BC}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E48FE6DD-79F9-4D42-BAC3-CB39F69171BC}"
  Open s & Me.Name & "{E48FE6DD-79F9-4D42-BAC3-CB39F69171BC}" For Output As #ff
