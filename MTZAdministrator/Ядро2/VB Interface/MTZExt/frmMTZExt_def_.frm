...
Begin VB.Form frmMTZExt_def_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Список зарегистрированных расширений"
      Top             =   6225
      Width           =   825
   End
   Begin MTZExtGUI.MTZExt_def Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMTZExt_def_"
...
' Форма редактирования раздела MTZExt_def режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{7F62144A-8576-48BC-ACBA-1F9DC4874459}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{7F62144A-8576-48BC-ACBA-1F9DC4874459}"
  Open s & Me.Name & "{7F62144A-8576-48BC-ACBA-1F9DC4874459}" For Output As #ff
