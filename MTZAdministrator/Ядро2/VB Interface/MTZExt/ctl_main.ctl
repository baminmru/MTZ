...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZExtGUI.vpnMTZExt_def_ pnlMTZExt_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZExtGUI.vpnMTZExtRel_ pnlMTZExtRel 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlMTZExt_def.IsOK
If IsItOk Then IsItOk = pnlMTZExtRel.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlMTZExtRel.Visible = False
  pnlMTZExt_def.Visible = False
   ...
   Case "MTZExt_def"
     ...
     .Visible = True
     .ZOrder 0
     pnlMTZExt_def.OnClick Item, ParentForm
     End With
   Case "MTZExtRel"
     With pnlMTZExtRel
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlMTZExtRel.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "MTZExt_def"
pnlMTZExt_def.OnInit Item, ParentForm
Call ts.Tabs.Add(, "MTZExtRel", "Реализации расширения")
pnlMTZExtRel.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZExt", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlMTZExt_def.CloseClass
 pnlMTZExtRel.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlMTZExt_def.IsChanged
m_IsChanged = m_IsChanged Or pnlMTZExtRel.IsChanged
