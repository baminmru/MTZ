...
If Name = "STDMail_Info" Then
 Set FormByName = New frmSTDMail_Info_
 Exit Function
End If

If Name = "STDMail_Attach" Then
 Set FormByName = New frmSTDMail_Attach_
 Exit Function
End If

If Name = "STDMail_To" Then
 Set FormByName = New frmSTDMail_To_
 Exit Function
End If
