VERSION 5.00
Begin VB.Form frmSTDMail_Info_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDMailGUI.STDMail_Info Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDMail_Info_"
...
' Форма редактирования раздела STDMail_Info режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{6CB96585-E541-42BF-B2E0-86C2B0E7B136}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{6CB96585-E541-42BF-B2E0-86C2B0E7B136}"
  Open s & Me.Name & "{6CB96585-E541-42BF-B2E0-86C2B0E7B136}" For Output As #ff
