VERSION 5.00
Begin VB.Form frmSTDMail_Attach_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDMailGUI.STDMail_Attach Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDMail_Attach_"
...
' Форма редактирования раздела STDMail_Attach режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{6347D8FE-AD4B-46A3-AEFF-56DCAF62A66F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{6347D8FE-AD4B-46A3-AEFF-56DCAF62A66F}"
  Open s & Me.Name & "{6347D8FE-AD4B-46A3-AEFF-56DCAF62A66F}" For Output As #ff
