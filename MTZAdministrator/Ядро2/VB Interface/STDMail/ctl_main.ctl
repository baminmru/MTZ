...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin STDMailGUI.vpnSTDMail_Info_ pnlSTDMail_Info 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin STDMailGUI.vpnSTDMail_Attach_ pnlSTDMail_Attach 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin STDMailGUI.vpnSTDMail_To_ pnlSTDMail_To 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
If IsItOk Then IsItOk = pnlSTDMail_Info.IsOK
If IsItOk Then IsItOk = pnlSTDMail_Attach.IsOK
If IsItOk Then IsItOk = pnlSTDMail_To.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlSTDMail_To.Visible = False
  pnlSTDMail_Attach.Visible = False
  pnlSTDMail_Info.Visible = False

   Select Case ts.SelectedItem.Key
   Case "STDMail_Info"
     With pnlSTDMail_Info
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     ...
     .Visible = True
     .ZOrder 0
     pnlSTDMail_Info.OnClick Item, ParentForm
     End With
   Case "STDMail_Attach"
     With pnlSTDMail_Attach
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlSTDMail_Attach.OnClick Item, ParentForm
     End With
   Case "STDMail_To"
     With pnlSTDMail_To
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlSTDMail_To.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Сообщение"
ts.Tabs.Item(1).Key = "STDMail_Info"
pnlSTDMail_Info.OnInit Item, ParentForm
Call ts.Tabs.Add(, "STDMail_Attach", "Вложения")
pnlSTDMail_Attach.OnInit Item, ParentForm
Call ts.Tabs.Add(, "STDMail_To", "Адресаты")
pnlSTDMail_To.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "STDMail", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlSTDMail_Info.CloseClass
 pnlSTDMail_Attach.CloseClass
 pnlSTDMail_To.CloseClass
End Sub
...
'  call me.OnSave()
Public Sub OnSave()
 pnlSTDMail_Info.OnSave
 pnlSTDMail_Attach.OnSave
 pnlSTDMail_To.OnSave
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlSTDMail_Info.IsChanged
m_IsChanged = m_IsChanged Or pnlSTDMail_Attach.IsChanged
m_IsChanged = m_IsChanged Or pnlSTDMail_To.IsChanged
