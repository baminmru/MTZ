...
Begin VB.Form frmSTDMail_To_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDMailGUI.STDMail_To Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDMail_To_"
...
' Форма редактирования раздела STDMail_To режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{182FA5F6-FDC8-4939-80DC-23879D405B41}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{182FA5F6-FDC8-4939-80DC-23879D405B41}"
  Open s & Me.Name & "{182FA5F6-FDC8-4939-80DC-23879D405B41}" For Output As #ff
