...
Begin VB.Form frmARMJRNLADD_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Варианты обработки добавления"
      Top             =   6225
      Width           =   825
   End
   Begin MTZwpGUI.ARMJRNLADD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmARMJRNLADD_"
...
' Форма редактирования раздела ARMJRNLADD режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F837ABED-CAE9-430A-9DEE-519DBB1B79D5}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F837ABED-CAE9-430A-9DEE-519DBB1B79D5}"
  Open s & Me.Name & "{F837ABED-CAE9-430A-9DEE-519DBB1B79D5}" For Output As #ff
