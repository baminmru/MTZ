...
Begin VB.Form frmARMJRNLREP_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Отчеты из журнала"
      Top             =   6225
      Width           =   825
   End
   Begin MTZwpGUI.ARMJRNLREP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmARMJRNLREP_"
...
' Форма редактирования раздела ARMJRNLREP режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C2763400-BE34-4033-B4B5-756CD5252CEA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C2763400-BE34-4033-B4B5-756CD5252CEA}"
  Open s & Me.Name & "{C2763400-BE34-4033-B4B5-756CD5252CEA}" For Output As #ff
