VERSION 5.00
Begin VB.Form frmEPFilterLink_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Привязка фильтра"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Привязка фильтра к журналу"
      Top             =   6225
      Width           =   825
   End
   Begin MTZwpGUI.EPFilterLink Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmEPFilterLink_"
...
' Форма редактирования раздела EPFilterLink режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D407359F-2204-4969-9789-956215E456E6}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D407359F-2204-4969-9789-956215E456E6}"
  Open s & Me.Name & "{D407359F-2204-4969-9789-956215E456E6}" For Output As #ff
