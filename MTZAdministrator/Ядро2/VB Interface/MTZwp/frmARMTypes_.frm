...
Begin VB.Form frmARMTypes_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Типы документов, которые подключаются в MDI режиме"
      Top             =   6225
      Width           =   825
   End
   Begin MTZwpGUI.ARMTypes Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmARMTypes_"
...
' Форма редактирования раздела ARMTypes режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{30F737CE-1C81-4672-B0F9-6E5BF4B15971}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{30F737CE-1C81-4672-B0F9-6E5BF4B15971}"
  Open s & Me.Name & "{30F737CE-1C81-4672-B0F9-6E5BF4B15971}" For Output As #ff
