...
Begin VB.Form frmEntryPoints_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZwpGUI.EntryPoints Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmEntryPoints_"
...
' Форма редактирования раздела EntryPoints режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{EF4EDE2C-458B-4EAB-AFE3-66AA500081DA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{EF4EDE2C-458B-4EAB-AFE3-66AA500081DA}"
  Open s & Me.Name & "{EF4EDE2C-458B-4EAB-AFE3-66AA500081DA}" For Output As #ff
