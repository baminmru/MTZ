...
Begin VB.Form frmWorkPlace_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZwpGUI.WorkPlace Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWorkPlace_"
...
' Форма редактирования раздела WorkPlace режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{973921C4-4926-4C9D-A781-6062CF81B5AD}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{973921C4-4926-4C9D-A781-6062CF81B5AD}"
  Open s & Me.Name & "{973921C4-4926-4C9D-A781-6062CF81B5AD}" For Output As #ff
