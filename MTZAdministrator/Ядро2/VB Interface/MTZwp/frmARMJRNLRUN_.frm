...
Begin VB.Form frmARMJRNLRUN_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Дополнительные действия в журнале"
      Top             =   6225
      Width           =   825
   End
   Begin MTZwpGUI.ARMJRNLRUN Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmARMJRNLRUN_"
...
' Форма редактирования раздела ARMJRNLRUN режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4FE83181-00A5-4B59-9413-D06318A119D4}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4FE83181-00A5-4B59-9413-D06318A119D4}"
  Open s & Me.Name & "{4FE83181-00A5-4B59-9413-D06318A119D4}" For Output As #ff
