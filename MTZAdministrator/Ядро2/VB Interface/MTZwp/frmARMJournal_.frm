VERSION 5.00
Begin VB.Form frmARMJournal_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Поведение журналов"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание действий журанлов"
      Top             =   6225
      Width           =   825
   End
   Begin MTZwpGUI.ARMJournal Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmARMJournal_"
...
' Форма редактирования раздела ARMJournal режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C41C0E05-8CF3-4B43-9D6E-C5FCD37BEB47}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C41C0E05-8CF3-4B43-9D6E-C5FCD37BEB47}"
  Open s & Me.Name & "{C41C0E05-8CF3-4B43-9D6E-C5FCD37BEB47}" For Output As #ff
