...
Begin VB.UserControl ARMJRNLADD 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
...
'панель редактирования раздела Варианты обработки добавления
...
If mIsOK Then mIsOK = txtTheExtention.Tag <> ""
  IsOK = mIsOK
End Function
