VERSION 5.00
Begin VB.Form frmSrvMessageInfo_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Суть сообщения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Суть сообщения"
      Top             =   6225
      Width           =   825
   End
   Begin MTZSrvMsgGUI.SrvMessageInfo Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSrvMessageInfo_"
...
' Форма редактирования раздела SrvMessageInfo режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{088013A0-4393-487A-B6F0-C4A0BBDAD98B}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{088013A0-4393-487A-B6F0-C4A0BBDAD98B}"
  Open s & Me.Name & "{088013A0-4393-487A-B6F0-C4A0BBDAD98B}" For Output As #ff
