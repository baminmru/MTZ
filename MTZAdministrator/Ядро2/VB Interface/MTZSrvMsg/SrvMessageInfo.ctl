...
'панель редактирования раздела Суть сообщения
...
Private Sub cmdTheDocument_CLick()
  On Error Resume Next
     If txtTheDocument.Tag = "" Then
       cmdTheDocument_MenuClick "Выбрать"
     Else
       cmdTheDocument_MenuClick "Открыть"
     End If
End Sub
...
End If
 LoadBtnPictures cmdTheDocument, cmdTheDocument.Tag
  ...
  cmdTheDocument.AddMenu "Очистить"
  cmdTheDocument.AddMenu "Создать"
  cmdTheDocument.AddMenu "Выбрать"
  cmdTheDocument.AddMenu "Открыть"
dtpReadTime = Now
