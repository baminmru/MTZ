...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZSrvMsgGUI.vpnSrvMessageInfo_ pnlSrvMessageInfo 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlSrvMessageInfo.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlSrvMessageInfo.Visible = False

   Select Case ts.SelectedItem.Key
   Case "SrvMessageInfo"
     With pnlSrvMessageInfo
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     ...
     .Visible = True
     .ZOrder 0
     pnlSrvMessageInfo.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Суть сообщения"
ts.Tabs.Item(1).Key = "SrvMessageInfo"
pnlSrvMessageInfo.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZSrvMsg", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlSrvMessageInfo.IsChanged
