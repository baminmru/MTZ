...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZRprtGUI.vpnReports_ pnlReports 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZRprtGUI.vpnRPTStruct_ pnlRPTStruct 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZRprtGUI.vpnRPTFormula_ pnlRPTFormula 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
If IsItOk Then IsItOk = pnlReports.IsOK
If IsItOk Then IsItOk = pnlRPTStruct.IsOK
If IsItOk Then IsItOk = pnlRPTFormula.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlRPTFormula.Visible = False
  pnlRPTStruct.Visible = False
  pnlReports.Visible = False
   ...
   Case "Reports"
     ...
     .Visible = True
     .ZOrder 0
     pnlReports.OnClick Item, ParentForm
     End With
   Case "RPTStruct"
     With pnlRPTStruct
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlRPTStruct.OnClick Item, ParentForm
     End With
   Case "RPTFormula"
     With pnlRPTFormula
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlRPTFormula.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "Reports"
pnlReports.OnInit Item, ParentForm
Call ts.Tabs.Add(, "RPTStruct", "Секции")
pnlRPTStruct.OnInit Item, ParentForm
Call ts.Tabs.Add(, "RPTFormula", "Формулы")
pnlRPTFormula.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZRprt", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlReports.CloseClass
 pnlRPTStruct.CloseClass
 pnlRPTFormula.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlReports.IsChanged
m_IsChanged = m_IsChanged Or pnlRPTStruct.IsChanged
m_IsChanged = m_IsChanged Or pnlRPTFormula.IsChanged
