...
If Name = "Reports" Then
 Set FormByName = New frmReports_
 Exit Function
End If

If Name = "RPTStruct" Then
 Set FormByName = New frmRPTStruct_
 Exit Function
End If

If Name = "RPTFields" Then
 Set FormByName = New frmRPTFields_
 Exit Function
End If

If Name = "RPTFormula" Then
 Set FormByName = New frmRPTFormula_
 Exit Function
End If
