...
Begin VB.Form frmRPTFormula_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZRprtGUI.RPTFormula Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRPTFormula_"
...
' Форма редактирования раздела RPTFormula режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E422132E-07F4-4C0F-8246-B0F16CD9186A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E422132E-07F4-4C0F-8246-B0F16CD9186A}"
  Open s & Me.Name & "{E422132E-07F4-4C0F-8246-B0F16CD9186A}" For Output As #ff
