...
Begin VB.Form frmReports_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZRprtGUI.Reports Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела Reports режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{259B3DFA-B8AC-4178-88FD-4B715D372FC3}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{259B3DFA-B8AC-4178-88FD-4B715D372FC3}"
  Open s & Me.Name & "{259B3DFA-B8AC-4178-88FD-4B715D372FC3}" For Output As #ff
