...
Begin VB.Form frmRPTStruct_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZRprtGUI.RPTStruct Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRPTStruct_"
...
' Форма редактирования раздела RPTStruct режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F5E8492A-2224-452F-85FF-A14882C6554F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F5E8492A-2224-452F-85FF-A14882C6554F}"
  Open s & Me.Name & "{F5E8492A-2224-452F-85FF-A14882C6554F}" For Output As #ff
