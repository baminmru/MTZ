...
Begin VB.Form frmRPTFields_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Поля секции"
      Top             =   6225
      Width           =   825
   End
   Begin MTZRprtGUI.RPTFields Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRPTFields_"
...
' Форма редактирования раздела RPTFields режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0C77D0DE-559E-43FC-B181-156E126543F1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0C77D0DE-559E-43FC-B181-156E126543F1}"
  Open s & Me.Name & "{0C77D0DE-559E-43FC-B181-156E126543F1}" For Output As #ff
