...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZ2JOBGUI.vpnMTZ2JOB_DEF_ pnlMTZ2JOB_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlMTZ2JOB_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlMTZ2JOB_DEF.Visible = False
   ...
   Case "MTZ2JOB_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlMTZ2JOB_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Отложенное событие"
ts.Tabs.Item(1).Key = "MTZ2JOB_DEF"
pnlMTZ2JOB_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZ2JOB", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlMTZ2JOB_DEF.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    i = 0
    i = i + 1
    m(i).Caption = "В обработку"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{F1C74700-26BE-4FB0-B439-29DAD7DA4F79}"
    i = i + 1
    m(i).Caption = "Активен"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{FFE96BE3-1E28-4EAD-A06B-4E45C8DBCD7C}"
    i = i + 1
    m(i).Caption = "Закрыт"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{549A314D-3D56-45C7-B895-5EF3816C3749}"
End Function
...
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{F1C74700-26BE-4FB0-B439-29DAD7DA4F79}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{549A314D-3D56-45C7-B895-5EF3816C3749}" Then
            m(i).Enabled = True
          End If
        Next
      End If
      If Item.Statusid = "{FFE96BE3-1E28-4EAD-A06B-4E45C8DBCD7C}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{549A314D-3D56-45C7-B895-5EF3816C3749}" Then
            m(i).Enabled = True
          End If
          If m(i).Tag = "{F1C74700-26BE-4FB0-B439-29DAD7DA4F79}" Then
            m(i).Enabled = True
          End If
        Next
      End If
      If Item.Statusid = "{549A314D-3D56-45C7-B895-5EF3816C3749}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
   End If
