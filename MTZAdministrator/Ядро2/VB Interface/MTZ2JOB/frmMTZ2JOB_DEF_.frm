VERSION 5.00
Begin VB.Form frmMTZ2JOB_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Отложенное событие"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание отложенного события"
      Top             =   6225
      Width           =   825
   End
   Begin MTZ2JOBGUI.MTZ2JOB_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMTZ2JOB_DEF_"
...
' Форма редактирования раздела MTZ2JOB_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{242A72AB-18EE-49CC-BF1B-8E554AD3AA57}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{242A72AB-18EE-49CC-BF1B-8E554AD3AA57}"
  Open s & Me.Name & "{242A72AB-18EE-49CC-BF1B-8E554AD3AA57}" For Output As #ff
