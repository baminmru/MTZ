...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZStateSrvGUI.vpnStateAction_ pnlStateAction 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlStateAction.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlStateAction.Visible = False
   ...
   Case "StateAction"
     ...
     .Visible = True
     .ZOrder 0
     pnlStateAction.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Дейсвие при смене"
ts.Tabs.Item(1).Key = "StateAction"
pnlStateAction.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZStateSrv", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlStateAction.IsChanged
