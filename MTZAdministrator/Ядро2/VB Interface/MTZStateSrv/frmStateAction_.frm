VERSION 5.00
Begin VB.Form frmStateAction_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Дейсвие при смене"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Дейсвие при смене"
      Top             =   6225
      Width           =   825
   End
   Begin MTZStateSrvGUI.StateAction Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmStateAction_"
...
' Форма редактирования раздела StateAction режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A4A6861C-99DF-4760-9543-3B072C1A0F50}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A4A6861C-99DF-4760-9543-3B072C1A0F50}"
  Open s & Me.Name & "{A4A6861C-99DF-4760-9543-3B072C1A0F50}" For Output As #ff
