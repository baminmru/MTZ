...
If Name = "STDJournlaExtInfo" Then
 Set FormByName = New frmSTDJournlaExtInfo_
 Exit Function
End If

If Name = "STDJournalExtParam" Then
 Set FormByName = New frmSTDJournalExtParam_
 Exit Function
End If

If Name = "STDJournalExtFlt" Then
 Set FormByName = New frmSTDJournalExtFlt_
 Exit Function
End If

If Name = "STDJournalExtField" Then
 Set FormByName = New frmSTDJournalExtField_
 Exit Function
End If
