VERSION 5.00
Begin VB.Form frmSTDJournalExtFlt_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Фильтры журнала"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDJournalExtGUI.STDJournalExtFlt Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDJournalExtFlt_"
...
' Форма редактирования раздела STDJournalExtFlt режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DB0ACA44-F6AD-45BF-B109-F59F2D120D7E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DB0ACA44-F6AD-45BF-B109-F59F2D120D7E}"
  Open s & Me.Name & "{DB0ACA44-F6AD-45BF-B109-F59F2D120D7E}" For Output As #ff
