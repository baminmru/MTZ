VERSION 5.00
Begin VB.Form frmSTDJournlaExtInfo_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание расширения Журнал"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDJournalExtGUI.STDJournlaExtInfo Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDJournlaExtInfo_"
...
' Форма редактирования раздела STDJournlaExtInfo режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5D5127CC-5992-4B42-A6F7-8D66FF6105F8}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5D5127CC-5992-4B42-A6F7-8D66FF6105F8}"
  Open s & Me.Name & "{5D5127CC-5992-4B42-A6F7-8D66FF6105F8}" For Output As #ff
