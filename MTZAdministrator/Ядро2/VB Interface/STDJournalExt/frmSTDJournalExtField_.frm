VERSION 5.00
Begin VB.Form frmSTDJournalExtField_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDJournalExtGUI.STDJournalExtField Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDJournalExtField_"
...
' Форма редактирования раздела STDJournalExtField режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E259BCAE-E5E4-4A19-8871-7D81A7D526FE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E259BCAE-E5E4-4A19-8871-7D81A7D526FE}"
  Open s & Me.Name & "{E259BCAE-E5E4-4A19-8871-7D81A7D526FE}" For Output As #ff
