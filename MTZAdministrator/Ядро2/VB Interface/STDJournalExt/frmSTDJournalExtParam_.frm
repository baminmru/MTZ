VERSION 5.00
Begin VB.Form frmSTDJournalExtParam_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin STDJournalExtGUI.STDJournalExtParam Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTDJournalExtParam_"
...
' Форма редактирования раздела STDJournalExtParam режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{6F5A3BA3-5C2C-4305-9E62-BD8045176466}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{6F5A3BA3-5C2C-4305-9E62-BD8045176466}"
  Open s & Me.Name & "{6F5A3BA3-5C2C-4305-9E62-BD8045176466}" For Output As #ff
