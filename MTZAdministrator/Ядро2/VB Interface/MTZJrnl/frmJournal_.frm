...
Begin VB.Form frmJournal_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZJrnlGUI.Journal Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела Journal режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{34C46C6E-9215-4746-8D9D-4800B6549003}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{34C46C6E-9215-4746-8D9D-4800B6549003}"
  Open s & Me.Name & "{34C46C6E-9215-4746-8D9D-4800B6549003}" For Output As #ff
