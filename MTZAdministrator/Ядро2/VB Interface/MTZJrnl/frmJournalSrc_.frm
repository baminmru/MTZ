VERSION 5.00
Begin VB.Form frmJournalSrc_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Источники журнала"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Источники журнала"
      Top             =   6225
      Width           =   825
   End
   Begin MTZJrnlGUI.JournalSrc Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmJournalSrc_"
...
' Форма редактирования раздела JournalSrc режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DAC3244D-70D6-45A4-885D-D610F748EBFC}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DAC3244D-70D6-45A4-885D-D610F748EBFC}"
  Open s & Me.Name & "{DAC3244D-70D6-45A4-885D-D610F748EBFC}" For Output As #ff
