VERSION 5.00
Begin VB.Form frmJColumnSource_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Состав колонки"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Состав колонки"
      Top             =   6225
      Width           =   825
   End
   Begin MTZJrnlGUI.JColumnSource Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmJColumnSource_"
...
' Форма редактирования раздела JColumnSource режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8D8C85EB-D15E-45D7-B13B-0B4001EB9AC2}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8D8C85EB-D15E-45D7-B13B-0B4001EB9AC2}"
  Open s & Me.Name & "{8D8C85EB-D15E-45D7-B13B-0B4001EB9AC2}" For Output As #ff
