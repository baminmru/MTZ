...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZJrnlGUI.vpnJournal_ pnlJournal 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZJrnlGUI.vpnJournalSrc_ pnlJournalSrc 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZJrnlGUI.vpnJournalColumn_ pnlJournalColumn 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
If IsItOk Then IsItOk = pnlJournal.IsOK
If IsItOk Then IsItOk = pnlJournalSrc.IsOK
If IsItOk Then IsItOk = pnlJournalColumn.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlJournalColumn.Visible = False
  pnlJournalSrc.Visible = False
  pnlJournal.Visible = False
   ...
   Case "Journal"
     ...
     .Visible = True
     .ZOrder 0
     pnlJournal.OnClick Item, ParentForm
     End With
   Case "JournalSrc"
     With pnlJournalSrc
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlJournalSrc.OnClick Item, ParentForm
     End With
   Case "JournalColumn"
     With pnlJournalColumn
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlJournalColumn.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Журнал"
ts.Tabs.Item(1).Key = "Journal"
pnlJournal.OnInit Item, ParentForm
Call ts.Tabs.Add(, "JournalSrc", "Источники журнала")
pnlJournalSrc.OnInit Item, ParentForm
Call ts.Tabs.Add(, "JournalColumn", "Колонки журнала")
pnlJournalColumn.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZJrnl", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlJournal.CloseClass
 pnlJournalSrc.CloseClass
 pnlJournalColumn.CloseClass
End Sub
...
Public Sub OnSave()
 pnlJournal.OnSave
 pnlJournalSrc.OnSave
 pnlJournalColumn.OnSave
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlJournal.IsChanged
m_IsChanged = m_IsChanged Or pnlJournalSrc.IsChanged
m_IsChanged = m_IsChanged Or pnlJournalColumn.IsChanged
