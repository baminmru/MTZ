VERSION 5.00
Begin VB.Form frmJournalColumn_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Колонки журнала"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Колонки журнала"
      Top             =   6225
      Width           =   825
   End
   Begin MTZJrnlGUI.JournalColumn Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmJournalColumn_"
...
' Форма редактирования раздела JournalColumn режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F8D77B31-A757-488C-BB58-22700737D4B8}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F8D77B31-A757-488C-BB58-22700737D4B8}"
  Open s & Me.Name & "{F8D77B31-A757-488C-BB58-22700737D4B8}" For Output As #ff
