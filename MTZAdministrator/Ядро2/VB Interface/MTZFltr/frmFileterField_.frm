VERSION 5.00
Begin VB.Form frmFileterField_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZFltrGUI.FileterField Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFileterField_"
...
' Форма редактирования раздела FileterField режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F4B3740C-E676-4B6E-A833-EDE44CB9FA63}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F4B3740C-E676-4B6E-A833-EDE44CB9FA63}"
  Open s & Me.Name & "{F4B3740C-E676-4B6E-A833-EDE44CB9FA63}" For Output As #ff
