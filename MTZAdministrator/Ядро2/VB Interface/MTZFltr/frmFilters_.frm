...
Begin VB.Form frmFilters_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZFltrGUI.Filters Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела Filters режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{B75AD724-6B6F-45BD-B0BB-C75D17309DC9}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{B75AD724-6B6F-45BD-B0BB-C75D17309DC9}"
  Open s & Me.Name & "{B75AD724-6B6F-45BD-B0BB-C75D17309DC9}" For Output As #ff
