VERSION 5.00
Begin VB.Form frmFilterFieldGroup_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Группа полей фильтра"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Группа полей фильтра"
      Top             =   6225
      Width           =   825
   End
   Begin MTZFltrGUI.FilterFieldGroup Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFilterFieldGroup_"
...
' Форма редактирования раздела FilterFieldGroup режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{98C6D923-B807-418C-91E7-C351511B5EB1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{98C6D923-B807-418C-91E7-C351511B5EB1}"
  Open s & Me.Name & "{98C6D923-B807-418C-91E7-C351511B5EB1}" For Output As #ff
