...
If Name = "Filters" Then
 Set FormByName = New frmFilters_
 Exit Function
End If

If Name = "FilterFieldGroup" Then
 Set FormByName = New frmFilterFieldGroup_
 Exit Function
End If

If Name = "FileterField" Then
 Set FormByName = New frmFileterField_
 Exit Function
End If
