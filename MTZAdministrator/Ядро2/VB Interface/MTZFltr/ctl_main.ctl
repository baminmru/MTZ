...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZFltrGUI.vpnFilters_ pnlFilters 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZFltrGUI.vpnFilterFieldGroup_ pnlFilterFieldGroup 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlFilters.IsOK
If IsItOk Then IsItOk = pnlFilterFieldGroup.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlFilterFieldGroup.Visible = False
  pnlFilters.Visible = False
   ...
   Case "Filters"
     ...
     .Visible = True
     .ZOrder 0
     pnlFilters.OnClick Item, ParentForm
     End With
   Case "FilterFieldGroup"
     With pnlFilterFieldGroup
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlFilterFieldGroup.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Фильтр"
ts.Tabs.Item(1).Key = "Filters"
pnlFilters.OnInit Item, ParentForm
Call ts.Tabs.Add(, "FilterFieldGroup", "Группа полей фильтра")
pnlFilterFieldGroup.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZFltr", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlFilters.CloseClass
 pnlFilterFieldGroup.CloseClass
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlFilters.IsChanged
m_IsChanged = m_IsChanged Or pnlFilterFieldGroup.IsChanged
