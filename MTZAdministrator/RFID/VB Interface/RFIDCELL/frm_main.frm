...
Begin VB.Form frm_main 
   ...
   Tag             =   "Card.ICO"
   Begin RFIDCELLGUI.ctl_main ctl 
      Height          =   1500
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
Attribute item.VB_VarHelpID = 110
Public Host As GUI
Attribute Host.VB_VarHelpID = 100
Public ModalMode As Boolean
Attribute ModalMode.VB_VarHelpID = 115
...
Attribute BeforeChangeStatus.VB_HelpID = 85
  Dim logic As Object
...
Attribute CheckIsOk.VB_HelpID = 95
    'get plain part
    Dim res As Boolean
    Dim p_col As Object
    Dim p As Object
...
Attribute CheckIsNew.VB_HelpID = 90
    'get plain part
    Dim res As Boolean
    Dim p_col As Object
    Dim p As Object
...
Private Sub LoadFromSkin()
  ...
  Dim ff As Long, buf As String
  ff = FreeFile
  Open s & "MainForm" & "RFIDCELL" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & "MainForm" & "RFIDCELL"
  Open s & "MainForm" & "RFIDCELL" For Output As #ff
  buf = "FormTag:" & Me.Tag
