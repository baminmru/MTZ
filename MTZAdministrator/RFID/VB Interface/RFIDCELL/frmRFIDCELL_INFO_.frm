VERSION 5.00
Begin VB.Form frmRFIDCELL_INFO_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDCELLGUI.RFIDCELL_INFO Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDCELL_INFO_"
...
' Форма редактирования раздела RFIDCELL_INFO режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D7C5C284-E4EC-4AB6-9404-28884F63F1FA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D7C5C284-E4EC-4AB6-9404-28884F63F1FA}"
  Open s & Me.Name & "{D7C5C284-E4EC-4AB6-9404-28884F63F1FA}" For Output As #ff
