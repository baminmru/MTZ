...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin RFIDCELLGUI.vpnRFIDCELL_INFO_ pnlRFIDCELL_INFO 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlRFIDCELL_INFO.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlRFIDCELL_INFO.Visible = False

   Select Case ts.SelectedItem.Key
   Case "RFIDCELL_INFO"
     With pnlRFIDCELL_INFO
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     ...
     .Visible = True
     .ZOrder 0
     pnlRFIDCELL_INFO.OnClick item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.item(1).Caption = "Ячейки"
ts.Tabs.item(1).Key = "RFIDCELL_INFO"
pnlRFIDCELL_INFO.OnInit item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "RFIDCELL", "ctl_main"
...
Attribute IsChanged.VB_HelpID = 30
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlRFIDCELL_INFO.IsChanged
