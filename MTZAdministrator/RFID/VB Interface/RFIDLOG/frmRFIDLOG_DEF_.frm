VERSION 5.00
Begin VB.Form frmRFIDLOG_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание журнала"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDLOGGUI.RFIDLOG_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDLOG_DEF_"
...
' Форма редактирования раздела RFIDLOG_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{CA3125FB-2D8B-4360-8E4D-D5224FCA886D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{CA3125FB-2D8B-4360-8E4D-D5224FCA886D}"
  Open s & Me.Name & "{CA3125FB-2D8B-4360-8E4D-D5224FCA886D}" For Output As #ff
