...
Begin VB.Form frmRFIDPL_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDPLGUI.RFIDPL_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDPL_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C8E5C40C-E198-4121-B669-8732FE0DE912}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C8E5C40C-E198-4121-B669-8732FE0DE912}"
  Open s & Me.Name & "{C8E5C40C-E198-4121-B669-8732FE0DE912}" For Output As #ff
