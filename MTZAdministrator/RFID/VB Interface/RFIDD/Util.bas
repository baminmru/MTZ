...
If Name = "RFIDD_LTYPE" Then
 Set FormByName = New frmRFIDD_LTYPE_
 Exit Function
End If

If Name = "RFIDD_CAR" Then
 Set FormByName = New frmRFIDD_CAR_
 Exit Function
End If

If Name = "RFIDD_PSTATE" Then
 Set FormByName = New frmRFIDD_PSTATE_
 Exit Function
End If

If Name = "RFIIDD_OPTYPE" Then
 Set FormByName = New frmRFIIDD_OPTYPE_
 Exit Function
End If

If Name = "RFIDD_CELLTYPE" Then
 Set FormByName = New frmRFIDD_CELLTYPE_
 Exit Function
End If
