VERSION 5.00
Begin VB.Form frmRFIDD_CELLTYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDDGUI.RFIDD_CELLTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDD_CELLTYPE_"
...
' Форма редактирования раздела RFIDD_CELLTYPE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2250167B-0CB1-486C-866A-127A7267A938}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2250167B-0CB1-486C-866A-127A7267A938}"
  Open s & Me.Name & "{2250167B-0CB1-486C-866A-127A7267A938}" For Output As #ff
