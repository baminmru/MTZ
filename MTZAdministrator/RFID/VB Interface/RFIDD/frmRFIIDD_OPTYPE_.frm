VERSION 5.00
Begin VB.Form frmRFIIDD_OPTYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDDGUI.RFIIDD_OPTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIIDD_OPTYPE_"
...
' Форма редактирования раздела RFIIDD_OPTYPE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C8936528-977F-4A55-82EE-FA7650D2116B}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C8936528-977F-4A55-82EE-FA7650D2116B}"
  Open s & Me.Name & "{C8936528-977F-4A55-82EE-FA7650D2116B}" For Output As #ff
