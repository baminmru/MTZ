...
Begin VB.Form frmRFIDD_CAR_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Коды штабелеров"
      Top             =   6225
      Width           =   825
   End
   Begin RFIDDGUI.RFIDD_CAR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDD_CAR_"
...
' Форма редактирования раздела RFIDD_CAR режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{554AACBA-09F5-49C0-8D91-6F9BA7DD7498}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{554AACBA-09F5-49C0-8D91-6F9BA7DD7498}"
  Open s & Me.Name & "{554AACBA-09F5-49C0-8D91-6F9BA7DD7498}" For Output As #ff
