VERSION 5.00
Begin VB.Form frmRFIDD_PSTATE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Сосотояние паллеты"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDDGUI.RFIDD_PSTATE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDD_PSTATE_"
...
' Форма редактирования раздела RFIDD_PSTATE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2D6CF068-D50B-40EA-B613-F7AE9A181F4E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2D6CF068-D50B-40EA-B613-F7AE9A181F4E}"
  Open s & Me.Name & "{2D6CF068-D50B-40EA-B613-F7AE9A181F4E}" For Output As #ff
