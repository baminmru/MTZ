...
Begin VB.Form frmRFIDD_LTYPE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDDGUI.RFIDD_LTYPE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDD_LTYPE_"
...
' Форма редактирования раздела RFIDD_LTYPE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0747D4F8-C459-4A8F-8564-78EBEE599146}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0747D4F8-C459-4A8F-8564-78EBEE599146}"
  Open s & Me.Name & "{0747D4F8-C459-4A8F-8564-78EBEE599146}" For Output As #ff
