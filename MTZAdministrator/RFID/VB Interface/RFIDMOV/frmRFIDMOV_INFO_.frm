VERSION 5.00
Begin VB.Form frmRFIDMOV_INFO_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin RFIDMOVGUI.RFIDMOV_INFO Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmRFIDMOV_INFO_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{57852795-3D8A-438C-94F3-30D2CBE29155}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{57852795-3D8A-438C-94F3-30D2CBE29155}"
  Open s & Me.Name & "{57852795-3D8A-438C-94F3-30D2CBE29155}" For Output As #ff
