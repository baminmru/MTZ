...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin RFIDMOVGUI.vpnRFIDMOV_INFO_ pnlRFIDMOV_INFO 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlRFIDMOV_INFO.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlRFIDMOV_INFO.Visible = False

   Select Case ts.SelectedItem.Key
   Case "RFIDMOV_INFO"
     With pnlRFIDMOV_INFO
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     ...
     .Visible = True
     .ZOrder 0
     pnlRFIDMOV_INFO.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Перемещения"
ts.Tabs.Item(1).Key = "RFIDMOV_INFO"
pnlRFIDMOV_INFO.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "RFIDMOV", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlRFIDMOV_INFO.CloseClass
End Sub
Public Sub OnSave()
 pnlRFIDMOV_INFO.OnSave
End Sub
Public Function IsChanged() As Boolean
  Dim m_IsChanged As Boolean
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlRFIDMOV_INFO.IsChanged
