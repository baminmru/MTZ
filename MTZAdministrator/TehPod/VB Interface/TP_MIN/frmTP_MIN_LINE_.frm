...
Begin VB.Form frmTP_MIN_LINE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Строки акта приемки модемов"
      Top             =   6225
      Width           =   825
   End
   Begin TP_MINGUI.TP_MIN_LINE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_MIN_LINE_"
...
' Форма редактирования раздела TP_MIN_LINE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3BAC877A-F9EF-4367-945F-DE956AB85AFE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3BAC877A-F9EF-4367-945F-DE956AB85AFE}"
  Open s & Me.Name & "{3BAC877A-F9EF-4367-945F-DE956AB85AFE}" For Output As #ff
