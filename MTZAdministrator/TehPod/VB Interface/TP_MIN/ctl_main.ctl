...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_MINGUI.vpnTP_MIN_DEF_ pnlTP_MIN_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_MINGUI.vpnTP_MIN_LINE_ pnlTP_MIN_LINE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlTP_MIN_DEF.IsOK
If IsItOk Then IsItOk = pnlTP_MIN_LINE.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlTP_MIN_LINE.Visible = False
  pnlTP_MIN_DEF.Visible = False
   ...
   Case "TP_MIN_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlTP_MIN_DEF.OnClick Item, ParentForm
     End With
   Case "TP_MIN_LINE"
     With pnlTP_MIN_LINE
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlTP_MIN_LINE.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "TP_MIN_DEF"
pnlTP_MIN_DEF.OnInit Item, ParentForm
Call ts.Tabs.Add(, "TP_MIN_LINE", "Строки акта")
pnlTP_MIN_LINE.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "TP_MIN", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlTP_MIN_DEF.CloseClass
 pnlTP_MIN_LINE.CloseClass
End Sub
...
'  call me.OnSave()
Public Sub OnSave()
 pnlTP_MIN_DEF.OnSave
 pnlTP_MIN_LINE.OnSave
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlTP_MIN_DEF.IsChanged
m_IsChanged = m_IsChanged Or pnlTP_MIN_LINE.IsChanged
