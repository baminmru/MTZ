...
Begin VB.UserControl TP_MIN_DEF 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.Label lblNDS 
         ...
         Width           =   3000
      End
      Begin VB.Label lblClientReturns 
         BackStyle       =   0  'Transparent
...
If mIsOK Then mIsOK = (cmbClientReturns.ListIndex >= 0)
...
cmbClientReturns.ItemData(cmbClientReturns.NewIndex) = 0
 For iii = 0 To cmbClientReturns.ListCount - 1
  If Item.ClientReturns = cmbClientReturns.ItemData(iii) Then
   cmbClientReturns.ListIndex = iii
   Exit For
  End If
 Next
txtNDS = Item.NDS
...
Item.ActNum = txtActNum
 If cmbClientReturns.ListIndex >= 0 Then
   Item.ClientReturns = cmbClientReturns.ItemData(cmbClientReturns.ListIndex)
 End If
