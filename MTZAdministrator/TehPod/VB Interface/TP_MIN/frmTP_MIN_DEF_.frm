...
Begin VB.Form frmTP_MIN_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_MINGUI.TP_MIN_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_MIN_DEF_"
...
' Форма редактирования раздела TP_MIN_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{96355BCE-2F6A-43FA-AF32-3E33E8FBDDA7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{96355BCE-2F6A-43FA-AF32-3E33E8FBDDA7}"
  Open s & Me.Name & "{96355BCE-2F6A-43FA-AF32-3E33E8FBDDA7}" For Output As #ff
