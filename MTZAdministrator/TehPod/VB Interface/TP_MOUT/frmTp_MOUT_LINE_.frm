VERSION 5.00
Begin VB.Form frmTp_MOUT_LINE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Строки акта передачи"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_MOUTGUI.Tp_MOUT_LINE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTp_MOUT_LINE_"
...
' Форма редактирования раздела Tp_MOUT_LINE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0067820F-435F-4CE8-8D73-82A56B41DD44}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0067820F-435F-4CE8-8D73-82A56B41DD44}"
  Open s & Me.Name & "{0067820F-435F-4CE8-8D73-82A56B41DD44}" For Output As #ff
