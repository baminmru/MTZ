VERSION 5.00
Begin VB.Form frmTP_MOUT_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Акт передачи модема"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Акт передачи модема"
      Top             =   6225
      Width           =   825
   End
   Begin TP_MOUTGUI.TP_MOUT_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_MOUT_DEF_"
...
' Форма редактирования раздела TP_MOUT_DEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{922FBD4D-BCAC-460E-BB1E-86AE0C591A2D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{922FBD4D-BCAC-460E-BB1E-86AE0C591A2D}"
  Open s & Me.Name & "{922FBD4D-BCAC-460E-BB1E-86AE0C591A2D}" For Output As #ff
