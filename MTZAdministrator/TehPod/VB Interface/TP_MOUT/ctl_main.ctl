...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_MOUTGUI.vpnTP_MOUT_DEF_ pnlTP_MOUT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_MOUTGUI.vpnTp_MOUT_LINE_ pnlTp_MOUT_LINE 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlTP_MOUT_DEF.IsOK
If IsItOk Then IsItOk = pnlTp_MOUT_LINE.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlTp_MOUT_LINE.Visible = False
  pnlTP_MOUT_DEF.Visible = False
   ...
   Case "TP_MOUT_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlTP_MOUT_DEF.OnClick Item, ParentForm
     End With
   Case "Tp_MOUT_LINE"
     With pnlTp_MOUT_LINE
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlTp_MOUT_LINE.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Акт передачи модема"
ts.Tabs.Item(1).Key = "TP_MOUT_DEF"
pnlTP_MOUT_DEF.OnInit Item, ParentForm
Call ts.Tabs.Add(, "Tp_MOUT_LINE", "Строки акта передачи")
pnlTp_MOUT_LINE.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "TP_MOUT", "ctl_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlTP_MOUT_DEF.CloseClass
 pnlTp_MOUT_LINE.CloseClass
End Sub
...
'  call me.OnSave()
Public Sub OnSave()
 pnlTP_MOUT_DEF.OnSave
 pnlTp_MOUT_LINE.OnSave
End Sub
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlTP_MOUT_DEF.IsChanged
m_IsChanged = m_IsChanged Or pnlTp_MOUT_LINE.IsChanged
