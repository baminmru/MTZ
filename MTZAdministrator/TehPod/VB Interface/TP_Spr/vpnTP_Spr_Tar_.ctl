...
Begin VB.UserControl vpnTP_Spr_Tar_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerTP_Spr_Tar 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlTP_Spr_Tar 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdTP_Spr_TarAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_TarAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridTP_Spr_Tar 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Spr_Tar_.ctx":0000
         Column(2)       =   "vpnTP_Spr_Tar_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Spr_Tar_.ctx":016C
         FormatStyle(2)  =   "vpnTP_Spr_Tar_.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Spr_Tar_.ctx":0378
         FormatStyle(4)  =   "vpnTP_Spr_Tar_.ctx":042C
         FormatStyle(5)  =   "vpnTP_Spr_Tar_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Spr_Tar_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdTP_Spr_TarRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupTP_Spr_Tar 
      Caption         =   "Меню для Тариф"
      Visible         =   0   'False
      Begin VB.Menu mnuTP_Spr_TarAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuTP_Spr_TarEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuTP_Spr_TarDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuTP_Spr_TarOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuTP_Spr_TarRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuTP_Spr_TarS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuTP_Spr_TarBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuTP_Spr_TarCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuTP_Spr_TarCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuTP_Spr_TarPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuTP_Spr_TarCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuTP_Spr_TarCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuTP_Spr_TarPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuTP_Spr_TarCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuTP_Spr_TarFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuTP_Spr_TarAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnTP_Spr_Tar_"
