VERSION 5.00
Begin VB.Form frmTP_Spr_Modem_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_Modem Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_Modem_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E7BB5779-8E23-432A-B8EE-B55B9CC5B38D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E7BB5779-8E23-432A-B8EE-B55B9CC5B38D}"
  Open s & Me.Name & "{E7BB5779-8E23-432A-B8EE-B55B9CC5B38D}" For Output As #ff
