VERSION 5.00
Begin VB.Form frmTP_Spr_SrochDog_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_SrochDog Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_SrochDog_"
...
' Форма редактирования раздела TP_Spr_SrochDog режим
