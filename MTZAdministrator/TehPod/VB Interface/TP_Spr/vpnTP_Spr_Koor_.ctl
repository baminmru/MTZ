...
Begin VB.UserControl vpnTP_Spr_Koor_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerTP_Spr_Koor 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlTP_Spr_Koor 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdTP_Spr_KoorAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_KoorAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridTP_Spr_Koor 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Spr_Koor_.ctx":0000
         Column(2)       =   "vpnTP_Spr_Koor_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Spr_Koor_.ctx":016C
         FormatStyle(2)  =   "vpnTP_Spr_Koor_.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Spr_Koor_.ctx":0378
         FormatStyle(4)  =   "vpnTP_Spr_Koor_.ctx":042C
         FormatStyle(5)  =   "vpnTP_Spr_Koor_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Spr_Koor_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdTP_Spr_KoorRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupTP_Spr_Koor 
      Caption         =   "Меню для Координатор"
      Visible         =   0   'False
      Begin VB.Menu mnuTP_Spr_KoorAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuTP_Spr_KoorEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuTP_Spr_KoorDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuTP_Spr_KoorOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuTP_Spr_KoorRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuTP_Spr_KoorS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuTP_Spr_KoorBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuTP_Spr_KoorCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuTP_Spr_KoorCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuTP_Spr_KoorPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuTP_Spr_KoorCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuTP_Spr_KoorCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuTP_Spr_KoorPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuTP_Spr_KoorCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuTP_Spr_KoorFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuTP_Spr_KoorAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnTP_Spr_Koor_"
