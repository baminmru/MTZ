...
Begin VB.Form frmTP_Spr_Tzay_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_Tzay Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_Tzay_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{84545092-D3AD-44F2-AD8F-8256C584C083}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{84545092-D3AD-44F2-AD8F-8256C584C083}"
  Open s & Me.Name & "{84545092-D3AD-44F2-AD8F-8256C584C083}" For Output As #ff
