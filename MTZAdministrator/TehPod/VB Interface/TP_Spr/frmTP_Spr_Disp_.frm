...
Begin VB.Form frmTP_Spr_Disp_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_Disp Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_Disp_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{990678A8-BCF1-4E79-A7FC-AABD2EF0CCAA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{990678A8-BCF1-4E79-A7FC-AABD2EF0CCAA}"
  Open s & Me.Name & "{990678A8-BCF1-4E79-A7FC-AABD2EF0CCAA}" For Output As #ff
