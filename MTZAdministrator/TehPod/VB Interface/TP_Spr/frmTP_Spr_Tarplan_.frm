VERSION 5.00
Begin VB.Form frmTP_Spr_Tarplan_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_Tarplan Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_Tarplan_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4C92FF30-1437-4BEF-A01A-BA166F4176AA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4C92FF30-1437-4BEF-A01A-BA166F4176AA}"
  Open s & Me.Name & "{4C92FF30-1437-4BEF-A01A-BA166F4176AA}" For Output As #ff
