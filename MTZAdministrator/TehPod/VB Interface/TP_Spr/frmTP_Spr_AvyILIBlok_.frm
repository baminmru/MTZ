VERSION 5.00
Begin VB.Form frmTP_Spr_AvyILIBlok_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "АВУ или блокиратор"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_AvyILIBlok Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_AvyILIBlok_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{20A8D652-FF08-4647-BA14-4F30F5665464}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{20A8D652-FF08-4647-BA14-4F30F5665464}"
  Open s & Me.Name & "{20A8D652-FF08-4647-BA14-4F30F5665464}" For Output As #ff
