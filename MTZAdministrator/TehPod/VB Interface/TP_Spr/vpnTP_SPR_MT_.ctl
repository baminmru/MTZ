...
Begin VB.UserControl vpnTP_SPR_MT_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerTP_SPR_MT 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlTP_SPR_MT 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdTP_SPR_MTAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_SPR_MTAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridTP_SPR_MT 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_SPR_MT_.ctx":0000
         Column(2)       =   "vpnTP_SPR_MT_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_SPR_MT_.ctx":016C
         FormatStyle(2)  =   "vpnTP_SPR_MT_.ctx":02C8
         FormatStyle(3)  =   "vpnTP_SPR_MT_.ctx":0378
         FormatStyle(4)  =   "vpnTP_SPR_MT_.ctx":042C
         FormatStyle(5)  =   "vpnTP_SPR_MT_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_SPR_MT_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdTP_SPR_MTRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupTP_SPR_MT 
      Caption         =   "Меню для Тип модема"
      Visible         =   0   'False
      Begin VB.Menu mnuTP_SPR_MTAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuTP_SPR_MTEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuTP_SPR_MTDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuTP_SPR_MTOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuTP_SPR_MTRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuTP_SPR_MTS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuTP_SPR_MTBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuTP_SPR_MTCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuTP_SPR_MTCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuTP_SPR_MTPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuTP_SPR_MTCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuTP_SPR_MTCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuTP_SPR_MTPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuTP_SPR_MTCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuTP_SPR_MTFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuTP_SPR_MTAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnTP_SPR_MT_"
...
'панель для работы со строками раздела Тип модема
