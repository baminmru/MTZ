VERSION 5.00
Begin VB.Form frmTP_Spt_TarplanZFTV_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spt_TarplanZFTV Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spt_TarplanZFTV_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8BF7952F-4F5E-44D4-8F45-3DE544743948}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8BF7952F-4F5E-44D4-8F45-3DE544743948}"
  Open s & Me.Name & "{8BF7952F-4F5E-44D4-8F45-3DE544743948}" For Output As #ff
