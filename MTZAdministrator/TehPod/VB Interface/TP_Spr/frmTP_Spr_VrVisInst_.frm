VERSION 5.00
Begin VB.Form frmTP_Spr_VrVisInst_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Время визита инсталятора"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_VrVisInst Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_VrVisInst_"
...
' Форма редактирования раздела TP_Spr_VrVisInst режим
