...
Begin VB.UserControl vpnTP_Spr_Oper_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerTP_Spr_Oper 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlTP_Spr_Oper 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdTP_Spr_OperAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdTP_Spr_OperAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridTP_Spr_Oper 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Spr_Oper_.ctx":0000
         Column(2)       =   "vpnTP_Spr_Oper_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Spr_Oper_.ctx":016C
         FormatStyle(2)  =   "vpnTP_Spr_Oper_.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Spr_Oper_.ctx":0378
         FormatStyle(4)  =   "vpnTP_Spr_Oper_.ctx":042C
         FormatStyle(5)  =   "vpnTP_Spr_Oper_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Spr_Oper_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdTP_Spr_OperRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupTP_Spr_Oper 
      Caption         =   "Меню для Оператор"
      Visible         =   0   'False
      Begin VB.Menu mnuTP_Spr_OperAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuTP_Spr_OperEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuTP_Spr_OperDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuTP_Spr_OperOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuTP_Spr_OperRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuTP_Spr_OperS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuTP_Spr_OperBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuTP_Spr_OperCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuTP_Spr_OperCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuTP_Spr_OperPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuTP_Spr_OperCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuTP_Spr_OperCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuTP_Spr_OperPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuTP_Spr_OperCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuTP_Spr_OperFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuTP_Spr_OperAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnTP_Spr_Oper_"
