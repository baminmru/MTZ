VERSION 5.00
Begin VB.Form frmTP_Spr_tklient_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_tklient Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_tklient_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DB98FCA5-C95A-4CAE-A12C-107381F8366C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DB98FCA5-C95A-4CAE-A12C-107381F8366C}"
  Open s & Me.Name & "{DB98FCA5-C95A-4CAE-A12C-107381F8366C}" For Output As #ff
