VERSION 5.00
Begin VB.Form frmTP_Spr_TarplanTLF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_TarplanTLF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_TarplanTLF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A2EF4F4D-EDE2-468D-B752-1BCA7DA331DE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A2EF4F4D-EDE2-468D-B752-1BCA7DA331DE}"
  Open s & Me.Name & "{A2EF4F4D-EDE2-468D-B752-1BCA7DA331DE}" For Output As #ff
