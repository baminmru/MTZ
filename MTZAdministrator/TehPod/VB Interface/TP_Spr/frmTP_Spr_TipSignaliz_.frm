VERSION 5.00
Begin VB.Form frmTP_Spr_TipSignaliz_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_TipSignaliz Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_TipSignaliz_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D33E36DD-9B89-462B-A399-5C4296E81433}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D33E36DD-9B89-462B-A399-5C4296E81433}"
  Open s & Me.Name & "{D33E36DD-9B89-462B-A399-5C4296E81433}" For Output As #ff
