...
Begin VB.UserControl vpnRayon_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerRayon 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlRayon 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdRayonAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdRayonAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridRayon 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnRayon_.ctx":0000
         Column(2)       =   "vpnRayon_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnRayon_.ctx":016C
         FormatStyle(2)  =   "vpnRayon_.ctx":02C8
         FormatStyle(3)  =   "vpnRayon_.ctx":0378
         FormatStyle(4)  =   "vpnRayon_.ctx":042C
         FormatStyle(5)  =   "vpnRayon_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnRayon_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdRayonRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupRayon 
      Caption         =   "Меню для Район"
      Visible         =   0   'False
      Begin VB.Menu mnuRayonAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuRayonEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuRayonDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuRayonOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuRayonRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuRayonS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuRayonBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuRayonCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuRayonCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuRayonPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuRayonCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuRayonCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuRayonPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuRayonCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuRayonFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuRayonAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnRayon_"
