VERSION 5.00
Begin VB.Form frmTP_Spr_PakYsl_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Пакеты услуг"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_PakYsl Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_PakYsl_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{19985A85-CD93-425F-944D-83669E311533}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{19985A85-CD93-425F-944D-83669E311533}"
  Open s & Me.Name & "{19985A85-CD93-425F-944D-83669E311533}" For Output As #ff
