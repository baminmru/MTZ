VERSION 5.00
Begin VB.Form frmTP_Spr_TipModADSL_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_SprGUI.TP_Spr_TipModADSL Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Spr_TipModADSL_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{7BE2C82B-6967-427F-BBCD-A5F94BDEFFBE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{7BE2C82B-6967-427F-BBCD-A5F94BDEFFBE}"
  Open s & Me.Name & "{7BE2C82B-6967-427F-BBCD-A5F94BDEFFBE}" For Output As #ff
