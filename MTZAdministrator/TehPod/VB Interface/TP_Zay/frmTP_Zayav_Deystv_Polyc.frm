VERSION 5.00
Begin VB.Form frmTP_Zayav_Deystv_Polyc 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Действия над заявкой"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_ZayGUI.TP_Zayav_DeystvPolyc Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Zayav_Deystv_Polyc"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{750FACE9-ACF8-402C-98D2-972D3D0CA680}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{750FACE9-ACF8-402C-98D2-972D3D0CA680}"
  Open s & Me.Name & "{750FACE9-ACF8-402C-98D2-972D3D0CA680}" For Output As #ff
