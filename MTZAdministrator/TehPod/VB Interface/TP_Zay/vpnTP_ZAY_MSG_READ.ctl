...
Begin VB.UserControl vpnTP_ZAY_MSG_READ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlTP_ZAY_MSG 
      ...
      Begin GridEX20.GridEX gridTP_ZAY_MSG 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_ZAY_MSG_READ.ctx":0000
         Column(2)       =   "vpnTP_ZAY_MSG_READ.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_ZAY_MSG_READ.ctx":016C
         FormatStyle(2)  =   "vpnTP_ZAY_MSG_READ.ctx":02C8
         FormatStyle(3)  =   "vpnTP_ZAY_MSG_READ.ctx":0378
         FormatStyle(4)  =   "vpnTP_ZAY_MSG_READ.ctx":042C
         FormatStyle(5)  =   "vpnTP_ZAY_MSG_READ.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_ZAY_MSG_READ.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnTP_ZAY_MSG_READ"
