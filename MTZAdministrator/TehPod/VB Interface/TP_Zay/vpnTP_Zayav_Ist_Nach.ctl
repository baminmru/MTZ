...
Begin VB.UserControl vpnTP_Zayav_Ist_Nach 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlTP_Zayav_Ist 
      ...
      Begin GridEX20.GridEX gridTP_Zayav_Ist 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Zayav_Ist_Nach.ctx":0000
         Column(2)       =   "vpnTP_Zayav_Ist_Nach.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Zayav_Ist_Nach.ctx":016C
         FormatStyle(2)  =   "vpnTP_Zayav_Ist_Nach.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Zayav_Ist_Nach.ctx":0378
         FormatStyle(4)  =   "vpnTP_Zayav_Ist_Nach.ctx":042C
         FormatStyle(5)  =   "vpnTP_Zayav_Ist_Nach.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Zayav_Ist_Nach.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnTP_Zayav_Ist_Nach"
...
If gridTP_Zayav_Ist.Row > 0 Then
 If gridTP_Zayav_Ist.RowIndex(gridTP_Zayav_Ist.Row) > 0 Then
    ...
    bm = gridTP_Zayav_Ist.RowBookmark(gridTP_Zayav_Ist.RowIndex(gridTP_Zayav_Ist.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmTP_Zayav_Ist_Nach.item = u
again:     frmTP_Zayav_Ist_Nach.NotFirstTime = False
    frmTP_Zayav_Ist_Nach.OnInit
    frmTP_Zayav_Ist_Nach.Show vbModal
    If frmTP_Zayav_Ist_Nach.OK Then
    On Error Resume Next
    err.Clear
    u.Save
