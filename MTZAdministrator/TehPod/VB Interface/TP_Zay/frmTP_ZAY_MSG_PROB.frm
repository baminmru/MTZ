VERSION 5.00
Begin VB.Form frmTP_ZAY_MSG_PROB 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Сообщения"
      Top             =   6225
      Width           =   825
   End
   Begin TP_ZayGUI.TP_ZAY_MSGPROB Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_ZAY_MSG_PROB"
...
' Форма редактирования раздела TP_ZAY_MSG режим PROB
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2DAD3398-2BE1-4996-913D-AD4CFC1E7DC8}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2DAD3398-2BE1-4996-913D-AD4CFC1E7DC8}"
  Open s & Me.Name & "{2DAD3398-2BE1-4996-913D-AD4CFC1E7DC8}" For Output As #ff
