...
Begin VB.UserControl ctlVipol_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_ZayGUI.vpnTP_Zayv_Vipol pnlTP_Zayv 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_Zayav_Ist_Vipol pnlTP_Zayav_Ist 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_Zayav_Deystv_Vipol pnlTP_Zayav_Deystv 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
   ...
   End
End
Attribute VB_Name = "ctlVipol_main"
...
pnlTP_Zayav_Deystv.OnInit item, ParentForm
  ...
  TSCustom.Init ts, "TP_Zay", "ctlVipol_main"
