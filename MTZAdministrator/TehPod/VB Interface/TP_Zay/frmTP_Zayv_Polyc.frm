VERSION 5.00
Begin VB.Form frmTP_Zayv_Polyc 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_ZayGUI.TP_ZayvPolyc Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Zayv_Polyc"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A5A08671-FABF-400B-8385-8F2D1C6C03E1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A5A08671-FABF-400B-8385-8F2D1C6C03E1}"
  Open s & Me.Name & "{A5A08671-FABF-400B-8385-8F2D1C6C03E1}" For Output As #ff
