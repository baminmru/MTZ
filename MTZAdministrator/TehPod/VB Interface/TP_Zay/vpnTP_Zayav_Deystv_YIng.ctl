...
Begin VB.UserControl vpnTP_Zayav_Deystv_YIng 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlTP_Zayav_Deystv 
      ...
      Begin GridEX20.GridEX gridTP_Zayav_Deystv 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Zayav_Deystv_YIng.ctx":0000
         Column(2)       =   "vpnTP_Zayav_Deystv_YIng.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Zayav_Deystv_YIng.ctx":016C
         FormatStyle(2)  =   "vpnTP_Zayav_Deystv_YIng.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Zayav_Deystv_YIng.ctx":0378
         FormatStyle(4)  =   "vpnTP_Zayav_Deystv_YIng.ctx":042C
         FormatStyle(5)  =   "vpnTP_Zayav_Deystv_YIng.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Zayav_Deystv_YIng.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnTP_Zayav_Deystv_YIng"
...
If gridTP_Zayav_Deystv.Row > 0 Then
 If gridTP_Zayav_Deystv.RowIndex(gridTP_Zayav_Deystv.Row) > 0 Then
    ...
    bm = gridTP_Zayav_Deystv.RowBookmark(gridTP_Zayav_Deystv.RowIndex(gridTP_Zayav_Deystv.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmTP_Zayav_Deystv_YIng.item = u
again:     frmTP_Zayav_Deystv_YIng.NotFirstTime = False
    frmTP_Zayav_Deystv_YIng.OnInit
    frmTP_Zayav_Deystv_YIng.Show vbModal
    If frmTP_Zayav_Deystv_YIng.OK Then
    On Error Resume Next
    err.Clear
    u.Save
