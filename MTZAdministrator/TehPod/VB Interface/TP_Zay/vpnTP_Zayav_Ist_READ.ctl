...
Begin VB.UserControl vpnTP_Zayav_Ist_READ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlTP_Zayav_Ist 
      ...
      Begin GridEX20.GridEX gridTP_Zayav_Ist 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Zayav_Ist_READ.ctx":0000
         Column(2)       =   "vpnTP_Zayav_Ist_READ.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Zayav_Ist_READ.ctx":016C
         FormatStyle(2)  =   "vpnTP_Zayav_Ist_READ.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Zayav_Ist_READ.ctx":0378
         FormatStyle(4)  =   "vpnTP_Zayav_Ist_READ.ctx":042C
         FormatStyle(5)  =   "vpnTP_Zayav_Ist_READ.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Zayav_Ist_READ.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnTP_Zayav_Ist_READ"
