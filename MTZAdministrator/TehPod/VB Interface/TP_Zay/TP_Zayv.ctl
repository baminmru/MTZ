...
Private Sub cmdViborOperat_CLick()
  On Error Resume Next
        ...
        If Item.Application.Manager.GetReferenceDialogEx2("TP_Spr_Oper", ID, brief) Then
          txtViborOperat.Tag = Left(ID, 38)
          txtViborOperat = brief
        End If
End Sub
...
Private Sub cmdEstAVYorBLOK_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("TP_Spr_AvyILIBlok", ID, brief) Then
          txtEstAVYorBLOK.Tag = Left(ID, 38)
          txtEstAVYorBLOK = brief
        End If
End Sub
...
Private Sub cmdTipSignalizazii_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("TP_Spr_TipSignaliz", ID, brief) Then
          txtTipSignalizazii.Tag = Left(ID, 38)
          txtTipSignalizazii = brief
        End If
End Sub
...
Private Sub cmdPaketYsl_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("TP_Spr_PakYsl", ID, brief) Then
          txtPaketYsl.Tag = Left(ID, 38)
          txtPaketYsl = brief
        End If
End Sub
...
Private Sub cmdDisp_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("TP_Spr_Disp", ID, brief) Then
          txtDisp.Tag = Left(ID, 38)
          txtDisp = brief
        End If
End Sub
...
Item.PodborNomerTLF = txtPodborNomerTLF
 ...
 End If
 If cmbMGMNTelSviaz.ListIndex >= 0 Then
   Item.MGMNTelSviaz = cmbMGMNTelSviaz.ItemData(cmbMGMNTelSviaz.ListIndex)
 End If
If txtViborOperat.Tag <> "" Then
  Set Item.ViborOperat = Item.Application.FindRowObject("TP_Spr_Oper", txtViborOperat.Tag)
Else
  Set Item.ViborOperat = Nothing
End If
 If cmbDVO.ListIndex >= 0 Then
   Item.DVO = cmbDVO.ItemData(cmbDVO.ListIndex)
 End If
 If cmbYslygiInformSpravSlygb.ListIndex >= 0 Then
   Item.YslygiInformSpravSlygb = cmbYslygiInformSpravSlygb.ItemData(cmbYslygiInformSpravSlygb.ListIndex)
 End If
If txtEstAVYorBLOK.Tag <> "" Then
  Set Item.EstAVYorBLOK = Item.Application.FindRowObject("TP_Spr_AvyILIBlok", txtEstAVYorBLOK.Tag)
Else
  Set Item.EstAVYorBLOK = Nothing
End If
Item.SerNomModem = txtSerNomModem
If txtSrochDogovor.Tag <> "" Then
  Set Item.SrochDogovor = Item.Application.FindRowObject("TP_Spr_SrochDog", txtSrochDogovor.Tag)
Else
  Set Item.SrochDogovor = Nothing
End If
 If cmbNalichSignalizazii.ListIndex >= 0 Then
   Item.NalichSignalizazii = cmbNalichSignalizazii.ItemData(cmbNalichSignalizazii.ListIndex)
 End If
If txtTipSignalizazii.Tag <> "" Then
  Set Item.TipSignalizazii = Item.Application.FindRowObject("TP_Spr_TipSignaliz", txtTipSignalizazii.Tag)
Else
  Set Item.TipSignalizazii = Nothing
End If
If txtPaketYsl.Tag <> "" Then
  Set Item.PaketYsl = Item.Application.FindRowObject("TP_Spr_PakYsl", txtPaketYsl.Tag)
Else
  Set Item.PaketYsl = Nothing
End If
Item.Rayon = txtRayon
If txtDisp.Tag <> "" Then
  Set Item.Disp = Item.Application.FindRowObject("TP_Spr_Disp", txtDisp.Tag)
Else
  Set Item.Disp = Nothing
End If
If txtKoord.Tag <> "" Then
  Set Item.Koord = Item.Application.FindRowObject("TP_Spr_Koor", txtKoord.Tag)
Else
  Set Item.Koord = Nothing
End If
...
End If
 ...
 End If
  ...
  End If
 If cmbOtkaz.ListIndex >= 0 Then
   Item.Otkaz = cmbOtkaz.ItemData(cmbOtkaz.ListIndex)
 End If
Item.OpisProblem = txtOpisProblem
Item.FIOdogovor = txtFIOdogovor
  If IsNull(dtpDataInstall) Then
    Item.DataInstall = 0
  Else
    Item.DataInstall = dtpDataInstall.Value
  End If
