...
Begin VB.UserControl ctlPerVS_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_ZayGUI.vpnTP_Zayv_PerVS pnlTP_Zayv 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_Zayav_Ist_PerVS pnlTP_Zayav_Ist 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_Zayav_Deystv_PerVS pnlTP_Zayav_Deystv 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
   ...
   End
End
Attribute VB_Name = "ctlPerVS_main"
...
If IsItOk Then IsItOk = pnlTP_Zayv.IsOK
If IsItOk Then IsItOk = pnlTP_Zayav_Ist.IsOK
If IsItOk Then IsItOk = pnlTP_Zayav_Deystv.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlTP_Zayav_Deystv.Visible = False
  pnlTP_Zayav_Ist.Visible = False
  pnlTP_Zayv.Visible = False
   ...
   Case "TP_Zayv"
     ...
     .Visible = True
     .ZOrder 0
     pnlTP_Zayv.OnClick item, ParentForm
     End With
   Case "TP_Zayav_Ist"
     With pnlTP_Zayav_Ist
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlTP_Zayav_Ist.OnClick item, ParentForm
     End With
   Case "TP_Zayav_Deystv"
     With pnlTP_Zayav_Deystv
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     .Width = ts.ClientWidth
     .Height = ts.ClientHeight
     .Visible = True
     .ZOrder 0
     pnlTP_Zayav_Deystv.OnClick item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.item(1).Key = "TP_Zayv"
pnlTP_Zayv.OnInit item, ParentForm
Call ts.Tabs.Add(, "TP_Zayav_Ist", "История")
pnlTP_Zayav_Ist.OnInit item, ParentForm
Call ts.Tabs.Add(, "TP_Zayav_Deystv", "Действия над заявкой")
pnlTP_Zayav_Deystv.OnInit item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "TP_Zay", "ctlPerVS_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlTP_Zayv.CloseClass
 pnlTP_Zayav_Ist.CloseClass
 pnlTP_Zayav_Deystv.CloseClass
End Sub
Public Sub OnSave()
 pnlTP_Zayv.OnSave
 pnlTP_Zayav_Ist.OnSave
 pnlTP_Zayav_Deystv.OnSave
End Sub
Public Function IsChanged() As Boolean
  Dim m_IsChanged As Boolean
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlTP_Zayv.IsChanged
m_IsChanged = m_IsChanged Or pnlTP_Zayav_Ist.IsChanged
m_IsChanged = m_IsChanged Or pnlTP_Zayav_Deystv.IsChanged
