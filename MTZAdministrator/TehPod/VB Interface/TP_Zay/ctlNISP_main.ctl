...
Begin VB.UserControl ctlNISP_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_ZayGUI.vpnTP_Zay_Zay_NISP pnlTP_Zay_Zay 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_ZAY_MSG_NISP pnlTP_ZAY_MSG 
      Height          =   1500
      Left            =   4500
      TabIndex        =   2
      Top             =   0
   ...
   End
End
Attribute VB_Name = "ctlNISP_main"
...
' Главный контрольный элемент для редактирования документа режим NISP
...
pnlTP_ZAY_MSG.OnInit item, ParentForm
  ...
  TSCustom.Init ts, "TP_Zay", "ctlNISP_main"
