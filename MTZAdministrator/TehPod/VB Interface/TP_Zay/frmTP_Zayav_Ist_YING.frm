VERSION 5.00
Begin VB.Form frmTP_Zayav_Ist_YING 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_ZayGUI.TP_Zayav_IstYING Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Zayav_Ist_YING"
...
' Форма редактирования раздела TP_Zayav_Ist режим YING
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9EDFB00D-CD4E-4344-8F83-622CECE94FB5}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9EDFB00D-CD4E-4344-8F83-622CECE94FB5}"
  Open s & Me.Name & "{9EDFB00D-CD4E-4344-8F83-622CECE94FB5}" For Output As #ff
