...
Begin VB.UserControl ctlVIP_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_ZayGUI.vpnTP_Zay_Zay_VIP pnlTP_Zay_Zay 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_Zayav_Ist_VIP pnlTP_Zayav_Ist 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_ZAY_MSG_VIP pnlTP_ZAY_MSG 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
' Главный контрольный элемент для редактирования документа режим VIP
...
pnlTP_ZAY_MSG.OnInit item, ParentForm
  ...
  TSCustom.Init ts, "TP_Zay", "ctlVIP_main"
