...
Begin VB.UserControl ctlREAD_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin TP_ZayGUI.vpnTP_Zay_Zay_READ pnlTP_Zay_Zay 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_Zayav_Ist_READ pnlTP_Zayav_Ist 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin TP_ZayGUI.vpnTP_ZAY_MSG_READ pnlTP_ZAY_MSG 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
pnlTP_ZAY_MSG.OnInit item, ParentForm
  ...
  TSCustom.Init ts, "TP_Zay", "ctlREAD_main"
