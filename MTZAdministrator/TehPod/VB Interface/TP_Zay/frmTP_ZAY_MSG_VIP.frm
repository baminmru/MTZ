VERSION 5.00
Begin VB.Form frmTP_ZAY_MSG_VIP 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_ZayGUI.TP_ZAY_MSGVIP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_ZAY_MSG_VIP"
...
' Форма редактирования раздела TP_ZAY_MSG режим VIP
