...
Begin VB.UserControl vpnTP_Zayav_Ist_Probl 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlTP_Zayav_Ist 
      ...
      Begin GridEX20.GridEX gridTP_Zayav_Ist 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTP_Zayav_Ist_Probl.ctx":0000
         Column(2)       =   "vpnTP_Zayav_Ist_Probl.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTP_Zayav_Ist_Probl.ctx":016C
         FormatStyle(2)  =   "vpnTP_Zayav_Ist_Probl.ctx":02C8
         FormatStyle(3)  =   "vpnTP_Zayav_Ist_Probl.ctx":0378
         FormatStyle(4)  =   "vpnTP_Zayav_Ist_Probl.ctx":042C
         FormatStyle(5)  =   "vpnTP_Zayav_Ist_Probl.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTP_Zayav_Ist_Probl.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnTP_Zayav_Ist_Probl"
...
Dim jset As Object 'MTZ_JSetup.Customizer
Set jset = CreateObject("MTZ_JSetup.Customizer")
jset.Preview gridTP_Zayav_Ist, "История"
Set jset = Nothing
End Sub
...
If gridTP_Zayav_Ist.Row > 0 Then
 If gridTP_Zayav_Ist.RowIndex(gridTP_Zayav_Ist.Row) > 0 Then
    ...
    bm = gridTP_Zayav_Ist.RowBookmark(gridTP_Zayav_Ist.RowIndex(gridTP_Zayav_Ist.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmTP_Zayav_Ist_Probl.item = u
again:     frmTP_Zayav_Ist_Probl.NotFirstTime = False
    frmTP_Zayav_Ist_Probl.OnInit
    frmTP_Zayav_Ist_Probl.Show vbModal
    If frmTP_Zayav_Ist_Probl.OK Then
    On Error Resume Next
    err.Clear
    u.Save
    If err.Number <> 0 Then
      ...
      GoTo again
    End If
    gridTP_Zayav_Ist.RefreshRowBookmark bm
    Else
     u.Refresh
    End If
 End If
...
Private Sub cmdTP_Zayav_IstDel_Click()
  On Error Resume Next
  gridTP_Zayav_Ist.Delete
End Sub
Private Sub cmdTP_Zayav_IstAdd_Click()
  On Error Resume Next
      Dim u As Object
      Set u = item.TP_Zayav_Ist.Add()
...
again:       frmTP_Zayav_Ist_Probl.NotFirstTime = False
      ...
      If frmTP_Zayav_Ist_Probl.OK Then
        ...
        gridTP_Zayav_Ist.ItemCount = item.TP_Zayav_Ist.Count
        gridTP_Zayav_Ist.Refresh
        gridTP_Zayav_Ist.RefreshGroups
        gridTP_Zayav_Ist.RefreshSort
        gridTP_Zayav_Ist.MoveToBookmark u.ID & "TP_Zayav_Ist"
      Else
        item.TP_Zayav_Ist.Delete u.ID
        item.TP_Zayav_Ist.Remove u.ID
      End If
      Exit Sub
bye:
   MsgBox err.Description, vbOKOnly + vbExclamation, "Создание"
...
Private Sub gridTP_Zayav_Ist_BeforeDeleteEX(ByVal RowIndex As Long, ByVal Bookmark As Variant, ByVal Cancel As GridEX20.JSRetBoolean)
  If gridTP_Zayav_Ist.ItemCount = 0 Then Exit Sub
  Dim u As Object
  Set u = item.FindRowObject("TP_Zayav_Ist", Left(Bookmark, 38))
