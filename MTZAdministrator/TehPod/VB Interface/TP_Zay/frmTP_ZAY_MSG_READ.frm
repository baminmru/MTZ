VERSION 5.00
Begin VB.Form frmTP_ZAY_MSG_READ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_ZayGUI.TP_ZAY_MSGREAD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_ZAY_MSG_READ"
...
' Форма редактирования раздела TP_ZAY_MSG режим READ
