...
Begin VB.UserControl TP_ZAY_MSGNISP 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.ComboBox cmbIsUrgent 
         ...
         Width           =   3000
      End
      Begin VB.TextBox txtTheMessage 
         Height          =   1200
         Left            =   300
         MultiLine       =   -1  'True
   ...
   End
End
Attribute VB_Name = "TP_ZAY_MSGNISP"
...
'панель редактирования раздела Сообщения
...
Private Sub cmdTheUser_MenuClick(ByVal sCaption As String)
          ...
          txtTheUser = ""
End Sub
Private Sub txtTheMessage_Change()
  Changing

End Sub
Private Sub cmbIsUrgent_Click()
  On Error Resume Next
  Changing
...
If mIsOK Then mIsOK = IsSet(txtTheMessage.Text)
  IsOK = mIsOK
End Function
...
txtTheMessage = Item.TheMessage
cmbIsUrgent.Clear
cmbIsUrgent.AddItem "Да"
cmbIsUrgent.ItemData(cmbIsUrgent.NewIndex) = -1
cmbIsUrgent.AddItem "Нет"
cmbIsUrgent.ItemData(cmbIsUrgent.NewIndex) = 0
 For iii = 0 To cmbIsUrgent.ListCount - 1
  If Item.IsUrgent = cmbIsUrgent.ItemData(iii) Then
   cmbIsUrgent.ListIndex = iii
   Exit For
  End If
 Next
...
End If
Item.TheMessage = txtTheMessage
 If cmbIsUrgent.ListIndex >= 0 Then
   Item.IsUrgent = cmbIsUrgent.ItemData(cmbIsUrgent.ListIndex)
 End If
 mIsChanged = False
 RaiseEvent Changed
End Sub
