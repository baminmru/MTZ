VERSION 5.00
Begin VB.Form frmTP_Zay_Zay_VSZT 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin TP_ZayGUI.TP_Zay_ZayVSZT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTP_Zay_Zay_VSZT"
...
' Форма редактирования раздела TP_Zay_Zay режим VSZT
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{EE955512-0EE4-4547-BE64-1FED4917308D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{EE955512-0EE4-4547-BE64-1FED4917308D}"
  Open s & Me.Name & "{EE955512-0EE4-4547-BE64-1FED4917308D}" For Output As #ff
