  ...
  public partial class ucTabTP_Zayav_Ist  : ucParent
  {
    ...
    private void LoadData()
    {
     ...
     // change column headers here
      ...
      DataGrid_TP_Zayav_Ist.Columns.FromKey("ImenStatys").Header.Caption = "»ÁÏÂÌ∏Ì ÒÚ‡ÚÛÒ";
      DataGrid_TP_Zayav_Ist.Columns.FromKey("Data").Header.Caption = "ƒ‡Ú‡ Ë ‚ÂÏˇ ËÁÏÂÌÂÌËˇ";
      DataGrid_TP_Zayav_Ist.Columns.FromKey("FIO").Header.Caption = "»ÁÏÂÌËÎ(‘»Œ)";
      DataGrid_TP_Zayav_Ist.Columns.FromKey("Komment").Header.Caption = " ÓÏÏÂÌÚ‡ËÈ";
