  ...
  public partial class ucTabTP_MOUT_DEF  : ucParent
  {
    ...
    private void LoadData()
    {
     ...
     // change column headers here
      ...
      DataGrid_TP_MOUT_DEF.Columns.FromKey("TheDAte").Header.Caption = "ƒ‡Ú‡ ‡ÍÚ‡";
      DataGrid_TP_MOUT_DEF.Columns.FromKey("ActNum").Header.Caption = "ÕÓÏÂ ‡ÍÚ‡";
      DataGrid_TP_MOUT_DEF.Columns.FromKey("RetToSZT").Header.Caption = "¬ÓÁ‚‡Ú ‚ —«“";
      DataGrid_TP_MOUT_DEF.Columns.FromKey("RetToSZT_VAL").ServerOnly = true;
      DataGrid_TP_MOUT_DEF.Columns.FromKey("NDS").Header.Caption = "—Ú‡‚Í‡ Õƒ—";
