  ...
  public partial class ucTabTP_Spr_Ing  : ucParent
  {
    ...
    private void LoadData()
    {
     ...
     // change column headers here
      ...
      DataGrid_TP_Spr_Ing.Columns.FromKey("Name").Header.Caption = "‘»Œ";
      DataGrid_TP_Spr_Ing.Columns.FromKey("Telefon").Header.Caption = "“ÂÎÂÙÓÌ";
      DataGrid_TP_Spr_Ing.Columns.FromKey("TheUser").Header.Caption = "œÓÎ¸ÁÓ‚‡ÚÂÎ¸";
