VERSION 5.00
Begin VB.Form frmPEKORD_DATA_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Таблица тарифов"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Таблица тарифов"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ORDGUI.PEKORD_DATAread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKORD_DATA_read"
