...
Begin VB.UserControl vpnPEKORD_DATA_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKORD_DATA 
      ...
      Begin GridEX20.GridEX gridPEKORD_DATA 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKORD_DATA_.ctx":0000
         Column(2)       =   "vpnPEKORD_DATA_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKORD_DATA_.ctx":016C
         FormatStyle(2)  =   "vpnPEKORD_DATA_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKORD_DATA_.ctx":0378
         FormatStyle(4)  =   "vpnPEKORD_DATA_.ctx":042C
         FormatStyle(5)  =   "vpnPEKORD_DATA_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKORD_DATA_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKORD_DATA_"
