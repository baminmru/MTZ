VERSION 5.00
Begin VB.UserControl vpnPEKORD_DEF_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKORD_DEF 
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdPEKORD_DEFCfg 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPEKORD_DEFRef 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPEKORD_DEFSave 
         Enabled         =   0   'False
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin PEK2ORDGUI.PEKORD_DEFread editPEKORD_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnPEKORD_DEF_read"
