...
Begin VB.UserControl PEKD_AUTOadmi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.ComboBox cmbCalcWithNDS 
         ...
         Width           =   3000
      End
      Begin VB.TextBox txtTheDimentions 
         Height          =   300
         Left            =   300
         MaxLength       =   80
         TabIndex        =   6
         ToolTipText     =   "Габариты"
         Top             =   1815
         Width           =   3000
      End
      Begin MSMask.MaskEdBox txtTheVolume 
         Height          =   300
         Left            =   300
         TabIndex        =   4
         ToolTipText     =   "Грузоподъемность"
         Top             =   1110
         Width           =   1800
         _ExtentX        =   3175
         _ExtentY        =   529
      ...
      Begin VB.Label lblCalcWithNDS 
         ...
         Width           =   3000
      End
      Begin VB.Label lblTheDimentions 
         BackStyle       =   0  'Transparent
         Caption         =   "Габариты:"
         ForeColor       =   &H00FF0000&
         Height          =   300
   ...
   End
End
Attribute VB_Name = "PEKD_AUTOadmi"
...
If txtTheVolume.Text <> "" Then
 On Error Resume Next
  ...
  ElseIf Val(txtTheVolume.Text) < -922337203685478# Or Val(txtTheVolume.Text) > 922337203685478# Then
     cancel = True
