...
Begin VB.UserControl vpnPEKD_AUTO_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKD_AUTO 
      ...
      Begin GridEX20.GridEX gridPEKD_AUTO 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKD_AUTO_admi.ctx":0000
         Column(2)       =   "vpnPEKD_AUTO_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKD_AUTO_admi.ctx":016C
         FormatStyle(2)  =   "vpnPEKD_AUTO_admi.ctx":02C8
         FormatStyle(3)  =   "vpnPEKD_AUTO_admi.ctx":0378
         FormatStyle(4)  =   "vpnPEKD_AUTO_admi.ctx":042C
         FormatStyle(5)  =   "vpnPEKD_AUTO_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKD_AUTO_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKD_AUTO_admi"
