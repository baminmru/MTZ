...
Begin VB.UserControl PEKD_1CTRmain 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtTR1CCode 
         Height          =   300
         Left            =   300
         MaxLength       =   40
         TabIndex        =   5
         ToolTipText     =   "Код строки таранспортных услуг"
         Top             =   1110
         Width           =   3000
      End
      ...
      Begin VB.TextBox txtTheDept 
         ...
         Width           =   2550
      End
      Begin VB.Label lblTR1CCode 
         BackStyle       =   0  'Transparent
         Caption         =   "Код строки таранспортных услуг:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "PEKD_1CTRmain"
