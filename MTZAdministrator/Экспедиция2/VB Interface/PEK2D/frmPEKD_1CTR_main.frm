VERSION 5.00
Begin VB.Form frmPEKD_1CTR_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Коды основных услуг"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Коды строк транспортировки в различных базах филиалов"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2DGUI.PEKD_1CTRmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKD_1CTR_main"
