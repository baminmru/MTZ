VERSION 5.00
Begin VB.Form frmPEKD_DEPT1C_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2DGUI.PEKD_DEPT1Cadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKD_DEPT1C_admi"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5194E894-142A-458C-8C69-FF7FADF457F9}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5194E894-142A-458C-8C69-FF7FADF457F9}"
  Open s & Me.Name & "{5194E894-142A-458C-8C69-FF7FADF457F9}" For Output As #ff
