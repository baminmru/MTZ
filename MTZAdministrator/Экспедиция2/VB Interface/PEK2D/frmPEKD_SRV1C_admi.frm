VERSION 5.00
Begin VB.Form frmPEKD_SRV1C_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2DGUI.PEKD_SRV1Cadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKD_SRV1C_admi"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{493CD4D5-4AAF-412D-A10C-8A3B12020F08}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{493CD4D5-4AAF-412D-A10C-8A3B12020F08}"
  Open s & Me.Name & "{493CD4D5-4AAF-412D-A10C-8A3B12020F08}" For Output As #ff
