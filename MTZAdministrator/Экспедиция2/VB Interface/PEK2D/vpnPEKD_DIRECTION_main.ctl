...
Begin VB.UserControl vpnPEKD_DIRECTION_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.VFrames pnlPEKD_DIRECTION 
      ...
      Begin GridEX20.GridEX gridPEKD_DIRECTION 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKD_DIRECTION_main.ctx":0000
         Column(2)       =   "vpnPEKD_DIRECTION_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKD_DIRECTION_main.ctx":016C
         FormatStyle(2)  =   "vpnPEKD_DIRECTION_main.ctx":02C8
         FormatStyle(3)  =   "vpnPEKD_DIRECTION_main.ctx":0378
         FormatStyle(4)  =   "vpnPEKD_DIRECTION_main.ctx":042C
         FormatStyle(5)  =   "vpnPEKD_DIRECTION_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKD_DIRECTION_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKD_DIRECTION_main"
