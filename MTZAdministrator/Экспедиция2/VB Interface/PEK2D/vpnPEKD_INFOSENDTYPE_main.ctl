...
Begin VB.UserControl vpnPEKD_INFOSENDTYPE_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKD_INFOSENDTYPE 
      ...
      Begin GridEX20.GridEX gridPEKD_INFOSENDTYPE 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKD_INFOSENDTYPE_main.ctx":0000
         Column(2)       =   "vpnPEKD_INFOSENDTYPE_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKD_INFOSENDTYPE_main.ctx":016C
         FormatStyle(2)  =   "vpnPEKD_INFOSENDTYPE_main.ctx":02C8
         FormatStyle(3)  =   "vpnPEKD_INFOSENDTYPE_main.ctx":0378
         FormatStyle(4)  =   "vpnPEKD_INFOSENDTYPE_main.ctx":042C
         FormatStyle(5)  =   "vpnPEKD_INFOSENDTYPE_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKD_INFOSENDTYPE_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKD_INFOSENDTYPE_main"
