...
Begin VB.UserControl vpnPEKD_1CTR_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKD_1CTR 
      ...
      Begin GridEX20.GridEX gridPEKD_1CTR 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKD_1CTR_.ctx":0000
         Column(2)       =   "vpnPEKD_1CTR_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKD_1CTR_.ctx":016C
         FormatStyle(2)  =   "vpnPEKD_1CTR_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKD_1CTR_.ctx":0378
         FormatStyle(4)  =   "vpnPEKD_1CTR_.ctx":042C
         FormatStyle(5)  =   "vpnPEKD_1CTR_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKD_1CTR_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKD_1CTR_"
