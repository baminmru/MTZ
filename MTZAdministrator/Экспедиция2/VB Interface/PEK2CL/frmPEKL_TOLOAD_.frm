VERSION 5.00
Begin VB.Form frmPEKL_TOLOAD_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Обемы под загрузку"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Обемы под загрузку"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2CLGUI.PEKL_TOLOAD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKL_TOLOAD_"
