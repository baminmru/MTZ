VERSION 5.00
Begin VB.Form frmBaseSetting_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin SettingPEK2GUI.BaseSettingmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmBaseSetting_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F56D11BE-34F1-4122-84EA-90243AD336BD}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F56D11BE-34F1-4122-84EA-90243AD336BD}"
  Open s & Me.Name & "{F56D11BE-34F1-4122-84EA-90243AD336BD}" For Output As #ff
