...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin SettingPEK2GUI.vpnBaseSetting_main pnlBaseSetting 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlBaseSetting.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlBaseSetting.Visible = False
   ...
   Case "BaseSetting"
     ...
     .Visible = True
     .ZOrder 0
     pnlBaseSetting.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Текущие настройки"
ts.Tabs.Item(1).Key = "BaseSetting"
pnlBaseSetting.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "SettingPEK2", "ctlmain_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlBaseSetting.CloseClass
End Sub
Public Sub OnSave()
 pnlBaseSetting.OnSave
End Sub
Public Function IsChanged() As Boolean
  Dim m_IsChanged As Boolean
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlBaseSetting.IsChanged
