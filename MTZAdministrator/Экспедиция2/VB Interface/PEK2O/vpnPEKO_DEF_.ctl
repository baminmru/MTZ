VERSION 5.00
Begin VB.UserControl vpnPEKO_DEF_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKO_DEF 
      ...
      Begin VB.CommandButton cmdPEKO_DEFSave 
         ...
         Width           =   330
      End
      Begin PEK2OGUI.PEKO_DEF editPEKO_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnPEKO_DEF_"
...
Private Sub opPEKO_DEF_UpdateItemName_(RowItem As Object)
With RowItem
...
Private Sub cmdPEKO_DEFCfg_Click()
    ...
    Dim ff As Long
    ff = FreeFile
    Open GetSetting("MTZ", "CONFIG", "LAYOUTS", "c:\") & "PEK2O_editPEKO_DEF_" For Output As #ff
...
Private Sub cmdPEKO_DEFSave_Click()
  ...
  On Error GoTo bye
    ...
    MousePointer = vbNormal
        opPEKO_DEF_UpdateItemName_ editPEKO_DEF.Item
    cmdPEKO_DEFSave.Enabled = False
    Else
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  ff = FreeFile
  On Error Resume Next
  Open GetSetting("MTZ", "CONFIG", "LAYOUTS", App.Path & "\LAYOUTS\") & "PEK2O_editPEKO_DEF_" For Input As #ff
  buf = ""
  buf = Input(LOF(ff), ff)
  Close #ff
