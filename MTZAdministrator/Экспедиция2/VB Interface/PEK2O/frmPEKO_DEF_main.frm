VERSION 5.00
Begin VB.Form frmPEKO_DEF_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2OGUI.PEKO_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKO_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{166C01FB-D488-4781-8453-B7C1EDD269EB}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{166C01FB-D488-4781-8453-B7C1EDD269EB}"
  Open s & Me.Name & "{166C01FB-D488-4781-8453-B7C1EDD269EB}" For Output As #ff
