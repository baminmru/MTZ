VERSION 5.00
Begin VB.UserControl vpnPEKO_DEF_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKO_DEF 
      ...
      Begin VB.CommandButton cmdPEKO_DEFSave 
         ...
         Width           =   330
      End
      Begin PEK2OGUI.PEKO_DEFread editPEKO_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnPEKO_DEF_read"
...
Private Sub opPEKO_DEF_UpdateItemName_read(RowItem As Object)
With RowItem
Run_VBUpdateItemName Name:="Оплата поставщику " & .ToClient.brief & " №" & .PLPNum & " от " & .PLPDate, RowItem:=RowItem
End With
End Sub
...
Private Sub cmdPEKO_DEFCfg_Click()
    ...
    Dim ff As Long
    ff = FreeFile
    Open GetSetting("MTZ", "CONFIG", "LAYOUTS", "c:\") & "PEK2O_editPEKO_DEF_read" For Output As #ff
...
Private Sub cmdPEKO_DEFDel_Click()
  ...
  If MsgBox("Удалить элемент" & vbCrLf & editPEKO_DEF.Item.brief & vbCrLf & "?", vbYesNo + vbQuestion, "Внимание") = vbYes Then
    On Error GoTo bye
...
Private Sub cmdPEKO_DEFSave_Click()
  ...
  On Error GoTo bye
    ...
    MousePointer = vbNormal
        opPEKO_DEF_UpdateItemName_read editPEKO_DEF.Item
    cmdPEKO_DEFSave.Enabled = False
    Else
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  ff = FreeFile
  On Error Resume Next
  Open GetSetting("MTZ", "CONFIG", "LAYOUTS", App.Path & "\LAYOUTS\") & "PEK2O_editPEKO_DEF_read" For Input As #ff
  buf = ""
  buf = Input(LOF(ff), ff)
  Close #ff
