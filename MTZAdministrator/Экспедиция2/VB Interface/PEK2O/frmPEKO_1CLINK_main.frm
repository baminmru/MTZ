VERSION 5.00
Begin VB.Form frmPEKO_1CLINK_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2OGUI.PEKO_1CLINKmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKO_1CLINK_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1ED861D5-3B42-4A24-A12A-F25559E7020F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1ED861D5-3B42-4A24-A12A-F25559E7020F}"
  Open s & Me.Name & "{1ED861D5-3B42-4A24-A12A-F25559E7020F}" For Output As #ff
