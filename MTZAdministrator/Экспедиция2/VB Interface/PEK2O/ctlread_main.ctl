...
Begin VB.UserControl ctlread_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2OGUI.vpnPEKO_DEF_read pnlPEKO_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlPEKO_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlPEKO_DEF.Visible = False
   ...
   Case "PEKO_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlPEKO_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "PEKO_DEF"
pnlPEKO_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "PEK2O", "ctlread_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlPEKO_DEF.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{685E61D4-92E8-4B43-8C75-83EE5A148E47}"
    i = i + 1
    m(i).Caption = "Оформляется"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{29988312-598E-4284-AC23-8ED685015E81}"
End Function
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{685E61D4-92E8-4B43-8C75-83EE5A148E47}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
      If Item.Statusid = "{29988312-598E-4284-AC23-8ED685015E81}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{685E61D4-92E8-4B43-8C75-83EE5A148E47}" Then
            m(i).Enabled = True
          End If
        Next
      End If
