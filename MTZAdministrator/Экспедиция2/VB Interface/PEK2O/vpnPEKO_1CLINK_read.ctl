...
Begin VB.UserControl vpnPEKO_1CLINK_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKO_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKO_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKO_1CLINK_read.ctx":0000
         Column(2)       =   "vpnPEKO_1CLINK_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKO_1CLINK_read.ctx":016C
         FormatStyle(2)  =   "vpnPEKO_1CLINK_read.ctx":02C8
         FormatStyle(3)  =   "vpnPEKO_1CLINK_read.ctx":0378
         FormatStyle(4)  =   "vpnPEKO_1CLINK_read.ctx":042C
         FormatStyle(5)  =   "vpnPEKO_1CLINK_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKO_1CLINK_read.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKO_1CLINK_read"
...
If gridPEKO_1CLINK.Row > 0 Then
 If gridPEKO_1CLINK.RowIndex(gridPEKO_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKO_1CLINK.RowBookmark(gridPEKO_1CLINK.RowIndex(gridPEKO_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKO_1CLINK_read.item = u
again:     frmPEKO_1CLINK_read.NotFirstTime = False
    frmPEKO_1CLINK_read.OnInit
    frmPEKO_1CLINK_read.Show vbModal
    If frmPEKO_1CLINK_read.OK Then
    On Error Resume Next
    err.Clear
    u.Save
