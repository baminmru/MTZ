...
Begin VB.UserControl PEKNAL_DEFmain 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.ComboBox cmbCalcWithNDS 
         ...
         Width           =   3000
      End
      Begin MTZ_PANEL.DropButton cmdRceivedBy 
         Height          =   300
         Left            =   2850
         TabIndex        =   20
         Tag             =   "refopen.ico"
         ToolTipText     =   "Кто получил"
         Top             =   6240
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
   ...
   End
End
Attribute VB_Name = "PEKNAL_DEFmain"
...
End Sub
Private Sub txtRceivedBy_Change()
  If Not (OnInit) Then
  Changing

  End If
End Sub
Private Sub cmdRceivedBy_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("Users", ID, brief) Then
          txtRceivedBy.Tag = Left(ID, 38)
          txtRceivedBy = brief
        End If
End Sub
Private Sub cmdRceivedBy_MenuClick(ByVal sCaption As String)
          txtRceivedBy.Tag = ""
          txtRceivedBy = ""
End Sub
...
If Not Item.RceivedBy Is Nothing Then
  txtRceivedBy.Tag = Item.RceivedBy.ID
  txtRceivedBy = Item.RceivedBy.brief
Else
  txtRceivedBy.Tag = ""
  txtRceivedBy = ""
End If
 LoadBtnPictures cmdRceivedBy, cmdRceivedBy.Tag
  cmdRceivedBy.RemoveAllMenu
  cmdRceivedBy.AddMenu "Очистить"
...
If txtRceivedBy.Tag <> "" Then
  Set Item.RceivedBy = Item.Application.FindRowObject("Users", txtRceivedBy.Tag)
Else
  Set Item.RceivedBy = Nothing
End If
