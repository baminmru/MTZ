...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2NALGUI.vpnPEKNAL_DEF_ pnlPEKNAL_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2NALGUI.vpnPEKNAL_PZ_ pnlPEKNAL_PZ 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2NALGUI.vpnPEKNAL_ROWS_ pnlPEKNAL_ROWS 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
pnlPEKNAL_ROWS.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "PEK2NAL", "ctl_main"
