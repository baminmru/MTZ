VERSION 5.00
Begin VB.Form frmPEKNAL_1CLINK_read 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2NALGUI.PEKNAL_1CLINKread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKNAL_1CLINK_read"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0CE12585-50A5-4F84-BC50-5AB62B09843D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0CE12585-50A5-4F84-BC50-5AB62B09843D}"
  Open s & Me.Name & "{0CE12585-50A5-4F84-BC50-5AB62B09843D}" For Output As #ff
