VERSION 5.00
Begin VB.Form frmPEKNAL_ROWS_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Раскладка по филиалам"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Разбивка стоимости наличной оплаты по филиалам"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2NALGUI.PEKNAL_ROWSread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKNAL_ROWS_read"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{990F8659-F198-4E93-A022-F2D621FA287F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{990F8659-F198-4E93-A022-F2D621FA287F}"
  Open s & Me.Name & "{990F8659-F198-4E93-A022-F2D621FA287F}" For Output As #ff
