...
Begin VB.UserControl vpnPEKNAL_1CLINK_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKNAL_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKNAL_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKNAL_1CLINK_.ctx":0000
         Column(2)       =   "vpnPEKNAL_1CLINK_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKNAL_1CLINK_.ctx":016C
         FormatStyle(2)  =   "vpnPEKNAL_1CLINK_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKNAL_1CLINK_.ctx":0378
         FormatStyle(4)  =   "vpnPEKNAL_1CLINK_.ctx":042C
         FormatStyle(5)  =   "vpnPEKNAL_1CLINK_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKNAL_1CLINK_.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKNAL_1CLINK_"
...
If gridPEKNAL_1CLINK.Row > 0 Then
 If gridPEKNAL_1CLINK.RowIndex(gridPEKNAL_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKNAL_1CLINK.RowBookmark(gridPEKNAL_1CLINK.RowIndex(gridPEKNAL_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKNAL_1CLINK_.item = u
again:     frmPEKNAL_1CLINK_.NotFirstTime = False
    frmPEKNAL_1CLINK_.OnInit
    frmPEKNAL_1CLINK_.Show vbModal
    If frmPEKNAL_1CLINK_.OK Then
    On Error Resume Next
    err.Clear
    u.Save
