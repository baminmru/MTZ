...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2NALGUI.vpnPEKNAL_DEF_main pnlPEKNAL_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2NALGUI.vpnPEKNAL_PZ_main pnlPEKNAL_PZ 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2NALGUI.vpnPEKNAL_ROWS_main pnlPEKNAL_ROWS 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
Call ts.Tabs.Add(, "PEKNAL_PZ", "Привязка к заявкам")
pnlPEKNAL_PZ.OnInit Item, ParentForm
Call ts.Tabs.Add(, "PEKNAL_ROWS", "Раскладка по филиалам")
pnlPEKNAL_ROWS.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "PEK2NAL", "ctlmain_main"
