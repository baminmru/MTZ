VERSION 5.00
Begin VB.Form frmPEKNAL_PZ_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Привязка к заявкам"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Привязка оплаты к заявкам"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2NALGUI.PEKNAL_PZmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKNAL_PZ_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{686B3F7F-1DD0-48A5-AF61-E9E55599DB68}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{686B3F7F-1DD0-48A5-AF61-E9E55599DB68}"
  Open s & Me.Name & "{686B3F7F-1DD0-48A5-AF61-E9E55599DB68}" For Output As #ff
