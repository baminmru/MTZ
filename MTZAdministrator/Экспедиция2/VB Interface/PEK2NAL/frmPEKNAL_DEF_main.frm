VERSION 5.00
Begin VB.Form frmPEKNAL_DEF_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Раздел описывает факт наличной оплаты"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2NALGUI.PEKNAL_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKNAL_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{595A6A7F-9FDF-4943-81A0-5BD282856DAA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{595A6A7F-9FDF-4943-81A0-5BD282856DAA}"
  Open s & Me.Name & "{595A6A7F-9FDF-4943-81A0-5BD282856DAA}" For Output As #ff
