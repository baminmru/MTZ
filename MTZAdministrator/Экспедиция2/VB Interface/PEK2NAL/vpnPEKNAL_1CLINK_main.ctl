...
Begin VB.UserControl vpnPEKNAL_1CLINK_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKNAL_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKNAL_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKNAL_1CLINK_main.ctx":0000
         Column(2)       =   "vpnPEKNAL_1CLINK_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKNAL_1CLINK_main.ctx":016C
         FormatStyle(2)  =   "vpnPEKNAL_1CLINK_main.ctx":02C8
         FormatStyle(3)  =   "vpnPEKNAL_1CLINK_main.ctx":0378
         FormatStyle(4)  =   "vpnPEKNAL_1CLINK_main.ctx":042C
         FormatStyle(5)  =   "vpnPEKNAL_1CLINK_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKNAL_1CLINK_main.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKNAL_1CLINK_main"
...
Dim jset As Object 'MTZ_JSetup.Customizer
Set jset = CreateObject("MTZ_JSetup.Customizer")
jset.Preview gridPEKNAL_1CLINK, "Связь с 1С"
Set jset = Nothing
End Sub
...
If gridPEKNAL_1CLINK.Row > 0 Then
 If gridPEKNAL_1CLINK.RowIndex(gridPEKNAL_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKNAL_1CLINK.RowBookmark(gridPEKNAL_1CLINK.RowIndex(gridPEKNAL_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKNAL_1CLINK_main.item = u
again:     frmPEKNAL_1CLINK_main.NotFirstTime = False
    frmPEKNAL_1CLINK_main.OnInit
    frmPEKNAL_1CLINK_main.Show vbModal
    If frmPEKNAL_1CLINK_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
