VERSION 5.00
Begin VB.Form frmTheDefenitionDiffP_R 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание сложного маршрута"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2DPGUI.TheDefenitionDiffPR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTheDefenitionDiffP_R"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{AF6B3596-A35A-4DD5-BE19-26D2839F7312}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{AF6B3596-A35A-4DD5-BE19-26D2839F7312}"
  Open s & Me.Name & "{AF6B3596-A35A-4DD5-BE19-26D2839F7312}" For Output As #ff
