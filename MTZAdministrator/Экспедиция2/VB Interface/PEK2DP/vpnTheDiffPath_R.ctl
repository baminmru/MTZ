...
Begin VB.UserControl vpnTheDiffPath_R 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.VFrames pnlTheDiffPath 
      ...
      Begin GridEX20.GridEX gridTheDiffPath 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnTheDiffPath_R.ctx":0000
         Column(2)       =   "vpnTheDiffPath_R.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnTheDiffPath_R.ctx":016C
         FormatStyle(2)  =   "vpnTheDiffPath_R.ctx":02C8
         FormatStyle(3)  =   "vpnTheDiffPath_R.ctx":0378
         FormatStyle(4)  =   "vpnTheDiffPath_R.ctx":042C
         FormatStyle(5)  =   "vpnTheDiffPath_R.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnTheDiffPath_R.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnTheDiffPath_R"
...
If gridTheDiffPath.Row > 0 Then
 If gridTheDiffPath.RowIndex(gridTheDiffPath.Row) > 0 Then
    ...
    Dim frm As Form
    Set frm = FormByName(TypeName(u), "R")
    Set frm.Item = u
...
If Node.Child.Tag = "ToDelete" Then
 ...
 Item.Expand treeTheDiffPath, Node.key, "R"
...
Item.FillTree treeTheDiffPath, "", "R", "TheDiffPath"
