VERSION 5.00
Begin VB.Form frmDopUslTo_R 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Доп. услуги в точке прибытия"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2DPGUI.DopUslToR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDopUslTo_R"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{059D1E07-80CE-44C4-9840-3FCAC44928F1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{059D1E07-80CE-44C4-9840-3FCAC44928F1}"
  Open s & Me.Name & "{059D1E07-80CE-44C4-9840-3FCAC44928F1}" For Output As #ff
