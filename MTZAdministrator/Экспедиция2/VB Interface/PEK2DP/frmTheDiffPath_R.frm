VERSION 5.00
Begin VB.Form frmTheDiffPath_R 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Элементы маршрута"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2DPGUI.TheDiffPathR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTheDiffPath_R"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DEB03679-5A79-4FE0-84EE-1F07873A3F87}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DEB03679-5A79-4FE0-84EE-1F07873A3F87}"
  Open s & Me.Name & "{DEB03679-5A79-4FE0-84EE-1F07873A3F87}" For Output As #ff
