VERSION 5.00
Begin VB.Form frmDopUslFrom_R 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Доп. услуги в точке отправления"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2DPGUI.DopUslFromR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDopUslFrom_R"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{12F120BD-E228-4D40-989C-FDE41431C8DD}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{12F120BD-E228-4D40-989C-FDE41431C8DD}"
  Open s & Me.Name & "{12F120BD-E228-4D40-989C-FDE41431C8DD}" For Output As #ff
