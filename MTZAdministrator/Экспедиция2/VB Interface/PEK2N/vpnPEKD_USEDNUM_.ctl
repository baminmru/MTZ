...
Begin VB.UserControl vpnPEKD_USEDNUM_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKD_USEDNUM 
      ...
      Begin GridEX20.GridEX gridPEKD_USEDNUM 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKD_USEDNUM_.ctx":0000
         Column(2)       =   "vpnPEKD_USEDNUM_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKD_USEDNUM_.ctx":016C
         FormatStyle(2)  =   "vpnPEKD_USEDNUM_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKD_USEDNUM_.ctx":0378
         FormatStyle(4)  =   "vpnPEKD_USEDNUM_.ctx":042C
         FormatStyle(5)  =   "vpnPEKD_USEDNUM_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKD_USEDNUM_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKD_USEDNUM_"
...
If gridPEKD_USEDNUM.Row > 0 Then
 If gridPEKD_USEDNUM.RowIndex(gridPEKD_USEDNUM.Row) > 0 Then
    ...
    bm = gridPEKD_USEDNUM.RowBookmark(gridPEKD_USEDNUM.RowIndex(gridPEKD_USEDNUM.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKD_USEDNUM_.Item = u
again:     frmPEKD_USEDNUM_.NotFirstTime = False
    frmPEKD_USEDNUM_.OnInit
    frmPEKD_USEDNUM_.Show vbModal
    If frmPEKD_USEDNUM_.OK Then
    On Error Resume Next
    err.Clear
    u.Save
