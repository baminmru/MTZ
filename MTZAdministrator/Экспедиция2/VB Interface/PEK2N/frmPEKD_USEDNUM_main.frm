VERSION 5.00
Begin VB.Form frmPEKD_USEDNUM_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Занятые номера"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Занятые номера"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2NGUI.PEKD_USEDNUMmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKD_USEDNUM_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{817C66B9-0735-419A-A370-72B779A9C6F7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{817C66B9-0735-419A-A370-72B779A9C6F7}"
  Open s & Me.Name & "{817C66B9-0735-419A-A370-72B779A9C6F7}" For Output As #ff
