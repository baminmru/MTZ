VERSION 5.00
Begin VB.Form frmPEKD_NZONE_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Зоны номеров ППО"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Зоны номеров ППО"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2NGUI.PEKD_NZONEmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKD_NZONE_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3395FB44-D0C0-4A5A-9245-136BD3C697B4}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3395FB44-D0C0-4A5A-9245-136BD3C697B4}"
  Open s & Me.Name & "{3395FB44-D0C0-4A5A-9245-136BD3C697B4}" For Output As #ff
