VERSION 5.00
Begin VB.UserControl vpnPEKD_NZONE_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKD_NZONE 
      ...
      Begin VB.CommandButton cmdPEKD_NZONESave 
         ...
         Width           =   330
      End
      Begin PEK2NGUI.PEKD_NZONEmain editPEKD_NZONE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnPEKD_NZONE_main"
...
Private Sub opPEKD_NZONE_UpdateItemName_main(RowItem As Object)
With RowItem
...
Private Sub cmdPEKD_NZONECfg_Click()
    ...
    Dim ff As Long
    ff = FreeFile
    Open GetSetting("MTZ", "CONFIG", "LAYOUTS", "c:\") & "PEK2N_editPEKD_NZONE_main" For Output As #ff
...
Private Sub cmdPEKD_NZONESave_Click()
  ...
  On Error GoTo bye
    ...
    MousePointer = vbNormal
        opPEKD_NZONE_UpdateItemName_main editPEKD_NZONE.Item
    cmdPEKD_NZONESave.Enabled = False
    Else
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  ff = FreeFile
  On Error Resume Next
  Open GetSetting("MTZ", "CONFIG", "LAYOUTS", App.Path & "\LAYOUTS\") & "PEK2N_editPEKD_NZONE_main" For Input As #ff
  buf = ""
  buf = Input(LOF(ff), ff)
  Close #ff
