...
Begin VB.UserControl vpnPEKRKO_1CLINK_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKRKO_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKRKO_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKRKO_1CLINK_main.ctx":0000
         Column(2)       =   "vpnPEKRKO_1CLINK_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKRKO_1CLINK_main.ctx":016C
         FormatStyle(2)  =   "vpnPEKRKO_1CLINK_main.ctx":02C8
         FormatStyle(3)  =   "vpnPEKRKO_1CLINK_main.ctx":0378
         FormatStyle(4)  =   "vpnPEKRKO_1CLINK_main.ctx":042C
         FormatStyle(5)  =   "vpnPEKRKO_1CLINK_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKRKO_1CLINK_main.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKRKO_1CLINK_main"
...
If gridPEKRKO_1CLINK.Row > 0 Then
 If gridPEKRKO_1CLINK.RowIndex(gridPEKRKO_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKRKO_1CLINK.RowBookmark(gridPEKRKO_1CLINK.RowIndex(gridPEKRKO_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKRKO_1CLINK_main.item = u
again:     frmPEKRKO_1CLINK_main.NotFirstTime = False
    frmPEKRKO_1CLINK_main.OnInit
    frmPEKRKO_1CLINK_main.Show vbModal
    If frmPEKRKO_1CLINK_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
