VERSION 5.00
Begin VB.Form frmPEKRKO_ROWS_read 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Разбивка стоимости возврата наличных по филиалам"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2RKOGUI.PEKRKO_ROWSread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKRKO_ROWS_read"
