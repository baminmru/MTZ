VERSION 5.00
Begin VB.Form frmPEKRKO_1CLINK_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Раздел для хранения информации о привязки к 1С на уровне филиала"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2RKOGUI.PEKRKO_1CLINKmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKRKO_1CLINK_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2C6F0150-C13B-43C8-A46E-AFDC32A8FD51}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2C6F0150-C13B-43C8-A46E-AFDC32A8FD51}"
  Open s & Me.Name & "{2C6F0150-C13B-43C8-A46E-AFDC32A8FD51}" For Output As #ff
