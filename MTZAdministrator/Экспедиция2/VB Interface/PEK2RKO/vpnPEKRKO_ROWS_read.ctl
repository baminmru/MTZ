...
Begin VB.UserControl vpnPEKRKO_ROWS_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKRKO_ROWS 
      ...
      Begin GridEX20.GridEX gridPEKRKO_ROWS 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKRKO_ROWS_read.ctx":0000
         Column(2)       =   "vpnPEKRKO_ROWS_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKRKO_ROWS_read.ctx":016C
         FormatStyle(2)  =   "vpnPEKRKO_ROWS_read.ctx":02C8
         FormatStyle(3)  =   "vpnPEKRKO_ROWS_read.ctx":0378
         FormatStyle(4)  =   "vpnPEKRKO_ROWS_read.ctx":042C
         FormatStyle(5)  =   "vpnPEKRKO_ROWS_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKRKO_ROWS_read.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKRKO_ROWS_read"
