VERSION 5.00
Begin VB.Form frmPEKRKO_DEF_read 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Раздел описывает факт возварта наличных из кассы"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2RKOGUI.PEKRKO_DEFread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKRKO_DEF_read"
