VERSION 5.00
Begin VB.Form frmPEKP_PZ_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Заявки к платежному поручению"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "привязка заявок к платежному поручению"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2PGUI.PEKP_PZmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKP_PZ_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{02AD883E-7C7D-433C-8647-E0E5D13C781F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{02AD883E-7C7D-433C-8647-E0E5D13C781F}"
  Open s & Me.Name & "{02AD883E-7C7D-433C-8647-E0E5D13C781F}" For Output As #ff
