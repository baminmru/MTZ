...
Begin VB.UserControl vpnPEKP_PZ_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKP_PZ 
      ...
      Begin GridEX20.GridEX gridPEKP_PZ 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKP_PZ_main.ctx":0000
         Column(2)       =   "vpnPEKP_PZ_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKP_PZ_main.ctx":016C
         FormatStyle(2)  =   "vpnPEKP_PZ_main.ctx":02C8
         FormatStyle(3)  =   "vpnPEKP_PZ_main.ctx":0378
         FormatStyle(4)  =   "vpnPEKP_PZ_main.ctx":042C
         FormatStyle(5)  =   "vpnPEKP_PZ_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKP_PZ_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKP_PZ_main"
...
If gridPEKP_PZ.Row > 0 Then
 If gridPEKP_PZ.RowIndex(gridPEKP_PZ.Row) > 0 Then
    ...
    bm = gridPEKP_PZ.RowBookmark(gridPEKP_PZ.RowIndex(gridPEKP_PZ.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKP_PZ_main.Item = u
again:     frmPEKP_PZ_main.NotFirstTime = False
    frmPEKP_PZ_main.OnInit
    frmPEKP_PZ_main.Show vbModal
    If frmPEKP_PZ_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
