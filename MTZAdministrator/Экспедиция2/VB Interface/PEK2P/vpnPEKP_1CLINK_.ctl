...
Begin VB.UserControl vpnPEKP_1CLINK_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKP_1CLINK 
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdPEKP_1CLINKAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdPEKP_1CLINKFnd 
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdPEKP_1CLINKCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin GridEX20.GridEX gridPEKP_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKP_1CLINK_.ctx":0000
         Column(2)       =   "vpnPEKP_1CLINK_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKP_1CLINK_.ctx":016C
         FormatStyle(2)  =   "vpnPEKP_1CLINK_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKP_1CLINK_.ctx":0378
         FormatStyle(4)  =   "vpnPEKP_1CLINK_.ctx":042C
         FormatStyle(5)  =   "vpnPEKP_1CLINK_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKP_1CLINK_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdPEKP_1CLINKRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
   ...
   Begin VB.Menu mnuPopupPEKP_1CLINK 
      ...
      Begin VB.Menu mnuPEKP_1CLINKRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuPEKP_1CLINKS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuPEKP_1CLINKBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuPEKP_1CLINKCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuPEKP_1CLINKCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuPEKP_1CLINKPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuPEKP_1CLINKCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuPEKP_1CLINKCLEAN 
            Caption         =   "Очистить"
         End
      End
      ...
      Begin VB.Menu mnuPEKP_1CLINKCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuPEKP_1CLINKFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuPEKP_1CLINKAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnPEKP_1CLINK_"
...
If gridPEKP_1CLINK.Row > 0 Then
 If gridPEKP_1CLINK.RowIndex(gridPEKP_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKP_1CLINK.RowBookmark(gridPEKP_1CLINK.RowIndex(gridPEKP_1CLINK.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKP_1CLINK_.Item = u
again:     frmPEKP_1CLINK_.NotFirstTime = False
    frmPEKP_1CLINK_.OnInit
    frmPEKP_1CLINK_.Show vbModal
    If frmPEKP_1CLINK_.OK Then
    On Error Resume Next
    err.Clear
    u.Save
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  LoadBtnPictures cmdPEKP_1CLINKRun, cmdPEKP_1CLINKRun.Tag
  LoadBtnPictures cmdPEKP_1CLINKAcc, cmdPEKP_1CLINKAcc.Tag
  LoadBtnPictures cmdPEKP_1CLINKCfg, cmdPEKP_1CLINKCfg.Tag
