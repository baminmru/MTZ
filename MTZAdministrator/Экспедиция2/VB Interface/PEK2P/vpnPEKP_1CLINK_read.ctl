...
Begin VB.UserControl vpnPEKP_1CLINK_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKP_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKP_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKP_1CLINK_read.ctx":0000
         Column(2)       =   "vpnPEKP_1CLINK_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKP_1CLINK_read.ctx":016C
         FormatStyle(2)  =   "vpnPEKP_1CLINK_read.ctx":02C8
         FormatStyle(3)  =   "vpnPEKP_1CLINK_read.ctx":0378
         FormatStyle(4)  =   "vpnPEKP_1CLINK_read.ctx":042C
         FormatStyle(5)  =   "vpnPEKP_1CLINK_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKP_1CLINK_read.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKP_1CLINK_read"
...
If gridPEKP_1CLINK.Row > 0 Then
 If gridPEKP_1CLINK.RowIndex(gridPEKP_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKP_1CLINK.RowBookmark(gridPEKP_1CLINK.RowIndex(gridPEKP_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKP_1CLINK_read.item = u
again:     frmPEKP_1CLINK_read.NotFirstTime = False
    frmPEKP_1CLINK_read.OnInit
    frmPEKP_1CLINK_read.Show vbModal
    If frmPEKP_1CLINK_read.OK Then
    On Error Resume Next
    err.Clear
    u.Save
