VERSION 5.00
Begin VB.Form frmPEKP_1CLINK_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2PGUI.PEKP_1CLINKmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKP_1CLINK_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{538EA93B-107B-4ECA-96DB-4A2A6772340C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{538EA93B-107B-4ECA-96DB-4A2A6772340C}"
  Open s & Me.Name & "{538EA93B-107B-4ECA-96DB-4A2A6772340C}" For Output As #ff
