VERSION 5.00
Begin VB.Form frmPEKP_DEF_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание платежа"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание платежа"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2PGUI.PEKP_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKP_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{65AD8B18-2C3C-4E33-B115-0DF27710DCFD}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{65AD8B18-2C3C-4E33-B115-0DF27710DCFD}"
  Open s & Me.Name & "{65AD8B18-2C3C-4E33-B115-0DF27710DCFD}" For Output As #ff
