VERSION 5.00
Begin VB.Form frmPEKTRF_REGALL_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Регресс по общему весу"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Регресс по общему весу"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2TRFGUI.PEKTRF_REGALLread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKTRF_REGALL_read"
