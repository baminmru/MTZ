VERSION 5.00
Begin VB.Form frmPEKTRF_AUTO_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Автодоставка"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Стоимость автодоставки груза"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2TRFGUI.PEKTRF_AUTOread Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKTRF_AUTO_read"
