...
Begin VB.UserControl vpnPEKTRF_TR_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlPEKTRF_TR 
      ...
      Begin GridEX20.GridEX gridPEKTRF_REGRTR 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKTRF_TR_read.ctx":0000
         Column(2)       =   "vpnPEKTRF_TR_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKTRF_TR_read.ctx":016C
         FormatStyle(2)  =   "vpnPEKTRF_TR_read.ctx":02C8
         FormatStyle(3)  =   "vpnPEKTRF_TR_read.ctx":0378
         FormatStyle(4)  =   "vpnPEKTRF_TR_read.ctx":042C
         FormatStyle(5)  =   "vpnPEKTRF_TR_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKTRF_TR_read.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridPEKTRF_TR 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKTRF_TR_read.ctx":0794
         Column(2)       =   "vpnPEKTRF_TR_read.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKTRF_TR_read.ctx":0900
         FormatStyle(2)  =   "vpnPEKTRF_TR_read.ctx":0A5C
         FormatStyle(3)  =   "vpnPEKTRF_TR_read.ctx":0B0C
         FormatStyle(4)  =   "vpnPEKTRF_TR_read.ctx":0BC0
         FormatStyle(5)  =   "vpnPEKTRF_TR_read.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnPEKTRF_TR_read.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKTRF_TR_read"
