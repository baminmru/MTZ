VERSION 5.00
Begin VB.Form frmPEKTRF_SRV_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Тарифы на услуги"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Тарифы на услуги"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2TRFGUI.PEKTRF_SRVmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKTRF_SRV_main"
