...
Begin VB.UserControl PEKTRF_DECRmain 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin MSMask.MaskEdBox txtDecrPercent 
         Height          =   300
         Left            =   300
         TabIndex        =   4
         ToolTipText     =   "Процент к тарифу"
         Top             =   1110
         Width           =   1800
         _ExtentX        =   3175
         _ExtentY        =   529
      ...
      Begin VB.TextBox txtName 
         ...
         MaxLength       =   255
         TabIndex        =   2
         ToolTipText     =   "Название скидки"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblDecrPercent 
         BackStyle       =   0  'Transparent
         Caption         =   "Процент к тарифу:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "PEKTRF_DECRmain"
...
If txtDecrPercent.Text <> "" Then
 On Error Resume Next
  ...
  ElseIf Val(txtDecrPercent.Text) < -922337203685478# Or Val(txtDecrPercent.Text) > 922337203685478# Then
     cancel = True
