...
Begin VB.UserControl vpnPEKTRF_SRV_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKTRF_SRV 
      ...
      Begin GridEX20.GridEX gridPEKTRF_SRV 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKTRF_SRV_main.ctx":0000
         Column(2)       =   "vpnPEKTRF_SRV_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKTRF_SRV_main.ctx":016C
         FormatStyle(2)  =   "vpnPEKTRF_SRV_main.ctx":02C8
         FormatStyle(3)  =   "vpnPEKTRF_SRV_main.ctx":0378
         FormatStyle(4)  =   "vpnPEKTRF_SRV_main.ctx":042C
         FormatStyle(5)  =   "vpnPEKTRF_SRV_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKTRF_SRV_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKTRF_SRV_main"
