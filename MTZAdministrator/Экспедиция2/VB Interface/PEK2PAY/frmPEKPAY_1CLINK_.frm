VERSION 5.00
Begin VB.Form frmPEKPAY_1CLINK_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2PAYGUI.PEKPAY_1CLINK Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKPAY_1CLINK_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{40E43A2C-5FB0-4F28-8AF5-50DF19A59BEF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{40E43A2C-5FB0-4F28-8AF5-50DF19A59BEF}"
  Open s & Me.Name & "{40E43A2C-5FB0-4F28-8AF5-50DF19A59BEF}" For Output As #ff
