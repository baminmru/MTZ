...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2PAYGUI.vpnPEKPAY_DEF_main pnlPEKPAY_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlPEKPAY_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlPEKPAY_DEF.Visible = False
   ...
   Case "PEKPAY_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlPEKPAY_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "PEKPAY_DEF"
pnlPEKPAY_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "PEK2PAY", "ctlmain_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlPEKPAY_DEF.CloseClass
End Sub
Public Sub OnSave()
 pnlPEKPAY_DEF.OnSave
End Sub
Public Function IsChanged() As Boolean
  Dim m_IsChanged As Boolean
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlPEKPAY_DEF.IsChanged
