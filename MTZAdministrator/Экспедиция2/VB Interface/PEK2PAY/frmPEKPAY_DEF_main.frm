VERSION 5.00
Begin VB.Form frmPEKPAY_DEF_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Докумен для учета внутренних затрат"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2PAYGUI.PEKPAY_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKPAY_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2A7C4574-FE88-44DF-93F5-D7E7AC5FA01D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2A7C4574-FE88-44DF-93F5-D7E7AC5FA01D}"
  Open s & Me.Name & "{2A7C4574-FE88-44DF-93F5-D7E7AC5FA01D}" For Output As #ff
