VERSION 5.00
Begin VB.UserControl vpnPEKPAY_DEF_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKPAY_DEF 
      ...
      Begin VB.CommandButton cmdPEKPAY_DEFSave 
         ...
         Width           =   330
      End
      Begin PEK2PAYGUI.PEKPAY_DEFmain editPEKPAY_DEF 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
   ...
   End
End
Attribute VB_Name = "vpnPEKPAY_DEF_main"
...
Private Sub cmdPEKPAY_DEFCfg_Click()
    ...
    Dim ff As Long
    ff = FreeFile
    Open GetSetting("MTZ", "CONFIG", "LAYOUTS", "c:\") & "PEK2PAY_editPEKPAY_DEF_main" For Output As #ff
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  ff = FreeFile
  On Error Resume Next
  Open GetSetting("MTZ", "CONFIG", "LAYOUTS", App.Path & "\LAYOUTS\") & "PEK2PAY_editPEKPAY_DEF_main" For Input As #ff
  buf = ""
  buf = Input(LOF(ff), ff)
  Close #ff
