...
Begin VB.Form frmPEKPQ_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание требования на оплату"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2PQGUI.PEKPQ_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKPQ_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DE9080CB-1749-426B-9B80-0FE645843FAF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DE9080CB-1749-426B-9B80-0FE645843FAF}"
  Open s & Me.Name & "{DE9080CB-1749-426B-9B80-0FE645843FAF}" For Output As #ff
