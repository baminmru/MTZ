VERSION 5.00
Begin VB.Form frmPEKPQ_1CLINK_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2PQGUI.PEKPQ_1CLINK Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKPQ_1CLINK_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4EC75098-EAC9-48A6-AB63-F05766B5495E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4EC75098-EAC9-48A6-AB63-F05766B5495E}"
  Open s & Me.Name & "{4EC75098-EAC9-48A6-AB63-F05766B5495E}" For Output As #ff
