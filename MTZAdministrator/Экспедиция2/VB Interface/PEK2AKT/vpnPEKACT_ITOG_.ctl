...
Begin VB.UserControl vpnPEKACT_ITOG_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKACT_ITOG 
      ...
      Begin GridEX20.GridEX gridPEKACT_ITOG 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKACT_ITOG_.ctx":0000
         Column(2)       =   "vpnPEKACT_ITOG_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKACT_ITOG_.ctx":016C
         FormatStyle(2)  =   "vpnPEKACT_ITOG_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKACT_ITOG_.ctx":0378
         FormatStyle(4)  =   "vpnPEKACT_ITOG_.ctx":042C
         FormatStyle(5)  =   "vpnPEKACT_ITOG_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKACT_ITOG_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKACT_ITOG_"
