...
Begin VB.UserControl vpnPEKACT_1CLINK_fill 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKACT_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKACT_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKACT_1CLINK_fill.ctx":0000
         Column(2)       =   "vpnPEKACT_1CLINK_fill.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKACT_1CLINK_fill.ctx":016C
         FormatStyle(2)  =   "vpnPEKACT_1CLINK_fill.ctx":02C8
         FormatStyle(3)  =   "vpnPEKACT_1CLINK_fill.ctx":0378
         FormatStyle(4)  =   "vpnPEKACT_1CLINK_fill.ctx":042C
         FormatStyle(5)  =   "vpnPEKACT_1CLINK_fill.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKACT_1CLINK_fill.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKACT_1CLINK_fill"
...
If gridPEKACT_1CLINK.Row > 0 Then
 If gridPEKACT_1CLINK.RowIndex(gridPEKACT_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKACT_1CLINK.RowBookmark(gridPEKACT_1CLINK.RowIndex(gridPEKACT_1CLINK.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKACT_1CLINK_fill.Item = u
again:     frmPEKACT_1CLINK_fill.NotFirstTime = False
    frmPEKACT_1CLINK_fill.OnInit
    frmPEKACT_1CLINK_fill.Show vbModal
    If frmPEKACT_1CLINK_fill.OK Then
    On Error Resume Next
    err.Clear
    u.Save
