...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2AKTGUI.vpnPEKACT_DEF_main pnlPEKACT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2AKTGUI.vpnPEKACT_LINES_main pnlPEKACT_LINES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2AKTGUI.vpnPEKACT_ITOG_main pnlPEKACT_ITOG 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2AKTGUI.vpnPEKACT_1CLINK_main pnlPEKACT_1CLINK 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
...
pnlPEKACT_1CLINK.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "PEK2AKT", "ctlmain_main"
