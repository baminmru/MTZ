...
Begin VB.UserControl ctlfill_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2AKTGUI.vpnPEKACT_DEF_fill pnlPEKACT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2AKTGUI.vpnPEKACT_LINES_fill pnlPEKACT_LINES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2AKTGUI.vpnPEKACT_ITOG_fill pnlPEKACT_ITOG 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2AKTGUI.vpnPEKACT_1CLINK_fill pnlPEKACT_1CLINK 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
   ...
   End
End
Attribute VB_Name = "ctlfill_main"
...
pnlPEKACT_1CLINK.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "PEK2AKT", "ctlfill_main"
