VERSION 5.00
Begin VB.Form frmPEKACT_ITOG_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Итоги по акту"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Подводятся итоги по акту в разрезе услуг"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2AKTGUI.PEKACT_ITOGmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKACT_ITOG_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{6B13403B-C0B8-4833-A2FC-4CDC3915E3BB}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{6B13403B-C0B8-4833-A2FC-4CDC3915E3BB}"
  Open s & Me.Name & "{6B13403B-C0B8-4833-A2FC-4CDC3915E3BB}" For Output As #ff
