VERSION 5.00
Begin VB.Form frmPEKACT_1CLINK_fill 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2AKTGUI.PEKACT_1CLINKfill Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKACT_1CLINK_fill"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E9BF27D7-B04D-4F9E-B0D1-5E70B2ADA701}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E9BF27D7-B04D-4F9E-B0D1-5E70B2ADA701}"
  Open s & Me.Name & "{E9BF27D7-B04D-4F9E-B0D1-5E70B2ADA701}" For Output As #ff
