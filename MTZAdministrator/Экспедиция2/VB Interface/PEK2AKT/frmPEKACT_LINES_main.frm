VERSION 5.00
Begin VB.Form frmPEKACT_LINES_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Строки акта сверки "
      Top             =   6225
      Width           =   825
   End
   Begin PEK2AKTGUI.PEKACT_LINESmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKACT_LINES_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{168442AA-649B-422B-BD08-BB641F1C4902}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{168442AA-649B-422B-BD08-BB641F1C4902}"
  Open s & Me.Name & "{168442AA-649B-422B-BD08-BB641F1C4902}" For Output As #ff
