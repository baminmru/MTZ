...
Begin VB.UserControl PEKSH_START 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin MSComCtl2.DTPicker dtpStartTime 
         ...
         CurrentDate     =   39500
      End
      Begin VB.TextBox txtDayInYear 
         Height          =   300
         Left            =   300
         MaxLength       =   15
         TabIndex        =   2
         ToolTipText     =   "Номер дня в году"
         Top             =   405
         Width           =   1800
      End
      Begin VB.Label lblStartTime 
         ...
         Width           =   3000
      End
      Begin VB.Label lblDayInYear 
         BackStyle       =   0  'Transparent
         Caption         =   "Номер дня в году:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   1
