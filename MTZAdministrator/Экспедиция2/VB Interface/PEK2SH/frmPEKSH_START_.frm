VERSION 5.00
Begin VB.Form frmPEKSH_START_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "День и время отправления"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "День и время отправления"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2SHGUI.PEKSH_START Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKSH_START_"
