VERSION 5.00
Begin VB.Form frmPEKL_WDAY_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Стандартные лимиты"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Стандартные лимиты"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2LGUI.PEKL_WDAY Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKL_WDAY_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{58524CA6-771E-409D-B636-4A6056CF49D7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{58524CA6-771E-409D-B636-4A6056CF49D7}"
  Open s & Me.Name & "{58524CA6-771E-409D-B636-4A6056CF49D7}" For Output As #ff
