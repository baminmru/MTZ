...
Begin VB.UserControl PEKL_DEF 
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin MSComCtl2.DTPicker dtpToDate 
         ...
         Left            =   300
         TabIndex        =   7
         ToolTipText     =   "Окончание действия"
         Top             =   1815
         Width           =   1800
         _ExtentX        =   3175
         _ExtentY        =   529
      ...
      Begin MSComCtl2.DTPicker dtpFromDate 
         ...
         CurrentDate     =   39500
      End
      Begin MTZ_PANEL.DropButton cmdTheDep 
         Height          =   300
         Left            =   2850
         TabIndex        =   3
         Tag             =   "refopen.ico"
...
If mIsOK Then mIsOK = IsSet(dtpFromDate.Value)
  IsOK = mIsOK
End Function
...
dtpFromDate = Date
If Item.FromDate <> 0 Then
 dtpFromDate = Item.FromDate
End If
dtpToDate = Date
If Item.ToDate <> 0 Then
 dtpToDate = Item.ToDate
Else
...
End If
  If IsNull(dtpFromDate) Then
    Item.FromDate = 0
  Else
    Item.FromDate = dtpFromDate.Value
  End If
  If IsNull(dtpToDate) Then
    Item.ToDate = 0
  Else
