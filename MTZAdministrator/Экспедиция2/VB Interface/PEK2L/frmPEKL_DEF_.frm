VERSION 5.00
Begin VB.Form frmPEKL_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание лимитов"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание лимитов"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2LGUI.PEKL_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKL_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E05D9E7C-AD82-4843-A9E7-3508BE9A0ABE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E05D9E7C-AD82-4843-A9E7-3508BE9A0ABE}"
  Open s & Me.Name & "{E05D9E7C-AD82-4843-A9E7-3508BE9A0ABE}" For Output As #ff
