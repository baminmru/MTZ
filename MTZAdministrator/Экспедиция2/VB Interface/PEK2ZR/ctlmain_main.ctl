...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2ZRGUI.vpnPEKZR_DATA_main pnlPEKZR_DATA 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlPEKZR_DATA.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlPEKZR_DATA.Visible = False
   ...
   Case "PEKZR_DATA"
     ...
     .Visible = True
     .ZOrder 0
     pnlPEKZR_DATA.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Z-Отчет"
ts.Tabs.Item(1).Key = "PEKZR_DATA"
pnlPEKZR_DATA.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "PEK2ZR", "ctlmain_main"
...
Private Sub UserControl_Terminate()
 ...
 pnlPEKZR_DATA.CloseClass
End Sub
Public Sub OnSave()
 pnlPEKZR_DATA.OnSave
End Sub
Public Function IsChanged() As Boolean
  Dim m_IsChanged As Boolean
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlPEKZR_DATA.IsChanged
