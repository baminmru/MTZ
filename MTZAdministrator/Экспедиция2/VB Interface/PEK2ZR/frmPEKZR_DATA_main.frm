VERSION 5.00
Begin VB.Form frmPEKZR_DATA_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Данные ежедневного Z отчета"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZRGUI.PEKZR_DATAmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKZR_DATA_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{EF5A3509-86CD-4851-914D-583FD5F24B42}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{EF5A3509-86CD-4851-914D-583FD5F24B42}"
  Open s & Me.Name & "{EF5A3509-86CD-4851-914D-583FD5F24B42}" For Output As #ff
