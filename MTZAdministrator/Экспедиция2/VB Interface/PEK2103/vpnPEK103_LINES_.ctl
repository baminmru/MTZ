...
Begin VB.UserControl vpnPEK103_LINES_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEK103_LINES 
      ...
      Begin GridEX20.GridEX gridPEK103_LINES 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEK103_LINES_.ctx":0000
         Column(2)       =   "vpnPEK103_LINES_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEK103_LINES_.ctx":016C
         FormatStyle(2)  =   "vpnPEK103_LINES_.ctx":02C8
         FormatStyle(3)  =   "vpnPEK103_LINES_.ctx":0378
         FormatStyle(4)  =   "vpnPEK103_LINES_.ctx":042C
         FormatStyle(5)  =   "vpnPEK103_LINES_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEK103_LINES_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEK103_LINES_"
...
If gridPEK103_LINES.Row > 0 Then
 If gridPEK103_LINES.RowIndex(gridPEK103_LINES.Row) > 0 Then
    ...
    bm = gridPEK103_LINES.RowBookmark(gridPEK103_LINES.RowIndex(gridPEK103_LINES.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEK103_LINES_.Item = u
again:     frmPEK103_LINES_.NotFirstTime = False
    frmPEK103_LINES_.OnInit
    frmPEK103_LINES_.Show vbModal
    If frmPEK103_LINES_.OK Then
    On Error Resume Next
    err.Clear
    u.Save
