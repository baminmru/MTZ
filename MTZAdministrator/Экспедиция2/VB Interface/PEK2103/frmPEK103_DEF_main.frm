VERSION 5.00
Begin VB.Form frmPEK103_DEF_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание формы"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2103GUI.PEK103_DEFmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEK103_DEF_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0EF68BE0-624A-4F45-9D02-22745AD0C122}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0EF68BE0-624A-4F45-9D02-22745AD0C122}"
  Open s & Me.Name & "{0EF68BE0-624A-4F45-9D02-22745AD0C122}" For Output As #ff
