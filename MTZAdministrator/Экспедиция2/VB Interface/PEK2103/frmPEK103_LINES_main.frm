VERSION 5.00
Begin VB.Form frmPEK103_LINES_main 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Cтроки формы"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Cтроки формы"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2103GUI.PEK103_LINESmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEK103_LINES_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{41131614-5003-4A8C-8DEC-6D3D73FE4112}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{41131614-5003-4A8C-8DEC-6D3D73FE4112}"
  Open s & Me.Name & "{41131614-5003-4A8C-8DEC-6D3D73FE4112}" For Output As #ff
