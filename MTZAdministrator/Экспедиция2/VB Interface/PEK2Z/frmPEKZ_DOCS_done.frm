VERSION 5.00
Begin VB.Form frmPEKZ_DOCS_done 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Почтовые документы"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Почтовые документы"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.PEKZ_DOCSdone Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKZ_DOCS_done"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8B2126CF-AF9C-40B8-A1C9-10E0E7596823}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8B2126CF-AF9C-40B8-A1C9-10E0E7596823}"
  Open s & Me.Name & "{8B2126CF-AF9C-40B8-A1C9-10E0E7596823}" For Output As #ff
