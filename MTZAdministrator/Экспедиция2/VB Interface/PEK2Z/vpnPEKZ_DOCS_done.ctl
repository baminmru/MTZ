...
Begin VB.UserControl vpnPEKZ_DOCS_done 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKZ_DOCS 
      ...
      Begin GridEX20.GridEX gridPEKZ_DOCS 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKZ_DOCS_done.ctx":0000
         Column(2)       =   "vpnPEKZ_DOCS_done.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKZ_DOCS_done.ctx":016C
         FormatStyle(2)  =   "vpnPEKZ_DOCS_done.ctx":02C8
         FormatStyle(3)  =   "vpnPEKZ_DOCS_done.ctx":0378
         FormatStyle(4)  =   "vpnPEKZ_DOCS_done.ctx":042C
         FormatStyle(5)  =   "vpnPEKZ_DOCS_done.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKZ_DOCS_done.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKZ_DOCS_done"
...
Private Sub opPEKZ_DOCS_openRef_done(RowItem As Object)
With RowItem
...
If gridPEKZ_DOCS.Row > 0 Then
 If gridPEKZ_DOCS.RowIndex(gridPEKZ_DOCS.Row) > 0 Then
    ...
    bm = gridPEKZ_DOCS.RowBookmark(gridPEKZ_DOCS.RowIndex(gridPEKZ_DOCS.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKZ_DOCS_done.item = u
again:     frmPEKZ_DOCS_done.NotFirstTime = False
    frmPEKZ_DOCS_done.OnInit
    frmPEKZ_DOCS_done.Show vbModal
    If frmPEKZ_DOCS_done.OK Then
    On Error Resume Next
    err.Clear
    u.Save
