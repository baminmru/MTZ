...
Begin VB.UserControl vpnpekz_dop_prnt 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlpekz_dop 
      ...
      Begin GridEX20.GridEX gridpekz_dop 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnpekz_dop_prnt.ctx":0000
         Column(2)       =   "vpnpekz_dop_prnt.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnpekz_dop_prnt.ctx":016C
         FormatStyle(2)  =   "vpnpekz_dop_prnt.ctx":02C8
         FormatStyle(3)  =   "vpnpekz_dop_prnt.ctx":0378
         FormatStyle(4)  =   "vpnpekz_dop_prnt.ctx":042C
         FormatStyle(5)  =   "vpnpekz_dop_prnt.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnpekz_dop_prnt.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnpekz_dop_prnt"
...
If gridpekz_dop.Row > 0 Then
 If gridpekz_dop.RowIndex(gridpekz_dop.Row) > 0 Then
    ...
    bm = gridpekz_dop.RowBookmark(gridpekz_dop.RowIndex(gridpekz_dop.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmpekz_dop_prnt.item = u
again:     frmpekz_dop_prnt.NotFirstTime = False
    frmpekz_dop_prnt.OnInit
    frmpekz_dop_prnt.Show vbModal
    If frmpekz_dop_prnt.OK Then
    On Error Resume Next
    err.Clear
    u.Save
