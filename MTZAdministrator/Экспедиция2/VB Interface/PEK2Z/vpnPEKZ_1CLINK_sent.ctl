...
Begin VB.UserControl vpnPEKZ_1CLINK_sent 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKZ_1CLINK 
      ...
      Begin GridEX20.GridEX gridPEKZ_1CLINK 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKZ_1CLINK_sent.ctx":0000
         Column(2)       =   "vpnPEKZ_1CLINK_sent.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKZ_1CLINK_sent.ctx":016C
         FormatStyle(2)  =   "vpnPEKZ_1CLINK_sent.ctx":02C8
         FormatStyle(3)  =   "vpnPEKZ_1CLINK_sent.ctx":0378
         FormatStyle(4)  =   "vpnPEKZ_1CLINK_sent.ctx":042C
         FormatStyle(5)  =   "vpnPEKZ_1CLINK_sent.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKZ_1CLINK_sent.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKZ_1CLINK_sent"
...
If gridPEKZ_1CLINK.Row > 0 Then
 If gridPEKZ_1CLINK.RowIndex(gridPEKZ_1CLINK.Row) > 0 Then
    ...
    bm = gridPEKZ_1CLINK.RowBookmark(gridPEKZ_1CLINK.RowIndex(gridPEKZ_1CLINK.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKZ_1CLINK_sent.item = u
again:     frmPEKZ_1CLINK_sent.NotFirstTime = False
    frmPEKZ_1CLINK_sent.OnInit
    frmPEKZ_1CLINK_sent.Show vbModal
    If frmPEKZ_1CLINK_sent.OK Then
    On Error Resume Next
    err.Clear
    u.Save
