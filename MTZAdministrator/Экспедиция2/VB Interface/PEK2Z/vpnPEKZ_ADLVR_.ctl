...
Begin VB.UserControl vpnPEKZ_ADLVR_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKZ_ADLVR 
      ...
      Begin GridEX20.GridEX gridPEKZ_ADLVR 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKZ_ADLVR_.ctx":0000
         Column(2)       =   "vpnPEKZ_ADLVR_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKZ_ADLVR_.ctx":016C
         FormatStyle(2)  =   "vpnPEKZ_ADLVR_.ctx":02C8
         FormatStyle(3)  =   "vpnPEKZ_ADLVR_.ctx":0378
         FormatStyle(4)  =   "vpnPEKZ_ADLVR_.ctx":042C
         FormatStyle(5)  =   "vpnPEKZ_ADLVR_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKZ_ADLVR_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnPEKZ_ADLVR_"
...
If gridPEKZ_ADLVR.Row > 0 Then
 If gridPEKZ_ADLVR.RowIndex(gridPEKZ_ADLVR.Row) > 0 Then
    ...
    bm = gridPEKZ_ADLVR.RowBookmark(gridPEKZ_ADLVR.RowIndex(gridPEKZ_ADLVR.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmPEKZ_ADLVR_.item = u
again:     frmPEKZ_ADLVR_.NotFirstTime = False
    frmPEKZ_ADLVR_.OnInit
    frmPEKZ_ADLVR_.Show vbModal
    If frmPEKZ_ADLVR_.OK Then
    On Error Resume Next
    err.Clear
    u.Save
