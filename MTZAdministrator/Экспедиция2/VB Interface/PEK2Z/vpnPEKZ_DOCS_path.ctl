...
Begin VB.UserControl vpnPEKZ_DOCS_path 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlPEKZ_DOCS 
      ...
      Begin GridEX20.GridEX gridPEKZ_DOCS 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnPEKZ_DOCS_path.ctx":0000
         Column(2)       =   "vpnPEKZ_DOCS_path.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnPEKZ_DOCS_path.ctx":016C
         FormatStyle(2)  =   "vpnPEKZ_DOCS_path.ctx":02C8
         FormatStyle(3)  =   "vpnPEKZ_DOCS_path.ctx":0378
         FormatStyle(4)  =   "vpnPEKZ_DOCS_path.ctx":042C
         FormatStyle(5)  =   "vpnPEKZ_DOCS_path.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnPEKZ_DOCS_path.ctx":05BC
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnPEKZ_DOCS_path"
...
Private Sub opPEKZ_DOCS_openRef_path(RowItem As Object)
With RowItem
