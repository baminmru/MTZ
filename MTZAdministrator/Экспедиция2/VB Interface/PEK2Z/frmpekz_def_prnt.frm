VERSION 5.00
Begin VB.Form frmpekz_def_prnt 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание заявки"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Раздел описывает основные данные о заявке."
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.pekz_defprnt Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmpekz_def_prnt"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A5EBEF40-AD30-4E66-BC35-8697C1E3B251}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A5EBEF40-AD30-4E66-BC35-8697C1E3B251}"
  Open s & Me.Name & "{A5EBEF40-AD30-4E66-BC35-8697C1E3B251}" For Output As #ff
