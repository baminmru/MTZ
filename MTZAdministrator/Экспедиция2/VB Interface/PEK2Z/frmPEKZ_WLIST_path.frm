VERSION 5.00
Begin VB.Form frmPEKZ_WLIST_path 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Весовой список ППО"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Весовой список ППО"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.PEKZ_WLISTpath Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKZ_WLIST_path"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{934B083E-98B2-4029-A3AC-58BCEE2A9D91}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{934B083E-98B2-4029-A3AC-58BCEE2A9D91}"
  Open s & Me.Name & "{934B083E-98B2-4029-A3AC-58BCEE2A9D91}" For Output As #ff
