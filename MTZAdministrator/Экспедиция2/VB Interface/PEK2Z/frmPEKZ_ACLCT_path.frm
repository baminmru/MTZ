VERSION 5.00
Begin VB.Form frmPEKZ_ACLCT_path 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Сбор груза для отправки автотранспортом"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.PEKZ_ACLCTpath Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKZ_ACLCT_path"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{CF2E37C6-EDBE-4107-A2B0-AD3841BFABCF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{CF2E37C6-EDBE-4107-A2B0-AD3841BFABCF}"
  Open s & Me.Name & "{CF2E37C6-EDBE-4107-A2B0-AD3841BFABCF}" For Output As #ff
