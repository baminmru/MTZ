...
Begin VB.UserControl vpnpekz_path_read 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlpekz_path 
      ...
      Begin GridEX20.GridEX gridPEKZ_WLIST 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnpekz_path_read.ctx":0000
         Column(2)       =   "vpnpekz_path_read.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnpekz_path_read.ctx":016C
         FormatStyle(2)  =   "vpnpekz_path_read.ctx":02C8
         FormatStyle(3)  =   "vpnpekz_path_read.ctx":0378
         FormatStyle(4)  =   "vpnpekz_path_read.ctx":042C
         FormatStyle(5)  =   "vpnpekz_path_read.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnpekz_path_read.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridpekz_path 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnpekz_path_read.ctx":0794
         Column(2)       =   "vpnpekz_path_read.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnpekz_path_read.ctx":0900
         FormatStyle(2)  =   "vpnpekz_path_read.ctx":0A5C
         FormatStyle(3)  =   "vpnpekz_path_read.ctx":0B0C
         FormatStyle(4)  =   "vpnpekz_path_read.ctx":0BC0
         FormatStyle(5)  =   "vpnpekz_path_read.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnpekz_path_read.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnpekz_path_read"
...
If gridpekz_path.Row > 0 Then
 If gridpekz_path.RowIndex(gridpekz_path.Row) > 0 Then
    ...
    bm = gridpekz_path.RowBookmark(gridpekz_path.RowIndex(gridpekz_path.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmpekz_path_read.item = u
again:     frmpekz_path_read.NotFirstTime = False
    frmpekz_path_read.OnInit
    frmpekz_path_read.Show vbModal
    If frmpekz_path_read.OK Then
    On Error Resume Next
    err.Clear
    u.Save
...
Private Sub cmdPEKZ_WLISTEdit_Click()
    ...
    Set frmPEKZ_WLIST_read.item = u
again:     frmPEKZ_WLIST_read.NotFirstTime = False
    frmPEKZ_WLIST_read.OnInit
    frmPEKZ_WLIST_read.Show vbModal
    If frmPEKZ_WLIST_read.OK Then
    On Error Resume Next
    err.Clear
    u.Save
    If err.Number <> 0 Then
