VERSION 5.00
Begin VB.Form frmpekz_path_done 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Маршрут доставки"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Маршрут доставки"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.pekz_pathdone Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmpekz_path_done"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E00B7911-F212-46A2-BF10-0DAA8F60D1CD}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E00B7911-F212-46A2-BF10-0DAA8F60D1CD}"
  Open s & Me.Name & "{E00B7911-F212-46A2-BF10-0DAA8F60D1CD}" For Output As #ff
