VERSION 5.00
Begin VB.Form frmPEKZ_1CLINK_prnt 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin PEK2ZGUI.PEKZ_1CLINKprnt Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKZ_1CLINK_prnt"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5821443E-AB13-4C62-AC2D-367ADE4CC3E2}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5821443E-AB13-4C62-AC2D-367ADE4CC3E2}"
  Open s & Me.Name & "{5821443E-AB13-4C62-AC2D-367ADE4CC3E2}" For Output As #ff
