VERSION 5.00
Begin VB.Form frmpekz_dop_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Дополнительные услуги"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.pekz_dopmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmpekz_dop_main"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8BDF89D8-BFFE-4381-8F5A-F1BC923395BE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8BDF89D8-BFFE-4381-8F5A-F1BC923395BE}"
  Open s & Me.Name & "{8BDF89D8-BFFE-4381-8F5A-F1BC923395BE}" For Output As #ff
