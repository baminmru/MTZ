VERSION 5.00
Begin VB.Form frmPEKZ_ADLVR_prnt 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Авто доставка"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Доставка груза получателю автотранспортом"
      Top             =   6225
      Width           =   825
   End
   Begin PEK2ZGUI.PEKZ_ADLVRprnt Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPEKZ_ADLVR_prnt"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DBD9A267-94CF-48D0-9365-B183D9E5318E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DBD9A267-94CF-48D0-9365-B183D9E5318E}"
  Open s & Me.Name & "{DBD9A267-94CF-48D0-9365-B183D9E5318E}" For Output As #ff
