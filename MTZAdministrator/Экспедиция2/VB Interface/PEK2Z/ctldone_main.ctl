...
Begin VB.UserControl ctldone_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin PEK2ZGUI.vpnpekz_def_done pnlpekz_def 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2ZGUI.vpnpekz_path_done pnlpekz_path 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2ZGUI.vpnpekz_dop_done pnlpekz_dop 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2ZGUI.vpnPEKZ_ACLCT_done pnlPEKZ_ACLCT 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin PEK2ZGUI.vpnPEKZ_ADLVR_done pnlPEKZ_ADLVR 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
   ...
   End
End
Attribute VB_Name = "ctldone_main"
...
pnlPEKZ_ADLVR.OnInit item, ParentForm
  ...
  TSCustom.Init ts, "PEK2Z", "ctldone_main"
