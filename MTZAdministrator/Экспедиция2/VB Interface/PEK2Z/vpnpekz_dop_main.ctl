...
Begin VB.UserControl vpnpekz_dop_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlpekz_dop 
      ...
      Begin GridEX20.GridEX gridpekz_dop 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnpekz_dop_main.ctx":0000
         Column(2)       =   "vpnpekz_dop_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnpekz_dop_main.ctx":016C
         FormatStyle(2)  =   "vpnpekz_dop_main.ctx":02C8
         FormatStyle(3)  =   "vpnpekz_dop_main.ctx":0378
         FormatStyle(4)  =   "vpnpekz_dop_main.ctx":042C
         FormatStyle(5)  =   "vpnpekz_dop_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnpekz_dop_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnpekz_dop_main"
...
If gridpekz_dop.Row > 0 Then
 If gridpekz_dop.RowIndex(gridpekz_dop.Row) > 0 Then
    ...
    bm = gridpekz_dop.RowBookmark(gridpekz_dop.RowIndex(gridpekz_dop.Row))
    Set u = item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmpekz_dop_main.item = u
again:     frmpekz_dop_main.NotFirstTime = False
    frmpekz_dop_main.OnInit
    frmpekz_dop_main.Show vbModal
    If frmpekz_dop_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
