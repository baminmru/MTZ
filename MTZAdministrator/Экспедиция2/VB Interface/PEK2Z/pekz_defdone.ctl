...
Begin VB.UserControl pekz_defdone 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin MSComCtl2.DTPicker dtpLoadDate 
         ...
         CurrentDate     =   39567
      End
      Begin MSComCtl2.DTPicker dtpLoadTime 
         Height          =   300
         Left            =   6600
         TabIndex        =   40
         ToolTipText     =   "Время приема груза на склад"
         Top             =   405
         Width           =   1800
         _ExtentX        =   3175
         _ExtentY        =   529
         ...
         CurrentDate     =   39567
      End
      Begin MSComCtl2.DTPicker dtpAcceptTime 
         Height          =   300
         Left            =   3450
         TabIndex        =   38
         ToolTipText     =   "Время приема заявки"
         Top             =   6435
         Width           =   1800
         _ExtentX        =   3175
         _ExtentY        =   529
      ...
      Begin VB.Label lblLoadTime 
         BackStyle       =   0  'Transparent
         Caption         =   "Время приема груза на склад:"
         Enabled         =   0   'False
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   6600
   ...
   End
End
Attribute VB_Name = "pekz_defdone"
...
End Sub
Private Sub dtpAcceptTime_Change()
  Changing

End Sub
Private Sub dtpLoadTime_Change()
  Changing
...
cmbIsNal.ItemData(cmbIsNal.NewIndex) = 0
 ...
 Next
dtpAcceptTime = Time
If Item.AcceptTime <> 0 Then
 dtpAcceptTime = Item.AcceptTime
Else
 dtpAcceptTime.Value = Null
End If
dtpLoadTime = Time
If Item.LoadTime <> 0 Then
 dtpLoadTime = Item.LoadTime
Else
 dtpLoadTime.Value = Null
End If
dtpLoadDate = Date
