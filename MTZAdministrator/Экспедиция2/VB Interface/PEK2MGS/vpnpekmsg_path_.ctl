...
Begin VB.UserControl vpnpekmsg_path_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlpekmsg_path 
      ...
      Begin GridEX20.GridEX gridpekmsg_path 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnpekmsg_path_.ctx":0000
         Column(2)       =   "vpnpekmsg_path_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnpekmsg_path_.ctx":016C
         FormatStyle(2)  =   "vpnpekmsg_path_.ctx":02C8
         FormatStyle(3)  =   "vpnpekmsg_path_.ctx":0378
         FormatStyle(4)  =   "vpnpekmsg_path_.ctx":042C
         FormatStyle(5)  =   "vpnpekmsg_path_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnpekmsg_path_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnpekmsg_path_"
