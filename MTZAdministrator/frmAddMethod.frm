...
Begin VB.Form frmAddMethod 
   ...
   Begin VB.CommandButton cmdRun 
      Caption         =   "Добавить к типам объектов метод SetName"
      Height          =   375
      Left            =   0
      TabIndex        =   3
      Top             =   6000
...
Private Sub cmdRun_Click()
  ...
  ' поиск разделов и добавление в них методов
  If optApp.Value Then APPS
  If optType.Value Then types
  
  MsgBox "Методы успешно добавлены", vbInformation + vbOKOnly, "Администратор"
  Exit Sub
bye:
