VERSION 5.00
Begin VB.Form frmWFDic_presets_ 
   Caption         =   "Значения атрибутов по умолчанию"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Значения некоторых атрибутов  могут быть зафиксированы"
      Top             =   6225
      Width           =   825
   End
   Begin WFDicGUI.WFDic_presets Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFDic_presets_"
