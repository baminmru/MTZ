VERSION 5.00
Begin VB.Form frmWFDic_func_ 
   Caption         =   "Типы функций"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание функций, которые могут быть использованы при построении процесса"
      Top             =   6225
      Width           =   825
   End
   Begin WFDicGUI.WFDic_func Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFDic_func_"
