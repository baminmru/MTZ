...
Begin VB.UserControl vpnWFDef_master_ 
   ...
   Begin VB.Frame pnlWFDef_master 
      ...
      Begin GridEX20.GridEX gridWFDef_master 
         ...
         FormatStyle(2)  =   "vpnWFDef_master_.ctx":02C8
         FormatStyle(3)  =   "vpnWFDef_master_.ctx":0378
         FormatStyle(4)  =   "vpnWFDef_master_.ctx":042C
         FormatStyle(5)  =   "vpnWFDef_master_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWFDef_master_.ctx":05BC
      End
   End
