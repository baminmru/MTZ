VERSION 5.00
Begin VB.Form frmWFDef_param_M0 
   Caption         =   "Параметры и переменные"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Парамеры и переменные процесса"
      Top             =   6225
      Width           =   825
   End
   Begin WFDefGUI.WFDef_paramM0 Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFDef_param_M0"
