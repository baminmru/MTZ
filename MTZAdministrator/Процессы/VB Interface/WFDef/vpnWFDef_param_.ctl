...
Begin VB.UserControl vpnWFDef_param_ 
   ...
   Begin VB.Frame pnlWFDef_param 
      ...
      Begin GridEX20.GridEX gridWFDef_param 
         ...
         FormatStyle(2)  =   "vpnWFDef_param_.ctx":02C8
         FormatStyle(3)  =   "vpnWFDef_param_.ctx":0378
         FormatStyle(4)  =   "vpnWFDef_param_.ctx":042C
         FormatStyle(5)  =   "vpnWFDef_param_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWFDef_param_.ctx":05BC
      End
   End
