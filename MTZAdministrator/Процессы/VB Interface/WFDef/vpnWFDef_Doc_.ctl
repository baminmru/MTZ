...
Begin VB.UserControl vpnWFDef_Doc_ 
   ...
   Begin VB.Frame pnlWFDef_Doc 
      ...
      Begin GridEX20.GridEX gridWFDef_Doc 
         ...
         FormatStyle(2)  =   "vpnWFDef_Doc_.ctx":02C8
         FormatStyle(3)  =   "vpnWFDef_Doc_.ctx":0378
         FormatStyle(4)  =   "vpnWFDef_Doc_.ctx":042C
         FormatStyle(5)  =   "vpnWFDef_Doc_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWFDef_Doc_.ctx":05BC
      End
   End
