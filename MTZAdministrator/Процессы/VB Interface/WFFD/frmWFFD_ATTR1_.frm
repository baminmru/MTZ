VERSION 5.00
Begin VB.Form frmWFFD_ATTR1_ 
   Caption         =   "Дополнительные атрибуты"
   ClientHeight    =   6795
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Дополнительные атрибуты для описания функции"
      Top             =   6225
      Width           =   825
   End
   Begin WFFDGUI.WFFD_ATTR1 Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFFD_ATTR1_"
