...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WMSKGUI.vpnWMSK_DEF_ pnlWMSK_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlWMSK_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlWMSK_DEF.Visible = False
   ...
   Case "WMSK_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlWMSK_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "WMSK_DEF"
pnlWMSK_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "WMSK", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlWMSK_DEF.IsChanged
