...
Begin VB.Form frmWMSK_DEF_ 
   ...
   End
End
Attribute VB_Name = "frmWMSK_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{053F16A2-6707-4EE7-B60E-15172F8F6947}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{053F16A2-6707-4EE7-B60E-15172F8F6947}"
  Open s & Me.Name & "{053F16A2-6707-4EE7-B60E-15172F8F6947}" For Output As #ff
