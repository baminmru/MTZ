...
Begin VB.Form frmWMSSS_GOOD_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WMSSGUI.WMSSS_GOOD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSSS_GOOD_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8BCA1891-785C-4437-ADAF-33E9CA61B076}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8BCA1891-785C-4437-ADAF-33E9CA61B076}"
  Open s & Me.Name & "{8BCA1891-785C-4437-ADAF-33E9CA61B076}" For Output As #ff
