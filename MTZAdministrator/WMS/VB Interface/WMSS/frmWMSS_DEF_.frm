...
Begin VB.Form frmWMSS_DEF_ 
   ...
   End
End
Attribute VB_Name = "frmWMSS_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{FEAD5E3D-6B57-4CAA-8621-464E6F589F11}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{FEAD5E3D-6B57-4CAA-8621-464E6F589F11}"
  Open s & Me.Name & "{FEAD5E3D-6B57-4CAA-8621-464E6F589F11}" For Output As #ff
