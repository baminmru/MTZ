...
Begin VB.UserControl vpnWMSD_OPTTYPE_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSD_OPTTYPE 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSD_OPTTYPE 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSD_OPTTYPEAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPEFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPECfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPEPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPERef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPEDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPEEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_OPTTYPEAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSD_OPTTYPE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_OPTTYPE_main.ctx":0000
         Column(2)       =   "vpnWMSD_OPTTYPE_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_OPTTYPE_main.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_OPTTYPE_main.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_OPTTYPE_main.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_OPTTYPE_main.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_OPTTYPE_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_OPTTYPE_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSD_OPTTYPERun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSD_OPTTYPE 
      Caption         =   "Меню для Тип оптимизации"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSD_OPTTYPEAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSD_OPTTYPEEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSD_OPTTYPEDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSD_OPTTYPEOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSD_OPTTYPERef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSD_OPTTYPES1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSD_OPTTYPEBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSD_OPTTYPECOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSD_OPTTYPECUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSD_OPTTYPEPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSD_OPTTYPECHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSD_OPTTYPECLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSD_OPTTYPEPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSD_OPTTYPECfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSD_OPTTYPEFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSD_OPTTYPEAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSD_OPTTYPE_main"
