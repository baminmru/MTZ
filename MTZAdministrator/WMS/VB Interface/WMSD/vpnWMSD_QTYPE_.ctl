...
Begin VB.UserControl vpnWMSD_QTYPE_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlWMSD_QTYPE 
      ...
      Begin GridEX20.GridEX gridWMSD_QTYPE 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_QTYPE_.ctx":0000
         Column(2)       =   "vpnWMSD_QTYPE_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_QTYPE_.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_QTYPE_.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_QTYPE_.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_QTYPE_.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_QTYPE_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_QTYPE_.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnWMSD_QTYPE_"
