...
Begin VB.UserControl vpnWMSD_PART_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlWMSD_PART 
      ...
      Begin GridEX20.GridEX gridWMSD_PART 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_PART_main.ctx":0000
         Column(2)       =   "vpnWMSD_PART_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_PART_main.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_PART_main.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_PART_main.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_PART_main.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_PART_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_PART_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnWMSD_PART_main"
