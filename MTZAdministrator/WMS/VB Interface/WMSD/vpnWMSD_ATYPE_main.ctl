...
Begin VB.UserControl vpnWMSD_ATYPE_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSD_ATYPE 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSD_ATYPE 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSD_ATYPEAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPEFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPECfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPEPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPERef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPEDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPEEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_ATYPEAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSD_ATYPE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_ATYPE_main.ctx":0000
         Column(2)       =   "vpnWMSD_ATYPE_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_ATYPE_main.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_ATYPE_main.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_ATYPE_main.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_ATYPE_main.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_ATYPE_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_ATYPE_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSD_ATYPERun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSD_ATYPE 
      Caption         =   "Меню для Тип операции"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSD_ATYPEAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSD_ATYPEEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSD_ATYPEDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuWMSD_ATYPEOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSD_ATYPERef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSD_ATYPES1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSD_ATYPEBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSD_ATYPECOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSD_ATYPECUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSD_ATYPEPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSD_ATYPECHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSD_ATYPECLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSD_ATYPEPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSD_ATYPECfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSD_ATYPEFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSD_ATYPEAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSD_ATYPE_main"
