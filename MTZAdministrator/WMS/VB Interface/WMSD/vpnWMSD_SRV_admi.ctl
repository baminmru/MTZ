...
Begin VB.UserControl vpnWMSD_SRV_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlWMSD_SRV 
      ...
      Begin GridEX20.GridEX gridWMSD_SRV 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_SRV_admi.ctx":0000
         Column(2)       =   "vpnWMSD_SRV_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_SRV_admi.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_SRV_admi.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_SRV_admi.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_SRV_admi.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_SRV_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_SRV_admi.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnWMSD_SRV_admi"
