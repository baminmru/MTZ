...
Begin VB.UserControl vpnWMSD_WH_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlWMSD_WH 
      ...
      Begin GridEX20.GridEX gridWMSD_WH 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_WH_.ctx":0000
         Column(2)       =   "vpnWMSD_WH_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_WH_.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_WH_.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_WH_.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_WH_.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_WH_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_WH_.ctx":05BC
      End
