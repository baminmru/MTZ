...
Begin VB.UserControl vpnWMSD_QTYPE_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSD_QTYPE 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSD_QTYPE 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSD_QTYPEAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPEFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPECfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPEPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPERef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPEDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPEEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_QTYPEAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSD_QTYPE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_QTYPE_admi.ctx":0000
         Column(2)       =   "vpnWMSD_QTYPE_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_QTYPE_admi.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_QTYPE_admi.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_QTYPE_admi.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_QTYPE_admi.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_QTYPE_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_QTYPE_admi.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSD_QTYPERun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSD_QTYPE 
      Caption         =   "Меню для Тип заявки"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSD_QTYPEAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSD_QTYPEEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSD_QTYPEDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSD_QTYPEOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSD_QTYPERef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSD_QTYPES1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSD_QTYPEBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSD_QTYPECOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSD_QTYPECUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSD_QTYPEPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSD_QTYPECHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSD_QTYPECLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSD_QTYPEPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSD_QTYPECfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSD_QTYPEFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSD_QTYPEAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSD_QTYPE_admi"
