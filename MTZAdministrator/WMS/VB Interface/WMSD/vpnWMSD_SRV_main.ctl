...
Begin VB.UserControl vpnWMSD_SRV_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSD_SRV 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSD_SRV 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSD_SRVAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_SRVAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSD_SRV 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_SRV_main.ctx":0000
         Column(2)       =   "vpnWMSD_SRV_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_SRV_main.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_SRV_main.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_SRV_main.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_SRV_main.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_SRV_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_SRV_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSD_SRVRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSD_SRV 
      Caption         =   "Меню для Услуги"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSD_SRVAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSD_SRVEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSD_SRVDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuWMSD_SRVOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSD_SRVRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSD_SRVS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSD_SRVBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSD_SRVCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSD_SRVCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSD_SRVPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSD_SRVCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSD_SRVCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSD_SRVPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSD_SRVCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSD_SRVFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSD_SRVAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSD_SRV_main"
