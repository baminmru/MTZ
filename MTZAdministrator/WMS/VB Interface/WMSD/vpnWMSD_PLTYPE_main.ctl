...
Begin VB.UserControl vpnWMSD_PLTYPE_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSD_PLTYPE 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSD_PLTYPE 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSD_PLTYPEAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPEFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPECfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPEPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPERef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPEDel 
         Enabled         =   0   'False
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPEEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_PLTYPEAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSD_PLTYPE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_PLTYPE_main.ctx":0000
         Column(2)       =   "vpnWMSD_PLTYPE_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_PLTYPE_main.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_PLTYPE_main.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_PLTYPE_main.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_PLTYPE_main.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_PLTYPE_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_PLTYPE_main.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSD_PLTYPERun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSD_PLTYPE 
      Caption         =   "Меню для Тип палеты"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSD_PLTYPEAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSD_PLTYPEEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSD_PLTYPEDelete 
         Caption         =   "Удалить"
         Enabled         =   0   'False
      End
      Begin VB.Menu mnuWMSD_PLTYPEOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSD_PLTYPERef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSD_PLTYPES1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSD_PLTYPEBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSD_PLTYPECOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSD_PLTYPECUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSD_PLTYPEPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSD_PLTYPECHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSD_PLTYPECLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSD_PLTYPEPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSD_PLTYPECfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSD_PLTYPEFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSD_PLTYPEAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSD_PLTYPE_main"
