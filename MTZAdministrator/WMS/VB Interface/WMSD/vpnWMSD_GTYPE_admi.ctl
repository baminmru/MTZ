...
Begin VB.UserControl vpnWMSD_GTYPE_admi 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSD_GTYPE 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSD_GTYPE 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSD_GTYPEAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPEFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPECfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPEPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPERef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPEDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPEEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSD_GTYPEAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSD_GTYPE 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSD_GTYPE_admi.ctx":0000
         Column(2)       =   "vpnWMSD_GTYPE_admi.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSD_GTYPE_admi.ctx":016C
         FormatStyle(2)  =   "vpnWMSD_GTYPE_admi.ctx":02C8
         FormatStyle(3)  =   "vpnWMSD_GTYPE_admi.ctx":0378
         FormatStyle(4)  =   "vpnWMSD_GTYPE_admi.ctx":042C
         FormatStyle(5)  =   "vpnWMSD_GTYPE_admi.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSD_GTYPE_admi.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSD_GTYPERun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSD_GTYPE 
      Caption         =   "Меню для Тип товара"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSD_GTYPEAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSD_GTYPEEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSD_GTYPEDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSD_GTYPEOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSD_GTYPERef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSD_GTYPES1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSD_GTYPEBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSD_GTYPECOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSD_GTYPECUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSD_GTYPEPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSD_GTYPECHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSD_GTYPECLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSD_GTYPEPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSD_GTYPECfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSD_GTYPEFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSD_GTYPEAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSD_GTYPE_admi"
