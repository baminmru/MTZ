...
Begin VB.UserControl WMSCS_DEF 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
...
Private Sub cmdCLIENTCODE_CLick()
  On Error Resume Next
        ...
        If Item.Application.Manager.GetReferenceDialogEx2("WMSK_DEF", ID, brief) Then
          txtCLIENTCODE.Tag = Left(ID, 38)
          txtCLIENTCODE = brief
        End If
End Sub
Private Sub cmdCLIENTCODE_MenuClick(ByVal sCaption As String)
          txtCLIENTCODE.Tag = ""
          txtCLIENTCODE = ""
End Sub
...
If Not Item.CLIENTCODE Is Nothing Then
  txtCLIENTCODE.Tag = Item.CLIENTCODE.ID
  txtCLIENTCODE = Item.CLIENTCODE.brief
Else
  txtCLIENTCODE.Tag = ""
  txtCLIENTCODE = ""
End If
 LoadBtnPictures cmdCLIENTCODE, cmdCLIENTCODE.Tag
  ...
  cmdCLIENTCODE.AddMenu "Очистить"
...
If txtCLIENTCODE.Tag <> "" Then
  Set Item.CLIENTCODE = Item.Application.FindRowObject("WMSK_DEF", txtCLIENTCODE.Tag)
Else
  Set Item.CLIENTCODE = Nothing
End If
 mIsChanged = False
 RaiseEvent Changed
End Sub
