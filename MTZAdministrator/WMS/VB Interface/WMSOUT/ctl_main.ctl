...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WMSOUTGUI.vpnWMSOUT_DEF_ pnlWMSOUT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSOUTGUI.vpnWMSOUT_LINES_ pnlWMSOUT_LINES 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSOUTGUI.vpnWMSOUT_EPL_ pnlWMSOUT_EPL 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSOUTGUI.vpnWMSOUT_SRV_ pnlWMSOUT_SRV 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSOUTGUI.vpnWMSOUT_SET_ pnlWMSOUT_SET 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
