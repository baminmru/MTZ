...
Begin VB.UserControl vpnWMSOUT_SET_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSOUT_SET 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSOUT_SET 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSOUT_SETAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSOUT_SETAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSOUT_SET 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSOUT_SET_.ctx":0000
         Column(2)       =   "vpnWMSOUT_SET_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSOUT_SET_.ctx":016C
         FormatStyle(2)  =   "vpnWMSOUT_SET_.ctx":02C8
         FormatStyle(3)  =   "vpnWMSOUT_SET_.ctx":0378
         FormatStyle(4)  =   "vpnWMSOUT_SET_.ctx":042C
         FormatStyle(5)  =   "vpnWMSOUT_SET_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSOUT_SET_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSOUT_SETRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSOUT_SET 
      Caption         =   "Меню для Набор товаров"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSOUT_SETAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSOUT_SETEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSOUT_SETDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSOUT_SETOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSOUT_SETRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSOUT_SETS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSOUT_SETBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSOUT_SETCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSOUT_SETCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSOUT_SETPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSOUT_SETCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSOUT_SETCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSOUT_SETPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSOUT_SETCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSOUT_SETFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSOUT_SETAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSOUT_SET_"
