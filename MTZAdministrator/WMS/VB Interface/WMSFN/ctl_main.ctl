...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WMSFNGUI.vpnWMSFN_MAX_ pnlWMSFN_MAX 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlWMSFN_MAX.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlWMSFN_MAX.Visible = False
   ...
   Case "WMSFN_MAX"
     ...
     .Visible = True
     .ZOrder 0
     pnlWMSFN_MAX.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Key = "WMSFN_MAX"
pnlWMSFN_MAX.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "WMSFN", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlWMSFN_MAX.IsChanged
