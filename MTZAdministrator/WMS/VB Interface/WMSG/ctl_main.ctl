...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WMSGGUI.vpnWMSG_NOM_ pnlWMSG_NOM 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSGGUI.vpnWMSG_CLASS_ pnlWMSG_CLASS 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSGGUI.vpnWMSG_CAT_ pnlWMSG_CAT 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSGGUI.vpnWMSG_TYPE_ pnlWMSG_TYPE 
      Height          =   1500
      Left            =   6000
      TabIndex        =   4
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin WMSGGUI.vpnWMSG_ARTICUL_ pnlWMSG_ARTICUL 
      Height          =   1500
      Left            =   0
      TabIndex        =   5
      Top             =   1500
