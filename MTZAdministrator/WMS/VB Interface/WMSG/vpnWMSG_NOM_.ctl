...
Begin VB.UserControl vpnWMSG_NOM_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSG_NOM 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSG_NOM 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSG_NOMAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_NOMAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSG_NOM 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSG_NOM_.ctx":0000
         Column(2)       =   "vpnWMSG_NOM_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSG_NOM_.ctx":016C
         FormatStyle(2)  =   "vpnWMSG_NOM_.ctx":02C8
         FormatStyle(3)  =   "vpnWMSG_NOM_.ctx":0378
         FormatStyle(4)  =   "vpnWMSG_NOM_.ctx":042C
         FormatStyle(5)  =   "vpnWMSG_NOM_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSG_NOM_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSG_NOMRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSG_NOM 
      Caption         =   "Меню для Номенклатура товаров"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSG_NOMAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSG_NOMEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSG_NOMDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSG_NOMOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSG_NOMRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSG_NOMS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSG_NOMBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSG_NOMCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSG_NOMCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSG_NOMPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSG_NOMCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSG_NOMCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSG_NOMPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSG_NOMCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSG_NOMFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSG_NOMAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSG_NOM_"
