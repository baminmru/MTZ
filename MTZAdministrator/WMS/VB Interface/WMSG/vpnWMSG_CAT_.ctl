...
Begin VB.UserControl vpnWMSG_CAT_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSG_CAT 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSG_CAT 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSG_CATAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CATAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSG_CAT 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSG_CAT_.ctx":0000
         Column(2)       =   "vpnWMSG_CAT_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSG_CAT_.ctx":016C
         FormatStyle(2)  =   "vpnWMSG_CAT_.ctx":02C8
         FormatStyle(3)  =   "vpnWMSG_CAT_.ctx":0378
         FormatStyle(4)  =   "vpnWMSG_CAT_.ctx":042C
         FormatStyle(5)  =   "vpnWMSG_CAT_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSG_CAT_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSG_CATRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSG_CAT 
      Caption         =   "Меню для Категория товара"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSG_CATAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSG_CATEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSG_CATDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSG_CATOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSG_CATRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSG_CATS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSG_CATBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSG_CATCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSG_CATCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSG_CATPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSG_CATCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSG_CATCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSG_CATPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSG_CATCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSG_CATFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSG_CATAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSG_CAT_"
