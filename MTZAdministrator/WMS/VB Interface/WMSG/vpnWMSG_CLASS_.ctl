...
Begin VB.UserControl vpnWMSG_CLASS_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerWMSG_CLASS 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlWMSG_CLASS 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWMSG_CLASSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWMSG_CLASSAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridWMSG_CLASS 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWMSG_CLASS_.ctx":0000
         Column(2)       =   "vpnWMSG_CLASS_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnWMSG_CLASS_.ctx":016C
         FormatStyle(2)  =   "vpnWMSG_CLASS_.ctx":02C8
         FormatStyle(3)  =   "vpnWMSG_CLASS_.ctx":0378
         FormatStyle(4)  =   "vpnWMSG_CLASS_.ctx":042C
         FormatStyle(5)  =   "vpnWMSG_CLASS_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnWMSG_CLASS_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdWMSG_CLASSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupWMSG_CLASS 
      Caption         =   "Меню для Класс товара"
      Visible         =   0   'False
      Begin VB.Menu mnuWMSG_CLASSAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuWMSG_CLASSEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuWMSG_CLASSDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuWMSG_CLASSOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuWMSG_CLASSRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuWMSG_CLASSS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuWMSG_CLASSBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuWMSG_CLASSCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuWMSG_CLASSCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuWMSG_CLASSPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuWMSG_CLASSCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuWMSG_CLASSCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuWMSG_CLASSPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuWMSG_CLASSCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuWMSG_CLASSFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWMSG_CLASSAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnWMSG_CLASS_"
