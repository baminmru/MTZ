VERSION 5.00
Begin VB.Form frmWMSPL_GOOD_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Товар на поддоне"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WMSPLGUI.WMSPL_GOOD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSPL_GOOD_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{555DB04A-B218-4E9B-A870-8153873FC143}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{555DB04A-B218-4E9B-A870-8153873FC143}"
  Open s & Me.Name & "{555DB04A-B218-4E9B-A870-8153873FC143}" For Output As #ff
