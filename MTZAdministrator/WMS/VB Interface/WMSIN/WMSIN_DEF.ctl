...
Begin VB.UserControl WMSIN_DEF 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin MTZ_PANEL.DropButton cmdThePartyRule 
         ...
         TabIndex        =   39
         Tag             =   "refopen.ico"
         ToolTipText     =   "Правило оптимизации"
         Top             =   5340
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
...
If mIsOK Then mIsOK = IsSet(txtQryCode.Text)
...
If txtThePartyRule.Tag <> "" Then
  Set Item.ThePartyRule = Item.Application.FindRowObject("WMSD_RULE", txtThePartyRule.Tag)
Else
