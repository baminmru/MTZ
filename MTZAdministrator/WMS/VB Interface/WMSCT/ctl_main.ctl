...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin WMSCTGUI.vpnWMSCT_DEF_ pnlWMSCT_DEF 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlWMSCT_DEF.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlWMSCT_DEF.Visible = False
   ...
   Case "WMSCT_DEF"
     ...
     .Visible = True
     .ZOrder 0
     pnlWMSCT_DEF.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Описание договора"
ts.Tabs.Item(1).Key = "WMSCT_DEF"
pnlWMSCT_DEF.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "WMSCT", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlWMSCT_DEF.IsChanged
