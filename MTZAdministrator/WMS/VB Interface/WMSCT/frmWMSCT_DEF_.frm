VERSION 5.00
Begin VB.Form frmWMSCT_DEF_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание договора"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание заказа"
      Top             =   6225
      Width           =   825
   End
   Begin WMSCTGUI.WMSCT_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSCT_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1C081071-20B9-479C-94AC-D3250C7CF3E3}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1C081071-20B9-479C-94AC-D3250C7CF3E3}"
  Open s & Me.Name & "{1C081071-20B9-479C-94AC-D3250C7CF3E3}" For Output As #ff
