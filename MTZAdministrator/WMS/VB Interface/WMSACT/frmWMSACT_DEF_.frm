...
Begin VB.Form frmWMSACT_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание операции"
      Top             =   6225
      Width           =   825
   End
   Begin WMSACTGUI.WMSACT_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSACT_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1FDA5735-C4CC-4C48-A9A7-8D46CF5DE396}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1FDA5735-C4CC-4C48-A9A7-8D46CF5DE396}"
  Open s & Me.Name & "{1FDA5735-C4CC-4C48-A9A7-8D46CF5DE396}" For Output As #ff
