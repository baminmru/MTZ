VERSION 5.00
Begin VB.Form frmWMSACT_LINE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Строка операции"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Строка операции"
      Top             =   6225
      Width           =   825
   End
   Begin WMSACTGUI.WMSACT_LINE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSACT_LINE_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4F7F6770-610F-493B-BC7E-E1C8CF888EC7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4F7F6770-610F-493B-BC7E-E1C8CF888EC7}"
  Open s & Me.Name & "{4F7F6770-610F-493B-BC7E-E1C8CF888EC7}" For Output As #ff
