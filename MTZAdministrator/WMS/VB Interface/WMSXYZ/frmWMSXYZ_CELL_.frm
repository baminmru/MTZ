...
Begin VB.Form frmWMSXYZ_CELL_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WMSXYZGUI.WMSXYZ_CELL Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSXYZ_CELL_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C8CCE35A-C601-4362-A5EA-D4F8390BE34A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C8CCE35A-C601-4362-A5EA-D4F8390BE34A}"
  Open s & Me.Name & "{C8CCE35A-C601-4362-A5EA-D4F8390BE34A}" For Output As #ff
