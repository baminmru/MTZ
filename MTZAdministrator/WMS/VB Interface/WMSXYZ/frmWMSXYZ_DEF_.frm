...
Begin VB.Form frmWMSXYZ_DEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin WMSXYZGUI.WMSXYZ_DEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWMSXYZ_DEF_"
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C8512252-44CE-4203-864E-28368076A52D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C8512252-44CE-4203-864E-28368076A52D}"
  Open s & Me.Name & "{C8512252-44CE-4203-864E-28368076A52D}" For Output As #ff
