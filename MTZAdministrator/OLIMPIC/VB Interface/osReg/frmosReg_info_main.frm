VERSION 5.00
Begin VB.Form frmosReg_info_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osRegGUI.osReg_infomain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosReg_info_main"
...
' Форма редактирования раздела osReg_info режим main
