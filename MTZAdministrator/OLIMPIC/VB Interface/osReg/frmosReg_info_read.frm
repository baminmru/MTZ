VERSION 5.00
Begin VB.Form frmosReg_info_read 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Запись о посещении"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osRegGUI.osReg_inforead Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosReg_info_read"
...
' Форма редактирования раздела osReg_info режим read
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{692E3468-A12C-4B99-8E7E-5FDD2EB88B9C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{692E3468-A12C-4B99-8E7E-5FDD2EB88B9C}"
  Open s & Me.Name & "{692E3468-A12C-4B99-8E7E-5FDD2EB88B9C}" For Output As #ff
