...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin osRegGUI.vpnosReg_info_main pnlosReg_info 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlosReg_info.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlosReg_info.Visible = False
   ...
   Case "osReg_info"
     ...
     .Visible = True
     .ZOrder 0
     pnlosReg_info.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Запись о посещении"
ts.Tabs.Item(1).Key = "osReg_info"
pnlosReg_info.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "osReg", "ctlmain_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlosReg_info.IsChanged
...
Public Function SetupStatusMenu(m() As Object)
    ...
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{D8128DAC-60AB-47FF-9760-472C94776044}"
    i = i + 1
    m(i).Caption = "В клубе"
    m(i).Visible = True
    m(i).Enabled = True
    m(i).Checked = False
    m(i).Tag = "{24E77850-58BC-442E-96F5-F2221450BDC0}"
End Function
...
Public Sub CheckStatusMenu(m() As Object)
    ...
    Next
    If Not Item Is Nothing Then
      If Item.Statusid = "{D8128DAC-60AB-47FF-9760-472C94776044}" Then
        For i = 1 To StatusMenuCount
        Next
      End If
      If Item.Statusid = "{24E77850-58BC-442E-96F5-F2221450BDC0}" Then
        For i = 1 To StatusMenuCount
          If m(i).Tag = "{D8128DAC-60AB-47FF-9760-472C94776044}" Then
            m(i).Enabled = True
          End If
        Next
      End If
