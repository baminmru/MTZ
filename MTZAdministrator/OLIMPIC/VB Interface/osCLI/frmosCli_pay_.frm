...
Begin VB.Form frmosCli_pay_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osCLIGUI.osCli_pay Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosCli_pay_"
...
' Форма редактирования раздела osCli_pay режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C22CC566-5404-463E-8A8D-072EDB968DBF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C22CC566-5404-463E-8A8D-072EDB968DBF}"
  Open s & Me.Name & "{C22CC566-5404-463E-8A8D-072EDB968DBF}" For Output As #ff
