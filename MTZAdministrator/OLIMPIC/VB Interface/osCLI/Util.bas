...
If Name = "osCli_def" Then
 Set FormByName = New frmosCli_def_
 Exit Function
End If

If Name = "osCli_Abon" Then
 Set FormByName = New frmosCli_Abon_
 Exit Function
End If

If Name = "osCli_SRV" Then
 Set FormByName = New frmosCli_SRV_
 Exit Function
End If

If Name = "osCli_pay" Then
 Set FormByName = New frmosCli_pay_
 Exit Function
End If
