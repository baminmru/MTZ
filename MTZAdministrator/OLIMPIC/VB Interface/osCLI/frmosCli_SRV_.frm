...
Begin VB.Form frmosCli_SRV_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osCLIGUI.osCli_SRV Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosCli_SRV_"
...
' Форма редактирования раздела osCli_SRV режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3A5976F2-02FA-45ED-A281-79F0F7D746E0}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3A5976F2-02FA-45ED-A281-79F0F7D746E0}"
  Open s & Me.Name & "{3A5976F2-02FA-45ED-A281-79F0F7D746E0}" For Output As #ff
