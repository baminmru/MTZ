...
Begin VB.Form frmosCli_Abon_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osCLIGUI.osCli_Abon Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosCli_Abon_"
...
' Форма редактирования раздела osCli_Abon режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{FEDDA37F-A48E-411A-8426-5F2E11F0AA05}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{FEDDA37F-A48E-411A-8426-5F2E11F0AA05}"
  Open s & Me.Name & "{FEDDA37F-A48E-411A-8426-5F2E11F0AA05}" For Output As #ff
