...
Begin VB.UserControl osemp_def 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
...
If mIsOK Then mIsOK = IsSet(txtEmpPosition.Text)
  IsOK = mIsOK
End Function
...
txtFIO = Item.FIO
  On Error Resume Next
txtEmpPosition = Item.EmpPosition
  On Error Resume Next
...
Item.FIO = txtFIO
Item.EmpPosition = txtEmpPosition
