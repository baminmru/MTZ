...
Begin VB.Form frmosemp_def_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osEmpGUI.osemp_def Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosemp_def_"
...
' Форма редактирования раздела osemp_def режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9925A6B0-C341-4631-B6B8-87DE1343CE91}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9925A6B0-C341-4631-B6B8-87DE1343CE91}"
  Open s & Me.Name & "{9925A6B0-C341-4631-B6B8-87DE1343CE91}" For Output As #ff
