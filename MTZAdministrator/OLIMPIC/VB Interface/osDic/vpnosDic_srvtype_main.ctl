...
Begin VB.UserControl vpnosDic_srvtype_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlosDic_srvtype 
      ...
      Begin GridEX20.GridEX gridosDic_srvtype 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnosDic_srvtype_main.ctx":0000
         Column(2)       =   "vpnosDic_srvtype_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnosDic_srvtype_main.ctx":016C
         FormatStyle(2)  =   "vpnosDic_srvtype_main.ctx":02C8
         FormatStyle(3)  =   "vpnosDic_srvtype_main.ctx":0378
         FormatStyle(4)  =   "vpnosDic_srvtype_main.ctx":042C
         FormatStyle(5)  =   "vpnosDic_srvtype_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnosDic_srvtype_main.ctx":05BC
      End
   ...
   End
End
Attribute VB_Name = "vpnosDic_srvtype_main"
...
If gridosDic_srvtype.Row > 0 Then
 If gridosDic_srvtype.RowIndex(gridosDic_srvtype.Row) > 0 Then
    ...
    bm = gridosDic_srvtype.RowBookmark(gridosDic_srvtype.RowIndex(gridosDic_srvtype.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmosDic_srvtype_main.Item = u
again:     frmosDic_srvtype_main.NotFirstTime = False
    frmosDic_srvtype_main.OnInit
    frmosDic_srvtype_main.Show vbModal
    If frmosDic_srvtype_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
