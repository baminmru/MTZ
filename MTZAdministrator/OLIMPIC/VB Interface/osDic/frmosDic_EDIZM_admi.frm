VERSION 5.00
Begin VB.Form frmosDic_EDIZM_admi 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osDicGUI.osDic_EDIZMadmi Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosDic_EDIZM_admi"
...
' Форма редактирования раздела osDic_EDIZM режим admi
