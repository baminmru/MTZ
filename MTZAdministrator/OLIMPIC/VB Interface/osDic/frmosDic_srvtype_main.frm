VERSION 5.00
Begin VB.Form frmosDic_srvtype_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin osDicGUI.osDic_srvtypemain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmosDic_srvtype_main"
...
' Форма редактирования раздела osDic_srvtype режим main
