...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin osDicGUI.vpnosDic_SRV_ pnlosDic_SRV 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin osDicGUI.vpnosDic_EDIZM_ pnlosDic_EDIZM 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin osDicGUI.vpnosDic_srvtype_ pnlosDic_srvtype 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
...
pnlosDic_srvtype.OnInit Item, ParentForm
  ...
  TSCustom.Init ts, "osDic", "ctl_main"
