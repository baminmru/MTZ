...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZ_InstallGUI.vpnMTZ_Inst_Build_ pnlMTZ_Inst_Build 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZ_InstallGUI.vpnMTZ_Inst_Common_ pnlMTZ_Inst_Common 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZ_InstallGUI.vpnMTZ_Inst_Section_ pnlMTZ_Inst_Section 
      Height          =   1500
      Left            =   4500
      TabIndex        =   3
      Top             =   0
