VERSION 5.00
Begin VB.Form frmMTZ_Inst_Sec_Files_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Файлы секции"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZ_InstallGUI.MTZ_Inst_Sec_Files Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMTZ_Inst_Sec_Files_"
...
' Форма редактирования раздела MTZ_Inst_Sec_Files режим
