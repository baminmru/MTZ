...
Begin VB.UserControl vpnMTZ_Inst_Common_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin VB.Timer menuTimerMTZ_Inst_Common 
      Enabled         =   0   'False
      Interval        =   1
      Left            =   1800
      Top             =   1560
   End
   Begin VB.Frame pnlMTZ_Inst_Common 
      BorderStyle     =   0  'None
      Caption         =   "Frame1"
      Height          =   6000
      Left            =   0
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdMTZ_Inst_CommonAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonFnd 
         Height          =   330
         Left            =   2325
         Style           =   1  'Graphical
         TabIndex        =   8
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonPrn 
         Height          =   330
         Left            =   1575
         Style           =   1  'Graphical
         TabIndex        =   6
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonRef 
         Height          =   330
         Left            =   1200
         Style           =   1  'Graphical
         TabIndex        =   5
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonDel 
         Height          =   330
         Left            =   825
         Style           =   1  'Graphical
         TabIndex        =   4
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonEdit 
         Height          =   330
         Left            =   450
         Style           =   1  'Graphical
         TabIndex        =   3
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdMTZ_Inst_CommonAdd 
         Height          =   330
         Left            =   75
         Style           =   1  'Graphical
         TabIndex        =   2
         ...
         Width           =   330
      End
      Begin GridEX20.GridEX gridMTZ_Inst_Common 
         Height          =   480
         Left            =   3900
         TabIndex        =   1
         Top             =   2760
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnMTZ_Inst_Common_.ctx":0000
         Column(2)       =   "vpnMTZ_Inst_Common_.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnMTZ_Inst_Common_.ctx":016C
         FormatStyle(2)  =   "vpnMTZ_Inst_Common_.ctx":02C8
         FormatStyle(3)  =   "vpnMTZ_Inst_Common_.ctx":0378
         FormatStyle(4)  =   "vpnMTZ_Inst_Common_.ctx":042C
         FormatStyle(5)  =   "vpnMTZ_Inst_Common_.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnMTZ_Inst_Common_.ctx":05BC
      End
      Begin MTZ_PANEL.DropButton cmdMTZ_Inst_CommonRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
      ...
      End
   End
   Begin VB.Menu mnuPopupMTZ_Inst_Common 
      Caption         =   "Меню для Пользовательские скрипты"
      Visible         =   0   'False
      Begin VB.Menu mnuMTZ_Inst_CommonAdd 
         Caption         =   "Создать"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonEdit 
         Caption         =   "Свойства"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonDelete 
         Caption         =   "Удалить"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonOpen 
         Caption         =   "Открыть"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonRef 
         Caption         =   "Обновить"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonS1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonBuffer 
         Caption         =   "Буфер"
         Begin VB.Menu mnuMTZ_Inst_CommonCOPY 
            Caption         =   "Копировать"
         End
         Begin VB.Menu mnuMTZ_Inst_CommonCUT 
            Caption         =   "Вырезать"
         End
         Begin VB.Menu mnuMTZ_Inst_CommonPASTE 
            Caption         =   "Вставить"
         End
         Begin VB.Menu mnuMTZ_Inst_CommonCHANGE 
            Caption         =   "Заменить"
         End
         Begin VB.Menu mnuMTZ_Inst_CommonCLEAN 
            Caption         =   "Очистить"
         End
      End
      Begin VB.Menu mnuMTZ_Inst_CommonPrn 
         Caption         =   "Печать"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonCfg 
         Caption         =   "Настроить"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuMTZ_Inst_CommonAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
Attribute VB_Name = "vpnMTZ_Inst_Common_"
