VERSION 5.00
Begin VB.Form frmMTZSEC_RIGHT_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Описание прав"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "описание прав для каждой группы"
      Top             =   6225
      Width           =   825
   End
   Begin MTZSecurityGUI.MTZSEC_RIGHT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMTZSEC_RIGHT_"
...
' Форма редактирования раздела MTZSEC_RIGHT режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E6240765-E3F4-4461-8FB1-BF02F6895245}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E6240765-E3F4-4461-8FB1-BF02F6895245}"
  Open s & Me.Name & "{E6240765-E3F4-4461-8FB1-BF02F6895245}" For Output As #ff
