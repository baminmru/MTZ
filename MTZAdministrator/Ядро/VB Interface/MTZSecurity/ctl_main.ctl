...
Begin VB.UserControl ctl_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZSecurityGUI.vpnMTZSEC_RIGHT_ pnlMTZSEC_RIGHT 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
...
If IsItOk Then IsItOk = pnlMTZSEC_RIGHT.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  On Error Resume Next
  pnlMTZSEC_RIGHT.Visible = False

   Select Case ts.SelectedItem.Key
   Case "MTZSEC_RIGHT"
     With pnlMTZSEC_RIGHT
     .Top = ts.ClientTop
     .Left = ts.ClientLeft
     ...
     .Visible = True
     .ZOrder 0
     pnlMTZSEC_RIGHT.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Описание прав"
ts.Tabs.Item(1).Key = "MTZSEC_RIGHT"
pnlMTZSEC_RIGHT.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZSecurity", "ctl_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlMTZSEC_RIGHT.IsChanged
