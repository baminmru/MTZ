...
Begin VB.Form frmGroups_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZUsersGUI.Groupsmain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGroups_main"
...
' Форма редактирования раздела Groups режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A40E6AEE-7B41-476D-923C-ACA251C08E87}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A40E6AEE-7B41-476D-923C-ACA251C08E87}"
  Open s & Me.Name & "{A40E6AEE-7B41-476D-923C-ACA251C08E87}" For Output As #ff
