...
' Форма редактирования раздела Users режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{148BB855-0965-4E9E-A3D6-48DCC8CE528B}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{148BB855-0965-4E9E-A3D6-48DCC8CE528B}"
  Open s & Me.Name & "{148BB855-0965-4E9E-A3D6-48DCC8CE528B}" For Output As #ff
