VERSION 5.00
Begin VB.Form frmGroupUser_main 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Состав группы"
      Top             =   6225
      Width           =   825
   End
   Begin MTZUsersGUI.GroupUsermain Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGroupUser_main"
...
' Форма редактирования раздела GroupUser режим main
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{FE2C9352-E29A-420B-9134-3E3BDD832A6E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{FE2C9352-E29A-420B-9134-3E3BDD832A6E}"
  Open s & Me.Name & "{FE2C9352-E29A-420B-9134-3E3BDD832A6E}" For Output As #ff
