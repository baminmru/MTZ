...
Begin VB.UserControl ctlmain_main 
   ...
   Begin MSComctlLib.TabStrip ts 
      ...
      EndProperty
   End
   Begin MTZUsersGUI.vpnUsers_main pnlUsers 
      Height          =   1500
      Left            =   1500
      TabIndex        =   1
      Top             =   0
      ...
      _ExtentY        =   2646
   End
   Begin MTZUsersGUI.vpnGroups_main pnlGroups 
      Height          =   1500
      Left            =   3000
      TabIndex        =   2
      Top             =   0
...
If IsItOk Then IsItOk = pnlUsers.IsOK
If IsItOk Then IsItOk = pnlGroups.IsOK
IsOK = IsItOk
End Function
Private Sub ts_click()
  ...
  pnlUsers.Visible = False
   ...
   Case "Users"
     ...
     .Visible = True
     .ZOrder 0
     pnlUsers.OnClick Item, ParentForm
     End With
   Case "Groups"
     With pnlGroups
     .Top = ts.ClientTop
     ...
     .Visible = True
     .ZOrder 0
     pnlGroups.OnClick Item, ParentForm
     End With
     End Select
End Sub
...
ts.Tabs.Item(1).Caption = "Пользователи"
ts.Tabs.Item(1).Key = "Users"
pnlUsers.OnInit Item, ParentForm
Call ts.Tabs.Add(, "Groups", "Группы")
pnlGroups.OnInit Item, ParentForm
  Set TSCustom = New MTZ_CUSTOMTAB.TabStripCustomizer
  TSCustom.Init ts, "MTZUsers", "ctlmain_main"
...
Public Function IsChanged() As Boolean
  ...
  On Error Resume Next
m_IsChanged = m_IsChanged Or pnlUsers.IsChanged
m_IsChanged = m_IsChanged Or pnlGroups.IsChanged
