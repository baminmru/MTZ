...
Begin VB.UserControl vpnGroups_main 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.HFrames pnlGroups 
      ...
      Begin GridEX20.GridEX gridGroupUser 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnGroups_main.ctx":0000
         Column(2)       =   "vpnGroups_main.ctx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnGroups_main.ctx":016C
         FormatStyle(2)  =   "vpnGroups_main.ctx":02C8
         FormatStyle(3)  =   "vpnGroups_main.ctx":0378
         FormatStyle(4)  =   "vpnGroups_main.ctx":042C
         FormatStyle(5)  =   "vpnGroups_main.ctx":0504
         ImageCount      =   0
         PrinterProperties=   "vpnGroups_main.ctx":05BC
      End
      ...
      Begin GridEX20.GridEX gridGroups 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnGroups_main.ctx":0794
         Column(2)       =   "vpnGroups_main.ctx":085C
         FormatStylesCount=   5
         FormatStyle(1)  =   "vpnGroups_main.ctx":0900
         FormatStyle(2)  =   "vpnGroups_main.ctx":0A5C
         FormatStyle(3)  =   "vpnGroups_main.ctx":0B0C
         FormatStyle(4)  =   "vpnGroups_main.ctx":0BC0
         FormatStyle(5)  =   "vpnGroups_main.ctx":0C98
         ImageCount      =   0
         PrinterProperties=   "vpnGroups_main.ctx":0D50
      End
   End
   ...
   End
End
Attribute VB_Name = "vpnGroups_main"
...
If gridGroups.Row > 0 Then
 If gridGroups.RowIndex(gridGroups.Row) > 0 Then
    ...
    bm = gridGroups.RowBookmark(gridGroups.RowIndex(gridGroups.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmGroups_main.Item = u
again:     frmGroups_main.NotFirstTime = False
    frmGroups_main.OnInit
    frmGroups_main.Show vbModal
    If frmGroups_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
...
Private Sub cmdGroupUserEdit_Click()
    ...
    Set frmGroupUser_main.Item = u
again:     frmGroupUser_main.NotFirstTime = False
    frmGroupUser_main.OnInit
    frmGroupUser_main.Show vbModal
    If frmGroupUser_main.OK Then
    On Error Resume Next
    err.Clear
    u.Save
    If err.Number <> 0 Then
