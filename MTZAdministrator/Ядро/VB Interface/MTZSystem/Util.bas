...
If Name = "the_Session" Then
 Set FormByName = New frmthe_Session_
 Exit Function
End If

If Name = "Verb" Then
 Set FormByName = New frmVerb_
 Exit Function
End If

If Name = "LogReader" Then
 Set FormByName = New frmLogReader_
 Exit Function
End If

If Name = "SysLog" Then
 Set FormByName = New frmSysLog_
 Exit Function
End If
