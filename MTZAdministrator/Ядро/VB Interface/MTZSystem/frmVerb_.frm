...
Begin VB.Form frmVerb_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Защищаемые системой дейсвия"
      Top             =   6225
      Width           =   825
   End
   Begin MTZSystemGUI.Verb Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела Verb режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{2E9F6A99-E4BD-4F7B-9475-D1D44034F1F7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{2E9F6A99-E4BD-4F7B-9475-D1D44034F1F7}"
  Open s & Me.Name & "{2E9F6A99-E4BD-4F7B-9475-D1D44034F1F7}" For Output As #ff
