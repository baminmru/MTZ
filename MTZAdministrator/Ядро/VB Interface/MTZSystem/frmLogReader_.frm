VERSION 5.00
Begin VB.Form frmLogReader_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Роботы журнала событий"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Программы, которые егистрируют себя как обработчики лога событий."
      Top             =   6225
      Width           =   825
   End
   Begin MTZSystemGUI.LogReader Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmLogReader_"
...
' Форма редактирования раздела LogReader режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{7086CDCA-7DCE-47CB-8E93-BA154C51737E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{7086CDCA-7DCE-47CB-8E93-BA154C51737E}"
  Open s & Me.Name & "{7086CDCA-7DCE-47CB-8E93-BA154C51737E}" For Output As #ff
