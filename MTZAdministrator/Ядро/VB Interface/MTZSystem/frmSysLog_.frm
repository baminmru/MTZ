...
Begin VB.Form frmSysLog_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Журнал событий, которые произошли в системе"
      Top             =   6225
      Width           =   825
   End
   Begin MTZSystemGUI.SysLog Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела SysLog режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{45EADAE8-9837-4EE5-9A31-07370302F20F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{45EADAE8-9837-4EE5-9A31-07370302F20F}"
  Open s & Me.Name & "{45EADAE8-9837-4EE5-9A31-07370302F20F}" For Output As #ff
