VERSION 5.00
Begin VB.Form frmNEXTSTATE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Разрешенные переходы"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Матрица переходов "
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.NEXTSTATE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmNEXTSTATE_"
...
' Форма редактирования раздела NEXTSTATE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{11C1A179-29B2-4DDC-BDB7-1EB21D2FF878}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{11C1A179-29B2-4DDC-BDB7-1EB21D2FF878}"
  Open s & Me.Name & "{11C1A179-29B2-4DDC-BDB7-1EB21D2FF878}" For Output As #ff
