VERSION 5.00
Begin VB.Form frmSTRUCTRESTRICTION_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Органичения разделов"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Ораничения на доступ к разделу документа"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.STRUCTRESTRICTION Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSTRUCTRESTRICTION_"
...
' Форма редактирования раздела STRUCTRESTRICTION режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F448AC33-3B13-4899-93EE-47D3D62962EC}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F448AC33-3B13-4899-93EE-47D3D62962EC}"
  Open s & Me.Name & "{F448AC33-3B13-4899-93EE-47D3D62962EC}" For Output As #ff
