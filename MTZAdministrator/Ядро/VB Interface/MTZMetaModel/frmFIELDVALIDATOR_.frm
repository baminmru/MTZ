VERSION 5.00
Begin VB.Form frmFIELDVALIDATOR_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Логика поля на форме"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Логика взаимосвязей на форме при изменении поля"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.FIELDVALIDATOR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFIELDVALIDATOR_"
...
' Форма редактирования раздела FIELDVALIDATOR режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{B40BBED5-84C5-4B0B-8679-172AA1ACDAD9}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{B40BBED5-84C5-4B0B-8679-172AA1ACDAD9}"
  Open s & Me.Name & "{B40BBED5-84C5-4B0B-8679-172AA1ACDAD9}" For Output As #ff
