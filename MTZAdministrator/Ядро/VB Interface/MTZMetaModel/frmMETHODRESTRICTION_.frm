VERSION 5.00
Begin VB.Form frmMETHODRESTRICTION_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Ограничения методов"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Ограничение на использование методов раздела"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.METHODRESTRICTION Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmMETHODRESTRICTION_"
...
' Форма редактирования раздела METHODRESTRICTION режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0F7B3070-F709-4E7D-868C-CC337E3075D1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0F7B3070-F709-4E7D-868C-CC337E3075D1}"
  Open s & Me.Name & "{0F7B3070-F709-4E7D-868C-CC337E3075D1}" For Output As #ff
