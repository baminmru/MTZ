...
Begin VB.Form frmPARAMETERS_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Параметры метода"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.PARAMETERS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPARAMETERS_"
...
' Форма редактирования раздела PARAMETERS режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{E598E74C-A9DE-4041-86FA-972E95635600}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{E598E74C-A9DE-4041-86FA-972E95635600}"
  Open s & Me.Name & "{E598E74C-A9DE-4041-86FA-972E95635600}" For Output As #ff
