VERSION 5.00
Begin VB.Form frmFIELDEXPRESSION_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Выражение для вычисления поля или значение по умолчанию"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.FIELDEXPRESSION Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFIELDEXPRESSION_"
...
' Форма редактирования раздела FIELDEXPRESSION режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{34B08ED0-C4B5-4B9C-BA59-870A4599F52A}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{34B08ED0-C4B5-4B9C-BA59-870A4599F52A}"
  Open s & Me.Name & "{34B08ED0-C4B5-4B9C-BA59-870A4599F52A}" For Output As #ff
