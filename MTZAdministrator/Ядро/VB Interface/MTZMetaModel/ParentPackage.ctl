...
Begin VB.UserControl ParentPackage 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   End
End
Attribute VB_Name = "ParentPackage"
...
'панель редактировани€ раздела ѕриложени€ от которых зависит данное приложение
