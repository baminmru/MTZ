...
Begin VB.Form frmOBJECTMODE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZMetaModelGUI.OBJECTMODE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmOBJECTMODE_"
...
' Форма редактирования раздела OBJECTMODE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{1168296D-A01C-45DB-B67D-76A07F3FF64C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{1168296D-A01C-45DB-B67D-76A07F3FF64C}"
  Open s & Me.Name & "{1168296D-A01C-45DB-B67D-76A07F3FF64C}" For Output As #ff
