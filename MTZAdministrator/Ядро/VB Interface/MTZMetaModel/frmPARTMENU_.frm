VERSION 5.00
Begin VB.Form frmPARTMENU_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Методы раздела"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Методы уровня раздела"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.PARTMENU Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPARTMENU_"
...
' Форма редактирования раздела PARTMENU режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{548E9E2E-89F6-4822-A312-101CA4A9FE74}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{548E9E2E-89F6-4822-A312-101CA4A9FE74}"
  Open s & Me.Name & "{548E9E2E-89F6-4822-A312-101CA4A9FE74}" For Output As #ff
