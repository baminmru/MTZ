...
Begin VB.Form frmMTZAPP_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Группа взаимосвязных документов"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.MTZAPP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела MTZAPP режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8CDBE0C2-5989-4210-BDFB-33C2C45F2509}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8CDBE0C2-5989-4210-BDFB-33C2C45F2509}"
  Open s & Me.Name & "{8CDBE0C2-5989-4210-BDFB-33C2C45F2509}" For Output As #ff
