...
Begin VB.Form frmFIELDMENU_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Методы, ассоциированные с полем"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.FIELDMENU Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFIELDMENU_"
...
' Форма редактирования раздела FIELDMENU режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4189C3E4-71C2-423D-A56F-4E71CB91B52D}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4189C3E4-71C2-423D-A56F-4E71CB91B52D}"
  Open s & Me.Name & "{4189C3E4-71C2-423D-A56F-4E71CB91B52D}" For Output As #ff
