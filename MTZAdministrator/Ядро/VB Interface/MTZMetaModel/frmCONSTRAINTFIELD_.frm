VERSION 5.00
Begin VB.Form frmCONSTRAINTFIELD_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Поля ограничения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Поля ограничения"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.CONSTRAINTFIELD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmCONSTRAINTFIELD_"
...
' Форма редактирования раздела CONSTRAINTFIELD режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{C70106B1-AA95-4173-8097-614495D6EF28}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{C70106B1-AA95-4173-8097-614495D6EF28}"
  Open s & Me.Name & "{C70106B1-AA95-4173-8097-614495D6EF28}" For Output As #ff
