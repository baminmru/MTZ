...
Begin VB.Form frmSCRIPT_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Код метода на понятном конкретному генератору языке"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.SCRIPT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
' Форма редактирования раздела SCRIPT режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0670EFA3-5127-11D5-8822-204C4F4F5020}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0670EFA3-5127-11D5-8822-204C4F4F5020}"
  Open s & Me.Name & "{0670EFA3-5127-11D5-8822-204C4F4F5020}" For Output As #ff
