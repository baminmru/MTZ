VERSION 5.00
Begin VB.Form frmLocalizeInfo_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZMetaModelGUI.LocalizeInfo Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmLocalizeInfo_"
...
' Форма редактирования раздела LocalizeInfo режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{A57D435A-73B3-4107-B22B-C18782085C84}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{A57D435A-73B3-4107-B22B-C18782085C84}"
  Open s & Me.Name & "{A57D435A-73B3-4107-B22B-C18782085C84}" For Output As #ff
