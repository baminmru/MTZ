...
Begin VB.Form frmPARTVIEW_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Вариант представления, который может использоваться для создания журнала"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.PARTVIEW Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPARTVIEW_"
...
' Форма редактирования раздела PARTVIEW режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D713B64D-4CE8-466D-BE2B-448874DC0469}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D713B64D-4CE8-466D-BE2B-448874DC0469}"
  Open s & Me.Name & "{D713B64D-4CE8-466D-BE2B-448874DC0469}" For Output As #ff
