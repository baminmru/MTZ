...
Begin VB.Form frmFIELDSRCDEF_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Описание источника данных для полей типа ReferenceSQL "
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.FIELDSRCDEF Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFIELDSRCDEF_"
...
' Форма редактирования раздела FIELDSRCDEF режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{D3F1AF81-912C-4948-A87D-DF549EE796E2}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{D3F1AF81-912C-4948-A87D-DF549EE796E2}"
  Open s & Me.Name & "{D3F1AF81-912C-4948-A87D-DF549EE796E2}" For Output As #ff
