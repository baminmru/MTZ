VERSION 5.00
Begin VB.Form frmUNIQUECONSTRAINT_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Ограничение уникальности"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Ограничение уникальности"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.UNIQUECONSTRAINT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmUNIQUECONSTRAINT_"
...
' Форма редактирования раздела UNIQUECONSTRAINT режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{9CAA5C89-F1CB-4B62-B1D0-FF2D29A40057}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{9CAA5C89-F1CB-4B62-B1D0-FF2D29A40057}"
  Open s & Me.Name & "{9CAA5C89-F1CB-4B62-B1D0-FF2D29A40057}" For Output As #ff
