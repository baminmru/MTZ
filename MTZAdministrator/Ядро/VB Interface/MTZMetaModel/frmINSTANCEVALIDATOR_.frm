VERSION 5.00
Begin VB.Form frmINSTANCEVALIDATOR_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Проверка правильности"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Проверка правильности для объекта в целом"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.INSTANCEVALIDATOR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmINSTANCEVALIDATOR_"
...
' Форма редактирования раздела INSTANCEVALIDATOR режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{42515BAD-E233-40DB-8F90-45DCFCE01BE6}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{42515BAD-E233-40DB-8F90-45DCFCE01BE6}"
  Open s & Me.Name & "{42515BAD-E233-40DB-8F90-45DCFCE01BE6}" For Output As #ff
