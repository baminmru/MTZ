VERSION 5.00
Begin VB.Form frmGENCONTROLS_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Контрольные элементы"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Контрольные элементы, которые используются при генерации"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.GENCONTROLS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGENCONTROLS_"
...
' Форма редактирования раздела GENCONTROLS режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{04B31CFB-6525-474A-9F16-999870D8EAAF}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{04B31CFB-6525-474A-9F16-999870D8EAAF}"
  Open s & Me.Name & "{04B31CFB-6525-474A-9F16-999870D8EAAF}" For Output As #ff
