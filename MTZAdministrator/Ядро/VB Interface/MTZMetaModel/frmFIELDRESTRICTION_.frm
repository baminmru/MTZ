VERSION 5.00
Begin VB.Form frmFIELDRESTRICTION_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Ограничения полей"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Ограничения на доступ к полям раздела"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.FIELDRESTRICTION Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFIELDRESTRICTION_"
...
' Форма редактирования раздела FIELDRESTRICTION режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{24C5119C-5DC9-4AAC-BB01-B8CF8EBA998E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{24C5119C-5DC9-4AAC-BB01-B8CF8EBA998E}"
  Open s & Me.Name & "{24C5119C-5DC9-4AAC-BB01-B8CF8EBA998E}" For Output As #ff
