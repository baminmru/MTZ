...
Begin VB.Form frmViewColumn_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Колонка пердставления"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.ViewColumn Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmViewColumn_"
...
' Форма редактирования раздела ViewColumn режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{3BF43D5E-0EB5-4DDB-8EFA-62DF3261A272}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{3BF43D5E-0EB5-4DDB-8EFA-62DF3261A272}"
  Open s & Me.Name & "{3BF43D5E-0EB5-4DDB-8EFA-62DF3261A272}" For Output As #ff
