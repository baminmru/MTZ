...
Begin VB.UserControl FIELDSRCDEF 
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.ComboBox cmbDontShowDialog 
         ...
         TabIndex        =   18
         ToolTipText     =   "Не показывать форму выбора"
         Top             =   405
         Width           =   3000
      End
      ...
      Begin VB.TextBox txtSortField 
         ...
         MaxLength       =   512
         TabIndex        =   14
         ToolTipText     =   "Сортировка источника данных"
         Top             =   4635
         Width           =   3000
      End
      Begin VB.TextBox txtFilterString 
         ...
         MaxLength       =   512
         TabIndex        =   12
         ToolTipText     =   "Фильтр источника данных"
         Top             =   3930
         Width           =   3000
      End
      Begin VB.TextBox txtBriefString 
         ...
         MaxLength       =   512
         TabIndex        =   10
         ToolTipText     =   "Источник краткой информации"
         Top             =   3225
         Width           =   3000
      End
      ...
      Begin VB.TextBox txtConnectionString 
         ...
         MaxLength       =   512
         TabIndex        =   4
         ToolTipText     =   "Строка соединения с источником"
         Top             =   1110
         Width           =   3000
      End
      Begin VB.TextBox txtProvider 
         ...
         MaxLength       =   128
         TabIndex        =   2
         ToolTipText     =   "Провайдер"
         Top             =   405
         Width           =   3000
      End
      Begin VB.Label lblDontShowDialog 
         BackStyle       =   0  'Transparent
         Caption         =   "Не показывать форму выбора:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   3450
         TabIndex        =   17
      ...
      Begin VB.Label lblSortField 
         BackStyle       =   0  'Transparent
         Caption         =   "Сортировка источника данных:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   13
      ...
      Begin VB.Label lblFilterString 
         BackStyle       =   0  'Transparent
         Caption         =   "Фильтр источника данных:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   11
      ...
      Begin VB.Label lblBriefString 
         BackStyle       =   0  'Transparent
         Caption         =   "Источник краткой информации:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   9
      ...
      Begin VB.Label lblConnectionString 
         BackStyle       =   0  'Transparent
         Caption         =   "Строка соединения с источником:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   3
...
'панель редактирования раздела Описание источника данных для полей типа ReferenceSQL
...
cmbDontShowDialog.AddItem "Да"
cmbDontShowDialog.ItemData(cmbDontShowDialog.NewIndex) = 1
cmbDontShowDialog.AddItem "Нет"
