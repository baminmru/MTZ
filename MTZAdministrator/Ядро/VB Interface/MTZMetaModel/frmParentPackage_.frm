VERSION 5.00
Begin VB.Form frmParentPackage_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Обязательные приложения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Приложения от которых зависит данное приложение"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.ParentPackage Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmParentPackage_"
...
' Форма редактирования раздела ParentPackage режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{6EA00756-B980-4D23-B209-202389953A13}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{6EA00756-B980-4D23-B209-202389953A13}"
  Open s & Me.Name & "{6EA00756-B980-4D23-B209-202389953A13}" For Output As #ff
