VERSION 5.00
Begin VB.Form frmFldExtenders_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZMetaModelGUI.FldExtenders Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFldExtenders_"
...
' Форма редактирования раздела FldExtenders режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{5D0B0E1A-8036-4B12-B081-60139558B594}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{5D0B0E1A-8036-4B12-B081-60139558B594}"
  Open s & Me.Name & "{5D0B0E1A-8036-4B12-B081-60139558B594}" For Output As #ff
