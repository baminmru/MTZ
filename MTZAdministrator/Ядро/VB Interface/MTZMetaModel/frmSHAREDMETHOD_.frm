VERSION 5.00
Begin VB.Form frmSHAREDMETHOD_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Методы и процедуры"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Методы и процедуры"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.SHAREDMETHOD Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmSHAREDMETHOD_"
...
' Форма редактирования раздела SHAREDMETHOD режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0670EFAD-5127-11D5-8822-204C4F4F5020}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0670EFAD-5127-11D5-8822-204C4F4F5020}"
  Open s & Me.Name & "{0670EFAD-5127-11D5-8822-204C4F4F5020}" For Output As #ff
