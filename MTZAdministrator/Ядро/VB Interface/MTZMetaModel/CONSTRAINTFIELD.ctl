...
Begin VB.UserControl CONSTRAINTFIELD 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   End
End
Attribute VB_Name = "CONSTRAINTFIELD"
...
'панель редактирования раздела Поля ограничения
...
If mIsOK Then mIsOK = txtTheField.Tag <> ""
  IsOK = mIsOK
End Function
