VERSION 5.00
Begin VB.Form frmVALIDATOR_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Логика на форме"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Действия в впроцессе редактирования"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.VALIDATOR Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmVALIDATOR_"
...
' Форма редактирования раздела VALIDATOR режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{7D323655-BAD7-4D12-AFC2-E7FF3613B4A1}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{7D323655-BAD7-4D12-AFC2-E7FF3613B4A1}"
  Open s & Me.Name & "{7D323655-BAD7-4D12-AFC2-E7FF3613B4A1}" For Output As #ff
