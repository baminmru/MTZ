...
Begin VB.UserControl METHODRESTRICTION 
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.ComboBox cmbIsRestricted 
         ...
         TabIndex        =   8
         ToolTipText     =   "Запрещено использовать"
         Top             =   1815
         Width           =   3000
      End
      ...
      Begin MTZ_PANEL.DropButton cmdPart 
         ...
         TabIndex        =   3
         Tag             =   "refopen.ico"
         ToolTipText     =   "Структура, которой принадлежит метод"
         Top             =   405
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
      ...
      Begin VB.Label lblIsRestricted 
         ...
         Caption         =   "Запрещено использовать:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   7
      ...
      Begin VB.Label lblPart 
         BackStyle       =   0  'Transparent
         Caption         =   "Структура, которой принадлежит метод:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   1
...
'панель редактирования раздела Ограничение на использование методов раздела
...
cmbIsRestricted.AddItem "Да"
cmbIsRestricted.ItemData(cmbIsRestricted.NewIndex) = -1
cmbIsRestricted.AddItem "Нет"
