VERSION 5.00
Begin VB.Form frmPARTPARAMMAP_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Отображение параметров"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "отображение значений полей раздела на параметры метода"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.PARTPARAMMAP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPARTPARAMMAP_"
...
' Форма редактирования раздела PARTPARAMMAP режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{F8BE6FCA-595D-4F46-ACDB-FB5838A246CA}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{F8BE6FCA-595D-4F46-ACDB-FB5838A246CA}"
  Open s & Me.Name & "{F8BE6FCA-595D-4F46-ACDB-FB5838A246CA}" For Output As #ff
