...
Begin VB.UserControl FIELDMENU 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      Begin VB.ComboBox cmbIsMenuItem 
         ...
         Width           =   3000
      End
      Begin MTZ_PANEL.DropButton cmdActionID 
         Height          =   300
         Left            =   2850
         TabIndex        =   9
         Tag             =   "refopen.ico"
         ToolTipText     =   "Идентификатор вызываемого метода"
         Top             =   2520
         Width           =   450
         _ExtentX        =   794
         _ExtentY        =   529
      ...
      Begin VB.Label lblIsMenuItem 
         ...
         Width           =   3000
      End
      Begin VB.Label lblActionID 
         BackStyle       =   0  'Transparent
         Caption         =   "Идентификатор вызываемого метода:"
         ForeColor       =   &H000000FF&
         Height          =   300
         Left            =   300
         TabIndex        =   7
...
'панель редактирования раздела Методы, ассоциированные с полем
...
End Sub
Private Sub txtActionID_Change()
  If Not (OnInit) Then
  Changing

  End If
End Sub
Private Sub cmdActionID_CLick()
  On Error Resume Next
        Dim ID As String, brief As String
        If Item.Application.Manager.GetReferenceDialogEx2("SHAREDMETHOD", ID, brief) Then
          txtActionID.Tag = Left(ID, 38)
          txtActionID = brief
        End If
End Sub
Private Sub cmdActionID_MenuClick(ByVal sCaption As String)
          txtActionID.Tag = ""
          txtActionID = ""
End Sub
...
If mIsOK Then mIsOK = txtActionID.Tag <> ""
  IsOK = mIsOK
End Function
...
If Not Item.ActionID Is Nothing Then
  ...
  txtActionID = Item.ActionID.brief
Else
  txtActionID.Tag = ""
  txtActionID = ""
End If
 LoadBtnPictures cmdActionID, cmdActionID.Tag
  cmdActionID.RemoveAllMenu
  cmdActionID.AddMenu "Очистить"
cmbIsMenuItem.Clear
...
If txtActionID.Tag <> "" Then
  Set Item.ActionID = Item.Application.FindRowObject("SHAREDMETHOD", txtActionID.Tag)
Else
  Set Item.ActionID = Nothing
End If
