VERSION 5.00
Begin VB.Form frmGENPACKAGE_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Пакет генерации"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Пакет генерации"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.GENPACKAGE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGENPACKAGE_"
...
' Форма редактирования раздела GENPACKAGE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{4612C605-7E72-47D0-8A28-52CC7BFF4C7F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{4612C605-7E72-47D0-8A28-52CC7BFF4C7F}"
  Open s & Me.Name & "{4612C605-7E72-47D0-8A28-52CC7BFF4C7F}" For Output As #ff
