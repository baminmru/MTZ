VERSION 5.00
Begin VB.Form frmFIELDPARAMMAP_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Отображение значений на параметры метода"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.FIELDPARAMMAP Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmFIELDPARAMMAP_"
...
' Форма редактирования раздела FIELDPARAMMAP режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{54752AE8-06B0-4EC6-8DAA-692E52A0D36C}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{54752AE8-06B0-4EC6-8DAA-692E52A0D36C}"
  Open s & Me.Name & "{54752AE8-06B0-4EC6-8DAA-692E52A0D36C}" For Output As #ff
