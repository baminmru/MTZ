VERSION 5.00
Begin VB.Form frmGENMANUALCODE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Код, который не укладывается в описание модели"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.GENMANUALCODE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGENMANUALCODE_"
...
' Форма редактирования раздела GENMANUALCODE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{766993CA-7DE6-4ADA-8216-8BDDF2B0588E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{766993CA-7DE6-4ADA-8216-8BDDF2B0588E}"
  Open s & Me.Name & "{766993CA-7DE6-4ADA-8216-8BDDF2B0588E}" For Output As #ff
