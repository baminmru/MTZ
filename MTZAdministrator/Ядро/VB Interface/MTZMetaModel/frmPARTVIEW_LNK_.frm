VERSION 5.00
Begin VB.Form frmPARTVIEW_LNK_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Связанные представления"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZMetaModelGUI.PARTVIEW_LNK Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmPARTVIEW_LNK_"
...
' Форма редактирования раздела PARTVIEW_LNK режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{EFAD7FA2-A77C-4A30-A0E1-FF0FFE0E4A61}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{EFAD7FA2-A77C-4A30-A0E1-FF0FFE0E4A61}"
  Open s & Me.Name & "{EFAD7FA2-A77C-4A30-A0E1-FF0FFE0E4A61}" For Output As #ff
