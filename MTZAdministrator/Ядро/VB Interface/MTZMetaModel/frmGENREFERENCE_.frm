VERSION 5.00
Begin VB.Form frmGENREFERENCE_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Библиотеки, которые используются при генерации"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.GENREFERENCE Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmGENREFERENCE_"
...
' Форма редактирования раздела GENREFERENCE режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{673E809B-CFF6-4309-A52B-FE2118AE508E}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{673E809B-CFF6-4309-A52B-FE2118AE508E}"
  Open s & Me.Name & "{673E809B-CFF6-4309-A52B-FE2118AE508E}" For Output As #ff
