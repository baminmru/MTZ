VERSION 5.00
Begin VB.Form frmDINAMICFILTERSCRIPT_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Динамический фильтр"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Выражение для построения дополнительного фильтра для ссылочных полей"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.DINAMICFILTERSCRIPT Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmDINAMICFILTERSCRIPT_"
...
' Форма редактирования раздела DINAMICFILTERSCRIPT режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{23E26182-CC84-42D6-B7A2-D8DA0026EBEE}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{23E26182-CC84-42D6-B7A2-D8DA0026EBEE}"
  Open s & Me.Name & "{23E26182-CC84-42D6-B7A2-D8DA0026EBEE}" For Output As #ff
