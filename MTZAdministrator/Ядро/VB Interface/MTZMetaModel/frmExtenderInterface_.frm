VERSION 5.00
Begin VB.Form frmExtenderInterface_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Интерфейсы расширения"
   ClientHeight    =   6810
   ClientLeft      =   60
   ClientTop       =   330
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Width           =   825
   End
   Begin MTZMetaModelGUI.ExtenderInterface Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmExtenderInterface_"
...
' Форма редактирования раздела ExtenderInterface режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{0FEFA996-3BAD-4EBB-A9AD-52AC582CD0A7}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{0FEFA996-3BAD-4EBB-A9AD-52AC582CD0A7}"
  Open s & Me.Name & "{0FEFA996-3BAD-4EBB-A9AD-52AC582CD0A7}" For Output As #ff
