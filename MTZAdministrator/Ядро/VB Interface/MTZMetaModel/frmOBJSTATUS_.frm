...
Begin VB.Form frmOBJSTATUS_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Возможные логические состояния документа"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.OBJSTATUS Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmOBJSTATUS_"
...
' Форма редактирования раздела OBJSTATUS режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{DF46C866-38F8-4EF1-92E2-5F899D98BD16}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{DF46C866-38F8-4EF1-92E2-5F899D98BD16}"
  Open s & Me.Name & "{DF46C866-38F8-4EF1-92E2-5F899D98BD16}" For Output As #ff
