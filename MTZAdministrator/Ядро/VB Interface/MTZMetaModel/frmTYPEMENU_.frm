...
Begin VB.Form frmTYPEMENU_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Методы уровня типа"
      Top             =   6225
      Width           =   825
   End
   Begin MTZMetaModelGUI.TYPEMENU Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmTYPEMENU_"
...
' Форма редактирования раздела TYPEMENU режим
...
Private Sub LoadFormSkin()
  ...
  ff = FreeFile
  Open s & Me.Name & "{8776747A-743D-47B9-AF1C-AB00FF81154F}" For Input As #ff
  buf = Input(LOF(ff), ff)
  Close #ff
...
Private Sub SaveToSkin()
  ...
  Dim ff As Long
  ff = FreeFile
  Kill s & Me.Name & "{8776747A-743D-47B9-AF1C-AB00FF81154F}"
  Open s & Me.Name & "{8776747A-743D-47B9-AF1C-AB00FF81154F}" For Output As #ff
