...
Begin VB.Form frmWF 
   ...
   Begin MSComctlLib.ImageList ImageList3 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmWF.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmWF.frx":0894
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame pnlProcessList 
      ...
      Begin GridEX20.GridEX grdPrcList 
         ...
         IntProp7        =   0
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmWF.frx":0CE6
         FormatStyle(2)  =   "frmWF.frx":0DC6
         FormatStyle(3)  =   "frmWF.frx":0F22
         FormatStyle(4)  =   "frmWF.frx":0FD2
         FormatStyle(5)  =   "frmWF.frx":1086
         FormatStyle(6)  =   "frmWF.frx":115E
         ImageCount      =   0
         PrinterProperties=   "frmWF.frx":1216
      End
   End
   Begin VB.Frame pnlTaskList 
      ...
      Begin GridEX20.GridEX grdTaskList 
         ...
         IntProp7        =   0
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmWF.frx":13EE
         FormatStyle(2)  =   "frmWF.frx":14CE
         FormatStyle(3)  =   "frmWF.frx":162A
         FormatStyle(4)  =   "frmWF.frx":16DA
         FormatStyle(5)  =   "frmWF.frx":178E
         FormatStyle(6)  =   "frmWF.frx":1866
         ImageCount      =   0
         PrinterProperties=   "frmWF.frx":191E
      End
   End
...
again:
  ...
  Set rs = Session.GetRow("the_session", Session.sessionid)
  UserID = rs!UsersID
  Set rs = Nothing
...
Private Sub grdPrcList_UnboundReadData(ByVal RowIndex As Long, ByVal Bookmark As Variant, ByVal Values As GridEX20.JSRowData)
  ...
  If RowIndex > 0 And RowIndex <= count Then
    ...
    Else
      Set Def = Rtm.WFRtm_main.Item(1).BasedOn
      Values.Value(1) = Left(Replace(Rtm.Name & "(" & Def.WFDef_INFO.Item(1).the_Description & ")", vbCrLf, " "), 255)
    End If
