...
Begin VB.UserControl vpnWFDef_master_M0 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlWFDef_master 
      ...
      Begin GridEX20.GridEX gridWFDef_master 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWFDef_master_M0.ctx":0000
         Column(2)       =   "vpnWFDef_master_M0.ctx":00C8
         FormatStylesCount=   6
         FormatStyle(1)  =   "vpnWFDef_master_M0.ctx":016C
         FormatStyle(2)  =   "vpnWFDef_master_M0.ctx":024C
         FormatStyle(3)  =   "vpnWFDef_master_M0.ctx":03A8
         FormatStyle(4)  =   "vpnWFDef_master_M0.ctx":0458
         FormatStyle(5)  =   "vpnWFDef_master_M0.ctx":050C
         FormatStyle(6)  =   "vpnWFDef_master_M0.ctx":05E4
         ImageCount      =   0
         PrinterProperties=   "vpnWFDef_master_M0.ctx":069C
      End
   ...
   End
End
Attribute VB_Name = "vpnWFDef_master_M0"
