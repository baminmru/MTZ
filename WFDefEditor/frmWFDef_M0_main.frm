...
Begin VB.Form frmWFDef_M0_main 
   ...
   End
End
Attribute VB_Name = "frmWFDef_M0_main"
...
If gridWFDef_links.Row > 0 Then
 If gridWFDef_links.RowIndex(gridWFDef_links.Row) > 0 Then
    ...
    bm = gridWFDef_links.RowBookmark(gridWFDef_links.RowIndex(gridWFDef_links.Row))
    Set u = Item.FindRowObject(Right(bm, Len(bm) - 38), Left(bm, 38))
    Set frmWFDef_links_M0.Item = u
again:     frmWFDef_links_M0.NotFirstTime = False
    frmWFDef_links_M0.Show vbModal
    If frmWFDef_links_M0.OK Then
    On Error Resume Next
    Err.Clear
    u.Save
...
Private Sub cmdWFDef_linkresEdit_Click()
    ...
    Set frmWFDef_linkres_M0.Item = u
again:     frmWFDef_linkres_M0.NotFirstTime = False
    frmWFDef_linkres_M0.Show vbModal
    If frmWFDef_linkres_M0.OK Then
    On Error Resume Next
    Err.Clear
    u.Save
    If Err.Number <> 0 Then
...
If Name = "WFDef_links" Then
 Set FormByName = New frmWFDef_links_M0
 Exit Function
End If

If Name = "WFDef_linkres" Then
 Set FormByName = New frmWFDef_linkres_M0
 Exit Function
End If
