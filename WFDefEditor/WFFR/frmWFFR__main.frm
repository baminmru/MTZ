...
Begin VB.Form frmWFFR__main 
   ...
   End
End
Attribute VB_Name = "frmWFFR__main"
...
If (treeWFFR_Fcomm.SelectedItem Is Nothing) Then Exit Sub
  ...
  Set f = p.WFFR_Fcomm.Add()
      ...
      Set frmWFFR_Fcomm_.Item = f
again:       frmWFFR_Fcomm_.NotFirstTime = False
      frmWFFR_Fcomm_.Show vbModal
      If frmWFFR_Fcomm_.OK Then
        Err.Clear
        f.Save
...
If Name = "WFFR_func" Then
 Set FormByName = New frmWFFR_func_
 Exit Function
End If

If Name = "WFFR_Fcomm" Then
 Set FormByName = New frmWFFR_Fcomm_
 Exit Function
End If
