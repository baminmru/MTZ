VERSION 5.00
Begin VB.Form frmWFFD_CustomParam_ 
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Дополнительные параметры, зависящие от типа функции"
      Top             =   6225
      Width           =   825
   End
   Begin WFFDGUI.WFFD_CustomParam Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFFD_CustomParam_"
