VERSION 5.00
Begin VB.Form frmWFFD_Results_ 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Возможные результаты"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   "Функция может закончится с некоторым результатом: Принять Оплатить и т.п. "
      Top             =   6225
      Width           =   825
   End
   Begin WFFDGUI.WFFD_Results Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFFD_Results_"
