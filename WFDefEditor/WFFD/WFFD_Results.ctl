...
Begin VB.UserControl WFFD_Results 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin MTZ_PANEL.ScrolledWindow Panel 
      ...
      _ExtentX        =   1773
      _ExtentY        =   1773
      Begin VB.TextBox txtResultWeight 
         Height          =   300
         Left            =   300
         MaxLength       =   27
         TabIndex        =   4
         ToolTipText     =   "Весовой коэффицент"
         Top             =   1110
         Width           =   1800
      End
      Begin VB.TextBox txtName 
         ...
         Width           =   3000
      End
      Begin VB.Label lblResultWeight 
         BackStyle       =   0  'Transparent
         Caption         =   "Весовой коэффицент:"
         ForeColor       =   &H00FF0000&
         Height          =   300
         Left            =   300
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "WFFD_Results"
...
Option Explicit
   ...
   Public item As WFFD.WFFD_Results
...
If txtResultWeight.Text <> "" Then
 On Error Resume Next
  ...
  ElseIf Val(txtResultWeight.Text) < -922337203685478# Or Val(txtResultWeight.Text) > 922337203685478# Then
     Cancel = True
