...
Begin VB.UserControl vpnWFFD_Results_ 
   ...
   Begin MTZ_PANEL.HFrames pnlWFFD_Results 
      ...
      _ExtentX        =   15875
      _ExtentY        =   10583
      Begin VB.CommandButton cmdWFFD_DOCSTOPSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   20
         ...
         Width           =   330
      End
      Begin MTZ_PANEL.DropButton cmdWFFD_DOCSTOPSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   19
         Tag             =   "run.ico"
      ...
      Begin VB.CommandButton cmdWFFD_DOCSTOPSFnd 
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWFFD_DOCSTOPSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin GridEX20.GridEX gridWFFD_DOCSTOPS 
         ...
         FormatStyle(6)  =   "vpnWFFD_Results_.ctx":05BC
         ImageCount      =   0
         PrinterProperties=   "vpnWFFD_Results_.ctx":069C
      End
      ...
      Begin GridEX20.GridEX gridWFFD_Results 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWFFD_Results_.ctx":0874
         Column(2)       =   "vpnWFFD_Results_.ctx":093C
         FormatStylesCount=   6
         FormatStyle(1)  =   "vpnWFFD_Results_.ctx":09E0
         FormatStyle(2)  =   "vpnWFFD_Results_.ctx":0B3C
         FormatStyle(3)  =   "vpnWFFD_Results_.ctx":0BEC
         FormatStyle(4)  =   "vpnWFFD_Results_.ctx":0CA0
         FormatStyle(5)  =   "vpnWFFD_Results_.ctx":0D78
         FormatStyle(6)  =   "vpnWFFD_Results_.ctx":0E30
         ImageCount      =   0
         PrinterProperties=   "vpnWFFD_Results_.ctx":0F10
      End
   End
   ...
   Begin VB.Menu mnuPopupWFFD_DOCSTOPS 
      ...
      Begin VB.Menu mnuWFFD_DOCSTOPSFind 
         Caption         =   "Поиск"
      End
      Begin VB.Menu mnuWFFD_DOCSTOPSAcc 
         Caption         =   "Стиль защиты"
      End
   End
End
...
Private Sub pnlWFFD_Results_MasterResize(ByVal Top As Single, ByVal Left As Single, ByVal Width As Single, ByVal Height As Single)
  ...
  gridWFFD_Results.Height = Height - 25 * Screen.TwipsPerPixelY
   ...
   cmdWFFD_ResultsCfg.Top = Top + 2 * Screen.TwipsPerPixelY
   cmdWFFD_ResultsFnd.Top = Top + 2 * Screen.TwipsPerPixelY
   cmdWFFD_ResultsRun.Top = Top + 2 * Screen.TwipsPerPixelY
   cmdWFFD_ResultsAcc.Top = Top + 2 * Screen.TwipsPerPixelY
   ...
   cmdWFFD_ResultsCfg.Left = Left + 130 * Screen.TwipsPerPixelX
   cmdWFFD_ResultsFnd.Left = Left + 155 * Screen.TwipsPerPixelX
   cmdWFFD_ResultsRun.Left = Left + 180 * Screen.TwipsPerPixelX
   cmdWFFD_ResultsAcc.Left = Left + 205 * Screen.TwipsPerPixelX
End Sub
...
Private Sub pnlWFFD_Results_SlaveResize(ByVal Top As Single, ByVal Left As Single, ByVal Width As Single, ByVal Height As Single)
  ...
  gridWFFD_DOCSTOPS.Height = Height - 25 * Screen.TwipsPerPixelY
   ...
   cmdWFFD_DOCSTOPSCfg.Top = Top + 2 * Screen.TwipsPerPixelY
   cmdWFFD_DOCSTOPSFnd.Top = Top + 2 * Screen.TwipsPerPixelY
   cmdWFFD_DOCSTOPSRun.Top = Top + 2 * Screen.TwipsPerPixelY
   cmdWFFD_DOCSTOPSAcc.Top = Top + 2 * Screen.TwipsPerPixelY
   ...
   cmdWFFD_DOCSTOPSCfg.Left = Left + 130 * Screen.TwipsPerPixelX
   cmdWFFD_DOCSTOPSFnd.Left = Left + 155 * Screen.TwipsPerPixelX
   cmdWFFD_DOCSTOPSRun.Left = Left + 180 * Screen.TwipsPerPixelX
   cmdWFFD_DOCSTOPSAcc.Left = Left + 205 * Screen.TwipsPerPixelX
End Sub
...
again:       frmWFFD_DOCSTOPS_.NotFirstTime = False
      ...
      Else
        item.WFFD_DOCSTOPS.Remove u.ID
      End If
Exit Sub
bye:
MsgBox Err.Description, vbOKOnly + vbExclamation, "Создание"
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  LoadBtnPictures cmdWFFD_DOCSTOPSCfg, cmdWFFD_DOCSTOPSCfg.Tag
  LoadBtnPictures cmdWFFD_DOCSTOPSFnd, cmdWFFD_DOCSTOPSFnd.Tag
  LoadBtnPictures cmdWFFD_DOCSTOPSRun, cmdWFFD_DOCSTOPSRun.Tag
  LoadBtnPictures cmdWFFD_DOCSTOPSAcc, cmdWFFD_DOCSTOPSAcc.Tag
  gridWFFD_DOCSTOPS.Columns.Clear
  gridWFFD_DOCSTOPS.ItemCount = 0
