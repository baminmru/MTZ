...
Begin VB.UserControl vpnWFFD_DOCS_ 
   ...
   Begin VB.Frame pnlWFFD_DOCS 
      ...
      Top             =   0
      Width           =   9000
      Begin VB.CommandButton cmdWFFD_DOCSAcc 
         Height          =   330
         Left            =   3075
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdWFFD_DOCSFnd 
         ...
         Width           =   330
      End
      Begin VB.CommandButton cmdWFFD_DOCSCfg 
         Height          =   330
         Left            =   1950
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin GridEX20.GridEX gridWFFD_DOCS 
         ...
         FormatStyle(6)  =   "vpnWFFD_DOCS_.ctx":05BC
         ImageCount      =   0
         PrinterProperties=   "vpnWFFD_DOCS_.ctx":069C
      End
      Begin MTZ_PANEL.DropButton cmdWFFD_DOCSRun 
         Height          =   330
         Left            =   2700
         TabIndex        =   9
         Tag             =   "run.ico"
...
Public Sub OnInit(aItem As Object, Optional pForm As Object = Nothing)
 ...
 Set ParentForm = pForm
  ...
  LoadBtnPictures cmdWFFD_DOCSCfg, cmdWFFD_DOCSCfg.Tag
  LoadBtnPictures cmdWFFD_DOCSPrn, cmdWFFD_DOCSPrn.Tag
  LoadBtnPictures cmdWFFD_DOCSFnd, cmdWFFD_DOCSFnd.Tag
  LoadBtnPictures cmdWFFD_DOCSRun, cmdWFFD_DOCSRun.Tag
  LoadBtnPictures cmdWFFD_DOCSAcc, cmdWFFD_DOCSAcc.Tag
