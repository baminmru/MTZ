...
Begin VB.UserControl vpnWFDef_param_ 
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4800
   ...
   Begin VB.Frame pnlWFDef_param 
      ...
      Begin GridEX20.GridEX gridWFDef_param 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "vpnWFDef_param_.ctx":0000
         Column(2)       =   "vpnWFDef_param_.ctx":00C8
         FormatStylesCount=   6
         FormatStyle(1)  =   "vpnWFDef_param_.ctx":016C
         FormatStyle(2)  =   "vpnWFDef_param_.ctx":024C
         FormatStyle(3)  =   "vpnWFDef_param_.ctx":03A8
         FormatStyle(4)  =   "vpnWFDef_param_.ctx":0458
         FormatStyle(5)  =   "vpnWFDef_param_.ctx":050C
         FormatStyle(6)  =   "vpnWFDef_param_.ctx":05E4
         ImageCount      =   0
         PrinterProperties=   "vpnWFDef_param_.ctx":069C
      End
   ...
   End
End
Attribute VB_Name = "vpnWFDef_param_"
