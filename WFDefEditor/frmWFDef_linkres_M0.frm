VERSION 5.00
Begin VB.Form frmWFDef_linkres_M0 
   BorderStyle     =   5  'Sizable ToolWindow
   Caption         =   "Допустимые результаты"
   ClientHeight    =   6840
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   9480
   ...
   Begin VB.CommandButton cmdOK 
      ...
      Left            =   1275
      TabIndex        =   1
      ToolTipText     =   $"frmWFDef_linkres_M0.frx":0000
      Top             =   6225
      Width           =   825
   End
   Begin WFDefGUI.WFDef_linkresM0 Panel 
      Height          =   6000
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmWFDef_linkres_M0"
