...
Begin VB.UserControl vpnWFDef_Doc_M0 
   ...
   Begin VB.Frame pnlWFDef_Doc 
      ...
      Begin GridEX20.GridEX gridWFDef_Doc 
         ...
         FormatStyle(2)  =   "vpnWFDef_Doc_M0.ctx":024C
         FormatStyle(3)  =   "vpnWFDef_Doc_M0.ctx":03A8
         FormatStyle(4)  =   "vpnWFDef_Doc_M0.ctx":0458
         FormatStyle(5)  =   "vpnWFDef_Doc_M0.ctx":050C
         FormatStyle(6)  =   "vpnWFDef_Doc_M0.ctx":05E4
         ImageCount      =   0
         PrinterProperties=   "vpnWFDef_Doc_M0.ctx":069C
      End
